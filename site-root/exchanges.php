...
$T = [
  ...
  'id' => [
    'title'=>'Bursa Terbaik — Binance vs Bybit | BTCtiming',
    'desc'=>'Bandingkan bursa untuk mulai trading Bitcoin dan altcoin. Fitur, kelebihan dan kekurangan, diskon fee terbaik serta bonus pengguna baru untuk Binance dan Bybit.',
    'back'=>'Kembali ke Analisis Langsung',
    'h1'=>'Bursa mana yang sebaiknya Anda mulai?',
    'lead'=>'Untuk mengubah skor BTCtiming menjadi hasil nyata, Anda memerlukan akun bursa. Daftar di salah satu dari dua bursa paling banyak digunakan melalui tautan di bawah untuk mendapatkan <b>diskon trading fee</b> plus <b>bonus pengguna baru</b>.',
    'disc'=>'Diskon fee hingga %s%%',
    'hero_disc'=>'Daftar melalui tautan di sini untuk mendapatkan',
    'hero_disc2'=>'diskon fee + bonus pengguna baru',
    'binance_tag'=>'#1 berdasarkan volume',
    'binance_desc'=>'Bursa dengan volume tertinggi di dunia. Dengan 350+ koin yang terdaftar, ia menawarkan beragam altcoin, dan likuiditasnya yang dalam mengeksekusi order besar dengan slippage minimal. Spot, futures, margin, dan staking semuanya dalam satu tempat, dengan sumber belajar pemula yang solid — sangat cocok untuk pemula.',
    'bonus'=>'Bonus pengguna baru hingga $100 USDT',
    'bybit_tag'=>'Favorit para trader futures',
    'bybit_desc'=>'Bursa yang berfokus pada derivatif, populer di kalangan scalper dan trader leverage. Eksekusi cepat dan antarmuka yang bersih memudahkan entry dan exit cepat. Leverage hingga 100x, beragam jenis order, serta copy trading memungkinkan pemula meniru trader berpengalaman.',
    'bonus_y'=>'Bonus selamat datang hingga $30.000 USDT',
    'pros_label'=>'Kelebihan',
    'cons_label'=>'Kekurangan',
    'pros_b'=>['Likuiditas tak tertandingi — slippage minimal pada order besar','350+ koin; spot, futures & staking dalam satu','Sumber belajar pemula yang kuat','Diskon ekstra saat membayar fee dengan BNB'],
    'cons_b'=>['UI yang kaya fitur bisa terasa rumit pada awalnya','Beberapa pembatasan wilayah/produk'],
    'pros_y'=>['Eksekusi futures cepat — bagus untuk scalping','Leverage hingga 100x, banyak jenis order','Copy trading untuk meniru para profesional','Bonus selamat datang & dana percobaan'],
    'cons_y'=>['Lebih sedikit spot/altcoin dibanding Binance','Leverage tinggi membawa risiko liquidation besar'],
    'cta_binance'=>'Daftar di Binance & hemat',
    'cta_bybit'=>'Daftar di Bybit & hemat',
    'why_title'=>'Mengapa mendaftar melalui tautan?',
    'why'=>['Fee adalah biaya tetap pada setiap trade. Menetapkan diskon sekali saja membuat perbedaan besar dalam jangka panjang.','Bonus pengguna baru dan voucher adalah keuntungan sekali pakai yang hanya tersedia di awal.'],
    'verify_note'=>'Tarif yang ditampilkan adalah maksimum program (“hingga”). Tarif aktual Anda muncul di kolom Referral ID pada layar pendaftaran dan dapat bervariasi menurut wilayah, produk, dan kampanye.',
    'note'=>'Mendaftar melalui tautan di atas memberi Anda diskon trading fee dan keuntungan pengguna baru.',
    'risk'=>'⚠ Trading kripto, terutama futures dan leverage, membawa risiko kerugian yang tinggi. Skor BTCtiming hanya untuk informasi dan bukan nasihat keuangan. Trading atas kebijaksanaan dan risiko Anda sendiri.',
    'f_privacy'=>'Kebijakan Privasi',
    'f_terms'=>'Ketentuan Layanan',
    'f_sitemap'=>'Peta Situs',
    'f_disclaimer'=>'Bukan nasihat keuangan',
  ],
  'pl' => [
    'title'=>'Najlepsza giełda — Binance vs Bybit | BTCtiming',
    'desc'=>'Porównaj giełdy, aby zacząć handel Bitcoinem i altcoinami. Funkcje, zalety i wady, najlepsze zniżki na opłaty oraz bonusy dla nowych użytkowników Binance i Bybit.',
    'back'=>'Powrót do analizy na żywo',
    'h1'=>'Od której giełdy powinieneś zacząć?',
    'lead'=>'Aby przekuć wyniki BTCtiming w realne rezultaty, potrzebujesz konta na giełdzie. Zarejestruj się na jednej z dwóch najczęściej używanych giełd poprzez poniższe linki, aby otrzymać <b>zniżkę na opłaty transakcyjne</b> oraz <b>bonus dla nowych użytkowników</b>.',
    'disc'=>'Zniżka na opłaty do %s%%',
    'hero_disc'=>'Zarejestruj się przez linki tutaj, aby otrzymać',
    'hero_disc2'=>'zniżkę na opłaty + bonus dla nowych użytkowników',
    'binance_tag'=>'#1 pod względem wolumenu',
    'binance_desc'=>'Giełda o najwyższym wolumenie na świecie. Z ponad 350 notowanymi monetami oferuje szeroki wybór altcoinów, a jej głęboka płynność realizuje duże zlecenia przy minimalnym slippage. Spot, futures, margin i staking są w jednym miejscu, wraz z solidnymi materiałami dla początkujących — świetnie sprawdza się dla osób zaczynających.',
    'bonus'=>'Bonus dla nowych użytkowników do 100 USDT',
    'bybit_tag'=>'Ulubiona wśród traderów futures',
    'bybit_desc'=>'Giełda skupiona na instrumentach pochodnych, popularna wśród scalperów i traderów korzystających z leverage. Szybka realizacja i przejrzysty interfejs ułatwiają błyskawiczne wejścia i wyjścia. Leverage do 100x, wiele typów zleceń oraz copy trading pozwalają początkującym naśladować doświadczonych traderów.',
    'bonus_y'=>'Bonus powitalny do 30 000 USDT',
    'pros_label'=>'Zalety',
    'cons_label'=>'Wady',
    'pros_b'=>['Niezrównana płynność — minimalny slippage przy dużych zleceniach','350+ monet; spot, futures i staking w jednym','Silne materiały dla początkujących','Dodatkowa zniżka przy opłacaniu prowizji w BNB'],
    'cons_b'=>['Bogaty w funkcje interfejs może początkowo wydawać się złożony','Pewne ograniczenia regionalne/produktowe'],
    'pros_y'=>['Szybka realizacja futures — świetna do scalpingu','Leverage do 100x, wiele typów zleceń','Copy trading do naśladowania profesjonalistów','Bonus powitalny i środki próbne'],
    'cons_y'=>['Mniej spotów/altcoinów niż Binance','Wysoki leverage niesie duże ryzyko liquidation'],
    'cta_binance'=>'Zarejestruj się na Binance i oszczędzaj',
    'cta_bybit'=>'Zarejestruj się na Bybit i oszczędzaj',
    'why_title'=>'Dlaczego warto rejestrować się przez link?',
    'why'=>['Opłaty to stały koszt każdej transakcji. Jednorazowe ustawienie zniżki robi ogromną różnicę w dłuższej perspektywie.','Bonusy dla nowych użytkowników i vouchery to jednorazowe korzyści dostępne tylko na początku.'],
    'verify_note'=>'Pokazana stawka to maksimum programu („do”). Twoja rzeczywista stawka pojawia się w polu Referral ID na ekranie rejestracji i może się różnić w zależności od regionu, produktu i kampanii.',
    'note'=>'Rejestracja przez powyższe linki zapewnia zniżkę na opłaty transakcyjne oraz korzyści dla nowych użytkowników.',
    'risk'=>'⚠ Handel kryptowalutami, zwłaszcza futures i leverage, niesie wysokie ryzyko straty. Wyniki BTCtiming służą wyłącznie celom informacyjnym i nie stanowią porady finansowej. Handluj według własnego uznania i na własne ryzyko.',
    'f_privacy'=>'Polityka prywatności',
    'f_terms'=>'Warunki korzystania z usługi',
    'f_sitemap'=>'Mapa witryny',
    'f_disclaimer'=>'To nie porada finansowa',
  ],
  'it' => [
    'title'=>'Miglior exchange — Binance vs Bybit | BTCtiming',
    'desc'=>'Confronta gli exchange per iniziare a fare trading di Bitcoin e altcoin. Funzionalità, pro e contro, migliori sconti sulle commissioni e bonus per i nuovi utenti di Binance e Bybit.',
    'back'=>'Torna all\'analisi in tempo reale',
    'h1'=>'Con quale exchange dovresti iniziare?',
    'lead'=>'Per trasformare i punteggi di BTCtiming in risultati concreti serve un account su un exchange. Registrati su uno dei due exchange più usati tramite i link qui sotto per ottenere uno <b>sconto sulle commissioni di trading</b> più un <b>bonus per i nuovi utenti</b>.',
    'disc'=>'Sconto sulle commissioni fino al %s%%',
    'hero_disc'=>'Registrati tramite i link qui per ottenere',
    'hero_disc2'=>'uno sconto sulle commissioni + bonus per i nuovi utenti',
    'binance_tag'=>'#1 per volume',
    'binance_desc'=>'L\'exchange con il volume più alto al mondo. Con oltre 350 monete quotate offre un\'ampia gamma di altcoin, e la sua liquidità profonda esegue ordini di grandi dimensioni con slippage minimo. Spot, futures, margin e staking sono tutti in un unico posto, con solide risorse per principianti — perfetto per chi inizia.',
    'bonus'=>'Bonus per i nuovi utenti fino a 100 USDT',
    'bybit_tag'=>'Prediletto dai trader di futures',
    'bybit_desc'=>'Un exchange focalizzato sui derivati, popolare tra scalper e trader che usano il leverage. L\'esecuzione rapida e un\'interfaccia pulita rendono facili entrate e uscite veloci. Leverage fino a 100x, vari tipi di ordine e il copy trading permettono ai principianti di replicare trader esperti.',
    'bonus_y'=>'Bonus di benvenuto fino a 30.000 USDT',
    'pros_label'=>'Pro',
    'cons_label'=>'Contro',
    'pros_b'=>['Liquidità impareggiabile — slippage minimo sui grandi ordini','350+ monete; spot, futures e staking in uno','Solide risorse per principianti','Sconto extra pagando le commissioni in BNB'],
    'cons_b'=>['L\'interfaccia ricca di funzioni può sembrare complessa all\'inizio','Alcune restrizioni regionali/di prodotto'],
    'pros_y'=>['Esecuzione rapida dei futures — ottima per lo scalping','Leverage fino a 100x, molti tipi di ordine','Copy trading per replicare i professionisti','Bonus di benvenuto e fondi di prova'],
    'cons_y'=>['Meno spot/altcoin rispetto a Binance','L\'alto leverage comporta un grande rischio di liquidation'],
    'cta_binance'=>'Registrati su Binance e risparmia',
    'cta_bybit'=>'Registrati su Bybit e risparmia',
    'why_title'=>'Perché registrarsi tramite il link?',
    'why'=>['Le commissioni sono un costo fisso su ogni operazione. Impostare uno sconto una volta fa una grande differenza nel lungo periodo.','I bonus per i nuovi utenti e i voucher sono vantaggi una tantum disponibili solo all\'inizio.'],
    'verify_note'=>'Il tasso mostrato è il massimo del programma (“fino a”). Il tuo tasso effettivo appare nel campo Referral ID nella schermata di registrazione e può variare in base a regione, prodotto e campagna.',
    'note'=>'Registrandoti tramite i link qui sopra ottieni uno sconto sulle commissioni di trading e vantaggi per i nuovi utenti.',
    'risk'=>'⚠ Il trading di criptovalute, in particolare futures e leverage, comporta un elevato rischio di perdita. I punteggi di BTCtiming sono solo a scopo informativo e non costituiscono consulenza finanziaria. Fai trading a tua discrezione e a tuo rischio.',
    'f_privacy'=>'Informativa sulla privacy',
    'f_terms'=>'Termini di servizio',
    'f_sitemap'=>'Mappa del sito',
    'f_disclaimer'=>'Non è consulenza finanziaria',
  ],
  'ru' => [
    'title'=>'Лучшая биржа — Binance vs Bybit | BTCtiming',
    'desc'=>'Сравните биржи, чтобы начать торговать Bitcoin и altcoin. Возможности, плюсы и минусы, лучшие скидки на комиссии и бонусы для новых пользователей Binance и Bybit.',
    'back'=>'Назад к анализу в реальном времени',
    'h1'=>'С какой биржи вам стоит начать?',
    'lead'=>'Чтобы превратить оценки BTCtiming в реальные результаты, вам нужен аккаунт на бирже. Зарегистрируйтесь на одной из двух самых используемых бирж по ссылкам ниже, чтобы получить <b>скидку на торговую комиссию</b> плюс <b>бонус для новых пользователей</b>.',
    'disc'=>'Скидка на комиссию до %s%%',
    'hero_disc'=>'Зарегистрируйтесь по ссылкам здесь, чтобы получить',
    'hero_disc2'=>'скидку на комиссию + бонус для новых пользователей',
    'binance_tag'=>'#1 по объёму',
    'binance_desc'=>'Биржа с самым большим объёмом в мире. С более чем 350 листингованными монетами она предлагает широкий выбор altcoin, а её глубокая ликвидность исполняет крупные ордера с минимальным slippage. Spot, futures, margin и staking — всё в одном месте, с надёжными обучающими материалами для новичков — отличный вариант для тех, кто только начинает.',
    'bonus'=>'Бонус для новых пользователей до $100 USDT',
    'bybit_tag'=>'Любимая биржа трейдеров futures',
    'bybit_desc'=>'Биржа, ориентированная на деривативы, популярна среди скальперов и трейдеров, использующих leverage. Быстрое исполнение и понятный интерфейс упрощают быстрые входы и выходы. Leverage до 100x, разнообразные типы ордеров и copy trading позволяют новичкам копировать опытных трейдеров.',
    'bonus_y'=>'Приветственный бонус до $30 000 USDT',
    'pros_label'=>'Плюсы',
    'cons_label'=>'Минусы',
    'pros_b'=>['Непревзойдённая ликвидность — минимальный slippage на крупных ордерах','350+ монет; spot, futures и staking в одном месте','Сильные обучающие материалы для новичков','Дополнительная скидка при оплате комиссий в BNB'],
    'cons_b'=>['Насыщенный функциями интерфейс поначалу может показаться сложным','Некоторые региональные/продуктовые ограничения'],
    'pros_y'=>['Быстрое исполнение futures — отлично для scalping','Leverage до 100x, множество типов ордеров','Copy trading для копирования профессионалов','Приветственный бонус и пробные средства'],
    'cons_y'=>['Меньше spot/altcoin, чем на Binance','Высокий leverage несёт большой риск liquidation'],
    'cta_binance'=>'Зарегистрируйтесь на Binance и экономьте',
    'cta_bybit'=>'Зарегистрируйтесь на Bybit и экономьте',
    'why_title'=>'Почему стоит регистрироваться по ссылке?',
    'why'=>['Комиссии — это фиксированные издержки на каждой сделке. Установка скидки один раз даёт большую разницу в долгосрочной перспективе.','Бонусы для новых пользователей и ваучеры — это разовые привилегии, доступные только в самом начале.'],
    'verify_note'=>'Указанная ставка — это максимум программы («до»). Ваша фактическая ставка отображается в поле Referral ID на экране регистрации и может отличаться в зависимости от региона, продукта и кампании.',
    'note'=>'Регистрация по ссылкам выше даёт вам скидку на торговую комиссию и привилегии для новых пользователей.',
    'risk'=>'⚠ Торговля криптовалютой, особенно futures и leverage, несёт высокий риск потерь. Оценки BTCtiming предназначены только для информации и не являются финансовой консультацией. Торгуйте на своё усмотрение и на свой риск.',
    'f_privacy'=>'Политика конфиденциальности',
    'f_terms'=>'Условия использования',
    'f_sitemap'=>'Карта сайта',
    'f_disclaimer'=>'Не является финансовой консультацией',
  ],
  'zh' => [
    'title'=>'最佳交易所 — Binance vs Bybit | BTCtiming',
    'desc'=>'比較各交易所，開始交易 Bitcoin 與 altcoin。Binance 與 Bybit 的功能、優缺點、最佳手續費折扣及新用戶獎勵。',
    'back'=>'返回即時分析',
    'h1'=>'你該從哪個交易所開始？',
    'lead'=>'要將 BTCtiming 的分數轉化為實際成果，你需要一個交易所帳戶。透過下方連結在兩個最多人使用的交易所之一註冊，即可獲得<b>交易手續費折扣</b>以及<b>新用戶獎勵</b>。',
    'disc'=>'手續費折扣最高 %s%%',
    'hero_disc'=>'透過此處連結註冊即可獲得',
    'hero_disc2'=>'手續費折扣 + 新用戶獎勵',
    'binance_tag'=>'交易量第一',
    'binance_desc'=>'全球交易量最高的交易所。上架 350+ 種幣，提供豐富多樣的 altcoin，其深厚的流動性能以最小的 slippage 成交大額訂單。spot、futures、margin 與 staking 都集於一處，並有紮實的新手學習資源 — 非常適合初次交易者。',
    'bonus'=>'新用戶獎勵最高 $100 USDT',
    'bybit_tag'=>'深受 futures 交易者青睞',
    'bybit_desc'=>'專注於衍生品的交易所，深受 scalper 與 leverage 交易者歡迎。快速的成交速度與簡潔的介面讓快速進出變得輕鬆。最高 100x leverage、多種訂單類型以及 copy trading，讓新手能夠複製資深交易者的操作。',
    'bonus_y'=>'歡迎獎勵最高 $30,000 USDT',
    'pros_label'=>'優點',
    'cons_label'=>'缺點',
    'pros_b'=>['無與倫比的流動性 — 大額訂單 slippage 極小','350+ 種幣；spot、futures 與 staking 集於一體','強大的新手學習資源','以 BNB 支付手續費可享額外折扣'],
    'cons_b'=>['功能豐富的介面起初可能會覺得複雜','部分地區/產品限制'],
    'pros_y'=>['快速的 futures 成交 — 非常適合 scalping','最高 100x leverage，多種訂單類型','copy trading 可複製專業交易者','歡迎獎勵與試用資金'],
    'cons_y'=>['spot/altcoin 數量少於 Binance','高 leverage 帶來巨大的 liquidation 風險'],
    'cta_binance'=>'在 Binance 註冊並省錢',
    'cta_bybit'=>'在 Bybit 註冊並省錢',
    'why_title'=>'為什麼要透過連結註冊？',
    'why'=>['手續費是每筆交易的固定成本。一次性設定折扣，長期下來會帶來巨大差異。','新用戶獎勵與抵用券是一次性優惠，僅在最初階段提供。'],
    'verify_note'=>'顯示的費率為方案上限（「最高」）。你的實際費率會顯示在註冊畫面的 Referral ID 欄位中，並可能因地區、產品與活動而異。',
    'note'=>'透過上方連結註冊，即可獲得交易手續費折扣與新用戶優惠。',
    'risk'=>'⚠ 加密貨幣交易，尤其是 futures 與 leverage，具有極高的虧損風險。BTCtiming 分數僅供參考，並非財務建議。請自行斟酌並自負風險進行交易。',
    'f_privacy'=>'隱私政策',
    'f_terms'=>'服務條款',
    'f_sitemap'=>'網站地圖',
    'f_disclaimer'=>'非財務建議',
