...
const TARGET_MAP = {
  "Oversold ≤ 30 (bonus); not overbought": {"ko": "과매도 ≤ 30", "en": "Oversold ≤ 30", "ja": "売られすぎ ≤ 30", "es": "Sobreventa ≤ 30", "de": "Überverkauft ≤ 30", "fr": "Survendu ≤ 30", "pt": "Sobrevenda ≤ 30", "tr": "Aşırı satım ≤ 30", "vi": "Quá bán ≤ 30"},
  "Overbought ≥ 70 (bonus); not oversold": {"ko": "과매수 ≥ 70", "en": "Overbought ≥ 70", "ja": "買われすぎ ≥ 70", "es": "Sobrecompra ≥ 70", "de": "Überkauft ≥ 70", "fr": "Suracheté ≥ 70", "pt": "Sobrecompra ≥ 70", "tr": "Aşırı alım ≥ 70", "vi": "Quá mua ≥ 70"},
  "Volume spike = capitulation-to-rebound bonus; dry-up = neutral (basing)": {"ko": "거래량 급증 = 항복 후 반등 신호", "en": "Volume spike = capitulation rebound", "ja": "出来高急増 = 投降後の反発シグナル", "es": "Pico de volumen = rebote tras capitulación", "de": "Volumenspike = Rebound nach Kapitulation", "fr": "Pic de volume = rebond post-capitulation", "pt": "Pico de volume = repique pós-capitulação", "tr": "Hacim sıçraması = kapitülasyon sonrası tepki", "vi": "Đột biến khối lượng = bật lại sau đầu hàng"},
  ...
  "FOMO (buy+spike+green) = bonus; quiet = neutral; capitulation = penalty": {"ko": "매수 주도 급증 + 양봉 = FOMO 과열", "en": "Buy-led spike + green = FOMO", "ja": "買い主導の急増+陽線 = FOMO過熱", "es": "Pico liderado por compra + vela verde = FOMO", "de": "Käufergetriebener Spike + grüne Kerze = FOMO", "fr": "Pic mené par l'achat + bougie verte = FOMO", "pt": "Pico liderado por compra + vela verde = FOMO", "tr": "Alım öncülüğünde sıçrama + yeşil mum = FOMO", "vi": "Đột biến do mua dẫn dắt + nến xanh = FOMO"},
  "SHORT zone ≥ 30% above realized": {"ko": "숏 구간: 실현가 +30% 이상", "en": "SHORT zone: ≥30% above realized", "ja": "ショート圏: 実現価格+30%以上", "es": "Zona corta: ≥30% sobre realizado", "de": "SHORT-Zone: ≥30% über Realized", "fr": "Zone short : ≥30% au-dessus du réalisé", "pt": "Zona short: ≥30% acima do realizado", "tr": "SHORT bölgesi: gerçekleşenin ≥%30 üstü", "vi": "Vùng short: ≥30% trên giá thực hiện"},
  "Correlation is direction-neutral for shorting": {"ko": "상관관계는 숏에 방향 중립", "en": "Direction-neutral for shorting", "ja": "相関はショートに方向中立", "es": "Neutral en dirección para cortos", "de": "Richtungsneutral für Shorts", "fr": "Neutre en direction pour le short", "pt": "Neutro em direção para short", "tr": "Short için yön-nötr", "vi": "Trung lập hướng khi short"},
  ...
  "≤5% or below": {"ko": "실현가 대비 ≤ 5%", "en": "≤ 5% from realized", "ja": "実現価格から ≤ 5%", "es": "≤ 5% del realizado", "de": "≤ 5% vom Realized", "fr": "≤ 5% du réalisé", "pt": "≤ 5% do realizado", "tr": "gerçekleşenden ≤ %5", "vi": "≤ 5% so với giá thực hiện"},
