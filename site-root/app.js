...
const SIGNAL_MAP = {
  "Above": {"ko": "위", "en": "Above", "ja": "上", "es": "Por Encima", "de": "Darüber", "fr": "Au-dessus", "pt": "Acima", "tr": "Üzerinde", "vi": "Trên", "id": "Di Atas", "pl": "Powyżej", "it": "Sopra", "ru": "Выше", "zh": "高於"},
  "Accumulating": {"ko": "매집 중", "en": "Accumulating", "ja": "蓄積中", "es": "Acumulando", "de": "Akkumulierend", "fr": "En accumulation", "pt": "Acumulando", "tr": "Biriktiriyor", "vi": "Đang tích lũy", "id": "Akumulasi", "pl": "Akumulacja", "it": "In accumulo", "ru": "Накопление", "zh": "累積中"},
  "Accumulation (Safe)": {"ko": "매집 구간 (안전)", "en": "Accumulation (Safe)", "ja": "蓄積ゾーン(安全)", "es": "Acumulación (Seguro)", "de": "Akkumulation (Sicher)", "fr": "Accumulation (Sûr)", "pt": "Acumulação (Seguro)", "tr": "Biriktirme (Güvenli)", "vi": "Tích lũy (An toàn)", "id": "Akumulasi (Aman)", "pl": "Akumulacja (Bezpiecznie)", "it": "Accumulo (Sicuro)", "ru": "Накопление (безопасно)", "zh": "累積區 (安全)"},
  "Alt Season Risk": {"ko": "알트시즌 리스크", "en": "Alt Season Risk", "ja": "アルトシーズンリスク", "es": "Riesgo Temporada Alt", "de": "Alt-Season-Risiko", "fr": "Risque Saison Alt", "pt": "Risco Temporada Alt", "tr": "Alt Sezon Riski", "vi": "Rủi ro Mùa Alt", "id": "Risiko Alt Season", "pl": "Ryzyko sezonu altów", "it": "Rischio Alt Season", "ru": "Риск альтсезона", "zh": "山寨季風險"},
  "Alt Season": {"ko": "알트시즌", "en": "Alt Season", "ja": "アルトシーズン", "es": "Temporada Alt", "de": "Alt Season", "fr": "Saison Alt", "pt": "Temporada Alt", "tr": "Alt Sezon", "vi": "Mùa Alt", "id": "Alt Season", "pl": "Sezon altów", "it": "Alt Season", "ru": "Альтсезон", "zh": "山寨季"},
  "BTC Season (Safe)": {"ko": "BTC 시즌 (안전)", "en": "BTC Season (Safe)", "ja": "BTCシーズン(安全)", "es": "Temporada BTC (Seguro)", "de": "BTC-Season (Sicher)", "fr": "Saison BTC (Sûr)", "pt": "Temporada BTC (Seguro)", "tr": "BTC Sezonu (Güvenli)", "vi": "Mùa BTC (An toàn)", "id": "BTC Season (Aman)", "pl": "Sezon BTC (Bezpiecznie)", "it": "BTC Season (Sicuro)", "ru": "Сезон BTC (безопасно)", "zh": "BTC 季 (安全)"},
  "BTC Season": {"ko": "BTC 시즌", "en": "BTC Season", "ja": "BTCシーズン", "es": "Temporada BTC", "de": "BTC-Season", "fr": "Saison BTC", "pt": "Temporada BTC", "tr": "BTC Sezonu", "vi": "Mùa BTC", "id": "BTC Season", "pl": "Sezon BTC", "it": "BTC Season", "ru": "Сезон BTC", "zh": "BTC 季"},
  "Backwardation (Safe)": {"ko": "백워데이션 (안전)", "en": "Backwardation (Safe)", "ja": "バックワーデーション(安全)", "es": "Backwardation (Seguro)", "de": "Backwardation (Sicher)", "fr": "Backwardation (Sûr)", "pt": "Backwardation (Seguro)", "tr": "Backwardation (Güvenli)", "vi": "Backwardation (An toàn)", "id": "Backwardation (Aman)", "pl": "Backwardation (Bezpiecznie)", "it": "Backwardation (Sicuro)", "ru": "Бэквордация (безопасно)", "zh": "逆價差 (安全)"},
  "Below Realized (Safe)": {"ko": "실현가 이하 (안전)", "en": "Below Realized (Safe)", "ja": "実現価格以下(安全)", "es": "Bajo Realizado (Seguro)", "de": "Unter Realized (Sicher)", "fr": "Sous le Réalisé (Sûr)", "pt": "Abaixo do Realizado (Seguro)", "tr": "Gerçekleşenin Altında (Güvenli)", "vi": "Dưới Thực hiện (An toàn)", "id": "Di Bawah Realized (Aman)", "pl": "Poniżej Realized (Bezpiecznie)", "it": "Sotto Realized (Sicuro)", "ru": "Ниже Realized (безопасно)", "zh": "低於實現價 (安全)"},
  "Below Realized": {"ko": "실현가 이하", "en": "Below Realized", "ja": "実現価格以下", "es": "Bajo Realizado", "de": "Unter Realized", "fr": "Sous le Réalisé", "pt": "Abaixo do Realizado", "tr": "Gerçekleşenin Altında", "vi": "Dưới Thực hiện", "id": "Di Bawah Realized", "pl": "Poniżej Realized", "it": "Sotto Realized", "ru": "Ниже Realized", "zh": "低於實現價"},
  "Borderline": {"ko": "경계선", "en": "Borderline", "ja": "境界線", "es": "Límite", "de": "Grenzwertig", "fr": "Limite", "pt": "Limítrofe", "tr": "Sınırda", "vi": "Ranh giới", "id": "Ambang Batas", "pl": "Graniczny", "it": "Al limite", "ru": "Пограничное", "zh": "臨界"},
  "Buyer-led (Caution)": {"ko": "매수 주도 (주의)", "en": "Buyer-led (Caution)", "ja": "買い主導(注意)", "es": "Liderado por Compra (Precaución)", "de": "Käufergetrieben (Vorsicht)", "fr": "Mené par l'Achat (Prudence)", "pt": "Liderado por Compra (Cautela)", "tr": "Alım Öncülüğünde (Dikkat)", "vi": "Do Mua dẫn dắt (Thận trọng)", "id": "Dipimpin Pembeli (Hati-hati)", "pl": "Przewaga kupujących (Uwaga)", "it": "Guidato dai compratori (Cautela)", "ru": "Ведут покупатели (осторожно)", "zh": "買方主導 (警戒)"},
  "Capitulation": {"ko": "항복", "en": "Capitulation", "ja": "キャピチュレーション", "es": "Capitulación", "de": "Kapitulation", "fr": "Capitulation", "pt": "Capitulação", "tr": "Kapitülasyon", "vi": "Đầu hàng", "id": "Kapitulasi", "pl": "Kapitulacja", "it": "Capitolazione", "ru": "Капитуляция", "zh": "投降"},
  "Caution": {"ko": "주의", "en": "Caution", "ja": "注意", "es": "Precaución", "de": "Vorsicht", "fr": "Prudence", "pt": "Cautela", "tr": "Dikkat", "vi": "Thận trọng", "id": "Hati-hati", "pl": "Uwaga", "it": "Cautela", "ru": "Осторожно", "zh": "警戒"},
  "Core Bottom Zone": {"ko": "핵심 저점 구간", "en": "Core Bottom Zone", "ja": "核心底値ゾーン", "es": "Zona Central de Suelo", "de": "Kern-Tiefzone", "fr": "Zone de Creux Central", "pt": "Zona Central de Fundo", "tr": "Çekirdek Dip Bölgesi", "vi": "Vùng Đáy Cốt lõi", "id": "Zona Dasar Inti", "pl": "Rdzeń strefy dna", "it": "Zona di fondo centrale", "ru": "Ядро зоны дна", "zh": "核心底部區"},
  "Correction": {"ko": "조정", "en": "Correction", "ja": "調整", "es": "Corrección", "de": "Korrektur", "fr": "Correction", "pt": "Correção", "tr": "Düzeltme", "vi": "Điều chỉnh", "id": "Koreksi", "pl": "Korekta", "it": "Correzione", "ru": "Коррекция", "zh": "修正"},
  "Deep Correction": {"ko": "깊은 조정", "en": "Deep Correction", "ja": "深い調整", "es": "Corrección Profunda", "de": "Tiefe Korrektur", "fr": "Correction Profonde", "pt": "Correção Profunda", "tr": "Derin Düzeltme", "vi": "Điều chỉnh Sâu", "id": "Koreksi Dalam", "pl": "Głęboka korekta", "it": "Correzione profonda", "ru": "Глубокая коррекция", "zh": "深度修正"},
  "Distribution": {"ko": "분산", "en": "Distribution", "ja": "分配", "es": "Distribución", "de": "Distribution", "fr": "Distribution", "pt": "Distribuição", "tr": "Dağıtım", "vi": "Phân phối", "id": "Distribusi", "pl": "Dystrybucja", "it": "Distribuzione", "ru": "Распределение", "zh": "派發"},
  "Elevated": {"ko": "상승", "en": "Elevated", "ja": "上昇", "es": "Elevado", "de": "Erhöht", "fr": "Élevé", "pt": "Elevado", "tr": "Yükselmiş", "vi": "Tăng cao", "id": "Meningkat", "pl": "Podwyższony", "it": "Elevato", "ru": "Повышенное", "zh": "偏高"},
  "Euphoria": {"ko": "도취", "en": "Euphoria", "ja": "陶酔", "es": "Euforia", "de": "Euphorie", "fr": "Euphorie", "pt": "Euforia", "tr": "Öfori", "vi": "Hưng phấn", "id": "Euforia", "pl": "Euforia", "it": "Euforia", "ru": "Эйфория", "zh": "狂熱"},
  "FOMO Buying": {"ko": "FOMO 매수", "en": "FOMO Buying", "ja": "FOMO買い", "es": "Compra por FOMO", "de": "FOMO-Kauf", "fr": "Achat FOMO", "pt": "Compra por FOMO", "tr": "FOMO Alımı", "vi": "Mua theo FOMO", "id": "Pembelian FOMO", "pl": "Zakupy FOMO", "it": "Acquisti FOMO", "ru": "Покупки FOMO", "zh": "FOMO 買進"},
  "Far (Safe)": {"ko": "멀음 (안전)", "en": "Far (Safe)", "ja": "遠い(安全)", "es": "Lejos (Seguro)", "de": "Weit (Sicher)", "fr": "Loin (Sûr)", "pt": "Longe (Seguro)", "tr": "Uzak (Güvenli)", "vi": "Xa (An toàn)", "id": "Jauh (Aman)", "pl": "Daleko (Bezpiecznie)", "it": "Lontano (Sicuro)", "ru": "Далеко (безопасно)", "zh": "遠離 (安全)"},
  "Far from ATH (Safe)": {"ko": "ATH와 멀음 (안전)", "en": "Far from ATH (Safe)", "ja": "ATHから遠い(安全)", "es": "Lejos del ATH (Seguro)", "de": "Weit vom ATH (Sicher)", "fr": "Loin de l'ATH (Sûr)", "pt": "Longe do ATH (Seguro)", "tr": "ATH'den Uzak (Güvenli)", "vi": "Xa ATH (An toàn)", "id": "Jauh dari ATH (Aman)", "pl": "Daleko od ATH (Bezpiecznie)", "it": "Lontano dall'ATH (Sicuro)", "ru": "Далеко от ATH (безопасно)", "zh": "遠離歷史高點 (安全)"},
  "Fear (Safe)": {"ko": "공포 (안전)", "en": "Fear (Safe)", "ja": "恐怖(安全)", "es": "Miedo (Seguro)", "de": "Angst (Sicher)", "fr": "Peur (Sûr)", "pt": "Medo (Seguro)", "tr": "Korku (Güvenli)", "vi": "Sợ hãi (An toàn)", "id": "Ketakutan (Aman)", "pl": "Strach (Bezpiecznie)", "it": "Paura (Sicuro)", "ru": "Страх (безопасно)", "zh": "恐懼 (安全)"},
  "Fear": {"ko": "공포", "en": "Fear", "ja": "恐怖", "es": "Miedo", "de": "Angst", "fr": "Peur", "pt": "Medo", "tr": "Korku", "vi": "Sợ hãi", "id": "Ketakutan", "pl": "Strach", "it": "Paura", "ru": "Страх", "zh": "恐懼"},
  "General": {"ko": "일반", "en": "General", "ja": "一般", "es": "General", "de": "Allgemein", "fr": "Général", "pt": "Geral", "tr": "Genel", "vi": "Chung", "id": "Umum", "pl": "Ogólny", "it": "Generale", "ru": "Общее", "zh": "一般"},
  "High": {"ko": "높음", "en": "High", "ja": "高い", "es": "Alto", "de": "Hoch", "fr": "Élevé", "pt": "Alto", "tr": "Yüksek", "vi": "Cao", "id": "Tinggi", "pl": "Wysoki", "it": "Alto", "ru": "Высокий", "zh": "高"},
  "Highly Correlated": {"ko": "높은 상관관계", "en": "Highly Correlated", "ja": "高い相関", "es": "Muy Correlacionado", "de": "Stark Korreliert", "fr": "Fortement Corrélé", "pt": "Altamente Correlacionado", "tr": "Yüksek Korelasyonlu", "vi": "Tương quan Cao", "id": "Korelasi Tinggi", "pl": "Silnie skorelowany", "it": "Altamente correlato", "ru": "Сильная корреляция", "zh": "高度相關"},
  "Hope Bottom": {"ko": "희망 저점", "en": "Hope Bottom", "ja": "希望底値", "es": "Esperanza de Suelo", "de": "Hoffnung Boden", "fr": "Creux d'Espoir", "pt": "Fundo de Esperança", "tr": "Umut Dibi", "vi": "Đáy Hy vọng", "id": "Dasar Harapan", "pl": "Dno nadziei", "it": "Fondo di speranza", "ru": "Дно надежды", "zh": "希望底部"},
  "Hope": {"ko": "희망", "en": "Hope", "ja": "希望", "es": "Esperanza", "de": "Hoffnung", "fr": "Espoir", "pt": "Esperança", "tr": "Umut", "vi": "Hy vọng", "id": "Harapan", "pl": "Nadzieja", "it": "Speranza", "ru": "Надежда", "zh": "希望"},
  "Ideal": {"ko": "이상적", "en": "Ideal", "ja": "理想的", "es": "Ideal", "de": "Ideal", "fr": "Idéal", "pt": "Ideal", "tr": "İdeal", "vi": "Lý tưởng", "id": "Ideal", "pl": "Idealny", "it": "Ideale", "ru": "Идеально", "zh": "理想"},
  "Independent": {"ko": "독립적", "en": "Independent", "ja": "独立的", "es": "Independiente", "de": "Unabhängig", "fr": "Indépendant", "pt": "Independente", "tr": "Bağımsız", "vi": "Độc lập", "id": "Independen", "pl": "Niezależny", "it": "Indipendente", "ru": "Независимо", "zh": "獨立"},
  "Institutional FOMO": {"ko": "기관 FOMO", "en": "Institutional FOMO", "ja": "機関FOMO", "es": "FOMO Institucional", "de": "Institutionelles FOMO", "fr": "FOMO Institutionnel", "pt": "FOMO Institucional", "tr": "Kurumsal FOMO", "vi": "FOMO Tổ chức", "id": "FOMO Institusional", "pl": "FOMO instytucjonalne", "it": "FOMO istituzionale", "ru": "Институциональное FOMO", "zh": "機構 FOMO"},
  "Long Overload": {"ko": "롱 과부하", "en": "Long Overload", "ja": "ロング過負荷", "es": "Sobrecarga de Largos", "de": "Long-Überlastung", "fr": "Surcharge de Longs", "pt": "Sobrecarga de Longs", "tr": "Long Aşırı Yük", "vi": "Quá tải Long", "id": "Long Berlebihan", "pl": "Przeciążenie longów", "it": "Sovraccarico long", "ru": "Перегрузка лонгов", "zh": "多頭過載"},
  "Loss (Safe)": {"ko": "손실 (안전)", "en": "Loss (Safe)", "ja": "損失(安全)", "es": "Pérdida (Seguro)", "de": "Verlust (Sicher)", "fr": "Perte (Sûr)", "pt": "Prejuízo (Seguro)", "tr": "Zarar (Güvenli)", "vi": "Lỗ (An toàn)", "id": "Rugi (Aman)", "pl": "Strata (Bezpiecznie)", "it": "Perdita (Sicuro)", "ru": "Убыток (безопасно)", "zh": "虧損 (安全)"},
  "Low (Safe)": {"ko": "낮음 (안전)", "en": "Low (Safe)", "ja": "低い(安全)", "es": "Bajo (Seguro)", "de": "Niedrig (Sicher)", "fr": "Bas (Sûr)", "pt": "Baixo (Seguro)", "tr": "Düşük (Güvenli)", "vi": "Thấp (An toàn)", "id": "Rendah (Aman)", "pl": "Niski (Bezpiecznie)", "it": "Basso (Sicuro)", "ru": "Низкий (безопасно)", "zh": "低 (安全)"},
  "Mid Range": {"ko": "중간 구간", "en": "Mid Range", "ja": "中間レンジ", "es": "Rango Medio", "de": "Mittlerer Bereich", "fr": "Fourchette Moyenne", "pt": "Faixa Média", "tr": "Orta Aralık", "vi": "Khoảng Giữa", "id": "Kisaran Tengah", "pl": "Środek zakresu", "it": "Fascia media", "ru": "Средний диапазон", "zh": "中間區間"},
  "Mild Buying": {"ko": "약한 매수", "en": "Mild Buying", "ja": "弱い買い", "es": "Compra Leve", "de": "Leichter Kauf", "fr": "Achat Léger", "pt": "Compra Leve", "tr": "Hafif Alım", "vi": "Mua Nhẹ", "id": "Pembelian Ringan", "pl": "Umiarkowane zakupy", "it": "Acquisti moderati", "ru": "Умеренные покупки", "zh": "溫和買進"},
  "Mild Premium": {"ko": "약한 프리미엄", "en": "Mild Premium", "ja": "弱いプレミアム", "es": "Prima Leve", "de": "Leichte Prämie", "fr": "Prime Légère", "pt": "Prêmio Leve", "tr": "Hafif Prim", "vi": "Phần bù Nhẹ", "id": "Premium Ringan", "pl": "Umiarkowana premia", "it": "Premio moderato", "ru": "Умеренная премия", "zh": "溫和溢價"},
  "Mild Profit": {"ko": "약한 수익", "en": "Mild Profit", "ja": "弱い利益", "es": "Ganancia Leve", "de": "Leichter Gewinn", "fr": "Profit Léger", "pt": "Lucro Leve", "tr": "Hafif Kar", "vi": "Lãi Nhẹ", "id": "Profit Ringan", "pl": "Umiarkowany zysk", "it": "Profitto moderato", "ru": "Умеренная прибыль", "zh": "溫和獲利"},
  "Mild Selling": {"ko": "약한 매도", "en": "Mild Selling", "ja": "弱い売り", "es": "Venta Leve", "de": "Leichter Verkauf", "fr": "Vente Légère", "pt": "Venda Leve", "tr": "Hafif Satış", "vi": "Bán Nhẹ", "id": "Penjualan Ringan", "pl": "Umiarkowana sprzedaż", "it": "Vendite moderate", "ru": "Умеренные продажи", "zh": "溫和賣出"},
  "Mild": {"ko": "약함", "en": "Mild", "ja": "弱い", "es": "Leve", "de": "Leicht", "fr": "Léger", "pt": "Leve", "tr": "Hafif", "vi": "Nhẹ", "id": "Ringan", "pl": "Umiarkowany", "it": "Moderato", "ru": "Умеренный", "zh": "溫和"},
  "Moderate": {"ko": "보통", "en": "Moderate", "ja": "中程度", "es": "Moderado", "de": "Moderat", "fr": "Modéré", "pt": "Moderado", "tr": "Orta", "vi": "Vừa phải", "id": "Sedang", "pl": "Umiarkowany", "it": "Moderato", "ru": "Умеренный", "zh": "中等"},
  "Near ATH": {"ko": "ATH 근접", "en": "Near ATH", "ja": "ATH近接", "es": "Cerca del ATH", "de": "Nahe ATH", "fr": "Proche de l'ATH", "pt": "Perto do ATH", "tr": "ATH'ye Yakın", "vi": "Gần ATH", "id": "Dekat ATH", "pl": "Blisko ATH", "it": "Vicino all'ATH", "ru": "Близко к ATH", "zh": "接近歷史高點"},
  "Near Bottom": {"ko": "저점 근접", "en": "Near Bottom", "ja": "底値近接", "es": "Cerca del Suelo", "de": "Nahe Boden", "fr": "Proche du Creux", "pt": "Perto do Fundo", "tr": "Dibe Yakın", "vi": "Gần Đáy", "id": "Dekat Dasar", "pl": "Blisko dna", "it": "Vicino al fondo", "ru": "Близко ко дну", "zh": "接近底部"},
  "Neutral": {"ko": "중립", "en": "Neutral", "ja": "中立", "es": "Neutral", "de": "Neutral", "fr": "Neutre", "pt": "Neutro", "tr": "Nötr", "vi": "Trung lập", "id": "Netral", "pl": "Neutralny", "it": "Neutrale", "ru": "Нейтрально", "zh": "中立"},
  "Normal": {"ko": "정상", "en": "Normal", "ja": "正常", "es": "Normal", "de": "Normal", "fr": "Normal", "pt": "Normal", "tr": "Normal", "vi": "Bình thường", "id": "Normal", "pl": "Normalny", "it": "Normale", "ru": "Норма", "zh": "正常"},
  "Optimism": {"ko": "낙관", "en": "Optimism", "ja": "楽観", "es": "Optimismo", "de": "Optimismus", "fr": "Optimisme", "pt": "Otimismo", "tr": "İyimserlik", "vi": "Lạc quan", "id": "Optimisme", "pl": "Optymizm", "it": "Ottimismo", "ru": "Оптимизм", "zh": "樂觀"},
  "Out of Range": {"ko": "범위 밖", "en": "Out of Range", "ja": "範囲外", "es": "Fuera de Rango", "de": "Außerhalb des Bereichs", "fr": "Hors Fourchette", "pt": "Fora da Faixa", "tr": "Aralık Dışı", "vi": "Ngoài Khoảng", "id": "Di Luar Kisaran", "pl": "Poza zakresem", "it": "Fuori range", "ru": "Вне диапазона", "zh": "超出區間"},
  "Overbought (Top)": {"ko": "과매수 (고점)", "en": "Overbought (Top)", "ja": "買われすぎ(天井)", "es": "Sobrecompra (Techo)", "de": "Überkauft (Top)", "fr": "Suracheté (Sommet)", "pt": "Sobrecompra (Topo)", "tr": "Aşırı Alım (Tepe)", "vi": "Quá mua (Đỉnh)", "id": "Jenuh Beli (Puncak)", "pl": "Wykupienie (Szczyt)", "it": "Ipercomprato (Top)", "ru": "Перекупленность (вершина)", "zh": "超買 (頂部)"},
  "Overbought": {"ko": "과매수", "en": "Overbought", "ja": "買われすぎ", "es": "Sobrecompra", "de": "Überkauft", "fr": "Suracheté", "pt": "Sobrecompra", "tr": "Aşırı Alım", "vi": "Quá mua", "id": "Jenuh Beli", "pl": "Wykupienie", "it": "Ipercomprato", "ru": "Перекупленность", "zh": "超買"},
  "Overheated": {"ko": "과열", "en": "Overheated", "ja": "過熱", "es": "Sobrecalentado", "de": "Überhitzt", "fr": "En Surchauffe", "pt": "Sobreaquecido", "tr": "Aşırı Isınmış", "vi": "Quá nóng", "id": "Terlalu Panas", "pl": "Przegrzany", "it": "Surriscaldato", "ru": "Перегрев", "zh": "過熱"},
  "Oversold (Bottom)": {"ko": "과매도 (저점)", "en": "Oversold (Bottom)", "ja": "売られすぎ(底値)", "es": "Sobreventa (Suelo)", "de": "Überverkauft (Boden)", "fr": "Survendu (Creux)", "pt": "Sobrevenda (Fundo)", "tr": "Aşırı Satım (Dip)", "vi": "Quá bán (Đáy)", "id": "Jenuh Jual (Dasar)", "pl": "Wyprzedanie (Dno)", "it": "Ipervenduto (Fondo)", "ru": "Перепроданность (дно)", "zh": "超賣 (底部)"},
  "Oversold": {"ko": "과매도", "en": "Oversold", "ja": "売られすぎ", "es": "Sobreventa", "de": "Überverkauft", "fr": "Survendu", "pt": "Sobrevenda", "tr": "Aşırı Satım", "vi": "Quá bán", "id": "Jenuh Jual", "pl": "Wyprzedanie", "it": "Ipervenduto", "ru": "Перепроданность", "zh": "超賣"},
  "Overvalued": {"ko": "고평가", "en": "Overvalued", "ja": "過大評価", "es": "Sobrevalorado", "de": "Überbewertet", "fr": "Survalorisé", "pt": "Sobrevalorizado", "tr": "Aşırı Değerli", "vi": "Định giá cao", "id": "Kemahalan", "pl": "Przewartościowany", "it": "Sopravvalutato", "ru": "Переоценено", "zh": "高估"},
  "Past Peak": {"ko": "고점 지남", "en": "Past Peak", "ja": "ピーク超過", "es": "Pasado el Pico", "de": "Über dem Höhepunkt", "fr": "Sommet Dépassé", "pt": "Após o Pico", "tr": "Zirveyi Geçmiş", "vi": "Qua Đỉnh", "id": "Melewati Puncak", "pl": "Po szczycie", "it": "Oltre il picco", "ru": "После пика", "zh": "已過峰值"},
  "Peak Zone": {"ko": "고점 구간", "en": "Peak Zone", "ja": "ピークゾーン", "es": "Zona de Pico", "de": "Höchststand-Zone", "fr": "Zone de Sommet", "pt": "Zona de Pico", "tr": "Zirve Bölgesi", "vi": "Vùng Đỉnh", "id": "Zona Puncak", "pl": "Strefa szczytu", "it": "Zona di picco", "ru": "Зона пика", "zh": "峰值區"},
  "Record Accumulation": {"ko": "역대급 매집", "en": "Record Accumulation", "ja": "記録的な蓄積", "es": "Acumulación Récord", "de": "Rekord-Akkumulation", "fr": "Accumulation Record", "pt": "Acumulação Recorde", "tr": "Rekor Biriktirme", "vi": "Tích lũy Kỷ lục", "id": "Akumulasi Rekor", "pl": "Rekordowa akumulacja", "it": "Accumulo record", "ru": "Рекордное накопление", "zh": "創紀錄累積"},
  "Rising/Bottom": {"ko": "상승/저점", "en": "Rising/Bottom", "ja": "上昇/底値", "es": "Subiendo/Suelo", "de": "Steigend/Boden", "fr": "En Hausse/Creux", "pt": "Subindo/Fundo", "tr": "Yükseliyor/Dip", "vi": "Tăng/Đáy", "id": "Naik/Dasar", "pl": "Wzrost/Dno", "it": "In salita/Fondo", "ru": "Рост/Дно", "zh": "上升/底部"},
  "Seller-led (Safe)": {"ko": "매도 주도 (안전)", "en": "Seller-led (Safe)", "ja": "売り主導(安全)", "es": "Liderado por Venta (Seguro)", "de": "Verkäufergetrieben (Sicher)", "fr": "Mené par la Vente (Sûr)", "pt": "Liderado por Venda (Seguro)", "tr": "Satış Öncülüğünde (Güvenli)", "vi": "Do Bán dẫn dắt (An toàn)", "id": "Dipimpin Penjual (Aman)", "pl": "Przewaga sprzedających (Bezpiecznie)", "it": "Guidato dai venditori (Sicuro)", "ru": "Ведут продавцы (безопасно)", "zh": "賣方主導 (安全)"},
  "Sideline (Safe)": {"ko": "관망 (안전)", "en": "Sideline (Safe)", "ja": "様子見(安全)", "es": "Al Margen (Seguro)", "de": "Abseits (Sicher)", "fr": "En Retrait (Sûr)", "pt": "À Margem (Seguro)", "tr": "Kenarda (Güvenli)", "vi": "Đứng ngoài (An toàn)", "id": "Menunggu (Aman)", "pl": "Na uboczu (Bezpiecznie)", "it": "In attesa (Sicuro)", "ru": "В стороне (безопасно)", "zh": "觀望 (安全)"},
  "Strong": {"ko": "강함", "en": "Strong", "ja": "強い", "es": "Fuerte", "de": "Stark", "fr": "Fort", "pt": "Forte", "tr": "Güçlü", "vi": "Mạnh", "id": "Kuat", "pl": "Silny", "it": "Forte", "ru": "Сильный", "zh": "強勢"},
  "Target Zone": {"ko": "목표 구간", "en": "Target Zone", "ja": "目標ゾーン", "es": "Zona Objetivo", "de": "Zielzone", "fr": "Zone Cible", "pt": "Zona Alvo", "tr": "Hedef Bölge", "vi": "Vùng Mục tiêu", "id": "Zona Target", "pl": "Strefa docelowa", "it": "Zona target", "ru": "Целевая зона", "zh": "目標區"},
  "Transitioning": {"ko": "전환 중", "en": "Transitioning", "ja": "転換中", "es": "Transición", "de": "Übergang", "fr": "En Transition", "pt": "Em Transição", "tr": "Geçiş Halinde", "vi": "Đang chuyển tiếp", "id": "Transisi", "pl": "Przejście", "it": "In transizione", "ru": "Переход", "zh": "過渡中"},
  "Volume Dry-up": {"ko": "거래량 고갈", "en": "Volume Dry-up", "ja": "出来高枯渇", "es": "Volumen Agotado", "de": "Volumen versiegt", "fr": "Volume Asséché", "pt": "Volume Esgotado", "tr": "Hacim Kuruması", "vi": "Cạn Khối lượng", "id": "Volume Mengering", "pl": "Wysychanie wolumenu", "it": "Volume in esaurimento", "ru": "Иссякание объёма", "zh": "量能枯竭"},
  "Volume Spike": {"ko": "거래량 급증", "en": "Volume Spike", "ja": "出来高急増", "es": "Pico de Volumen", "de": "Volumenspike", "fr": "Pic de Volume", "pt": "Pico de Volume", "tr": "Hacim Sıçraması", "vi": "Đột biến Khối lượng", "id": "Lonjakan Volume", "pl": "Skok wolumenu", "it": "Picco di volume", "ru": "Всплеск объёма", "zh": "量能爆發"},
  "Weak": {"ko": "약함", "en": "Weak", "ja": "弱い", "es": "Débil", "de": "Schwach", "fr": "Faible", "pt": "Fraco", "tr": "Zayıf", "vi": "Yếu", "id": "Lemah", "pl": "Słaby", "it": "Debole", "ru": "Слабый", "zh": "弱勢"},
};
const TARGET_MAP = {
  "Oversold ≤ 30 (bonus); not overbought": {"ko": "과매도 ≤ 30", "en": "Oversold ≤ 30", "ja": "売られすぎ ≤ 30", "es": "Sobreventa ≤ 30", "de": "Überverkauft ≤ 30", "fr": "Survendu ≤ 30", "pt": "Sobrevenda ≤ 30", "tr": "Aşırı satım ≤ 30", "vi": "Quá bán ≤ 30", "id": "Jenuh jual ≤ 30 (bonus); tidak jenuh beli", "pl": "Wyprzedanie ≤ 30 (bonus); brak wykupienia", "it": "Ipervenduto ≤ 30 (bonus); non ipercomprato", "ru": "Перепроданность ≤ 30 (бонус); не перекуплен", "zh": "超賣 ≤ 30 (加分)；未超買"},
  "Overbought ≥ 70 (bonus); not oversold": {"ko": "과매수 ≥ 70", "en": "Overbought ≥ 70", "ja": "買われすぎ ≥ 70", "es": "Sobrecompra ≥ 70", "de": "Überkauft ≥ 70", "fr": "Suracheté ≥ 70", "pt": "Sobrecompra ≥ 70", "tr": "Aşırı alım ≥ 70", "vi": "Quá mua ≥ 70", "id": "Jenuh beli ≥ 70 (bonus); tidak jenuh jual", "pl": "Wykupienie ≥ 70 (bonus); brak wyprzedania", "it": "Ipercomprato ≥ 70 (bonus); non ipervenduto", "ru": "Перекупленность ≥ 70 (бонус); не перепродан", "zh": "超買 ≥ 70 (加分)；未超賣"},
  "Volume spike = capitulation-to-rebound bonus; dry-up = neutral (basing)": {"ko": "거래량 급증 = 항복 후 반등 신호", "en": "Volume spike = capitulation rebound", "ja": "出来高急増 = 投降後の反発シグナル", "es": "Pico de volumen = rebote tras capitulación", "de": "Volumenspike = Rebound nach Kapitulation", "fr": "Pic de volume = rebond post-capitulation", "pt": "Pico de volume = repique pós-capitulação", "tr": "Hacim sıçraması = kapitülasyon sonrası tepki", "vi": "Đột biến khối lượng = bật lại sau đầu hàng", "id": "Lonjakan volume = bonus kapitulasi-ke-rebound; volume kering = netral (dasar)", "pl": "Skok wolumenu = bonus za kapitulację i odbicie; wysychanie = neutralnie (formowanie dna)", "it": "Picco di volume = bonus capitolazione-rimbalzo; esaurimento = neutro (base)", "ru": "Всплеск объёма = бонус за капитуляцию и отскок; иссякание = нейтрально (формирование дна)", "zh": "量能爆發 = 投降轉反彈加分；量能枯竭 = 中立 (打底)"},
  "Volume spike near highs = distribution bonus; dry-up = neutral": {"ko": "고점권 거래량 급증 = 분산(매도) 신호", "en": "Volume spike near highs = distribution", "ja": "高値圏の出来高急増 = 分配(売り)シグナル", "es": "Pico de volumen cerca de máximos = distribución", "de": "Volumenspike nahe Hochs = Distribution", "fr": "Pic de volume près des sommets = distribution", "pt": "Pico de volume perto das máximas = distribuição", "tr": "Zirveye yakın hacim sıçraması = dağıtım", "vi": "Đột biến khối lượng gần đỉnh = phân phối", "id": "Lonjakan volume dekat puncak = bonus distribusi; volume kering = netral", "pl": "Skok wolumenu przy szczytach = bonus dystrybucji; wysychanie = neutralnie", "it": "Picco di volume vicino ai massimi = bonus distribuzione; esaurimento = neutro", "ru": "Всплеск объёма у максимумов = бонус за распределение; иссякание = нейтрально", "zh": "高檔量能爆發 = 派發加分；量能枯竭 = 中立"},
  "Capitulation (sell+spike+red) = bonus; quiet = neutral; buying frenzy = penalty": {"ko": "매도 주도 급증 + 음봉 = 항복 신호", "en": "Sell-led spike + red = capitulation", "ja": "売り主導の急増+陰線 = 投降シグナル", "es": "Pico liderado por venta + vela roja = capitulación", "de": "Verkäufergetriebener Spike + rote Kerze = Kapitulation", "fr": "Pic mené par la vente + bougie rouge = capitulation", "pt": "Pico liderado por venda + vela vermelha = capitulação", "tr": "Satış öncülüğünde sıçrama + kırmızı mum = kapitülasyon", "vi": "Đột biến do bán dẫn dắt + nến đỏ = đầu hàng", "id": "Kapitulasi (jual+lonjakan+merah) = bonus; sepi = netral; euforia beli = penalti", "pl": "Kapitulacja (sprzedaż+skok+czerwona) = bonus; spokój = neutralnie; szał zakupów = kara", "it": "Capitolazione (vendita+picco+rossa) = bonus; calma = neutro; frenesia d'acquisto = penalità", "ru": "Капитуляция (продажи+всплеск+красная) = бонус; тишина = нейтрально; ажиотаж покупок = штраф", "zh": "投降 (賣出+爆量+黑K) = 加分；平靜 = 中立；搶買狂熱 = 扣分"},
  "FOMO (buy+spike+green) = bonus; quiet = neutral; capitulation = penalty": {"ko": "매수 주도 급증 + 양봉 = FOMO 과열", "en": "Buy-led spike + green = FOMO", "ja": "買い主導の急増+陽線 = FOMO過熱", "es": "Pico liderado por compra + vela verde = FOMO", "de": "Käufergetriebener Spike + grüne Kerze = FOMO", "fr": "Pic mené par l'achat + bougie verte = FOMO", "pt": "Pico liderado por compra + vela verde = FOMO", "tr": "Alım öncülüğünde sıçrama + yeşil mum = FOMO", "vi": "Đột biến do mua dẫn dắt + nến xanh = FOMO", "id": "FOMO (beli+lonjakan+hijau) = bonus; sepi = netral; kapitulasi = penalti", "pl": "FOMO (kupno+skok+zielona) = bonus; spokój = neutralnie; kapitulacja = kara", "it": "FOMO (acquisto+picco+verde) = bonus; calma = neutro; capitolazione = penalità", "ru": "FOMO (покупки+всплеск+зелёная) = бонус; тишина = нейтрально; капитуляция = штраф", "zh": "FOMO (買進+爆量+紅K) = 加分；平靜 = 中立；投降 = 扣分"},
  "SHORT zone ≥ 30% above realized": {"ko": "숏 구간: 실현가 +30% 이상", "en": "SHORT zone: ≥30% above realized", "ja": "ショート圏: 実現価格+30%以上", "es": "Zona corta: ≥30% sobre realizado", "de": "SHORT-Zone: ≥30% über Realized", "fr": "Zone short : ≥30% au-dessus du réalisé", "pt": "Zona short: ≥30% acima do realizado", "tr": "SHORT bölgesi: gerçekleşenin ≥%30 üstü", "vi": "Vùng short: ≥30% trên giá thực hiện", "id": "Zona SHORT ≥ 30% di atas realized", "pl": "Strefa SHORT ≥ 30% powyżej realized", "it": "Zona SHORT ≥ 30% sopra realized", "ru": "Зона SHORT ≥ 30% выше realized", "zh": "SHORT 區 ≥ 高於實現價 30%"},
  "Correlation is direction-neutral for shorting": {"ko": "상관관계는 숏에 방향 중립", "en": "Direction-neutral for shorting", "ja": "相関はショートに方向中立", "es": "Neutral en dirección para cortos", "de": "Richtungsneutral für Shorts", "fr": "Neutre en direction pour le short", "pt": "Neutro em direção para short", "tr": "Short için yön-nötr", "vi": "Trung lập hướng khi short", "id": "Korelasi bersifat netral arah untuk short", "pl": "Korelacja jest neutralna kierunkowo dla shortów", "it": "La correlazione è neutrale per lo short", "ru": "Корреляция нейтральна к направлению для шорта", "zh": "相關性對做空為方向中立"},
  "12~24mo before = bottom zone": {"ko": "반감기 12~24개월 전 = 저점 구간", "en": "12~24mo before = bottom zone", "ja": "半減期12〜24ヶ月前 = 底値ゾーン", "es": "12-24 meses antes = zona de suelo", "de": "12-24 Monate vorher = Tiefzone", "fr": "12-24 mois avant = zone de creux", "pt": "12-24 meses antes = zona de fundo", "tr": "Yarılanmadan 12-24 ay önce = dip bölgesi", "vi": "12~24 tháng trước = vùng đáy", "id": "12~24 bulan sebelumnya = zona dasar", "pl": "12~24 mies. wcześniej = strefa dna", "it": "12~24 mesi prima = zona di fondo", "ru": "За 12~24 мес. = зона дна", "zh": "前 12~24 個月 = 底部區"},
  "55~63% BTC season": {"ko": "55~63% BTC 시즌", "en": "55~63% BTC season", "ja": "55~63% BTCシーズン", "es": "55-63% temporada BTC", "de": "55-63% BTC-Season", "fr": "55-63% saison BTC", "pt": "55-63% temporada BTC", "tr": "55-63% BTC sezonu", "vi": "55~63% mùa BTC", "id": "55~63% BTC season", "pl": "55~63% sezon BTC", "it": "55~63% BTC season", "ru": "55~63% сезон BTC", "zh": "55~63% BTC 季"},
  "Alt season ≤ 50%": {"ko": "알트시즌 ≤ 50%", "en": "Alt season ≤ 50%", "ja": "アルトシーズン ≤ 50%", "es": "Temporada alt ≤ 50%", "de": "Alt-Season ≤ 50%", "fr": "Saison alt ≤ 50%", "pt": "Temporada alt ≤ 50%", "tr": "Alt sezon ≤ 50%", "vi": "Mùa alt ≤ 50%", "id": "Alt season ≤ 50%", "pl": "Sezon altów ≤ 50%", "it": "Alt season ≤ 50%", "ru": "Альтсезон ≤ 50%", "zh": "山寨季 ≤ 50%"},
  "Backwardation = short squeeze signal": {"ko": "백워데이션 = 숏스퀴즈 신호", "en": "Backwardation = short squeeze signal", "ja": "バックワーデーション = ショートスクイーズシグナル", "es": "Backwardation = señal de short squeeze", "de": "Backwardation = Short-Squeeze-Signal", "fr": "Backwardation = signal de short squeeze", "pt": "Backwardation = sinal de short squeeze", "tr": "Backwardation = short squeeze sinyali", "vi": "Backwardation = tín hiệu short squeeze", "id": "Backwardation = sinyal short squeeze", "pl": "Backwardation = sygnał short squeeze", "it": "Backwardation = segnale di short squeeze", "ru": "Бэквордация = сигнал шорт-сквиза", "zh": "逆價差 = 軋空訊號"},
  "Below estimated realized price": {"ko": "추정 실현가 이하", "en": "Below estimated realized price", "ja": "推定実現価格以下", "es": "Bajo el precio realizado estimado", "de": "Unter geschätztem Realized Price", "fr": "Sous le prix réalisé estimé", "pt": "Abaixo do preço realizado estimado", "tr": "Tahmini gerçekleşen fiyatın altında", "vi": "Dưới giá thực hiện ước tính", "id": "Di bawah estimasi harga realized", "pl": "Poniżej szacowanej ceny realized", "it": "Sotto il prezzo realized stimato", "ru": "Ниже расчётной цены realized", "zh": "低於估計實現價"},
  "Bottom zone ≤ 0": {"ko": "저점 구간 ≤ 0", "en": "Bottom zone ≤ 0", "ja": "底値ゾーン ≤ 0", "es": "Zona de suelo ≤ 0", "de": "Tiefzone ≤ 0", "fr": "Zone de creux ≤ 0", "pt": "Zona de fundo ≤ 0", "tr": "Dip bölgesi ≤ 0", "vi": "Vùng đáy ≤ 0", "id": "Zona dasar ≤ 0", "pl": "Strefa dna ≤ 0", "it": "Zona di fondo ≤ 0", "ru": "Зона дна ≤ 0", "zh": "底部區 ≤ 0"},
  "Buy ratio ≥ 65% + volume spike + green candle (last 15m)": {"ko": "매수 비율 ≥ 65% + 거래량 급증 + 양봉 (최근 15분)", "en": "Buy ratio ≥ 65% + volume spike + green candle (last 15m)", "ja": "買い比率 ≥ 65% + 出来高急増 + 陽線(直近15分)", "es": "Ratio de compra ≥ 65% + pico de volumen + vela verde (últimos 15m)", "de": "Kaufquote ≥ 65% + Volumenspike + grüne Kerze (letzte 15m)", "fr": "Ratio d'achat ≥ 65% + pic de volume + bougie verte (15 dernières min)", "pt": "Proporção de compra ≥ 65% + pico de volume + vela verde (últimos 15m)", "tr": "Alım oranı ≥ 65% + hacim sıçraması + yeşil mum (son 15d)", "vi": "Tỷ lệ mua ≥ 65% + đột biến khối lượng + nến xanh (15p qua)", "id": "Rasio beli ≥ 65% + lonjakan volume + candle hijau (15m terakhir)", "pl": "Udział kupna ≥ 65% + skok wolumenu + zielona świeca (ostatnie 15m)", "it": "Rapporto acquisti ≥ 65% + picco di volume + candela verde (ultimi 15m)", "ru": "Доля покупок ≥ 65% + всплеск объёма + зелёная свеча (посл. 15м)", "zh": "買進比 ≥ 65% + 爆量 + 紅K (近 15 分鐘)"},
  "Capitulation ≤0.95": {"ko": "항복 ≤0.95", "en": "Capitulation ≤0.95", "ja": "キャピチュレーション ≤0.95", "es": "Capitulación ≤0.95", "de": "Kapitulation ≤0,95", "fr": "Capitulation ≤0,95", "pt": "Capitulação ≤0,95", "tr": "Kapitülasyon ≤0,95", "vi": "Đầu hàng ≤0,95", "id": "Kapitulasi ≤0.95", "pl": "Kapitulacja ≤0.95", "it": "Capitolazione ≤0.95", "ru": "Капитуляция ≤0.95", "zh": "投降 ≤0.95"},
  "Fear zone ≤ 0%": {"ko": "공포 구간 ≤ 0%", "en": "Fear zone ≤ 0%", "ja": "恐怖ゾーン ≤ 0%", "es": "Zona de miedo ≤ 0%", "de": "Angstzone ≤ 0%", "fr": "Zone de peur ≤ 0%", "pt": "Zona de medo ≤ 0%", "tr": "Korku bölgesi ≤ 0%", "vi": "Vùng sợ hãi ≤ 0%", "id": "Zona ketakutan ≤ 0%", "pl": "Strefa strachu ≤ 0%", "it": "Zona di paura ≤ 0%", "ru": "Зона страха ≤ 0%", "zh": "恐懼區 ≤ 0%"},
  "High correlation = follows BTC weakness": {"ko": "높은 상관관계 = BTC 약세 추종", "en": "High correlation = follows BTC weakness", "ja": "高い相関 = BTCの弱さに追従", "es": "Alta correlación = sigue la debilidad de BTC", "de": "Hohe Korrelation = folgt BTC-Schwäche", "fr": "Forte corrélation = suit la faiblesse du BTC", "pt": "Alta correlação = segue a fraqueza do BTC", "tr": "Yüksek korelasyon = BTC zayıflığını izler", "vi": "Tương quan cao = theo điểm yếu BTC", "id": "Korelasi tinggi = mengikuti pelemahan BTC", "pl": "Wysoka korelacja = podąża za słabością BTC", "it": "Alta correlazione = segue la debolezza di BTC", "ru": "Высокая корреляция = следует за слабостью BTC", "zh": "高相關 = 跟隨 BTC 走弱"},
  "High dominance = strong network": {"ko": "높은 도미넌스 = 강한 네트워크", "en": "High dominance = strong network", "ja": "高いドミナンス = 強いネットワーク", "es": "Alta dominancia = red fuerte", "de": "Hohe Dominanz = starkes Netzwerk", "fr": "Forte dominance = réseau solide", "pt": "Alta dominância = rede forte", "tr": "Yüksek dominans = güçlü ağ", "vi": "Thống trị cao = mạng mạnh", "id": "Dominansi tinggi = jaringan kuat", "pl": "Wysoka dominacja = silna sieć", "it": "Alta dominanza = rete forte", "ru": "Высокое доминирование = сильная сеть", "zh": "高市佔 = 網路強勢"},
  "Low correlation = independent strength": {"ko": "낮은 상관관계 = 독자적 강세", "en": "Low correlation = independent strength", "ja": "低い相関 = 独自の強さ", "es": "Baja correlación = fortaleza independiente", "de": "Niedrige Korrelation = unabhängige Stärke", "fr": "Faible corrélation = force indépendante", "pt": "Baixa correlação = força independente", "tr": "Düşük korelasyon = bağımsız güç", "vi": "Tương quan thấp = sức mạnh độc lập", "id": "Korelasi rendah = kekuatan independen", "pl": "Niska korelacja = niezależna siła", "it": "Bassa correlazione = forza indipendente", "ru": "Низкая корреляция = независимая сила", "zh": "低相關 = 獨立強勢"},
  "Overbought ≥ 70": {"ko": "과매수 ≥ 70", "en": "Overbought ≥ 70", "ja": "買われすぎ ≥ 70", "es": "Sobrecompra ≥ 70", "de": "Überkauft ≥ 70", "fr": "Suracheté ≥ 70", "pt": "Sobrecompra ≥ 70", "tr": "Aşırı alım ≥ 70", "vi": "Quá mua ≥ 70", "id": "Jenuh beli ≥ 70", "pl": "Wykupienie ≥ 70", "it": "Ipercomprato ≥ 70", "ru": "Перекупленность ≥ 70", "zh": "超買 ≥ 70"},
  "Oversold ≤ 30": {"ko": "과매도 ≤ 30", "en": "Oversold ≤ 30", "ja": "売られすぎ ≤ 30", "es": "Sobreventa ≤ 30", "de": "Überverkauft ≤ 30", "fr": "Survendu ≤ 30", "pt": "Sobrevenda ≤ 30", "tr": "Aşırı satım ≤ 30", "vi": "Quá bán ≤ 30", "id": "Jenuh jual ≤ 30", "pl": "Wyprzedanie ≤ 30", "it": "Ipervenduto ≤ 30", "ru": "Перепроданность ≤ 30", "zh": "超賣 ≤ 30"},
  "Positive = institutional re-entry": {"ko": "양수 = 기관 재진입", "en": "Positive = institutional re-entry", "ja": "プラス = 機関再参入", "es": "Positivo = reingreso institucional", "de": "Positiv = institutioneller Wiedereinstieg", "fr": "Positif = réentrée institutionnelle", "pt": "Positivo = reentrada institucional", "tr": "Pozitif = kurumsal yeniden giriş", "vi": "Dương = tổ chức quay lại", "id": "Positif = masuknya kembali institusi", "pl": "Dodatni = powrót instytucji", "it": "Positivo = rientro istituzionale", "ru": "Положительно = возврат институционалов", "zh": "轉正 = 機構回補"},
  "Recovery cross (30MA>60MA)": {"ko": "회복 전환 (30MA>60MA)", "en": "Recovery cross (30MA>60MA)", "ja": "回復転換 (30MA>60MA)", "es": "Cruce de recuperación (30MA>60MA)", "de": "Erholungscross (30MA>60MA)", "fr": "Croisement de reprise (30MM>60MM)", "pt": "Cruzamento de recuperação (30MA>60MA)", "tr": "Toparlanma kesişimi (30HO>60HO)", "vi": "Giao cắt phục hồi (30MA>60MA)", "id": "Cross pemulihan (30MA>60MA)", "pl": "Krzyż odbicia (30MA>60MA)", "it": "Cross di ripresa (30MA>60MA)", "ru": "Крест восстановления (30MA>60MA)", "zh": "回升交叉 (30MA>60MA)"},
  "SHORT optimal: 12–18 months after halving": {"ko": "숏 최적: 반감기 후 12~18개월", "en": "SHORT optimal: 12–18 months after halving", "ja": "ショート最適: 半減期後12〜18ヶ月", "es": "Óptimo CORTO: 12-18 meses tras el halving", "de": "SHORT optimal: 12-18 Monate nach Halving", "fr": "SHORT optimal : 12-18 mois après le halving", "pt": "SHORT ótimo: 12-18 meses após o halving", "tr": "SHORT optimal: yarılanmadan 12-18 ay sonra", "vi": "SHORT tối ưu: 12-18 tháng sau halving", "id": "SHORT optimal: 12–18 bulan setelah halving", "pl": "SHORT optymalny: 12–18 miesięcy po halvingu", "it": "SHORT ottimale: 12–18 mesi dopo l'halving", "ru": "SHORT оптимален: 12–18 месяцев после халвинга", "zh": "SHORT 最佳：減半後 12–18 個月"},
  "SHORT zone > -20%": {"ko": "숏 구간 > -20%", "en": "SHORT zone > -20%", "ja": "ショートゾーン > -20%", "es": "Zona CORTO > -20%", "de": "SHORT-Zone > -20%", "fr": "Zone SHORT > -20%", "pt": "Zona SHORT > -20%", "tr": "SHORT bölgesi > -20%", "vi": "Vùng SHORT > -20%", "id": "Zona SHORT > -20%", "pl": "Strefa SHORT > -20%", "it": "Zona SHORT > -20%", "ru": "Зона SHORT > -20%", "zh": "SHORT 區 > -20%"},
  "SHORT zone ≤ 50%": {"ko": "숏 구간 ≤ 50%", "en": "SHORT zone ≤ 50%", "ja": "ショートゾーン ≤ 50%", "es": "Zona CORTO ≤ 50%", "de": "SHORT-Zone ≤ 50%", "fr": "Zone SHORT ≤ 50%", "pt": "Zona SHORT ≤ 50%", "tr": "SHORT bölgesi ≤ 50%", "vi": "Vùng SHORT ≤ 50%", "id": "Zona SHORT ≤ 50%", "pl": "Strefa SHORT ≤ 50%", "it": "Zona SHORT ≤ 50%", "ru": "Зона SHORT ≤ 50%", "zh": "SHORT 區 ≤ 50%"},
  "SHORT zone ≤ 70%": {"ko": "숏 구간 ≤ 70%", "en": "SHORT zone ≤ 70%", "ja": "ショートゾーン ≤ 70%", "es": "Zona CORTO ≤ 70%", "de": "SHORT-Zone ≤ 70%", "fr": "Zone SHORT ≤ 70%", "pt": "Zona SHORT ≤ 70%", "tr": "SHORT bölgesi ≤ 70%", "vi": "Vùng SHORT ≤ 70%", "id": "Zona SHORT ≤ 70%", "pl": "Strefa SHORT ≤ 70%", "it": "Zona SHORT ≤ 70%", "ru": "Зона SHORT ≤ 70%", "zh": "SHORT 區 ≤ 70%"},
  "SHORT zone ≥ 0.10%": {"ko": "숏 구간 ≥ 0.10%", "en": "SHORT zone ≥ 0.10%", "ja": "ショートゾーン ≥ 0.10%", "es": "Zona CORTO ≥ 0.10%", "de": "SHORT-Zone ≥ 0,10%", "fr": "Zone SHORT ≥ 0,10%", "pt": "Zona SHORT ≥ 0,10%", "tr": "SHORT bölgesi ≥ 0,10%", "vi": "Vùng SHORT ≥ 0,10%", "id": "Zona SHORT ≥ 0.10%", "pl": "Strefa SHORT ≥ 0.10%", "it": "Zona SHORT ≥ 0.10%", "ru": "Зона SHORT ≥ 0.10%", "zh": "SHORT 區 ≥ 0.10%"},
  "SHORT zone ≥ 0.15%": {"ko": "숏 구간 ≥ 0.15%", "en": "SHORT zone ≥ 0.15%", "ja": "ショートゾーン ≥ 0.15%", "es": "Zona CORTO ≥ 0.15%", "de": "SHORT-Zone ≥ 0,15%", "fr": "Zone SHORT ≥ 0,15%", "pt": "Zona SHORT ≥ 0,15%", "tr": "SHORT bölgesi ≥ 0,15%", "vi": "Vùng SHORT ≥ 0,15%", "id": "Zona SHORT ≥ 0.15%", "pl": "Strefa SHORT ≥ 0.15%", "it": "Zona SHORT ≥ 0.15%", "ru": "Зона SHORT ≥ 0.15%", "zh": "SHORT 區 ≥ 0.15%"},
  "SHORT zone ≥ 1.04": {"ko": "숏 구간 ≥ 1.04", "en": "SHORT zone ≥ 1.04", "ja": "ショートゾーン ≥ 1.04", "es": "Zona CORTO ≥ 1.04", "de": "SHORT-Zone ≥ 1,04", "fr": "Zone SHORT ≥ 1,04", "pt": "Zona SHORT ≥ 1,04", "tr": "SHORT bölgesi ≥ 1,04", "vi": "Vùng SHORT ≥ 1,04", "id": "Zona SHORT ≥ 1.04", "pl": "Strefa SHORT ≥ 1.04", "it": "Zona SHORT ≥ 1.04", "ru": "Зона SHORT ≥ 1.04", "zh": "SHORT 區 ≥ 1.04"},
  "SHORT zone ≥ 20% above realized": {"ko": "숏 구간: 실현가 대비 20% 이상", "en": "SHORT zone ≥ 20% above realized", "ja": "ショートゾーン: 実現価格比20%以上", "es": "Zona CORTO: 20% o más sobre el realizado", "de": "SHORT-Zone: 20%+ über Realized", "fr": "Zone SHORT : 20%+ au-dessus du réalisé", "pt": "Zona SHORT: 20% ou mais acima do realizado", "tr": "SHORT bölgesi: gerçekleşenin %20+ üstünde", "vi": "Vùng SHORT: 20%+ trên thực hiện", "id": "Zona SHORT ≥ 20% di atas realized", "pl": "Strefa SHORT ≥ 20% powyżej realized", "it": "Zona SHORT ≥ 20% sopra realized", "ru": "Зона SHORT ≥ 20% выше realized", "zh": "SHORT 區 ≥ 高於實現價 20%"},
  "SHORT zone ≥ 3.5": {"ko": "숏 구간 ≥ 3.5", "en": "SHORT zone ≥ 3.5", "ja": "ショートゾーン ≥ 3.5", "es": "Zona CORTO ≥ 3.5", "de": "SHORT-Zone ≥ 3,5", "fr": "Zone SHORT ≥ 3,5", "pt": "Zona SHORT ≥ 3,5", "tr": "SHORT bölgesi ≥ 3,5", "vi": "Vùng SHORT ≥ 3,5", "id": "Zona SHORT ≥ 3.5", "pl": "Strefa SHORT ≥ 3.5", "it": "Zona SHORT ≥ 3.5", "ru": "Зона SHORT ≥ 3.5", "zh": "SHORT 區 ≥ 3.5"},
  "SHORT zone ≥ 60%": {"ko": "숏 구간 ≥ 60%", "en": "SHORT zone ≥ 60%", "ja": "ショートゾーン ≥ 60%", "es": "Zona CORTO ≥ 60%", "de": "SHORT-Zone ≥ 60%", "fr": "Zone SHORT ≥ 60%", "pt": "Zona SHORT ≥ 60%", "tr": "SHORT bölgesi ≥ 60%", "vi": "Vùng SHORT ≥ 60%", "id": "Zona SHORT ≥ 60%", "pl": "Strefa SHORT ≥ 60%", "it": "Zona SHORT ≥ 60%", "ru": "Зона SHORT ≥ 60%", "zh": "SHORT 區 ≥ 60%"},
  "SHORT zone: within -15% of ATH": {"ko": "숏 구간: ATH 대비 -15% 이내", "en": "SHORT zone: within -15% of ATH", "ja": "ショートゾーン: ATH比-15%以内", "es": "Zona CORTO: dentro de -15% del ATH", "de": "SHORT-Zone: innerhalb -15% vom ATH", "fr": "Zone SHORT : à moins de -15% de l'ATH", "pt": "Zona SHORT: dentro de -15% do ATH", "tr": "SHORT bölgesi: ATH'nin -15% içinde", "vi": "Vùng SHORT: trong -15% của ATH", "id": "Zona SHORT: dalam -15% dari ATH", "pl": "Strefa SHORT: w granicach -15% od ATH", "it": "Zona SHORT: entro -15% dall'ATH", "ru": "Зона SHORT: в пределах -15% от ATH", "zh": "SHORT 區：距歷史高點 -15% 以內"},
  "Sell ratio ≥ 58% + volume spike + red candle (last 15m)": {"ko": "매도 비율 ≥ 58% + 거래량 급증 + 음봉 (최근 15분)", "en": "Sell ratio ≥ 58% + volume spike + red candle (last 15m)", "ja": "売り比率 ≥ 58% + 出来高急増 + 陰線(直近15分)", "es": "Ratio de venta ≥ 58% + pico de volumen + vela roja (últimos 15m)", "de": "Verkaufsquote ≥ 58% + Volumenspike + rote Kerze (letzte 15m)", "fr": "Ratio de vente ≥ 58% + pic de volume + bougie rouge (15 dernières min)", "pt": "Proporção de venda ≥ 58% + pico de volume + vela vermelha (últimos 15m)", "tr": "Satış oranı ≥ 58% + hacim sıçraması + kırmızı mum (son 15d)", "vi": "Tỷ lệ bán ≥ 58% + đột biến khối lượng + nến đỏ (15p qua)", "id": "Rasio jual ≥ 58% + lonjakan volume + candle merah (15m terakhir)", "pl": "Udział sprzedaży ≥ 58% + skok wolumenu + czerwona świeca (ostatnie 15m)", "it": "Rapporto vendite ≥ 58% + picco di volume + candela rossa (ultimi 15m)", "ru": "Доля продаж ≥ 58% + всплеск объёма + красная свеча (посл. 15м)", "zh": "賣出比 ≥ 58% + 爆量 + 黑K (近 15 分鐘)"},
  "Volume spike near highs = distribution (selling) signal": {"ko": "고점 근처 거래량 급증 = 분산(매도) 신호", "en": "Volume spike near highs = distribution (selling) signal", "ja": "高値近くの出来高急増 = 分配(売り)シグナル", "es": "Pico de volumen cerca de máximos = señal de distribución (venta)", "de": "Volumenspike nahe Hochs = Distributionssignal (Verkauf)", "fr": "Pic de volume près des sommets = signal de distribution (vente)", "pt": "Pico de volume perto de máximas = sinal de distribuição (venda)", "tr": "Tepelere yakın hacim sıçraması = dağıtım (satış) sinyali", "vi": "Đột biến khối lượng gần đỉnh = tín hiệu phân phối (bán)", "id": "Lonjakan volume dekat puncak = sinyal distribusi (jual)", "pl": "Skok wolumenu przy szczytach = sygnał dystrybucji (sprzedaży)", "it": "Picco di volume vicino ai massimi = segnale di distribuzione (vendita)", "ru": "Всплеск объёма у максимумов = сигнал распределения (продаж)", "zh": "高檔爆量 = 派發 (賣出) 訊號"},
  "Volume spike near lows = capitulation-to-rebound signal": {"ko": "저점 근처 거래량 급증 = 항복 후 반등 신호", "en": "Volume spike near lows = capitulation-to-rebound signal", "ja": "安値近くの出来高急増 = キャピチュレーション後反発シグナル", "es": "Pico de volumen cerca de mínimos = señal de capitulación a rebote", "de": "Volumenspike nahe Tiefs = Kapitulations-zu-Rebound-Signal", "fr": "Pic de volume près des creux = signal de capitulation vers rebond", "pt": "Pico de volume perto de mínimas = sinal de capitulação para recuperação", "tr": "Diplere yakın hacim sıçraması = kapitülasyondan toparlanmaya sinyali", "vi": "Đột biến khối lượng gần đáy = tín hiệu đầu hàng-hồi phục", "id": "Lonjakan volume dekat dasar = sinyal kapitulasi-ke-rebound", "pl": "Skok wolumenu przy dołkach = sygnał kapitulacji i odbicia", "it": "Picco di volume vicino ai minimi = segnale capitolazione-rimbalzo", "ru": "Всплеск объёма у минимумов = сигнал капитуляции и отскока", "zh": "低檔爆量 = 投降轉反彈訊號"},
  "≤5% or below": {"ko": "실현가 대비 ≤ 5%", "en": "≤ 5% from realized", "ja": "実現価格から ≤ 5%", "es": "≤ 5% del realizado", "de": "≤ 5% vom Realized", "fr": "≤ 5% du réalisé", "pt": "≤ 5% do realizado", "tr": "gerçekleşenden ≤ %5", "vi": "≤ 5% so với giá thực hiện", "id": "≤5% atau kurang", "pl": "≤5% lub mniej", "it": "≤5% o inferiore", "ru": "≤5% и ниже", "zh": "≤5% 或更低"},
  "≥70% drawdown from ATH": {"ko": "ATH 대비 ≥70% 하락", "en": "≥70% drawdown from ATH", "ja": "ATH比≥70%下落", "es": "≥70% de caída desde el ATH", "de": "≥70% Drawdown vom ATH", "fr": "≥70% de baisse depuis l'ATH", "pt": "≥70% de queda desde o ATH", "tr": "ATH'den ≥70% düşüş", "vi": "≥70% sụt giảm từ ATH", "id": "Penurunan ≥70% dari ATH", "pl": "Spadek ≥70% od ATH", "it": "Drawdown ≥70% dall'ATH", "ru": "Просадка ≥70% от ATH", "zh": "自歷史高點回落 ≥70%"},
  "≥75% whale accumulation": {"ko": "≥75% 고래 매집", "en": "≥75% whale accumulation", "ja": "≥75%クジラ蓄積", "es": "≥75% acumulación de ballenas", "de": "≥75% Wal-Akkumulation", "fr": "≥75% accumulation de baleines", "pt": "≥75% acumulação de baleias", "tr": "≥75% balina biriktirmesi", "vi": "≥75% cá voi tích lũy", "id": "Akumulasi whale ≥75%", "pl": "Akumulacja wielorybów ≥75%", "it": "Accumulo whale ≥75%", "ru": "Накопление китов ≥75%", "zh": "巨鯨累積 ≥75%"},
};
    ...
    ov.innerHTML = `
      <div class="coin-ov-box" role="dialog" aria-modal="true" aria-label="코인 전환">
        ...
        <div class="coin-sw-head">
          <div>
            <span class="coin-sw-title">${TT({ko:'코인 전환',en:'Switch coin',ja:'コイン切替',es:'Cambiar moneda',de:'Coin wechseln',fr:'Changer de crypto',pt:'Trocar moeda',tr:'Coin değiştir',vi:'Đổi coin',id:"Ganti coin",pl:"Zmień coina",it:"Cambia coin",ru:"Сменить монету",zh:"切換幣種"})}</span>
            <span class="coin-sw-sub">${TT({ko:'즐겨찾기한 코인',en:'Your favorite coins',ja:'お気に入りコイン',es:'Tus favoritos',de:'Deine Favoriten',fr:'Vos cryptos favorites',pt:'Suas moedas favoritas',tr:'Favori coinleriniz',vi:'Coin yêu thích của bạn',id:"Coin favorit Anda",pl:"Twoje ulubione coiny",it:"Le tue coin preferite",ru:"Ваши избранные монеты",zh:"你的收藏幣種"})}</span>
          </div>
        ...
        <button class="coin-sw-manage" onclick="closeCoinSwitcher();openCoinSearch()">
          ＋ ${TT({ko:'코인 검색 / 관리',en:'Search / manage coins',ja:'コイン検索・管理',es:'Buscar / gestionar',de:'Coins suchen / verwalten',fr:'Rechercher / gérer les cryptos',pt:'Buscar / gerenciar moedas',tr:'Coin ara / yönet',vi:'Tìm / quản lý coin',id:"Cari / kelola coin",pl:"Szukaj / zarządzaj",it:"Cerca / gestisci",ru:"Поиск / управление",zh:"搜尋／管理幣種"})}
        </button>
      </div>`;
...
function renderCoinSwitchList() {
  ...
  const favCoins = getFavoriteCoins();
  if (!favCoins.length) {
    list.innerHTML = `<div class="coin-ov-empty">${TT({ko:'즐겨찾기한 코인이 없습니다.',en:'No favorite coins yet.',ja:'お気に入りがありません。',es:'Sin favoritos.',de:'Keine Favoriten.',fr:'Aucune crypto favorite.',pt:'Nenhuma moeda favorita.',tr:'Henüz favori coin yok.',vi:'Chưa có coin yêu thích.',id:"Belum ada coin favorit.",pl:"Brak ulubionych coinów.",it:"Nessuna coin preferita.",ru:"Пока нет избранных монет.",zh:"尚無收藏幣種。"})}</div>`;
    return;
  }
  list.innerHTML = favCoins.map(c => `
    <div class="coin-sw-item${c.id===currentCoin?' current':''}" onclick="switchCoinFromSheet('${c.id}')">
      ...
      ${c.id===currentCoin?`<span class="coin-sw-cur">${TT({ko:'보는 중',en:'viewing',ja:'表示中',es:'viendo',de:'aktiv',fr:'en cours',pt:'visualizando',tr:'görüntüleniyor',vi:'đang xem',id:"dilihat",pl:"podgląd",it:"in vista",ru:"просмотр",zh:"檢視中"})}</span>`:''}
    </div>`).join('');
}
    ...
    ov.innerHTML = `
      <div class="coin-ov-box" role="dialog" aria-modal="true" aria-label="코인 검색">
        ...
        <div class="coin-ov-head">
          <input id="coinSearchInput" class="coin-ov-input" type="text" placeholder="${TT({ko:'코인 검색 (이름/심볼)',en:'Search coins (name/symbol)',ja:'コイン検索(名前/シンボル)',es:'Buscar monedas',de:'Coins suchen',fr:'Rechercher (nom/symbole)',pt:'Buscar (nome/símbolo)',tr:'Ara (isim/sembol)',vi:'Tìm (tên/ký hiệu)',id:"Cari coin (nama/simbol)",pl:"Szukaj (nazwa/symbol)",it:"Cerca (nome/simbolo)",ru:"Поиск (имя/символ)",zh:"搜尋幣種（名稱/代號）"})}" autocomplete="off">
          <button class="coin-ov-close" onclick="closeCoinSearch()" aria-label="Close">✕</button>
        </div>
        <div class="coin-ov-tabs">
          <button id="covTabFav" class="cov-tab active" onclick="setCoinSearchTab('fav')">★ ${TT({ko:'즐겨찾기',en:'Favorites',ja:'お気に入り',es:'Favoritos',de:'Favoriten',fr:'Favoris',pt:'Favoritos',tr:'Favoriler',vi:'Yêu thích',id:"Favorit",pl:"Ulubione",it:"Preferiti",ru:"Избранное",zh:"收藏"})} <span id="covFavCount" class="cov-cnt"></span></button>
          <button id="covTabAll" class="cov-tab" onclick="setCoinSearchTab('all')">${TT({ko:'전체',en:'All',ja:'すべて',es:'Todo',de:'Alle',fr:'Tout',pt:'Todos',tr:'Tümü',vi:'Tất cả',id:"Semua",pl:"Wszystko",it:"Tutti",ru:"Все",zh:"全部"})} <span class="cov-cnt">${COINS.length}</span></button>
        </div>
        <div class="coin-ov-bar">
          <span class="coin-ov-hint" id="covHint">${TT({ko:'별을 눌러 추가/제거',en:'Tap the star to add/remove',ja:'星をタップして追加/削除',es:'Toca la estrella',de:'Stern tippen',fr:'Touchez l\'étoile pour ajouter/retirer',pt:'Toque na estrela para adicionar/remover',tr:'Eklemek/çıkarmak için yıldıza dokunun',vi:'Chạm sao để thêm/xóa',id:"Ketuk bintang untuk tambah/hapus",pl:"Dotknij gwiazdki, aby dodać/usunąć",it:"Tocca la stella per aggiungere/rimuovere",ru:"Нажмите звезду, чтобы добавить/убрать",zh:"點星號以新增／移除"})}</span>
          <button class="coin-ov-reset" onclick="resetFavAndRefresh()">${TT({ko:'기본값 초기화',en:'Reset',ja:'リセット',es:'Restablecer',de:'Zurücksetzen',fr:'Réinitialiser',pt:'Redefinir',tr:'Sıfırla',vi:'Đặt lại',id:"Atur ulang",pl:"Resetuj",it:"Reimposta",ru:"Сбросить",zh:"重設"})}</button>
        </div>
...
function renderCoinSearchList(q) {
  ...
  if (hint) {
    hint.textContent = coinSearchTab === 'all'
      ? TT({ko:'항목을 눌러 즐겨찾기 추가/제거',en:'Tap an item to add/remove favorite',ja:'項目をタップして追加/削除',es:'Toca para añadir/quitar favorito',de:'Tippen zum Hinzufügen/Entfernen',fr:'Touchez un élément pour l\'ajouter/retirer des favoris',pt:'Toque num item para adicionar/remover favorito',tr:'Favoriye eklemek/çıkarmak için bir öğeye dokunun',vi:'Chạm mục để thêm/xóa yêu thích',id:"Ketuk item untuk tambah/hapus favorit",pl:"Dotknij, aby dodać/usunąć ulubione",it:"Tocca un elemento per gestire i preferiti",ru:"Нажмите элемент, чтобы изменить избранное",zh:"點項目以新增／移除收藏"})
      : TT({ko:'항목을 눌러 이동 · 별로 제거',en:'Tap to switch · star to remove',ja:'タップで移動・星で削除',es:'Toca para ir · estrella para quitar',de:'Tippen zum Wechseln · Stern entfernt',fr:'Touchez pour changer · étoile pour retirer',pt:'Toque para trocar · estrela para remover',tr:'Değiştirmek için dokunun · kaldırmak için yıldız',vi:'Chạm để đổi · sao để xóa',id:"Ketuk untuk ganti · bintang untuk hapus",pl:"Dotknij, aby przełączyć · gwiazdka usuwa",it:"Tocca per cambiare · stella per rimuovere",ru:"Нажмите для смены · звезда убирает",zh:"點擊切換 · 星號移除"});
  }
  ...
  if (!matched.length) {
    const emptyMsg = coinSearchTab === 'fav' && !query
      ? TT({ko:'즐겨찾기한 코인이 없습니다. 전체 탭에서 추가하세요.',en:'No favorites yet. Add from the All tab.',ja:'お気に入りがありません。すべてタブから追加してください。',es:'Sin favoritos. Añade desde la pestaña Todo.',de:'Keine Favoriten. Über den Alle-Tab hinzufügen.',fr:'Aucun favori. Ajoutez depuis l\'onglet Tout.',pt:'Nenhum favorito. Adicione na aba Todos.',tr:'Henüz favori yok. Tümü sekmesinden ekleyin.',vi:'Chưa có yêu thích. Thêm từ tab Tất cả.',id:"Belum ada favorit. Tambahkan dari tab Semua.",pl:"Brak ulubionych. Dodaj z zakładki Wszystko.",it:"Nessun preferito. Aggiungi dalla scheda Tutti.",ru:"Пока нет избранного. Добавьте на вкладке «Все».",zh:"尚無收藏。請從「全部」分頁新增。"})
      : TT({ko:'검색 결과 없음',en:'No results',ja:'該当なし',es:'Sin resultados',de:'Keine Ergebnisse',fr:'Aucun résultat',pt:'Nenhum resultado',tr:'Sonuç yok',vi:'Không có kết quả',id:"Tidak ada hasil",pl:"Brak wyników",it:"Nessun risultato",ru:"Нет результатов",zh:"無結果"});
...
function makeCard(d,mode='buy'){
  ...
  const valLbl=TT({ko:'현재값',en:'Value',ja:'現在値',es:'Valor',de:'Wert',fr:'Valeur',pt:'Valor',tr:'Değer',vi:'Giá trị',id:"Nilai",pl:"Wartość",it:"Valore",ru:"Значение",zh:"數值"});
  const scoreLbl=TT({ko:'점수',en:'Score',ja:'スコア',es:'Puntuación',de:'Score',fr:'Score',pt:'Pontuação',tr:'Puan',vi:'Điểm',id:"Skor",pl:"Wynik",it:"Punteggio",ru:"Оценка",zh:"分數"});
  const targetLbl=TT({ko:'목표',en:'Target',ja:'目標',es:'Objetivo',de:'Ziel',fr:'Objectif',pt:'Alvo',tr:'Hedef',vi:'Mục tiêu',id:"Target",pl:"Cel",it:"Obiettivo",ru:"Цель",zh:"目標"});
  const detailLbl=TT({ko:'▼ 탭하여 설명 보기',en:'▼ Tap for details',ja:'▼ タップして詳細を見る',es:'▼ Toca para ver detalles',de:'▼ Tippen für Details',fr:'▼ Touchez pour les détails',pt:'▼ Toque para detalhes',tr:'▼ Detaylar için dokunun',vi:'▼ Chạm để xem chi tiết',id:"▼ Ketuk untuk detail",pl:"▼ Dotknij po szczegóły",it:"▼ Tocca per i dettagli",ru:"▼ Нажмите для подробностей",zh:"▼ 點擊看說明"});
  ...
  const guideBtn=guideSlug?`<a href="${langHref('/blog/'+guideSlug+'.php', currentLang)}"
      ...
      ${TT({ko:'가이드 보기',en:'Read Guide',ja:'ガイドを見る',es:'Ver Guía',de:'Anleitung ansehen',fr:'Lire le guide',pt:'Ler o guia',tr:'Kılavuzu oku',vi:'Đọc hướng dẫn',id:"Baca panduan",pl:"Przeczytaj przewodnik",it:"Leggi la guida",ru:"Читать гайд",zh:"閱讀指南"})} →</a>`:'';
  const glossaryBtn=glossarySlug?`<a href="${langHref('/glossary/'+glossarySlug, currentLang)}"
      ...
      ${TT({ko:'용어 설명',en:'Definition',ja:'用語解説',es:'Definición',de:'Definition',fr:'Définition',pt:'Definição',tr:'Tanım',vi:'Định nghĩa',id:"Definisi",pl:"Definicja",it:"Definizione",ru:"Определение",zh:"定義"})} →</a>`:'';
  ...
  if (data && data.error === 'coin_unavailable') {
    ...
    try {
      ...
      if(txt) txt.innerHTML=TT({
        ...
        vi:`⚠ ${deadId} đã bị hủy niêm yết và xóa khỏi danh sách<br><small style="color:#888">Đang chuyển sang coin khác…</small>`,id:`⚠ ${deadId} telah didelisting dan dihapus dari daftar Anda<br><small style="color:#888">Beralih ke coin lain…</small>`,pl:`⚠ ${deadId} zostało wycofane z obrotu i usunięte z Twojej listy<br><small style="color:#888">Przełączanie na inną coin…</small>`,it:`⚠ ${deadId} è stata delistata e rimossa dalla tua lista<br><small style="color:#888">Passaggio a un'altra coin…</small>`,ru:`⚠ ${deadId} была делистнута и удалена из вашего списка<br><small style="color:#888">Переключение на другую монету…</small>`,zh:`⚠ ${deadId} 已下架並自你的清單移除<br><small style="color:#888">正在切換至其他幣種…</small>`
      });
...
function renderAll(ind) {
  ...
  // 섹션 헤더 다국어화
  const secMap = {
    'sec_onchain': TT({ko:'온체인 밸류에이션',en:'ON-CHAIN VALUATION',ja:'オンチェーン バリュエーション',es:'VALORACIÓN ON-CHAIN',de:'ON-CHAIN-BEWERTUNG',fr:'VALORISATION ON-CHAIN',pt:'VALORIZAÇÃO ON-CHAIN',tr:'ZİNCİR ÜSTÜ DEĞERLEME',vi:'ĐỊNH GIÁ ON-CHAIN',id:"VALUASI ON-CHAIN",pl:"WYCENA ON-CHAIN",it:"VALUTAZIONE ON-CHAIN",ru:"ON-CHAIN ОЦЕНКА",zh:"鏈上估值"}),
    'sec_miner':   TT({ko:'채굴자 / 심리',en:'MINER / SENTIMENT',ja:'マイナー / センチメント',es:'MINERO / SENTIMIENTO',de:'MINER / SENTIMENT',fr:'MINEUR / SENTIMENT',pt:'MINERADOR / SENTIMENTO',tr:'MADENCİ / DUYGU',vi:'THỢ ĐÀO / TÂM LÝ',id:"PENAMBANG / SENTIMEN",pl:"GÓRNICY / SENTYMENT",it:"MINER / SENTIMENT",ru:"МАЙНЕРЫ / НАСТРОЕНИЯ",zh:"礦工／情緒"}),
    'sec_inst':    TT({ko:'기관 수급 (선행)',en:'INSTITUTIONAL FLOW',ja:'機関資金フロー (先行)',es:'FLUJO INSTITUCIONAL (adelantado)',de:'INSTITUTIONELLER FLUSS (Vorlauf)',fr:'FLUX INSTITUTIONNEL',pt:'FLUXO INSTITUCIONAL',tr:'KURUMSAL AKIŞ',vi:'DÒNG TIỀN TỔ CHỨC',id:"ALIRAN INSTITUSIONAL",pl:"PRZEPŁYW INSTYTUCJONALNY",it:"FLUSSO ISTITUZIONALE",ru:"ИНСТИТУЦИОНАЛЬНЫЙ ПОТОК",zh:"機構資金流"}),
    'sec_cycle':   TT({ko:'사이클 위치',en:'CYCLE POSITION',ja:'サイクル位置',es:'POSICIÓN DEL CICLO',de:'ZYKLUSPOSITION',fr:'POSITION DU CYCLE',pt:'POSIÇÃO DO CICLO',tr:'DÖNGÜ KONUMU',vi:'VỊ TRÍ CHU KỲ',id:"POSISI SIKLUS",pl:"POZYCJA CYKLU",it:"POSIZIONE DEL CICLO",ru:"ПОЗИЦИЯ ЦИКЛА",zh:"週期位置"}),
    'sec_breakdown': TT({ko:'점수 합산',en:'Score Breakdown',ja:'スコア内訳',es:'Desglose de Puntuación',de:'Score-Aufschlüsselung',fr:'Détail du Score',pt:'Detalhamento da Pontuação',tr:'Puan Dökümü',vi:'Phân tích Điểm',id:"Rincian Skor",pl:"Rozkład Wyniku",it:"Dettaglio Punteggio",ru:"Разбор оценки",zh:"分數拆解"}),
    'sec_macro':   TT({ko:'매크로 경고등',en:'MACRO WARNINGS',ja:'マクロ警告',es:'ADVERTENCIAS MACRO',de:'MAKRO-WARNUNGEN',fr:'AVERTISSEMENTS MACRO',pt:'AVISOS MACRO',tr:'MAKRO UYARILARI',vi:'CẢNH BÁO VĨ MÔ',id:"PERINGATAN MAKRO",pl:"OSTRZEŻENIA MAKRO",it:"AVVISI MACRO",ru:"МАКРО-ПРЕДУПРЕЖДЕНИЯ",zh:"總體經濟警示"}),
    'sec_history': TT({ko:'점수 히스토리',en:'Score History',ja:'スコア履歴',es:'Historial de Puntuación',de:'Score-Verlauf',fr:'Historique des Scores',pt:'Histórico de Pontuação',tr:'Puan Geçmişi',vi:'Lịch sử Điểm',id:"Riwayat Skor",pl:"Historia Wyniku",it:"Storico Punteggio",ru:"История оценок",zh:"分數歷史"}),
    'sec_histSub': TT({ko:'브라우저 로컬 저장',en:'Saved locally in browser',ja:'ブラウザにローカル保存',es:'Guardado localmente en el navegador',de:'Lokal im Browser gespeichert',fr:'Enregistré localement dans le navigateur',pt:'Salvo localmente no navegador',tr:'Tarayıcıda yerel olarak kaydedildi',vi:'Lưu cục bộ trên trình duyệt',id:"Disimpan lokal di browser",pl:"Zapisane lokalnie w przeglądarce",it:"Salvato localmente nel browser",ru:"Сохранено локально в браузере",zh:"儲存在瀏覽器本機"}),
  };
  ...
  if(splitHd) splitHd.textContent=TT({ko:'단계별 진입 계획',en:'Split Entry Plan',ja:'段階別エントリー計画',es:'Plan de Entrada Escalonada',de:'Gestaffelter Einstiegsplan',fr:'Plan d\'Entrée Échelonnée',pt:'Plano de Entrada Escalonada',tr:'Kademeli Giriş Planı',vi:'Kế hoạch Vào lệnh Từng phần',id:"Rencana Entry Bertahap",pl:"Plan Wejścia Etapami",it:"Piano di Ingresso Scaglionato",ru:"План поэтапного входа",zh:"分批進場計畫"});
  const scoreLabel2=document.getElementById('scoreLabel');
  if(scoreLabel2) scoreLabel2.textContent = currentMode==='buy'
    ? TT({ko:'롱 타이밍 점수',en:'LONG TIMING SCORE',ja:'ロング タイミングスコア',es:'PUNTUACIÓN DE TIMING LARGO',de:'LONG-TIMING-SCORE',fr:'SCORE DE TIMING LONG',pt:'PONTUAÇÃO DE TIMING LONG',tr:'LONG ZAMANLAMA PUANI',vi:'ĐIỂM THỜI ĐIỂM LONG',id:"SKOR TIMING LONG",pl:"WYNIK TIMINGU LONG",it:"PUNTEGGIO TIMING LONG",ru:"ОЦЕНКА ТАЙМИНГА ЛОНГ",zh:"做多時機分數"})
    : TT({ko:'숏 타이밍 점수',en:'SHORT TIMING SCORE',ja:'ショート タイミングスコア',es:'PUNTUACIÓN DE TIMING CORTO',de:'SHORT-TIMING-SCORE',fr:'SCORE DE TIMING SHORT',pt:'PONTUAÇÃO DE TIMING SHORT',tr:'SHORT ZAMANLAMA PUANI',vi:'ĐIỂM THỜI ĐIỂM SHORT',id:"SKOR TIMING SHORT",pl:"WYNIK TIMINGU SHORT",it:"PUNTEGGIO TIMING SHORT",ru:"ОЦЕНКА ТАЙМИНГА ШОРТ",zh:"做空時機分數"});
  ...
  const actionLabelMap = {
    'FULL LONG':    TT({ko:'전량 진입',en:'FULL LONG',ja:'全量エントリー',es:'LONG TOTAL',de:'VOLL-LONG',fr:'LONG TOTAL',pt:'LONG TOTAL',tr:'TAM LONG',vi:'LONG TOÀN PHẦN',id:"LONG PENUH",pl:"PEŁNY LONG",it:"LONG TOTALE",ru:"ПОЛНЫЙ ЛОНГ",zh:"全力做多"}),
    'ADD LONG':     TT({ko:'비중 확대',en:'ADD LONG',ja:'比率拡大',es:'MÁS LONG',de:'LONG+',fr:'AUGMENTER LONG',pt:'AUMENTAR LONG',tr:'LONG ARTIR',vi:'TĂNG LONG',id:"TAMBAH LONG",pl:"ZWIĘKSZ LONG",it:"AUMENTA LONG",ru:"НАРАСТИТЬ ЛОНГ",zh:"加碼做多"}),
    'SPLIT LONG':   TT({ko:'분할 진입',en:'SPLIT LONG',ja:'分割エントリー',es:'LONG PARCIAL',de:'TEIL-LONG',fr:'LONG ÉCHELONNÉ',pt:'LONG ESCALONADO',tr:'KADEMELİ LONG',vi:'LONG TỪNG PHẦN',id:"LONG BERTAHAP",pl:"LONG ETAPAMI",it:"LONG SCAGLIONATO",ru:"ДРОБНЫЙ ЛОНГ",zh:"分批做多"}),
    'WATCH':        TT({ko:'관찰',en:'WATCH',ja:'様子見',es:'ESPERAR',de:'WARTEN',fr:'SURVEILLER',pt:'OBSERVAR',tr:'İZLE',vi:'QUAN SÁT',id:"PANTAU",pl:"OBSERWUJ",it:"OSSERVA",ru:"НАБЛЮДАТЬ",zh:"觀望"}),
    'SPLIT EXIT':   TT({ko:'분할 청산',en:'SPLIT EXIT',ja:'分割決済',es:'SALIDA PARCIAL',de:'TEIL-EXIT',fr:'SORTIE ÉCHELONNÉE',pt:'SAÍDA ESCALONADA',tr:'KADEMELİ ÇIKIŞ',vi:'THOÁT TỪNG PHẦN',id:"KELUAR BERTAHAP",pl:"WYJŚCIE ETAPAMI",it:"USCITA SCAGLIONATA",ru:"ДРОБНЫЙ ВЫХОД",zh:"分批出場"}),
    'EXIT LONG':    TT({ko:'청산 권고',en:'EXIT LONG',ja:'決済推奨',es:'SALIR',de:'EXIT',fr:'SORTIR DU LONG',pt:'SAIR DO LONG',tr:'LONG ÇIK',vi:'THOÁT LONG',id:"KELUAR LONG",pl:"ZAMKNIJ LONG",it:"ESCI DAL LONG",ru:"ВЫЙТИ ИЗ ЛОНГА",zh:"出清多單"}),
    'FULL SHORT':   TT({ko:'풀 숏 진입',en:'FULL SHORT',ja:'フルショート',es:'SHORT TOTAL',de:'VOLL-SHORT',fr:'SHORT TOTAL',pt:'SHORT TOTAL',tr:'TAM SHORT',vi:'SHORT TOÀN PHẦN',id:"SHORT PENUH",pl:"PEŁNY SHORT",it:"SHORT TOTALE",ru:"ПОЛНЫЙ ШОРТ",zh:"全力做空"}),
    'ADD SHORT':    TT({ko:'숏 확대',en:'ADD SHORT',ja:'ショート拡大',es:'MÁS SHORT',de:'SHORT+',fr:'AUGMENTER SHORT',pt:'AUMENTAR SHORT',tr:'SHORT ARTIR',vi:'TĂNG SHORT',id:"TAMBAH SHORT",pl:"ZWIĘKSZ SHORT",it:"AUMENTA SHORT",ru:"НАРАСТИТЬ ШОРТ",zh:"加碼做空"}),
    'PREPARE SHORT':TT({ko:'숏 준비',en:'PREPARE SHORT',ja:'ショート準備',es:'PREPARAR',de:'BEREIT',fr:'PRÉPARER SHORT',pt:'PREPARAR SHORT',tr:'SHORT HAZIRLA',vi:'CHUẨN BỊ SHORT',id:"SIAPKAN SHORT",pl:"PRZYGOTUJ SHORT",it:"PREPARA SHORT",ru:"ГОТОВИТЬ ШОРТ",zh:"準備做空"}),
    'EXIT SHORT':   TT({ko:'숏 청산',en:'EXIT SHORT',ja:'ショート決済',es:'SALIR',de:'EXIT',fr:'SORTIR DU SHORT',pt:'SAIR DO SHORT',tr:'SHORT ÇIK',vi:'THOÁT SHORT',id:"KELUAR SHORT",pl:"ZAMKNIJ SHORT",it:"ESCI DAL SHORT",ru:"ВЫЙТИ ИЗ ШОРТА",zh:"出清空單"}),
  };
  ...
  if(descEl) {
    ...
    if(currentMode === 'buy') {
      const buyDescMap = {
        'FULL LONG':    TT({ko:'최강 신호. 풀 롱 or 레버리지 진입.',en:'Max signal. Full long entry.',ja:'最強シグナル。フルロングまたはレバレッジエントリー。',es:'Señal máxima. Largo total o entrada apalancada.',de:'Maximales Signal. Voller Long oder gehebelter Einstieg.',fr:'Signal max. Entrée long totale.',pt:'Sinal máximo. Entrada long total.',tr:'Maks sinyal. Tam long girişi.',vi:'Tín hiệu tối đa. Vào long toàn phần.',id:"Sinyal maksimal. Entry long penuh.",pl:"Maksymalny sygnał. Pełne wejście long.",it:"Segnale massimo. Ingresso long pieno.",ru:"Максимальный сигнал. Полный вход в лонг.",zh:"訊號最強。全力做多進場。"}),
        'ADD LONG':     TT({ko:'강한 신호. 목표 비중 70~100% 진입.',en:'Strong signal. 70~100% of target.',ja:'強いシグナル。目標比率70~100%でエントリー。',es:'Señal fuerte. Entrada 70~100% del objetivo.',de:'Starkes Signal. Einstieg 70~100% des Ziels.',fr:'Signal fort. 70~100% de l\'objectif.',pt:'Sinal forte. 70~100% do alvo.',tr:'Güçlü sinyal. Hedefin %70~100\'ü.',vi:'Tín hiệu mạnh. 70~100% mục tiêu.',id:"Sinyal kuat. 70~100% dari target.",pl:"Silny sygnał. 70~100% celu.",it:"Segnale forte. 70~100% del target.",ru:"Сильный сигнал. 70~100% от цели.",zh:"訊號強。目標的 70~100%。"}),
        'SPLIT LONG':   TT({ko:'분할 시작. 목표 비중 30~50% 진입.',en:'Split entry. 30~50% of target.',ja:'分割開始。目標比率30~50%でエントリー。',es:'Inicio escalonado. Entrada 30~50% del objetivo.',de:'Staffelung startet. Einstieg 30~50% des Ziels.',fr:'Entrée échelonnée. 30~50% de l\'objectif.',pt:'Entrada escalonada. 30~50% do alvo.',tr:'Kademeli giriş. Hedefin %30~50\'si.',vi:'Vào từng phần. 30~50% mục tiêu.',id:"Entry bertahap. 30~50% dari target.",pl:"Wejście etapami. 30~50% celu.",it:"Ingresso scaglionato. 30~50% del target.",ru:"Дробный вход. 30~50% от цели.",zh:"分批進場。目標的 30~50%。"}),
        'WATCH':        TT({ko:'관찰 구간. 소량 선진입 or 트리거 대기.',en:'Watch. Small entry or await trigger.',ja:'様子見ゾーン。少量の先行エントリーまたはトリガー待ち。',es:'Zona de observación. Entrada pequeña o esperar disparador.',de:'Beobachtungszone. Kleiner Voreinstieg oder auf Trigger warten.',fr:'Surveiller. Petite entrée ou attendre le déclencheur.',pt:'Observar. Entrada pequena ou aguardar gatilho.',tr:'İzle. Küçük giriş veya tetikleyici bekle.',vi:'Quan sát. Vào nhỏ hoặc chờ kích hoạt.',id:"Pantau. Entry kecil atau tunggu pemicu.",pl:"Obserwuj. Małe wejście lub czekaj na wyzwalacz.",it:"Osserva. Piccolo ingresso o attendi il trigger.",ru:"Наблюдайте. Малый вход или ждите триггер.",zh:"觀望。小額進場或等待觸發。"}),
        'SPLIT EXIT':   TT({ko:'일부 정리. 리스크 관리 구간.',en:'Partial exit. Risk management zone.',ja:'一部決済。リスク管理ゾーン。',es:'Salida parcial. Zona de gestión de riesgo.',de:'Teilausstieg. Risikomanagement-Zone.',fr:'Sortie partielle. Zone de gestion du risque.',pt:'Saída parcial. Zona de gestão de risco.',tr:'Kısmi çıkış. Risk yönetimi bölgesi.',vi:'Thoát một phần. Vùng quản lý rủi ro.',id:"Keluar sebagian. Zona manajemen risiko.",pl:"Częściowe wyjście. Strefa zarządzania ryzykiem.",it:"Uscita parziale. Zona di gestione del rischio.",ru:"Частичный выход. Зона управления риском.",zh:"部分出場。風險管理區。"}),
        'EXIT LONG':    TT({ko:'전량 청산 고려. 고점 경고.',en:'Consider full exit. Top warning.',ja:'全量決済を検討。天井警告。',es:'Considerar salida total. Advertencia de techo.',de:'Vollständigen Ausstieg erwägen. Top-Warnung.',fr:'Envisager une sortie totale. Alerte de sommet.',pt:'Considere saída total. Aviso de topo.',tr:'Tam çıkışı düşün. Tepe uyarısı.',vi:'Cân nhắc thoát toàn bộ. Cảnh báo đỉnh.',id:"Pertimbangkan keluar penuh. Peringatan puncak.",pl:"Rozważ pełne wyjście. Ostrzeżenie szczytu.",it:"Valuta uscita totale. Allerta di massimo.",ru:"Рассмотрите полный выход. Сигнал вершины.",zh:"考慮全數出場。頂部警示。"}),
      };
      ...
      const sellDescMap = {
        'FULL SHORT':    TT({ko:'극단 과열. 풀 숏 진입.',en:'Extreme overheat. Full short entry.',ja:'極端な過熱。フルショートエントリー。',es:'Sobrecalentamiento extremo. Entrada corta total.',de:'Extreme Überhitzung. Vollständiger Short-Einstieg.',fr:'Surchauffe extrême. Entrée short totale.',pt:'Sobreaquecimento extremo. Entrada short total.',tr:'Aşırı ısınma. Tam short girişi.',vi:'Quá nóng cực độ. Vào short toàn phần.',id:"Overheat ekstrem. Entry short penuh.",pl:"Ekstremalne przegrzanie. Pełne wejście short.",it:"Surriscaldamento estremo. Ingresso short pieno.",ru:"Крайний перегрев. Полный вход в шорт.",zh:"極度過熱。全力做空進場。"}),
        'ADD SHORT':     TT({ko:'강한 과열. 숏 비중 확대.',en:'Strong overheat. Increase short.',ja:'強い過熱。ショート比率拡大。',es:'Sobrecalentamiento fuerte. Aumentar posición corta.',de:'Starke Überhitzung. Short-Position erhöhen.',fr:'Forte surchauffe. Augmenter le short.',pt:'Sobreaquecimento forte. Aumentar short.',tr:'Güçlü ısınma. Short artır.',vi:'Quá nóng mạnh. Tăng short.',id:"Overheat kuat. Tambah short.",pl:"Silne przegrzanie. Zwiększ short.",it:"Forte surriscaldamento. Aumenta lo short.",ru:"Сильный перегрев. Нарастить шорт.",zh:"強烈過熱。加碼做空。"}),
        'PREPARE SHORT': TT({ko:'과열 시작. 숏 준비.',en:'Overheat starting. Prepare short.',ja:'過熱開始。ショート準備。',es:'Inicio de sobrecalentamiento. Preparar corto.',de:'Überhitzung beginnt. Short vorbereiten.',fr:'Surchauffe naissante. Préparer le short.',pt:'Sobreaquecimento começando. Preparar short.',tr:'Isınma başlıyor. Short hazırla.',vi:'Bắt đầu quá nóng. Chuẩn bị short.',id:"Overheat mulai. Siapkan short.",pl:"Zaczyna się przegrzanie. Przygotuj short.",it:"Surriscaldamento in avvio. Prepara lo short.",ru:"Начинается перегрев. Готовьте шорт.",zh:"過熱開始。準備做空。"}),
        'WATCH':         TT({ko:'중립 관찰.',en:'Neutral watch.',ja:'中立の様子見。',es:'Observación neutral.',de:'Neutrale Beobachtung.',fr:'Surveillance neutre.',pt:'Observação neutra.',tr:'Nötr izleme.',vi:'Quan sát trung lập.',id:"Pantau netral.",pl:"Neutralna obserwacja.",it:"Osservazione neutrale.",ru:"Нейтральное наблюдение.",zh:"中性觀望。"}),
        'SPLIT EXIT':    TT({ko:'저점 근접. 숏 분할 청산.',en:'Near bottom. Scale out of short.',ja:'底値接近。ショート分割決済。',es:'Cerca del suelo. Salida escalonada del corto.',de:'Nahe am Tief. Gestaffelter Short-Ausstieg.',fr:'Proche du creux. Réduire le short.',pt:'Perto do fundo. Reduzir short.',tr:'Dibe yakın. Short azalt.',vi:'Gần đáy. Giảm short.',id:"Dekat dasar. Kurangi short.",pl:"Blisko dna. Redukuj short.",it:"Vicino al minimo. Riduci lo short.",ru:"Близко ко дну. Сокращайте шорт.",zh:"接近底部。減碼空單。"}),
        'EXIT SHORT':    TT({ko:'바닥. 숏 즉시 청산.',en:'Bottom zone. Exit short immediately.',ja:'底値圏。ショート即時決済。',es:'Suelo. Cerrar corto inmediatamente.',de:'Boden. Short sofort schließen.',fr:'Zone de creux. Sortir du short immédiatement.',pt:'Zona de fundo. Sair do short imediatamente.',tr:'Dip bölgesi. Short\'tan hemen çık.',vi:'Vùng đáy. Thoát short ngay.',id:"Zona dasar. Keluar short segera.",pl:"Strefa dna. Natychmiast zamknij short.",it:"Zona di minimo. Esci subito dallo short.",ru:"Зона дна. Немедленно закрывайте шорт.",zh:"底部區。立即出清空單。"}),
      };
  ...
  if(abarEl) {
    ...
    const segments = currentMode === 'buy' ? [
      {min:0,  max:3.5, bg:'#2d0a0a', color:'#ef4444', en:'EXIT LONG',  ko:'롱청산',  ja:'ロング決済', es:'SALIR', de:'EXIT', s:'≤3.5',fr:"SORTIR",pt:"SAIR",tr:"ÇIK",vi:"THOÁT",id:"KELUAR",pl:"WYJDŹ",it:"ESCI",ru:"ВЫХОД",zh:"出場"},
      {min:3.5,max:5.0, bg:'#2d1a0a', color:'#f97316', en:'SPLIT EXIT', ko:'분할청산', ja:'分割決済', es:'PARCIAL', de:'TEIL-EXIT', s:'3.5~5',fr:"PARTIEL",pt:"PARCIAL",tr:"KISMİ",vi:"MỘT PHẦN",id:"SEBAGIAN",pl:"CZĘŚĆ",it:"PARZIALE",ru:"ЧАСТЬ",zh:"分批出"},
      {min:5.0,max:6.0, bg:'#2d2a00', color:'#fbbf24', en:'WATCH',      ko:'관찰',    ja:'観察', es:'ESPERAR', de:'WARTEN', s:'5~6',fr:"SURVEILLER",pt:"OBSERVAR",tr:"İZLE",vi:"QUAN SÁT",id:"PANTAU",pl:"OBSERWUJ",it:"OSSERVA",ru:"ЖДАТЬ",zh:"觀望"},
      {min:6.0,max:7.0, bg:'#0d2208', color:'#86efac', en:'SPLIT LONG', ko:'분할매수', ja:'分割買い', es:'ENTRAR', de:'TEIL-LONG', s:'6~7',fr:"ENTRER",pt:"ENTRAR",tr:"GİR",vi:"VÀO",id:"MASUK",pl:"WEJDŹ",it:"ENTRA",ru:"ВХОД",zh:"分批多"},
      {min:7.0,max:8.0, bg:'#071a05', color:'#4ade80', en:'ADD LONG',   ko:'추가매수', ja:'追加買い', es:'LONG+', de:'LONG+', s:'7~8',fr:"LONG+",pt:"LONG+",tr:"LONG+",vi:"LONG+",id:"LONG+",pl:"LONG+",it:"LONG+",ru:"ЛОНГ+",zh:"加多"},
      {min:8.0,max:11,  bg:'#041203', color:'#22c55e', en:'FULL LONG',  ko:'풀롱',    ja:'フルロング', es:'TODO LONG', de:'VOLL-LONG', s:'8+',fr:"TOUT LONG",pt:"TUDO LONG",tr:"TAM LONG",vi:"LONG HẾT",id:"LONG PENUH",pl:"PEŁNY LONG",it:"TUTTO LONG",ru:"ВЕСЬ ЛОНГ",zh:"全多"},
    ] : [
      {min:0,  max:3.5, bg:'#041203', color:'#22c55e', en:'EXIT SHORT', ko:'숏청산',  ja:'ショート決済', es:'SALIR', de:'EXIT', s:'≤3.5',fr:"SORTIR",pt:"SAIR",tr:"ÇIK",vi:"THOÁT",id:"KELUAR",pl:"WYJDŹ",it:"ESCI",ru:"ВЫХОД",zh:"出場"},
      {min:3.5,max:5.0, bg:'#071a05', color:'#4ade80', en:'SPLIT EXIT', ko:'분할청산', ja:'分割決済', es:'PARCIAL', de:'TEIL-EXIT', s:'3.5~5',fr:"PARTIEL",pt:"PARCIAL",tr:"KISMİ",vi:"MỘT PHẦN",id:"SEBAGIAN",pl:"CZĘŚĆ",it:"PARZIALE",ru:"ЧАСТЬ",zh:"分批出"},
      {min:5.0,max:6.0, bg:'#2d2a00', color:'#fbbf24', en:'WATCH',      ko:'관찰',    ja:'観察', es:'ESPERAR', de:'WARTEN', s:'5~6',fr:"SURVEILLER",pt:"OBSERVAR",tr:"İZLE",vi:"QUAN SÁT",id:"PANTAU",pl:"OBSERWUJ",it:"OSSERVA",ru:"ЖДАТЬ",zh:"觀望"},
      {min:6.0,max:7.0, bg:'#2d1a0a', color:'#f97316', en:'PREPARE',    ko:'숏준비',  ja:'ショート準備', es:'PREPARAR', de:'BEREIT', s:'6~7',fr:"PRÊT",pt:"PRONTO",tr:"HAZIR",vi:"SẴN SÀNG",id:"SIAP",pl:"GOTOWY",it:"PRONTO",ru:"ГОТОВ",zh:"準備"},
      {min:7.0,max:8.0, bg:'#2d0a0a', color:'#ef4444', en:'ADD SHORT',  ko:'숏추가',  ja:'ショート追加', es:'SHORT+', de:'SHORT+', s:'7~8',fr:"SHORT+",pt:"SHORT+",tr:"SHORT+",vi:"SHORT+",id:"SHORT+",pl:"SHORT+",it:"SHORT+",ru:"ШОРТ+",zh:"加空"},
      {min:8.0,max:11,  bg:'#1a0505', color:'#dc2626', en:'FULL SHORT', ko:'풀숏',    ja:'フルショート', es:'TODO SHORT', de:'VOLL-SHORT', s:'8+',fr:"TOUT SHORT",pt:"TUDO SHORT",tr:"TAM SHORT",vi:"SHORT HẾT",id:"SHORT PENUH",pl:"PEŁNY SHORT",it:"TUTTO SHORT",ru:"ВЕСЬ ШОРТ",zh:"全空"},
    ]
    // 2줄 레이아웃: 위 4개 / 아래 3개
  ...
  if(currentMode==='sell') {
    ...
    if(sc>=8.0){
      stMain=TT({ko:'극단 과열 — 역대 고점 수준',en:'Extreme Overheat — Historical Top',ja:'極端な過熱 — 歴代高値水準',es:'Sobrecalentamiento Extremo — Nivel de Techo Histórico',de:'Extreme Überhitzung — Historisches Hoch-Niveau',fr:'Surchauffe Extrême — Sommet Historique',pt:'Sobreaquecimento Extremo — Topo Histórico',tr:'Aşırı Isınma — Tarihsel Tepe',vi:'Quá Nóng Cực Độ — Đỉnh Lịch Sử',id:"Overheat Ekstrem — Puncak Historis",pl:"Ekstremalne Przegrzanie — Historyczny Szczyt",it:"Surriscaldamento Estremo — Massimo Storico",ru:"Крайний перегрев — исторический максимум",zh:"極度過熱 — 歷史頂部"});
      stDesc=TT({ko:'모든 과열 지표가 위험 구간. 2021년 11월 ATH 직전과 유사한 패턴.',en:'All overheat indicators in danger zone.',ja:'全ての過熱指標が危険水準。2021年11月のATH直前と類似したパターン。',es:'Todos los indicadores de sobrecalentamiento en zona de peligro. Patrón similar al justo antes del ATH de noviembre 2021.',de:'Alle Überhitzungsindikatoren im Gefahrenbereich. Ähnliches Muster wie kurz vor dem ATH im November 2021.',fr:'Tous les indicateurs de surchauffe en zone de danger. Schéma similaire à juste avant l\'ATH de novembre 2021.',pt:'Todos os indicadores de sobreaquecimento em zona de perigo. Padrão semelhante ao anterior ao ATH de novembro de 2021.',tr:'Tüm aşırı ısınma göstergeleri tehlike bölgesinde. Kasım 2021 ATH öncesine benzer bir desen.',vi:'Tất cả chỉ báo quá nóng ở vùng nguy hiểm. Mô hình tương tự ngay trước ATH tháng 11/2021.',id:"Semua indikator overheat di zona bahaya.",pl:"Wszystkie wskaźniki przegrzania w strefie zagrożenia.",it:"Tutti gli indicatori di surriscaldamento in zona di pericolo.",ru:"Все индикаторы перегрева в опасной зоне.",zh:"所有過熱指標都在危險區。"});
      gAction=TT({ko:'FULL SHORT — 풀 숏 진입',en:'FULL SHORT — Full short entry',ja:'FULL SHORT — フルショートエントリー',es:'SHORT TOTAL — Entrada corta total',de:'VOLL-SHORT — Vollständiger Short-Einstieg',fr:'SHORT TOTAL — Entrée short totale',pt:'SHORT TOTAL — Entrada short total',tr:'TAM SHORT — Tam short girişi',vi:'SHORT TOÀN PHẦN — Vào short toàn phần',id:"SHORT PENUH — Entry short penuh",pl:"PEŁNY SHORT — Pełne wejście short",it:"SHORT TOTALE — Ingresso short pieno",ru:"ПОЛНЫЙ ШОРТ — Полный вход в шорт",zh:"全力做空 — 全力做空進場"});
      gDesc=TT({ko:'목표 비중 100% 숏 진입. 레버리지 숏 고려 가능. 스탑로스: ATH +5% 위 설정.',en:'Enter 100% short. Leverage possible. Stop loss: 5% above ATH.',ja:'目標比率100%でショートエントリー。レバレッジショートも検討可。ストップロス: ATH+5%上に設定。',es:'Entrada corta 100% del objetivo. Corto apalancado posible. Stop loss: 5% por encima del ATH.',de:'Short-Einstieg 100% des Ziels. Gehebelter Short möglich. Stop-Loss: 5% über ATH.',fr:'Entrez 100% en short. Levier possible. Stop loss : 5% au-dessus de l\'ATH.',pt:'Entre 100% short. Alavancagem possível. Stop loss: 5% acima do ATH.',tr:'%100 short gir. Kaldıraç mümkün. Stop loss: ATH\'nin %5 üstü.',vi:'Vào 100% short. Có thể đòn bẩy. Cắt lỗ: 5% trên ATH.',id:"Masuk short 100%. Leverage dimungkinkan. Stop loss: 5% di atas ATH.",pl:"Wejdź w short 100%. Dźwignia możliwa. Stop loss: 5% powyżej ATH.",it:"Entra short al 100%. Leva possibile. Stop loss: 5% sopra l'ATH.",ru:"Вход в шорт на 100%. Плечо возможно. Стоп-лосс: 5% выше ATH.",zh:"100% 做空進場。可用槓桿。停損：ATH 上方 5%。"});
      exitSig=TT({ko:'청산 조건 (중요)',en:'Exit Conditions (Important)',ja:'決済条件 (重要)',es:'Condiciones de Salida (Importante)',de:'Ausstiegsbedingungen (Wichtig)',fr:'Conditions de sortie (Important)',pt:'Condições de saída (Importante)',tr:'Çıkış Koşulları (Önemli)',vi:'Điều kiện thoát (Quan trọng)',id:"Kondisi Keluar (Penting)",pl:"Warunki Wyjścia (Ważne)",it:"Condizioni di Uscita (Importante)",ru:"Условия выхода (важно)",zh:"出場條件（重要）"});
      exitDesc=TT({ko:'• MVRV Z 2.5 이하 하락\n• Fear & Greed 50 이하\n• 선물 갭 0.05% 이하로 축소',en:'• MVRV Z drops below 2.5\n• Fear & Greed below 50\n• Futures gap shrinks below 0.05%',ja:'• MVRV Zが2.5以下に低下\n• Fear & Greedが50以下\n• 先物ギャップが0.05%以下に縮小',es:'• MVRV Z cae por debajo de 2.5\n• Fear & Greed por debajo de 50\n• Brecha de futuros se reduce por debajo de 0.05%',de:'• MVRV Z fällt unter 2,5\n• Angst & Gier unter 50\n• Futures-Spread schrumpft unter 0,05%',fr:'• MVRV Z passe sous 2,5\n• Fear & Greed sous 50\n• L\'écart des futures se réduit sous 0,05%',pt:'• MVRV Z cai abaixo de 2,5\n• Fear & Greed abaixo de 50\n• Gap de futuros encolhe abaixo de 0,05%',tr:'• MVRV Z 2,5 altına düşer\n• Fear & Greed 50 altında\n• Vadeli farkı %0,05 altına iner',vi:'• MVRV Z xuống dưới 2,5\n• Fear & Greed dưới 50\n• Chênh lệch futures co dưới 0,05%',id:"• MVRV Z turun di bawah 2.5\n• Fear & Greed di bawah 50\n• Selisih futures menyusut di bawah 0.05%",pl:"• MVRV Z spada poniżej 2,5\n• Fear & Greed poniżej 50\n• Różnica futures kurczy się poniżej 0,05%",it:"• MVRV Z scende sotto 2,5\n• Fear & Greed sotto 50\n• Lo scarto futures scende sotto lo 0,05%",ru:"• MVRV Z падает ниже 2,5\n• Fear & Greed ниже 50\n• Разрыв фьючерсов сжимается ниже 0,05%",zh:"• MVRV Z 跌破 2.5\n• Fear & Greed 低於 50\n• 期現差距縮至 0.05% 以下"});
    } else if(sc>=7.0){
      stMain=TT({ko:'강한 과열 신호',en:'Strong Overheat Signal',ja:'強い過熱シグナル',es:'Señal de Sobrecalentamiento Fuerte',de:'Starkes Überhitzungssignal',fr:'Signal de Surchauffe Fort',pt:'Sinal de Sobreaquecimento Forte',tr:'Güçlü Isınma Sinyali',vi:'Tín Hiệu Quá Nóng Mạnh',id:"Sinyal Overheat Kuat",pl:"Silny Sygnał Przegrzania",it:"Segnale di Forte Surriscaldamento",ru:"Сильный сигнал перегрева",zh:"強烈過熱訊號"});
      stDesc=TT({ko:'주요 과열 지표들이 경고 수준. 탐욕 지수와 선물 포지션이 과도하게 롱 쏠림.',en:'Key overheat indicators at warning levels. Extreme long bias.',ja:'主要な過熱指標が警告水準。強欲指数と先物ポジションが過度にロングに偏っています。',es:'Los principales indicadores de sobrecalentamiento en nivel de advertencia. Índice de codicia y posiciones de futuros muy sesgados a largo.',de:'Wichtige Überhitzungsindikatoren auf Warnstufe. Gier-Index und Futures-Positionen stark long-lastig.',fr:'Indicateurs de surchauffe clés à des niveaux d\'alerte. Biais long extrême, positions futures et avidité excessives.',pt:'Principais indicadores de sobreaquecimento em níveis de alerta. Viés long extremo, ganância e futuros excessivos.',tr:'Ana ısınma göstergeleri uyarı seviyesinde. Aşırı long eğilim, açgözlülük ve vadeli aşırı.',vi:'Các chỉ báo quá nóng chính ở mức cảnh báo. Thiên hướng long cực độ, tham lam và futures quá mức.',id:"Indikator overheat utama di level peringatan. Bias long ekstrem.",pl:"Kluczowe wskaźniki przegrzania na poziomach ostrzegawczych. Skrajne nastawienie long.",it:"Indicatori chiave di surriscaldamento a livelli di allerta. Forte bias long.",ru:"Ключевые индикаторы перегрева на тревожных уровнях. Крайний перекос в лонг.",zh:"關鍵過熱指標達警戒水位。極度偏多。"});
      gAction=TT({ko:'ADD SHORT — 숏 비중 확대',en:'ADD SHORT — Increase short',ja:'ADD SHORT — ショート比率拡大',es:'SHORT+ — Ampliar posición corta',de:'SHORT+ — Short-Position erhöhen',fr:'AUGMENTER SHORT — Augmenter le short',pt:'AUMENTAR SHORT — Aumentar short',tr:'SHORT ARTIR — Short\'u artır',vi:'TĂNG SHORT — Tăng short',id:"TAMBAH SHORT — Tambah short",pl:"ZWIĘKSZ SHORT — Zwiększ short",it:"AUMENTA SHORT — Aumenta lo short",ru:"НАРАСТИТЬ ШОРТ — Увеличить шорт",zh:"加碼做空 — 加碼空單"});
      gDesc=TT({ko:'기존 숏 있다면 목표 비중의 70~100%로 확대. 신규 진입은 분할로.',en:'If holding short, scale to 70~100%. New entry: split in.',ja:'既存ショートがあれば目標比率の70~100%まで拡大。新規エントリーは分割で。',es:'Si mantiene un corto, ampliar al 70~100% del objetivo. Nueva entrada de forma escalonada.',de:'Bei bestehendem Short auf 70~100% des Ziels erhöhen. Neueinstieg gestaffelt.',fr:'Si vous détenez un short, montez à 70~100%. Nouvelle entrée : échelonnée.',pt:'Se está short, aumente para 70~100%. Nova entrada: escalonada.',tr:'Short\'un varsa %70~100\'e çıkar. Yeni giriş: kademeli.',vi:'Nếu đang short, tăng lên 70~100%. Vào mới: từng phần.',id:"Jika memegang short, tambah ke 70~100%. Entry baru: bertahap.",pl:"Jeśli masz short, zwiększ do 70~100%. Nowe wejście: etapami.",it:"Se hai uno short, aumenta al 70~100%. Nuovo ingresso: scaglionato.",ru:"Если держите шорт, нарастите до 70~100%. Новый вход: дробно.",zh:"若已持空單，加至 70~100%。新進場：分批。"});
      exitSig=TT({ko:'숏 청산 조건',en:'Short Exit Conditions',ja:'ショート決済条件',es:'Condiciones de Salida Corta',de:'Short-Ausstiegsbedingungen',fr:'Conditions de sortie du short',pt:'Condições de saída do short',tr:'Short Çıkış Koşulları',vi:'Điều kiện thoát short',id:"Kondisi Keluar Short",pl:"Warunki Wyjścia ze Short",it:"Condizioni di Uscita dallo Short",ru:"Условия выхода из шорта",zh:"做空出場條件"});
      exitDesc=TT({ko:'• NUPL 50% 이하\n• Fear & Greed 60 이하\n• Coinbase Premium 음수 전환',en:'• NUPL drops below 50%\n• Fear & Greed below 60\n• Coinbase Premium turns negative',ja:'• NUPLが50%以下\n• Fear & Greedが60以下\n• Coinbaseプレミアムがマイナスに転換',es:'• NUPL cae por debajo de 50%\n• Fear & Greed por debajo de 60\n• Coinbase Premium se vuelve negativo',de:'• NUPL fällt unter 50%\n• Angst & Gier unter 60\n• Coinbase Premium wird negativ',fr:'• NUPL passe sous 50%\n• Fear & Greed sous 60\n• Coinbase Premium devient négatif',pt:'• NUPL cai abaixo de 50%\n• Fear & Greed abaixo de 60\n• Coinbase Premium fica negativo',tr:'• NUPL %50 altına düşer\n• Fear & Greed 60 altında\n• Coinbase Premium negatife döner',vi:'• NUPL xuống dưới 50%\n• Fear & Greed dưới 60\n• Coinbase Premium thành âm',id:"• NUPL turun di bawah 50%\n• Fear & Greed di bawah 60\n• Coinbase Premium jadi negatif",pl:"• NUPL spada poniżej 50%\n• Fear & Greed poniżej 60\n• Coinbase Premium staje się ujemny",it:"• NUPL scende sotto il 50%\n• Fear & Greed sotto 60\n• Coinbase Premium diventa negativo",ru:"• NUPL падает ниже 50%\n• Fear & Greed ниже 60\n• Coinbase Premium становится отрицательным",zh:"• NUPL 跌破 50%\n• Fear & Greed 低於 60\n• Coinbase Premium 轉負"});
    } else if(sc>=6.0){
      stMain=TT({ko:'과열 시작 — 준비 구간',en:'Overheat Beginning — Prepare',ja:'過熱開始 — 準備ゾーン',es:'Inicio de Sobrecalentamiento — Zona de Preparación',de:'Überhitzung beginnt — Vorbereitungszone',fr:'Surchauffe Naissante — Préparer',pt:'Sobreaquecimento Iniciando — Preparar',tr:'Isınma Başlıyor — Hazırlan',vi:'Bắt Đầu Quá Nóng — Chuẩn Bị',id:"Overheat Dimulai — Bersiap",pl:"Początek Przegrzania — Przygotuj się",it:"Inizio Surriscaldamento — Prepara",ru:"Начало перегрева — готовьтесь",zh:"過熱開始 — 準備"});
      stDesc=TT({ko:'일부 지표가 과열 신호. 아직 확정은 아니지만 숏 준비할 타이밍.',en:'Some overheat signals. Not confirmed but time to prepare.',ja:'一部の指標が過熱シグナル。まだ確定ではないもののショート準備のタイミング。',es:'Algunos indicadores muestran sobrecalentamiento. Aún no confirmado, pero es momento de preparar corto.',de:'Einige Indikatoren zeigen Überhitzung. Noch nicht bestätigt, aber Zeit, Short vorzubereiten.',fr:'Quelques signaux de surchauffe. Non confirmé mais le moment de préparer le short.',pt:'Alguns sinais de sobreaquecimento. Não confirmado mas hora de preparar o short.',tr:'Bazı ısınma sinyalleri. Onaylanmadı ama short hazırlama zamanı.',vi:'Một số tín hiệu quá nóng. Chưa xác nhận nhưng là lúc chuẩn bị short.',id:"Beberapa sinyal overheat. Belum terkonfirmasi tapi saatnya bersiap.",pl:"Kilka sygnałów przegrzania. Niepotwierdzone, ale czas się przygotować.",it:"Alcuni segnali di surriscaldamento. Non confermati ma è ora di prepararsi.",ru:"Есть сигналы перегрева. Не подтверждены, но пора готовиться.",zh:"出現部分過熱訊號。尚未確認，但該準備了。"});
      gAction=TT({ko:'PREPARE SHORT — 소량 선진입',en:'PREPARE SHORT — Small entry',ja:'PREPARE SHORT — 少量の先行エントリー',es:'PREPARAR — Entrada pequeña anticipada',de:'BEREIT — Kleiner Voreinstieg',fr:'PRÉPARER SHORT — Petite entrée',pt:'PREPARAR SHORT — Entrada pequena',tr:'SHORT HAZIRLA — Küçük giriş',vi:'CHUẨN BỊ SHORT — Vào nhỏ',id:"SIAPKAN SHORT — Entry kecil",pl:"PRZYGOTUJ SHORT — Małe wejście",it:"PREPARA SHORT — Piccolo ingresso",ru:"ГОТОВИТЬ ШОРТ — Малый вход",zh:"準備做空 — 小額進場"});
      gDesc=TT({ko:'목표 비중의 30~50% 소량 선진입. 추가 과열 확인 후 비중 확대.',en:'Enter 30~50% of target. Wait for confirmation to add.',ja:'目標比率の30~50%を少量先行エントリー。さらなる過熱確認後に拡大。',es:'Entrada pequeña anticipada 30~50% del objetivo. Ampliar tras confirmar más sobrecalentamiento.',de:'Kleiner Voreinstieg 30~50% des Ziels. Nach Bestätigung weiterer Überhitzung erhöhen.',fr:'Entrez 30~50% de l\'objectif. Attendez confirmation pour ajouter.',pt:'Entre 30~50% do alvo. Aguarde confirmação para adicionar.',tr:'Hedefin %30~50\'sini gir. Eklemek için onay bekle.',vi:'Vào 30~50% mục tiêu. Chờ xác nhận để thêm.',id:"Masuk 30~50% dari target. Tunggu konfirmasi untuk menambah.",pl:"Wejdź w 30~50% celu. Poczekaj na potwierdzenie, by dołożyć.",it:"Entra al 30~50% del target. Attendi conferma per aumentare.",ru:"Войдите на 30~50% от цели. Ждите подтверждения, чтобы добавить.",zh:"進場目標的 30~50%。待確認後加碼。"});
      exitSig=TT({ko:'추가 확인 조건',en:'Confirmation needed',ja:'追加確認条件',es:'Confirmación necesaria',de:'Bestätigung erforderlich',fr:'Confirmation nécessaire',pt:'Confirmação necessária',tr:'Onay gerekli',vi:'Cần xác nhận',id:"Perlu konfirmasi",pl:"Potrzebne potwierdzenie",it:"Serve conferma",ru:"Нужно подтверждение",zh:"需要確認"});
      exitDesc=TT({ko:'• 다음 추가 조건 대기:\n• NUPL 60% 이상\n• Fear & Greed 75 이상',en:'• Wait for:\n• NUPL above 60%\n• Fear & Greed above 75',ja:'• 次の条件を待機:\n• NUPLが60%以上\n• Fear & Greedが75以上',es:'• Esperar próxima condición:\n• NUPL por encima de 60%\n• Fear & Greed por encima de 75',de:'• Warten auf nächste Bedingung:\n• NUPL über 60%\n• Angst & Gier über 75',fr:'• Attendez :\n• NUPL au-dessus de 60%\n• Fear & Greed au-dessus de 75',pt:'• Aguarde:\n• NUPL acima de 60%\n• Fear & Greed acima de 75',tr:'• Bekle:\n• NUPL %60 üstü\n• Fear & Greed 75 üstü',vi:'• Chờ:\n• NUPL trên 60%\n• Fear & Greed trên 75',id:"• Tunggu:\n• NUPL di atas 60%\n• Fear & Greed di atas 75",pl:"• Poczekaj na:\n• NUPL powyżej 60%\n• Fear & Greed powyżej 75",it:"• Attendi:\n• NUPL sopra il 60%\n• Fear & Greed sopra 75",ru:"• Дождитесь:\n• NUPL выше 60%\n• Fear & Greed выше 75",zh:"• 等待：\n• NUPL 高於 60%\n• Fear & Greed 高於 75"});
    } else if(sc>=5.0){
      stMain=TT({ko:'중립 관찰 구간',en:'Neutral Watch Zone',ja:'中立の様子見ゾーン',es:'Zona de Observación Neutral',de:'Neutrale Beobachtungszone',fr:'Zone de Surveillance Neutre',pt:'Zona de Observação Neutra',tr:'Nötr İzleme Bölgesi',vi:'Vùng Quan Sát Trung Lập',id:"Zona Pantau Netral",pl:"Neutralna Strefa Obserwacji",it:"Zona di Osservazione Neutrale",ru:"Нейтральная зона наблюдения",zh:"中性觀望區"});
      stDesc=TT({ko:'뚜렷한 방향성 없음. 과열도 저점도 아닌 중간 구간. 서두르지 마세요.',en:'No clear direction. Neither overheat nor bottom.',ja:'明確な方向性なし。過熱でも底値でもない中間ゾーン。焦らないでください。',es:'Sin dirección clara. Ni sobrecalentado ni en suelo, zona intermedia. No se apresure.',de:'Keine klare Richtung. Weder überhitzt noch am Tief, mittlere Zone. Nicht überstürzen.',fr:'Aucune direction claire. Ni surchauffe ni creux, zone intermédiaire. Ne vous précipitez pas.',pt:'Sem direção clara. Nem sobreaquecimento nem fundo, zona intermediária. Não tenha pressa.',tr:'Net yön yok. Ne aşırı ısınma ne dip, ara bölge. Acele etme.',vi:'Không có hướng rõ. Không quá nóng cũng không đáy, vùng trung gian. Đừng vội.',id:"Tanpa arah jelas. Bukan overheat maupun dasar.",pl:"Brak wyraźnego kierunku. Ani przegrzanie, ani dno.",it:"Nessuna direzione chiara. Né surriscaldamento né minimo.",ru:"Нет чёткого направления. Ни перегрева, ни дна.",zh:"方向不明。既非過熱也非底部。"});
      gAction=TT({ko:'WATCH — 진입 대기',en:'WATCH — Wait for signal',ja:'WATCH — エントリー待機',es:'ESPERAR — Esperar señal',de:'WARTEN — Auf Signal warten',fr:'SURVEILLER — Attendre le signal',pt:'OBSERVAR — Aguardar sinal',tr:'İZLE — Sinyal bekle',vi:'QUAN SÁT — Chờ tín hiệu',id:"PANTAU — Tunggu sinyal",pl:"OBSERWUJ — Czekaj na sygnał",it:"OSSERVA — Attendi il segnale",ru:"НАБЛЮДАТЬ — Ждите сигнал",zh:"觀望 — 等待訊號"});
      gDesc=TT({ko:'숏 진입 서두르지 마세요. 6.0점 이상 도달 시 행동. 현 시장 모니터링 지속.',en:'Do not rush. Act when score reaches 6.0+. Keep monitoring.',ja:'ショートエントリーを急がないでください。スコア6.0以上で行動。現市場を継続監視。',es:'No se apresure a entrar en corto. Actuar al alcanzar 6.0+. Seguir monitoreando el mercado actual.',de:'Nicht überstürzt short gehen. Bei Erreichen von 6,0+ handeln. Markt weiter beobachten.',fr:'Ne vous précipitez pas sur le short. Agissez quand le score atteint 6,0+. Continuez à surveiller.',pt:'Não tenha pressa no short. Aja quando a pontuação chegar a 6,0+. Continue monitorando.',tr:'Short\'ta acele etme. Puan 6,0+ olunca hareket et. İzlemeye devam et.',vi:'Đừng vội short. Hành động khi điểm đạt 6,0+. Tiếp tục theo dõi.',id:"Jangan terburu. Bertindak saat skor mencapai 6.0+. Terus pantau.",pl:"Nie spiesz się. Działaj, gdy wynik osiągnie 6.0+. Obserwuj dalej.",it:"Non avere fretta. Agisci quando il punteggio raggiunge 6.0+. Continua a monitorare.",ru:"Не спешите. Действуйте при оценке 6.0+. Продолжайте наблюдать.",zh:"別急。分數達 6.0+ 再行動。持續觀察。"});
      exitSig=TT({ko:'기존 숏 보유 중이라면',en:'If holding short position',ja:'既存ショート保有中の場合',es:'Si mantiene posición corta',de:'Bei bestehender Short-Position',fr:'Si vous détenez une position short',pt:'Se está com posição short',tr:'Short pozisyonun varsa',vi:'Nếu đang giữ vị thế short',id:"Jika memegang posisi short",pl:"Jeśli masz pozycję short",it:"Se hai una posizione short",ru:"Если держите шорт-позицию",zh:"若持有空單部位"});
      exitDesc=TT({ko:'• 목표 수익 50% 달성 시 절반 청산\n• 손절: 진입가 대비 +5%',en:'• Close 50% at 50% profit target\n• Stop loss: +5% from entry',ja:'• 目標利益50%達成時に半分決済\n• 損切り: エントリー価格比+5%',es:'• Cerrar la mitad al alcanzar 50% de ganancia objetivo\n• Stop loss: +5% desde entrada',de:'• Bei 50% Zielgewinn die Hälfte schließen\n• Stop-Loss: +5% vom Einstieg',fr:'• Fermez 50% à 50% de l\'objectif de profit\n• Stop loss : +5% depuis l\'entrée',pt:'• Feche 50% ao atingir 50% da meta de lucro\n• Stop loss: +5% da entrada',tr:'• %50 kâr hedefinde %50 kapat\n• Stop loss: girişten +%5',vi:'• Đóng 50% khi đạt 50% mục tiêu lãi\n• Cắt lỗ: +5% từ điểm vào',id:"• Tutup 50% di target profit 50%\n• Stop loss: +5% dari entry",pl:"• Zamknij 50% przy 50% celu zysku\n• Stop loss: +5% od wejścia",it:"• Chiudi il 50% al target di profitto del 50%\n• Stop loss: +5% dall'ingresso",ru:"• Закройте 50% при цели прибыли 50%\n• Стоп-лосс: +5% от входа",zh:"• 於獲利目標 50% 平掉一半\n• 停損：進場價 +5%"});
    } else if(sc>=3.5){
      stMain=TT({ko:'과열 신호 부재 — 숏 위험',en:'No Overheat Signals — Short Risky',ja:'過熱シグナル不在 — ショートリスク高',es:'Sin Señales de Sobrecalentamiento — Corto Riesgoso',de:'Keine Überhitzungssignale — Short riskant',fr:'Aucun Signal de Surchauffe — Short Risqué',pt:'Sem Sinais de Sobreaquecimento — Short Arriscado',tr:'Isınma Sinyali Yok — Short Riskli',vi:'Không Có Tín Hiệu Quá Nóng — Short Rủi Ro',id:"Tanpa Sinyal Overheat — Short Berisiko",pl:"Brak Sygnałów Przegrzania — Short Ryzykowny",it:"Nessun Segnale di Surriscaldamento — Short Rischioso",ru:"Нет сигналов перегрева — шорт рискован",zh:"無過熱訊號 — 做空有風險"});
      stDesc=TT({ko:'현재 과열·고점 신호가 거의 없는 구간. 숏 포지션 보유 중이라면 일부 청산 권고. (※ 이 점수는 "지금 가격이 비싸 보이지 않는다"는 뜻이지, 실제 역사적 저점이라는 의미는 아닙니다.)',en:'Few overheat signals present right now. Partial exit recommended for shorts. (※ This means current price doesn\'t look overextended — not that it\'s an actual historical low.)',ja:'現在過熱・天井シグナルがほとんどないゾーン。ショートポジション保有中なら一部決済を推奨。(※このスコアは「今の価格が割高に見えない」という意味であり、実際の歴史的底値という意味ではありません。)',es:'Zona con casi ninguna señal de sobrecalentamiento o techo actualmente. Se recomienda salida parcial si mantiene posición corta. (※ Esta puntuación significa que "el precio actual no parece caro", no que sea un suelo histórico real.)',de:'Zone mit derzeit kaum Überhitzungs- oder Top-Signalen. Bei bestehender Short-Position wird Teilausstieg empfohlen. (※ Dieser Score bedeutet "aktueller Preis wirkt nicht teuer", nicht dass es sich um ein echtes historisches Tief handelt.)',fr:'Peu de signaux de surchauffe actuellement. Sortie partielle recommandée pour les shorts. (※ Cela signifie que le prix actuel ne semble pas surétendu — pas qu\'il s\'agit d\'un creux historique réel.)',pt:'Poucos sinais de sobreaquecimento agora. Saída parcial recomendada para shorts. (※ Isso significa que o preço atual não parece esticado — não que seja um fundo histórico real.)',tr:'Şu an az ısınma sinyali var. Short\'lar için kısmi çıkış önerilir. (※ Bu, mevcut fiyatın aşırı uzamış görünmediği anlamına gelir — gerçek tarihsel dip olduğu değil.)',vi:'Hiện ít tín hiệu quá nóng. Khuyến nghị thoát một phần với short. (※ Điều này nghĩa là giá hiện tại không có vẻ bị kéo căng — không phải là đáy lịch sử thực sự.)',id:"Sedikit sinyal overheat saat ini. Keluar sebagian disarankan untuk short. (※ Ini berarti harga saat ini tidak tampak berlebihan — bukan berarti ini benar-benar titik terendah historis.)",pl:"Obecnie mało sygnałów przegrzania. Zalecane częściowe wyjście ze shortów. (※ Oznacza to, że obecna cena nie wygląda na przeciągniętą — a nie że to faktyczne historyczne dno.)",it:"Pochi segnali di surriscaldamento ora. Uscita parziale consigliata per gli short. (※ Significa che il prezzo attuale non appare sovraesteso — non che sia un vero minimo storico.)",ru:"Сейчас мало сигналов перегрева. Для шортов рекомендуется частичный выход. (※ Это значит, что текущая цена не выглядит перегретой — а не что это реальный исторический минимум.)",zh:"目前過熱訊號很少。建議空單部分出場。（※ 這代表目前價格看來並未超漲 — 並非真的歷史低點。）"});
      gAction=TT({ko:'SPLIT EXIT — 분할 청산',en:'SPLIT EXIT — Scale out',ja:'SPLIT EXIT — 分割決済',es:'PARCIAL — Salida escalonada',de:'TEIL-EXIT — Gestaffelter Ausstieg',fr:'SORTIE ÉCHELONNÉE — Réduire',pt:'SAÍDA ESCALONADA — Reduzir',tr:'KADEMELİ ÇIKIŞ — Azalt',vi:'THOÁT TỪNG PHẦN — Giảm dần',id:"KELUAR BERTAHAP — Kurangi",pl:"WYJŚCIE ETAPAMI — Redukuj",it:"USCITA SCAGLIONATA — Riduci",ru:"ДРОБНЫЙ ВЫХОД — Сокращать",zh:"分批出場 — 減碼"});
      gDesc=TT({ko:'기존 숏의 50% 청산. 나머지는 추가 하락 관찰 후 판단. 신규 숏 진입 절대 금지.',en:'Close 50% of short. Hold rest carefully. No new short entries.',ja:'既存ショートの50%を決済。残りはさらなる下落を観察して判断。新規ショートエントリーは厳禁。',es:'Cerrar el 50% del corto existente. Decidir el resto tras observar más caídas. Prohibido abrir nuevos cortos.',de:'50% der bestehenden Short-Position schließen. Rest nach weiterer Beobachtung entscheiden. Keine neuen Short-Einstiege.',fr:'Fermez 50% du short. Gardez le reste prudemment. Aucune nouvelle entrée short.',pt:'Feche 50% do short. Segure o resto com cuidado. Sem novas entradas short.',tr:'Short\'un %50\'sini kapat. Kalanı dikkatli tut. Yeni short girişi yok.',vi:'Đóng 50% short. Giữ phần còn lại cẩn thận. Không vào short mới.',id:"Tutup 50% short. Tahan sisanya hati-hati. Jangan entry short baru.",pl:"Zamknij 50% shorta. Resztę trzymaj ostrożnie. Bez nowych wejść short.",it:"Chiudi il 50% dello short. Tieni il resto con cautela. Nessun nuovo short.",ru:"Закройте 50% шорта. Остальное держите осторожно. Без новых шортов.",zh:"平掉 50% 空單。其餘小心持有。不再新開空單。"});
      exitSig=TT({ko:'전량 청산 조건',en:'Full exit conditions',ja:'全量決済条件',es:'Condiciones de salida total',de:'Vollständige Ausstiegsbedingungen',fr:'Conditions de sortie totale',pt:'Condições de saída total',tr:'Tam çıkış koşulları',vi:'Điều kiện thoát toàn bộ',id:"Kondisi keluar penuh",pl:"Warunki pełnego wyjścia",it:"Condizioni di uscita totale",ru:"Условия полного выхода",zh:"全數出場條件"});
      exitDesc=TT({ko:'• MVRV Z 0.5 이하\n• Fear & Greed 20 이하\n• 선물 갭 음수 전환',en:'• MVRV Z below 0.5\n• Fear & Greed below 20\n• Futures gap turns negative',ja:'• MVRV Zが0.5以下\n• Fear & Greedが20以下\n• 先物ギャップがマイナスに転換',es:'• MVRV Z por debajo de 0.5\n• Fear & Greed por debajo de 20\n• Brecha de futuros se vuelve negativa',de:'• MVRV Z unter 0,5\n• Angst & Gier unter 20\n• Futures-Spread wird negativ',fr:'• MVRV Z sous 0,5\n• Fear & Greed sous 20\n• L\'écart des futures devient négatif',pt:'• MVRV Z abaixo de 0,5\n• Fear & Greed abaixo de 20\n• Gap de futuros fica negativo',tr:'• MVRV Z 0,5 altında\n• Fear & Greed 20 altında\n• Vadeli farkı negatife döner',vi:'• MVRV Z dưới 0,5\n• Fear & Greed dưới 20\n• Chênh lệch futures thành âm',id:"• MVRV Z di bawah 0.5\n• Fear & Greed di bawah 20\n• Selisih futures jadi negatif",pl:"• MVRV Z poniżej 0,5\n• Fear & Greed poniżej 20\n• Różnica futures staje się ujemna",it:"• MVRV Z sotto 0,5\n• Fear & Greed sotto 20\n• Lo scarto futures diventa negativo",ru:"• MVRV Z ниже 0,5\n• Fear & Greed ниже 20\n• Разрыв фьючерсов становится отрицательным",zh:"• MVRV Z 低於 0.5\n• Fear & Greed 低於 20\n• 期現差距轉負"});
    } else {
      stMain=TT({ko:'과열 신호 전무 — 숏 즉시 청산',en:'Zero Overheat Signals — Exit Short Now',ja:'過熱シグナル皆無 — ショート即時決済',es:'Cero Señales de Sobrecalentamiento — Cerrar Corto Ahora',de:'Keine Überhitzungssignale — Short sofort schließen',fr:'Zéro Signal de Surchauffe — Sortez du Short Maintenant',pt:'Zero Sinal de Sobreaquecimento — Saia do Short Agora',tr:'Sıfır Isınma Sinyali — Short\'tan Şimdi Çık',vi:'Không Tín Hiệu Quá Nóng — Thoát Short Ngay',id:"Nol Sinyal Overheat — Keluar Short Sekarang",pl:"Zero Sygnałów Przegrzania — Zamknij Short Teraz",it:"Zero Segnali di Surriscaldamento — Esci dallo Short Ora",ru:"Ноль сигналов перегрева — закрывайте шорт сейчас",zh:"零過熱訊號 — 立即出清空單"});
      stDesc=TT({ko:'고점·과열 신호가 전혀 없는 구간. 숏 포지션 유지는 위험하니 손실이더라도 즉시 청산을 고려하세요. (※ 차트가 실제로 상승 추세 중이어도 뜰 수 있는 메시지입니다 — 이 점수는 "역사적 저점"이 아니라 "지금은 과열되지 않았다"만 의미합니다. 차트와 함께 직접 판단하세요.)',en:'No overheat or top signals present at all. Holding a short here is risky — consider exiting even at a loss. (※ This can appear even while the chart is in a clear uptrend — the score means "not currently overheated," not "historical low." Always check the chart yourself.)',ja:'天井・過熱シグナルが全くないゾーン。ショートポジション維持はリスクが高いため、損失が出ていても即時決済を検討してください。(※チャートが実際に上昇トレンド中でも表示されうるメッセージです — このスコアは「歴史的底値」ではなく「今は過熱していない」という意味だけです。チャートと合わせてご自身で判断してください。)',es:'Zona sin ninguna señal de techo o sobrecalentamiento. Mantener una posición corta aquí es arriesgado — considere salir incluso con pérdida. (※ Este mensaje puede aparecer incluso con el gráfico en clara tendencia alcista — la puntuación significa "no sobrecalentado actualmente", no "suelo histórico". Siempre revise el gráfico usted mismo.)',de:'Zone ohne jegliche Top- oder Überhitzungssignale. Eine Short-Position hier zu halten ist riskant — Ausstieg auch bei Verlust erwägen. (※ Diese Meldung kann auch bei klarem Aufwärtstrend im Chart erscheinen — der Score bedeutet "aktuell nicht überhitzt", nicht "historisches Tief". Chart immer selbst prüfen.)',fr:'Aucun signal de surchauffe ou de sommet. Détenir un short ici est risqué — envisagez de sortir même à perte. (※ Cela peut apparaître même en tendance haussière claire — le score signifie « pas actuellement en surchauffe », pas « creux historique ». Vérifiez toujours le graphique vous-même.)',pt:'Nenhum sinal de sobreaquecimento ou topo. Manter short aqui é arriscado — considere sair mesmo com prejuízo. (※ Isso pode aparecer mesmo em tendência de alta clara — a pontuação significa "não sobreaquecido agora", não "fundo histórico". Sempre confira o gráfico.)',tr:'Hiç ısınma veya tepe sinyali yok. Burada short tutmak riskli — zararına bile çıkışı düşün. (※ Bu, grafik net yükselişteyken bile görünebilir — puan "şu an aşırı ısınmamış" demek, "tarihsel dip" değil. Grafiği hep kendin kontrol et.)',vi:'Không có tín hiệu quá nóng hay đỉnh. Giữ short ở đây rủi ro — cân nhắc thoát dù lỗ. (※ Điều này có thể xuất hiện ngay cả khi biểu đồ đang tăng rõ — điểm nghĩa là "hiện không quá nóng", không phải "đáy lịch sử". Luôn tự kiểm tra biểu đồ.)',id:"Tidak ada sinyal overheat atau puncak sama sekali. Menahan short di sini berisiko — pertimbangkan keluar meski rugi. (※ Ini bisa muncul bahkan saat chart jelas uptrend — skor berarti \"belum overheat\", bukan \"titik terendah historis\". Selalu periksa chart sendiri.)",pl:"W ogóle brak sygnałów przegrzania czy szczytu. Trzymanie shorta jest ryzykowne — rozważ wyjście nawet ze stratą. (※ Może się pojawić nawet przy wyraźnym trendzie wzrostowym — wynik oznacza \"obecnie nieprzegrzane\", nie \"historyczne dno\". Zawsze sam sprawdzaj wykres.)",it:"Nessun segnale di surriscaldamento o di massimo. Tenere uno short qui è rischioso — valuta di uscire anche in perdita. (※ Può comparire anche con un chiaro trend rialzista — il punteggio indica \"non attualmente surriscaldato\", non \"minimo storico\". Controlla sempre il grafico.)",ru:"Совсем нет сигналов перегрева или вершины. Держать шорт здесь рискованно — рассмотрите выход даже с убытком. (※ Это может появиться даже при явном восходящем тренде — оценка означает «сейчас не перегрето», а не «исторический минимум». Всегда проверяйте график сами.)",zh:"完全沒有過熱或頂部訊號。此處持有空單有風險 — 考慮即使虧損也出場。（※ 即使圖表明顯處於上升趨勢時也可能出現 — 分數代表「目前未過熱」，並非「歷史低點」。請務必自行確認圖表。）"});
      gAction=TT({ko:'EXIT SHORT — 전량 즉시 청산',en:'EXIT SHORT — Close all immediately',ja:'EXIT SHORT — 全量即時決済',es:'SALIR — Cerrar todo de inmediato',de:'EXIT — Alles sofort schließen',fr:'SORTIR DU SHORT — Fermez tout immédiatement',pt:'SAIR DO SHORT — Feche tudo imediatamente',tr:'SHORT ÇIK — Hepsini hemen kapat',vi:'THOÁT SHORT — Đóng tất cả ngay',id:"KELUAR SHORT — Tutup semua segera",pl:"ZAMKNIJ SHORT — Zamknij wszystko natychmiast",it:"ESCI DAL SHORT — Chiudi tutto subito",ru:"ВЫЙТИ ИЗ ШОРТА — Закрыть всё немедленно",zh:"出清空單 — 立即全數平倉"});
      gDesc=TT({ko:'모든 숏 즉시 청산. 손실 감수하더라도 추가 손실 방지 최우선. 롱 전환 검토.',en:'Close ALL shorts now. Prevent further losses. Consider switching to long.',ja:'全てのショートを即時決済。損失を受け入れてでもさらなる損失防止を最優先。ロング転換を検討。',es:'Cerrar TODOS los cortos ahora. Priorizar evitar más pérdidas incluso asumiendo pérdida. Considerar cambiar a largo.',de:'ALLE Short-Positionen sofort schließen. Weitere Verluste vermeiden hat Priorität, auch bei Verlust. Wechsel zu Long erwägen.',fr:'Fermez TOUS les shorts maintenant. Évitez d\'autres pertes. Envisagez de passer en long.',pt:'Feche TODOS os shorts agora. Evite mais perdas. Considere mudar para long.',tr:'TÜM short\'ları şimdi kapat. Daha fazla zararı önle. Long\'a geçmeyi düşün.',vi:'Đóng TẤT CẢ short ngay. Ngăn lỗ thêm. Cân nhắc chuyển sang long.',id:"Tutup SEMUA short sekarang. Cegah kerugian lebih lanjut. Pertimbangkan beralih ke long.",pl:"Zamknij WSZYSTKIE shorty teraz. Zapobiegnij dalszym stratom. Rozważ przejście na long.",it:"Chiudi TUTTI gli short ora. Evita ulteriori perdite. Valuta di passare al long.",ru:"Закройте ВСЕ шорты сейчас. Предотвратите дальнейшие убытки. Рассмотрите переход в лонг.",zh:"立即平掉所有空單。防止進一步虧損。考慮轉為做多。"});
      exitSig=TT({ko:'⚠️ 지금 즉시 행동',en:'⚠️ Act right now',ja:'⚠️ 今すぐ行動',es:'⚠️ Actuar ahora mismo',de:'⚠️ Sofort handeln',fr:'⚠️ Agissez maintenant',pt:'⚠️ Aja agora',tr:'⚠️ Şimdi hareket et',vi:'⚠️ Hành động ngay',id:"⚠️ Bertindak sekarang juga",pl:"⚠️ Działaj natychmiast",it:"⚠️ Agisci subito",ru:"⚠️ Действуйте прямо сейчас",zh:"⚠️ 立刻行動"});
      exitDesc=TT({ko:'• 현재 시장가로 전량 청산\n• 숏 재진입은 6.0점 이상에서만\n• 롱 진입 적극 검토',en:'• Close at market price now\n• Only re-short above 6.0\n• Strongly consider going long',ja:'• 現在の市場価格で全量決済\n• ショート再エントリーはスコア6.0以上でのみ\n• ロングエントリーを積極的に検討',es:'• Cerrar todo al precio de mercado actual\n• Reingresar corto solo por encima de 6.0\n• Considerar seriamente entrada larga',de:'• Alles zum aktuellen Marktpreis schließen\n• Short-Wiedereinstieg nur über 6,0\n• Long-Einstieg stark erwägen',fr:'• Fermez au prix du marché maintenant\n• Re-short uniquement au-dessus de 6,0\n• Envisagez fortement le long',pt:'• Feche a preço de mercado agora\n• Re-short apenas acima de 6,0\n• Considere fortemente ir long',tr:'• Şimdi piyasa fiyatından kapat\n• Sadece 6,0 üstünde tekrar short\n• Long\'a geçmeyi ciddi düşün',vi:'• Đóng theo giá thị trường ngay\n• Chỉ short lại trên 6,0\n• Cân nhắc mạnh việc vào long',id:"• Tutup di harga pasar sekarang\n• Short lagi hanya di atas 6.0\n• Sangat pertimbangkan untuk long",pl:"• Zamknij po cenie rynkowej teraz\n• Ponowny short tylko powyżej 6.0\n• Zdecydowanie rozważ long",it:"• Chiudi al prezzo di mercato ora\n• Rientra short solo sopra 6.0\n• Valuta seriamente il long",ru:"• Закройте по рынку сейчас\n• Повторный шорт только выше 6.0\n• Серьёзно рассмотрите лонг",zh:"• 立即以市價平倉\n• 僅在 6.0 以上才再做空\n• 強烈考慮轉多"});
    }

    if(el('sStatusTitle')) el('sStatusTitle').textContent=TT({ko:'현재 시장 상태',en:'MARKET STATUS',ja:'現在の市場状況',es:'ESTADO DEL MERCADO',de:'MARKTSTATUS',fr:'ÉTAT DU MARCHÉ',pt:'STATUS DO MERCADO',tr:'PİYASA DURUMU',vi:'TRẠNG THÁI THỊ TRƯỜNG',id:"STATUS PASAR",pl:"STATUS RYNKU",it:"STATO DEL MERCATO",ru:"СОСТОЯНИЕ РЫНКА",zh:"市場狀態"});
    ...
    if(el('sGuideTitle'))  el('sGuideTitle').textContent=TT({ko:'숏 포지션 가이드',en:'SHORT GUIDE',ja:'ショートポジションガイド',es:'GUÍA CORTO',de:'SHORT-ANLEITUNG',fr:'GUIDE SHORT',pt:'GUIA SHORT',tr:'SHORT KILAVUZU',vi:'HƯỚNG DẪN SHORT',id:"PANDUAN SHORT",pl:"PRZEWODNIK SHORT",it:"GUIDA SHORT",ru:"ГАЙД ПО ШОРТУ",zh:"做空指南"});
    ...
    if(el('sExitTitle'))   el('sExitTitle').textContent=TT({ko:'숏 청산 조건',en:'SHORT EXIT',ja:'ショート決済条件',es:'SALIDA CORTA',de:'SHORT-AUSSTIEG',fr:'SORTIE SHORT',pt:'SAÍDA SHORT',tr:'SHORT ÇIKIŞ',vi:'THOÁT SHORT',id:"KELUAR SHORT",pl:"WYJŚCIE ZE SHORT",it:"USCITA SHORT",ru:"ВЫХОД ИЗ ШОРТА",zh:"做空出場"});
    ...
    if(el('lGuideTitle'))  el('lGuideTitle').textContent=TT({ko:'롱 포지션 가이드',en:'LONG GUIDE',ja:'ロングポジションガイド',es:'GUÍA LARGO',de:'LONG-ANLEITUNG',fr:'GUIDE LONG',pt:'GUIA LONG',tr:'LONG KILAVUZU',vi:'HƯỚNG DẪN LONG',id:"PANDUAN LONG",pl:"PRZEWODNIK LONG",it:"GUIDA LONG",ru:"ГАЙД ПО ЛОНГУ",zh:"做多指南"});
    ...
    if(el('lNextTitle'))   el('lNextTitle').textContent=TT({ko:'다음 진입 조건',en:'NEXT TRIGGER',ja:'次のエントリー条件',es:'SIGUIENTE DISPARADOR',de:'NÄCHSTER TRIGGER',fr:'PROCHAIN DÉCLENCHEUR',pt:'PRÓXIMO GATILHO',tr:'SONRAKİ TETİKLEYİCİ',vi:'KÍCH HOẠT TIẾP THEO',id:"PEMICU BERIKUTNYA",pl:"NASTĘPNY WYZWALACZ",it:"PROSSIMO TRIGGER",ru:"СЛЕДУЮЩИЙ ТРИГГЕР",zh:"下一觸發"});
    if(el('lNextDesc'))    el('lNextDesc').innerHTML=_emphArrow(nextDesc);
    if(el('lSplitTitle'))  el('lSplitTitle').textContent=TT({ko:'분할 매수 계획',en:'SPLIT ENTRY PLAN',ja:'分割エントリー計画',es:'PLAN DE ENTRADA ESCALONADA',de:'GESTAFFELTER EINSTIEGSPLAN',fr:'PLAN D\'ENTRÉE ÉCHELONNÉE',pt:'PLANO DE ENTRADA ESCALONADA',tr:'KADEMELİ GİRİŞ PLANI',vi:'KẾ HOẠCH VÀO TỪNG PHẦN',id:"RENCANA ENTRY BERTAHAP",pl:"PLAN WEJŚCIA ETAPAMI",it:"PIANO INGRESSO SCAGLIONATO",ru:"ПЛАН ДРОБНОГО ВХОДА",zh:"分批進場計畫"});
  ...
  if(assetLbl) assetLbl.textContent = TT({ko:'투자 자산',en:'Investment',ja:'投資資産',es:'Inversión',de:'Investition',fr:'Investissement',pt:'Investimento',tr:'Yatırım',vi:'Đầu tư',id:"Investasi",pl:"Inwestycja",it:"Investimento",ru:"Инвестиция",zh:"投資"});
  }
  ...
  if(bkHd) bkHd.textContent=TT({ko:`점수 합산 (${result.max}pt → 10점 환산)`,en:`Score Breakdown (${result.max}pt → 10pt)`,ja:`スコア内訳 (${result.max}pt → 10pt換算)`,es:`Desglose de puntuación (${result.max}pt → convertido a 10pt)`,de:`Score-Aufschlüsselung (${result.max}pt → auf 10pt umgerechnet)`,fr:`Détail du score (${result.max}pt → converti sur 10)`,pt:`Detalhamento (${result.max}pt → convertido para 10)`,tr:`Puan dökümü (${result.max}pt → 10'a çevrildi)`,vi:`Phân tích điểm (${result.max}pt → quy về 10)`,id:`Rincian Skor (${result.max}poin → 10poin)`,pl:`Rozkład Wyniku (${result.max}pkt → 10pkt)`,it:`Dettaglio Punteggio (${result.max}pt → 10pt)`,ru:`Разбор оценки (${result.max} → 10)`,zh:`分數拆解 (${result.max}分 → 10分)`});
  // 트리거 헤더
  const trigTitleEl=document.getElementById('trigTitle');
  if(trigTitleEl) {
    if(currentMode==='buy') trigTitleEl.textContent=TT({ko:'다음 단계 트리거',en:'Next Level Triggers',ja:'次段階トリガー',es:'Próximos Disparadores',de:'Nächste Trigger',fr:'Déclencheurs du Niveau Suivant',pt:'Gatilhos do Próximo Nível',tr:'Sonraki Seviye Tetikleyicileri',vi:'Kích hoạt Cấp tiếp theo',id:"Pemicu Level Berikutnya",pl:"Wyzwalacze Kolejnego Poziomu",it:"Trigger Livello Successivo",ru:"Триггеры следующего уровня",zh:"下一級觸發條件"});
    else trigTitleEl.textContent=TT({ko:'숏 신호 트리거',en:'Short Signal Triggers',ja:'ショートシグナルトリガー',es:'Disparadores de Señal de Venta',de:'Verkaufssignal-Trigger',fr:'Déclencheurs de Signal Short',pt:'Gatilhos de Sinal Short',tr:'Short Sinyal Tetikleyicileri',vi:'Kích hoạt Tín hiệu Short',id:"Pemicu Sinyal Short",pl:"Wyzwalacze Sygnału Short",it:"Trigger Segnale Short",ru:"Триггеры сигнала шорта",zh:"做空訊號觸發"});
  }
  // 분할계획 단계 라벨
  ...
  if(currentMode==='buy') {
    ...
    const steps=[
      {pct:25,cond:canEnter?TT({ko:`지금 진입 (${sc.toFixed(1)}점)`,en:`Now (${sc.toFixed(1)}pt)`,ja:`今すぐ (${sc.toFixed(1)}pt)`,es:`Ahora (${sc.toFixed(1)}pt)`,de:`Jetzt (${sc.toFixed(1)}pt)`,fr:`Maintenant (${sc.toFixed(1)}pt)`,pt:`Agora (${sc.toFixed(1)}pt)`,tr:`Şimdi (${sc.toFixed(1)}pt)`,vi:`Bây giờ (${sc.toFixed(1)}pt)`,id:`Sekarang (${sc.toFixed(1)}poin)`,pl:`Teraz (${sc.toFixed(1)}pkt)`,it:`Ora (${sc.toFixed(1)}pt)`,ru:`Сейчас (${sc.toFixed(1)})`,zh:`現在 (${sc.toFixed(1)}分)`}):TT({ko:`점수 6.0 이상 대기 (현재 ${sc.toFixed(1)}점)`,en:`Await 6.0+ (now ${sc.toFixed(1)}pt)`,ja:`スコア6.0以上を待機 (現在${sc.toFixed(1)}pt)`,es:`Esperando 6.0+ (actual ${sc.toFixed(1)}pt)`,de:`Warten auf 6,0+ (aktuell ${sc.toFixed(1)}pt)`,fr:`Attendre 6,0+ (actuel ${sc.toFixed(1)}pt)`,pt:`Aguardar 6,0+ (atual ${sc.toFixed(1)}pt)`,tr:`6,0+ bekle (şu an ${sc.toFixed(1)}pt)`,vi:`Chờ 6,0+ (hiện ${sc.toFixed(1)}pt)`,id:`Tunggu 6.0+ (kini ${sc.toFixed(1)}poin)`,pl:`Czekaj 6.0+ (teraz ${sc.toFixed(1)}pkt)`,it:`Attendi 6.0+ (ora ${sc.toFixed(1)}pt)`,ru:`Ждать 6.0+ (сейчас ${sc.toFixed(1)})`,zh:`等待 6.0+ (目前 ${sc.toFixed(1)}分)`}),
       price:livePrice||p, now:canEnter, waiting:!canEnter},
      {pct:30,cond:TT({ko:'Hash Ribbon 회복 전환',en:'Hash Ribbon Recovery Cross',ja:'Hash Ribbon 回復転換',es:'Cruce de Recuperación Hash Ribbon',de:'Hash-Ribbon-Erholungscross',fr:'Croisement de Reprise Hash Ribbon',pt:'Cruzamento de Recuperação Hash Ribbon',tr:'Hash Ribbon Toparlanma Kesişimi',vi:'Giao cắt Phục hồi Hash Ribbon',id:"Recovery Cross Hash Ribbon",pl:"Recovery Cross Hash Ribbon",it:"Recovery Cross Hash Ribbon",ru:"Recovery Cross Hash Ribbon",zh:"Hash Ribbon 復甦交叉"}),price:null,range:'$50K~$58K'},
      {pct:25,cond:TT({ko:'Coinbase Premium 양전환',en:'Coinbase Premium Turns Positive',ja:'Coinbaseプレミアムがプラス転換',es:'Coinbase Premium se vuelve positivo',de:'Coinbase Premium wird positiv',fr:'Coinbase Premium Devient Positif',pt:'Coinbase Premium Fica Positivo',tr:'Coinbase Premium Pozitife Döner',vi:'Coinbase Premium Thành Dương',id:"Coinbase Premium Jadi Positif",pl:"Coinbase Premium Staje Się Dodatni",it:"Coinbase Premium Diventa Positivo",ru:"Coinbase Premium становится положительным",zh:"Coinbase Premium 轉正"}),price:null,range:'$52K~$62K'},
...
function renderTriggers(result, ind) {
  const sc=result.final;
  const ach=TT({ko:'달성',en:'Achieved',ja:'達成',es:'Logrado',de:'Erreicht',fr:'Atteint',pt:'Atingido',tr:'Tamamlandı',vi:'Đã đạt',id:"Tercapai",pl:"Osiągnięto",it:"Raggiunto",ru:"Выполнено",zh:"已達成"});
  const trig_ko=TT({ko:'발생',en:'Triggered!',ja:'発生!',es:'¡Activado!',de:'Ausgelöst!',fr:'Déclenché !',pt:'Acionado!',tr:'Tetiklendi!',vi:'Đã kích hoạt!',id:"Terpicu!",pl:"Wyzwolono!",it:"Attivato!",ru:"Сработало!",zh:"已觸發！"});
  const pick = (t) => t[currentLang] || t.en;
  let rows=[];
  if(currentMode==='buy') {
    const triggers=[
      {en:'Hash Ribbon 30d>60d recovery',ko:'Hash Ribbon 30일MA > 60일MA 회복 전환', ja:'Hash Ribbon 30日MA > 60日MA 回復転換', es:'Hash Ribbon: recuperación MA 30d > 60d', de:'Hash Ribbon: Erholung 30T-MA > 60T-MA', done: ind.hr_status==='Recovering',fr:"Hash Ribbon : reprise MA 30j > 60j",pt:"Hash Ribbon: recuperação MMA 30d > 60d",tr:"Hash Ribbon: 30g MA > 60g MA toparlanma",vi:"Hash Ribbon: hồi phục MA 30n > 60n",id:"Hash Ribbon: pemulihan MA 30h > 60h",pl:"Hash Ribbon: odbicie MA 30d > 60d",it:"Hash Ribbon: recupero MA 30g > 60g",ru:"Hash Ribbon: восстановление MA 30д > 60д",zh:"Hash Ribbon 30日均 > 60日均 復甦"},
      {en:'Coinbase Premium turns positive',ko:'Coinbase Premium 양전환', ja:'Coinbaseプレミアムがプラス転換', es:'Coinbase Premium se vuelve positivo', de:'Coinbase Premium wird positiv', done: ind.cb_premium>0,fr:"Coinbase Premium devient positif",pt:"Coinbase Premium torna-se positivo",tr:"Coinbase Premium pozitife döner",vi:"Coinbase Premium chuyển dương",id:"Coinbase Premium jadi positif",pl:"Coinbase Premium staje się dodatni",it:"Coinbase Premium diventa positivo",ru:"Coinbase Premium становится положительным",zh:"Coinbase Premium 轉正"},
      {en:'NUPL below 0% (Fear zone)',ko:'NUPL 0% 이하 (공포 구간)', ja:'NUPLが0%以下 (恐怖ゾーン)', es:'NUPL por debajo de 0% (zona de miedo)', de:'NUPL unter 0% (Angstzone)', done: ind.nupl<=0,fr:"NUPL sous 0% (zone de peur)",pt:"NUPL abaixo de 0% (zona de medo)",tr:"NUPL %0 altında (korku bölgesi)",vi:"NUPL dưới 0% (vùng sợ hãi)",id:"NUPL di bawah 0% (zona takut)",pl:"NUPL poniżej 0% (strefa strachu)",it:"NUPL sotto lo 0% (zona di paura)",ru:"NUPL ниже 0% (зона страха)",zh:"NUPL 低於 0%（恐懼區）"},
      {en:'MVRV Z Score ≤ 0',ko:'MVRV Z Score 0 이하', ja:'MVRV Zスコアが0以下', es:'MVRV Z-Score ≤ 0', de:'MVRV Z-Score ≤ 0', done: ind.mvrv_z<=0,fr:"MVRV Z-Score ≤ 0",pt:"MVRV Z-Score ≤ 0",tr:"MVRV Z-Score ≤ 0",vi:"MVRV Z-Score ≤ 0",id:"MVRV Z-Score ≤ 0",pl:"MVRV Z-Score ≤ 0",it:"MVRV Z-Score ≤ 0",ru:"MVRV Z-Score ≤ 0",zh:"MVRV Z-Score ≤ 0"},
      {en:'Futures-Spot gap negative',ko:'선물-현물 갭 음수 전환', ja:'先物-現物ギャップがマイナスに転換', es:'Brecha futuros-spot se vuelve negativa', de:'Futures-Spot-Spread wird negativ', done: ind.funding<0,fr:"Écart futures-spot négatif",pt:"Brecha futuros-spot negativa",tr:"Vadeli-spot farkı negatif",vi:"Chênh lệch futures-spot âm",id:"Selisih futures-spot negatif",pl:"Różnica futures-spot ujemna",it:"Scarto futures-spot negativo",ru:"Разрыв futures-spot отрицательный",zh:"期現差距轉負"},
    ];
    rows=triggers.map(t=>`
    ...
    const triggers=[
      {en:'MVRV Z Score ≥ 3.5 (euphoria)',ko:'MVRV Z ≥ 3.5 (도취 구간)', ja:'MVRV Z ≥ 3.5 (陶酔ゾーン)', es:'MVRV Z ≥ 3.5 (euforia)', de:'MVRV Z ≥ 3,5 (Euphorie)', done: ind.mvrv_z>=3.5,fr:"MVRV Z ≥ 3,5 (euphorie)",pt:"MVRV Z ≥ 3,5 (euforia)",tr:"MVRV Z ≥ 3,5 (öfori)",vi:"MVRV Z ≥ 3,5 (hưng phấn)",id:"MVRV Z ≥ 3,5 (euforia)",pl:"MVRV Z ≥ 3,5 (euforia)",it:"MVRV Z ≥ 3,5 (euforia)",ru:"MVRV Z ≥ 3,5 (эйфория)",zh:"MVRV Z ≥ 3.5（狂熱）"},
      {en:'NUPL ≥ 75% (extreme greed)',ko:'NUPL ≥ 75% (극단 탐욕)', ja:'NUPL ≥ 75% (極端な強欲)', es:'NUPL ≥ 75% (codicia extrema)', de:'NUPL ≥ 75% (extreme Gier)', done: ind.nupl>=0.75,fr:"NUPL ≥ 75% (avidité extrême)",pt:"NUPL ≥ 75% (ganância extrema)",tr:"NUPL ≥ %75 (aşırı açgözlülük)",vi:"NUPL ≥ 75% (tham lam cực độ)",id:"NUPL ≥ 75% (serakah ekstrem)",pl:"NUPL ≥ 75% (skrajna chciwość)",it:"NUPL ≥ 75% (avidità estrema)",ru:"NUPL ≥ 75% (крайняя жадность)",zh:"NUPL ≥ 75%（極度貪婪）"},
      {en:'Fear & Greed ≥ 80',ko:'공포·탐욕 ≥ 80', ja:'恐怖・強欲指数 ≥ 80', es:'Miedo y Codicia ≥ 80', de:'Angst & Gier ≥ 80', done: (ind.fear_greed||0)>=80,fr:"Peur & Avidité ≥ 80",pt:"Medo e Ganância ≥ 80",tr:"Korku & Açgözlülük ≥ 80",vi:"Sợ hãi & Tham lam ≥ 80",id:"Fear & Greed ≥ 80",pl:"Fear & Greed ≥ 80",it:"Fear & Greed ≥ 80",ru:"Fear & Greed ≥ 80",zh:"恐懼與貪婪 ≥ 80"},
      {en:'Futures contango ≥ 0.15%',ko:'선물 프리미엄 ≥ 0.15%', ja:'先物プレミアム ≥ 0.15%', es:'Contango de futuros ≥ 0.15%', de:'Futures-Contango ≥ 0,15%', done: ind.funding>=0.15,fr:"Contango futures ≥ 0,15%",pt:"Contango de futuros ≥ 0,15%",tr:"Vadeli contango ≥ %0,15",vi:"Contango tương lai ≥ 0,15%",id:"Contango futures ≥ 0,15%",pl:"Contango futures ≥ 0,15%",it:"Contango futures ≥ 0,15%",ru:"Contango фьючерсов ≥ 0,15%",zh:"期貨 Contango ≥ 0.15%"},
      {en:'Coinbase Premium ≥ 0.3%',ko:'Coinbase Premium ≥ 0.3%', ja:'Coinbaseプレミアム ≥ 0.3%', es:'Coinbase Premium ≥ 0.3%', de:'Coinbase Premium ≥ 0,3%', done: ind.cb_premium>=0.3,fr:"Coinbase Premium ≥ 0,3%",pt:"Coinbase Premium ≥ 0,3%",tr:"Coinbase Premium ≥ %0,3",vi:"Coinbase Premium ≥ 0,3%",id:"Coinbase Premium ≥ 0,3%",pl:"Coinbase Premium ≥ 0,3%",it:"Coinbase Premium ≥ 0,3%",ru:"Coinbase Premium ≥ 0,3%",zh:"Coinbase Premium ≥ 0.3%"},
    ];
    rows=triggers.map(t=>`
      <div class="trow ${t.done?'done':'pending'}">
        <span class="tnum">${t.done?'✓':'○'}</span>
...
function drawHistory() {
  ...
  if(sub){
    ...
    const pLabels={
      '1h': TT({ko:'최근 1시간',en:'Last 1h',ja:'直近1時間',es:'Última 1h',de:'Letzte 1 Std.',fr:'Dernière 1h',pt:'Última 1h',tr:'Son 1s',vi:'1g qua',id:"1j terakhir",pl:"Ostatnia 1h",it:"Ultima 1h",ru:"Последний 1ч",zh:"近 1 小時"}),
      '4h': TT({ko:'최근 4시간',en:'Last 4h',ja:'直近4時間',es:'Últimas 4h',de:'Letzte 4 Std.',fr:'Dernières 4h',pt:'Últimas 4h',tr:'Son 4s',vi:'4g qua',id:"4j terakhir",pl:"Ostatnie 4h",it:"Ultime 4h",ru:"Последние 4ч",zh:"近 4 小時"}),
      '6h': TT({ko:'최근 6시간',en:'Last 6h',ja:'直近6時間',es:'Últimas 6h',de:'Letzte 6 Std.',fr:'Dernières 6h',pt:'Últimas 6h',tr:'Son 6s',vi:'6g qua',id:"6j terakhir",pl:"Ostatnie 6h",it:"Ultime 6h",ru:"Последние 6ч",zh:"近 6 小時"}),
      '12h': TT({ko:'최근 12시간',en:'Last 12h',ja:'直近12時間',es:'Últimas 12h',de:'Letzte 12 Std.',fr:'Dernières 12h',pt:'Últimas 12h',tr:'Son 12s',vi:'12g qua',id:"12j terakhir",pl:"Ostatnie 12h",it:"Ultime 12h",ru:"Последние 12ч",zh:"近 12 小時"}),
      '1d': TT({ko:'최근 24시간',en:'Last 24h',ja:'直近24時間',es:'Últimas 24h',de:'Letzte 24 Std.',fr:'Dernières 24h',pt:'Últimas 24h',tr:'Son 24s',vi:'24g qua',id:"24j terakhir",pl:"Ostatnie 24h",it:"Ultime 24h",ru:"Последние 24ч",zh:"近 24 小時"}),
      '7d': TT({ko:'최근 7일',en:'Last 7d',ja:'直近7日間',es:'Últimos 7d',de:'Letzte 7 Tage',fr:'Derniers 7j',pt:'Últimos 7d',tr:'Son 7g',vi:'7n qua',id:"7h terakhir",pl:"Ostatnie 7 dni",it:"Ultimi 7g",ru:"Последние 7д",zh:"近 7 天"}),
      '30d': TT({ko:'최근 30일',en:'Last 30d',ja:'直近30日間',es:'Últimos 30d',de:'Letzte 30 Tage',fr:'Derniers 30j',pt:'Últimos 30d',tr:'Son 30g',vi:'30n qua',id:"30h terakhir",pl:"Ostatnie 30 dni",it:"Ultimi 30g",ru:"Последние 30д",zh:"近 30 天"}),
      'all': TT({ko:'전체',en:'All time',ja:'全期間',es:'Todo el tiempo',de:'Gesamter Zeitraum',fr:'Tout l\'historique',pt:'Todo o período',tr:'Tüm zamanlar',vi:'Toàn bộ',id:"Sepanjang waktu",pl:"Cały okres",it:"Sempre",ru:"За всё время",zh:"全期間"}),
    };
    sub.textContent=`${pLabels[histPeriod]||histPeriod} · ${data.length} ${TT({ko:'포인트',en:'points',ja:'ポイント',es:'puntos',de:'Punkte',fr:'points',pt:'pontos',tr:'puan',vi:'điểm',id:"poin",pl:"pkt",it:"punti",ru:"очков",zh:"分"})}`;
    // 통계 업데이트
    if(data.length > 0) {
      const scores = data.map(x=>x.s);
...
function attachHistoryHover() {
  ...
  function handleMove(clientX, clientY) {
    ...
    tScore.textContent = TT({ko:`점수 ${nearest.point.s.toFixed(2)}`,en:`Score ${nearest.point.s.toFixed(2)}`,ja:`スコア ${nearest.point.s.toFixed(2)}`,es:`Puntuación ${nearest.point.s.toFixed(2)}`,de:`Score ${nearest.point.s.toFixed(2)}`,fr:`Score ${nearest.point.s.toFixed(2)}`,pt:`Pontuação ${nearest.point.s.toFixed(2)}`,tr:`Puan ${nearest.point.s.toFixed(2)}`,vi:`Điểm ${nearest.point.s.toFixed(2)}`,id:`Skor ${nearest.point.s.toFixed(2)}`,pl:`Wynik ${nearest.point.s.toFixed(2)}`,it:`Punteggio ${nearest.point.s.toFixed(2)}`,ru:`Оценка ${nearest.point.s.toFixed(2)}`,zh:`分數 ${nearest.point.s.toFixed(2)}`});
...
async function requestNotif() {
  ...
  if(!('Notification' in window)) {
    if(statusEl) { statusEl.textContent = TT({ko:'이 브라우저는 알림을 지원하지 않습니다.',en:'This browser does not support notifications.',ja:'このブラウザは通知に対応していません。',es:'Este navegador no admite notificaciones.',de:'Dieser Browser unterstützt keine Benachrichtigungen.',fr:'Ce navigateur ne prend pas en charge les notifications.',pt:'Este navegador não suporta notificações.',tr:'Bu tarayıcı bildirimleri desteklemiyor.',vi:'Trình duyệt này không hỗ trợ thông báo.',id:"Browser ini tidak mendukung notifikasi.",pl:"Ta przeglądarka nie obsługuje powiadomień.",it:"Questo browser non supporta le notifiche.",ru:"Этот браузер не поддерживает уведомления.",zh:"此瀏覽器不支援通知。"}); statusEl.style.color='var(--red)'; }
    return;
  }
  try {
    ...
    if(statusEl) {
      if(notifGranted) { statusEl.textContent = TT({ko:'✓ 알림이 활성화되었습니다',en:'✓ Notifications enabled',ja:'✓ 通知が有効になりました',es:'✓ Notificaciones activadas',de:'✓ Benachrichtigungen aktiviert',fr:'✓ Notifications activées',pt:'✓ Notificações ativadas',tr:'✓ Bildirimler etkin',vi:'✓ Đã bật thông báo',id:"✓ Notifikasi diaktifkan",pl:"✓ Powiadomienia włączone",it:"✓ Notifiche attivate",ru:"✓ Уведомления включены",zh:"✓ 已啟用通知"}); statusEl.style.color='var(--green)'; }
      else { statusEl.textContent = TT({ko:'알림 권한이 거부되었습니다.',en:'Notification permission denied.',ja:'通知の許可が拒否されました。',es:'Permiso de notificación denegado.',de:'Benachrichtigungsberechtigung verweigert.',fr:'Autorisation de notification refusée.',pt:'Permissão de notificação negada.',tr:'Bildirim izni reddedildi.',vi:'Quyền thông báo bị từ chối.',id:"Izin notifikasi ditolak.",pl:"Odmówiono zgody na powiadomienia.",it:"Permesso notifiche negato.",ru:"Разрешение на уведомления отклонено.",zh:"通知權限遭拒。"}); statusEl.style.color='var(--red)'; }
    }
  } catch(e) {
    console.error('[notif] permission request failed:', e);
    if(statusEl) { statusEl.textContent = TT({ko:'알림 설정 중 오류 발생',en:'Error setting up notifications',ja:'通知設定中にエラーが発生しました',es:'Error al configurar notificaciones',de:'Fehler bei der Benachrichtigungseinrichtung',fr:'Erreur lors de la configuration des notifications',pt:'Erro ao configurar notificações',tr:'Bildirim ayarlanırken hata',vi:'Lỗi khi thiết lập thông báo',id:"Kesalahan menyiapkan notifikasi",pl:"Błąd konfiguracji powiadomień",it:"Errore nella configurazione delle notifiche",ru:"Ошибка настройки уведомлений",zh:"設定通知時發生錯誤"}); statusEl.style.color='var(--red)'; }
  }
}
...
async function loadAll() {
  ...
  try {
    ...
    document.getElementById('ovTxt').textContent=TT({ko:`${currentCoin} 데이터 불러오는 중...`,en:`Fetching ${currentCoin} data...`,ja:`${currentCoin} データ取得中...`,es:`Obteniendo datos de ${currentCoin}...`,de:`${currentCoin}-Daten werden geladen...`,fr:`Chargement des données ${currentCoin}...`,pt:`Carregando dados de ${currentCoin}...`,tr:`${currentCoin} verileri yükleniyor...`,vi:`Đang tải dữ liệu ${currentCoin}...`,id:`Mengambil data ${currentCoin}...`,pl:`Pobieranie danych ${currentCoin}...`,it:`Caricamento dati ${currentCoin}...`,ru:`Загрузка данных ${currentCoin}...`,zh:`正在載入 ${currentCoin} 資料...`});
...
function renderOnboardText(){
  ...
  if(isShort){
    txt.innerHTML = TT({
      ...
      de:'👋 <b>Neu hier?</b> Dieser Wert von 0–10 zeigt, wie gut das <b>Verkaufs-/Short-Timing (auf fallende Kurse setzen)</b> ist — höher ist besser. Er fasst die Indikatoren unten zusammen.',fr:'👋 <b>Nouveau ici ?</b> Ce score de 0 à 10 indique la qualité du <b>timing de vente / short (pari sur une baisse)</b> — plus c\'est haut, mieux c\'est. Il combine les indicateurs ci-dessous.',pt:'👋 <b>Novo por aqui?</b> Esta pontuação de 0 a 10 mostra a qualidade do <b>timing de venda / short (aposta na queda)</b> — quanto maior, melhor. Combina os indicadores abaixo.',tr:'👋 <b>Yeni misiniz?</b> Bu 0–10 puanı <b>satış / short (düşüşe bahis) zamanlamasının</b> ne kadar iyi olduğunu gösterir — yüksek olması daha iyi. Aşağıdaki göstergeleri birleştirir.',vi:'👋 <b>Mới ở đây?</b> Điểm 0–10 này cho biết <b>thời điểm bán / short (đặt cược giảm)</b> tốt đến đâu — càng cao càng tốt. Nó kết hợp các chỉ báo bên dưới.',id:"👋 <b>Baru di sini?</b> Skor 0–10 ini menunjukkan seberapa baik <b>timing jual / short (bertaruh turun)</b> — makin tinggi makin baik. Menggabungkan indikator di bawah.",pl:"👋 <b>Nowy tutaj?</b> Ten wynik 0–10 pokazuje, jak dobry jest <b>timing sprzedaży / short (zakład na spadek)</b> — im wyżej, tym lepiej. Łączy poniższe wskaźniki.",it:"👋 <b>Nuovo qui?</b> Questo punteggio 0–10 mostra quanto è buono il <b>timing di vendita / short (scommessa al ribasso)</b> — più alto è meglio. Combina gli indicatori sotto.",ru:"👋 <b>Впервые здесь?</b> Эта оценка 0–10 показывает, насколько хорош <b>тайминг продажи / шорта (ставка на падение)</b> — выше лучше. Она объединяет индикаторы ниже.",zh:"👋 <b>初次來訪？</b> 這個 0–10 分數顯示<b>賣出／做空（押注下跌）時機</b>有多好 — 越高越好。它結合下方指標。"
    });
  } else {
    txt.innerHTML = TT({
      ...
      de:'👋 <b>Neu hier?</b> Dieser Wert von 0–10 zeigt, wie gut das <b>Kauf-/Long-Timing (auf steigende Kurse setzen)</b> ist — höher ist besser. Er fasst die Indikatoren unten zusammen.',fr:'👋 <b>Nouveau ici ?</b> Ce score de 0 à 10 indique la qualité du <b>timing d\'achat / long (pari sur une hausse)</b> — plus c\'est haut, mieux c\'est. Il combine les indicateurs ci-dessous.',pt:'👋 <b>Novo por aqui?</b> Esta pontuação de 0 a 10 mostra a qualidade do <b>timing de compra / long (aposta na alta)</b> — quanto maior, melhor. Combina os indicadores abaixo.',tr:'👋 <b>Yeni misiniz?</b> Bu 0–10 puanı <b>alım / long (yükselişe bahis) zamanlamasının</b> ne kadar iyi olduğunu gösterir — yüksek olması daha iyi. Aşağıdaki göstergeleri birleştirir.',vi:'👋 <b>Mới ở đây?</b> Điểm 0–10 này cho biết <b>thời điểm mua / long (đặt cược tăng)</b> tốt đến đâu — càng cao càng tốt. Nó kết hợp các chỉ báo bên dưới.',id:"👋 <b>Baru di sini?</b> Skor 0–10 ini menunjukkan seberapa baik <b>timing beli / long (bertaruh naik)</b> — makin tinggi makin baik. Menggabungkan indikator di bawah.",pl:"👋 <b>Nowy tutaj?</b> Ten wynik 0–10 pokazuje, jak dobry jest <b>timing kupna / long (zakład na wzrost)</b> — im wyżej, tym lepiej. Łączy poniższe wskaźniki.",it:"👋 <b>Nuovo qui?</b> Questo punteggio 0–10 mostra quanto è buono il <b>timing di acquisto / long (scommessa al rialzo)</b> — più alto è meglio. Combina gli indicatori sotto.",ru:"👋 <b>Впервые здесь?</b> Эта оценка 0–10 показывает, насколько хорош <b>тайминг покупки / лонга (ставка на рост)</b> — выше лучше. Она объединяет индикаторы ниже.",zh:"👋 <b>初次來訪？</b> 這個 0–10 分數顯示<b>買進／做多（押注上漲）時機</b>有多好 — 越高越好。它結合下方指標。"
    });
  }
}
...
function renderBlogTicker() {
  ...
  if(label) label.textContent = TT({ko:'블로그:',en:'Blog:',ja:'ブログ:',es:'Blog:',de:'Blog:',fr:'Blog :',pt:'Blog:',tr:'Blog:',vi:'Blog:',id:"Blog:",pl:"Blog:",it:"Blog:",ru:"Блог:",zh:"部落格："});
  if(allLink) {
    allLink.textContent = TT({ko:'전체 보기 →',en:'View All →',ja:'全て見る →',es:'Ver Todo →',de:'Alle ansehen →',fr:'Voir tout →',pt:'Ver tudo →',tr:'Tümünü gör →',vi:'Xem tất cả →',id:"Lihat Semua →",pl:"Zobacz wszystko →",it:"Vedi tutto →",ru:"Смотреть все →",zh:"查看全部 →"});
...
function formatBlogCardDate(dateStr, lang) {
  ...
  const CONF = {
    ...
    vi: { tz:'Asia/Ho_Chi_Minh',  label:'ICT' },id:{ tz:'Asia/Jakarta', label:'WIB' },pl:{ tz:'Europe/Warsaw', label:null },it:{ tz:'Europe/Rome', label:null },ru:{ tz:'Europe/Moscow', label:'MSK' },zh:{ tz:'Asia/Taipei', label:null },
  };
...
function renderCategoryLinks() {
  ...
  const suffix = blogSuffix(currentLang);
  const label = document.getElementById('blogGuideLabel');
  if(label) label.textContent = TT({ko:'카테고리별 최신 글:',en:'Latest by Category:',ja:'カテゴリー別最新記事:',es:'Últimas por Categoría:',de:'Neueste nach Kategorie:',fr:'Derniers par catégorie :',pt:'Recentes por categoria:',tr:'Kategoriye göre son:',vi:'Mới nhất theo danh mục:',id:"Terbaru per Kategori:",pl:"Najnowsze wg Kategorii:",it:"Ultimi per Categoria:",ru:"Последнее по категориям:",zh:"各分類最新："});
...
function applyStaticI18n() {
  const ko = currentLang === 'ko';
  const allLbl = TT({ko:'전체',en:'All',ja:'全期間',es:'Todo',de:'Alle',fr:'Tout',pt:'Todos',tr:'Tümü',vi:'Tất cả',id:"Semua",pl:"Wszystko",it:"Tutti",ru:"Все",zh:"全部"});
...
function syncChatLang() {
  ...
  if(_chatTitle) _chatTitle.textContent = TT({ko:'실시간 채팅',en:'LIVE CHAT',ja:'ライブチャット',es:'CHAT EN VIVO',de:'LIVE-CHAT',fr:'CHAT EN DIRECT',pt:'CHAT AO VIVO',tr:'CANLI SOHBET',vi:'CHAT TRỰC TIẾP',id:"OBROLAN LANGSUNG",pl:"CZAT NA ŻYWO",it:"CHAT DAL VIVO",ru:"ЖИВОЙ ЧАТ",zh:"即時聊天"});
  const _chatInput = document.getElementById('chatInput');
  if(_chatInput) _chatInput.setAttribute('placeholder', TT({ko:'메시지 입력...',en:'Type a message...',ja:'メッセージを入力...',es:'Escribe un mensaje...',de:'Nachricht eingeben...',fr:'Écrivez un message...',pt:'Digite uma mensagem...',tr:'Mesaj yazın...',vi:'Nhập tin nhắn...',id:"Ketik pesan...",pl:"Napisz wiadomość...",it:"Scrivi un messaggio...",ru:"Введите сообщение...",zh:"輸入訊息..."}));
  const _chatSend = document.getElementById('chatSendBtn');
  if(_chatSend) _chatSend.textContent = TT({ko:'전송',en:'Send',ja:'送信',es:'Enviar',de:'Senden',fr:'Envoyer',pt:'Enviar',tr:'Gönder',vi:'Gửi',id:"Kirim",pl:"Wyślij",it:"Invia",ru:"Отправить",zh:"送出"});
  const _chatNick = document.getElementById('chatNickBtn');
  if(_chatNick) _chatNick.setAttribute('title', TT({ko:'닉네임 변경',en:'Change nickname',ja:'ニックネーム変更',es:'Cambiar apodo',de:'Spitznamen ändern',fr:'Changer de pseudo',pt:'Mudar apelido',tr:'Takma ad değiştir',vi:'Đổi biệt danh',id:"Ganti nama panggilan",pl:"Zmień pseudonim",it:"Cambia nickname",ru:"Сменить ник",zh:"變更暱稱"}));
}
// ═══════════════════════════════════════════════════════
...
function showChatError(detail) {
  ...
  if(msgsEl) {
    msgsEl.innerHTML = `<div style="text-align:center;color:var(--t3);font-size:11px;padding:20px;line-height:1.6">
      ${TT({ko:'채팅 서버 연결 실패.',en:'Chat server connection failed.',ja:'チャットサーバーへの接続に失敗しました。',es:'Falló la conexión al servidor de chat.',de:'Verbindung zum Chat-Server fehlgeschlagen.',fr:'Échec de connexion au serveur de chat.',pt:'Falha na conexão com o servidor de chat.',tr:'Sohbet sunucusu bağlantısı başarısız.',vi:'Kết nối máy chủ chat thất bại.',id:"Koneksi server obrolan gagal.",pl:"Połączenie z serwerem czatu nieudane.",it:"Connessione al server della chat fallita.",ru:"Не удалось подключиться к серверу чата.",zh:"聊天伺服器連線失敗。"})}<br>
...
function renderChatUserCount() {
  ...
  cEl.textContent = '· ' + TT({ko:`${count}명 접속중`, en:`${count} online`, ja:`${count}人 接続中`, es:`${count} en línea`, de:`${count} online`,fr:`${count} en ligne`,pt:`${count} online`,tr:`${count} çevrimiçi`,vi:`${count} trực tuyến`,id:`${count} daring`,pl:`${count} online`,it:`${count} online`,ru:`${count} онлайн`,zh:`${count} 人上線`});
}
...
function sendChatMsg() {
  ...
  chatDB.ref('messages').push({
    ...
    alert(TT({ko:'전송 실패: ',en:'Send failed: ',ja:'送信失敗: ',es:'Error al enviar: ',de:'Senden fehlgeschlagen: ',fr:'Échec de l\'envoi : ',pt:'Falha no envio: ',tr:'Gönderme başarısız: ',vi:'Gửi thất bại: ',id:"Gagal mengirim: ",pl:"Wysyłanie nieudane: ",it:"Invio fallito: ",ru:"Не удалось отправить: ",zh:"傳送失敗："}) + err.message);
  });
  input.value = '';
}
...
function promptNickname() {
  const newNick = prompt(TT({ko:'채팅 닉네임을 입력하세요:',en:'Enter your chat nickname:',ja:'チャットニックネームを入力してください:',es:'Ingresa tu apodo de chat:',de:'Gib deinen Chat-Spitznamen ein:',fr:'Entrez votre pseudo de chat :',pt:'Digite seu apelido no chat:',tr:'Sohbet takma adınızı girin:',vi:'Nhập biệt danh chat của bạn:',id:"Masukkan nama panggilan obrolan Anda:",pl:"Podaj swój pseudonim na czacie:",it:"Inserisci il tuo nickname per la chat:",ru:"Введите свой ник в чате:",zh:"請輸入你的聊天暱稱："}), chatNickname);
