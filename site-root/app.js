...
const SIGNAL_MAP = {
  "Above": {"ko": "위", "en": "Above", "ja": "上", "es": "Por Encima", "de": "Darüber", "pt": "Acima", "tr": "Üzerinde", "vi": "Trên"},
  "Accumulating": {"ko": "매집 중", "en": "Accumulating", "ja": "蓄積中", "es": "Acumulando", "de": "Akkumulierend", "pt": "Acumulando", "tr": "Biriktiriyor", "vi": "Đang tích lũy"},
  "Accumulation (Safe)": {"ko": "매집 구간 (안전)", "en": "Accumulation (Safe)", "ja": "蓄積ゾーン(安全)", "es": "Acumulación (Seguro)", "de": "Akkumulation (Sicher)", "pt": "Acumulação (Seguro)", "tr": "Biriktirme (Güvenli)", "vi": "Tích lũy (An toàn)"},
  "Alt Season Risk": {"ko": "알트시즌 리스크", "en": "Alt Season Risk", "ja": "アルトシーズンリスク", "es": "Riesgo Temporada Alt", "de": "Alt-Season-Risiko", "pt": "Risco Temporada Alt", "tr": "Alt Sezon Riski", "vi": "Rủi ro Mùa Alt"},
  "Alt Season": {"ko": "알트시즌", "en": "Alt Season", "ja": "アルトシーズン", "es": "Temporada Alt", "de": "Alt Season", "pt": "Temporada Alt", "tr": "Alt Sezon", "vi": "Mùa Alt"},
  "BTC Season (Safe)": {"ko": "BTC 시즌 (안전)", "en": "BTC Season (Safe)", "ja": "BTCシーズン(安全)", "es": "Temporada BTC (Seguro)", "de": "BTC-Season (Sicher)", "pt": "Temporada BTC (Seguro)", "tr": "BTC Sezonu (Güvenli)", "vi": "Mùa BTC (An toàn)"},
  "BTC Season": {"ko": "BTC 시즌", "en": "BTC Season", "ja": "BTCシーズン", "es": "Temporada BTC", "de": "BTC-Season", "pt": "Temporada BTC", "tr": "BTC Sezonu", "vi": "Mùa BTC"},
  "Backwardation (Safe)": {"ko": "백워데이션 (안전)", "en": "Backwardation (Safe)", "ja": "バックワーデーション(安全)", "es": "Backwardation (Seguro)", "de": "Backwardation (Sicher)", "pt": "Backwardation (Seguro)", "tr": "Backwardation (Güvenli)", "vi": "Backwardation (An toàn)"},
  "Below Realized (Safe)": {"ko": "실현가 이하 (안전)", "en": "Below Realized (Safe)", "ja": "実現価格以下(安全)", "es": "Bajo Realizado (Seguro)", "de": "Unter Realized (Sicher)", "pt": "Abaixo do Realizado (Seguro)", "tr": "Gerçekleşenin Altında (Güvenli)", "vi": "Dưới Thực hiện (An toàn)"},
  "Below Realized": {"ko": "실현가 이하", "en": "Below Realized", "ja": "実現価格以下", "es": "Bajo Realizado", "de": "Unter Realized", "pt": "Abaixo do Realizado", "tr": "Gerçekleşenin Altında", "vi": "Dưới Thực hiện"},
  "Borderline": {"ko": "경계선", "en": "Borderline", "ja": "境界線", "es": "Límite", "de": "Grenzwertig", "pt": "Limítrofe", "tr": "Sınırda", "vi": "Ranh giới"},
  "Buyer-led (Caution)": {"ko": "매수 주도 (주의)", "en": "Buyer-led (Caution)", "ja": "買い主導(注意)", "es": "Liderado por Compra (Precaución)", "de": "Käufergetrieben (Vorsicht)", "pt": "Liderado por Compra (Cautela)", "tr": "Alım Öncülüğünde (Dikkat)", "vi": "Do Mua dẫn dắt (Thận trọng)"},
  "Capitulation": {"ko": "항복", "en": "Capitulation", "ja": "キャピチュレーション", "es": "Capitulación", "de": "Kapitulation", "pt": "Capitulação", "tr": "Kapitülasyon", "vi": "Đầu hàng"},
  "Caution": {"ko": "주의", "en": "Caution", "ja": "注意", "es": "Precaución", "de": "Vorsicht", "pt": "Cautela", "tr": "Dikkat", "vi": "Thận trọng"},
  "Core Bottom Zone": {"ko": "핵심 저점 구간", "en": "Core Bottom Zone", "ja": "核心底値ゾーン", "es": "Zona Central de Suelo", "de": "Kern-Tiefzone", "pt": "Zona Central de Fundo", "tr": "Çekirdek Dip Bölgesi", "vi": "Vùng Đáy Cốt lõi"},
  "Correction": {"ko": "조정", "en": "Correction", "ja": "調整", "es": "Corrección", "de": "Korrektur", "pt": "Correção", "tr": "Düzeltme", "vi": "Điều chỉnh"},
  "Deep Correction": {"ko": "깊은 조정", "en": "Deep Correction", "ja": "深い調整", "es": "Corrección Profunda", "de": "Tiefe Korrektur", "pt": "Correção Profunda", "tr": "Derin Düzeltme", "vi": "Điều chỉnh Sâu"},
  "Distribution": {"ko": "분산", "en": "Distribution", "ja": "分配", "es": "Distribución", "de": "Distribution", "pt": "Distribuição", "tr": "Dağıtım", "vi": "Phân phối"},
  "Elevated": {"ko": "상승", "en": "Elevated", "ja": "上昇", "es": "Elevado", "de": "Erhöht", "pt": "Elevado", "tr": "Yükselmiş", "vi": "Tăng cao"},
  "Euphoria": {"ko": "도취", "en": "Euphoria", "ja": "陶酔", "es": "Euforia", "de": "Euphorie", "pt": "Euforia", "tr": "Öfori", "vi": "Hưng phấn"},
  "FOMO Buying": {"ko": "FOMO 매수", "en": "FOMO Buying", "ja": "FOMO買い", "es": "Compra por FOMO", "de": "FOMO-Kauf", "pt": "Compra por FOMO", "tr": "FOMO Alımı", "vi": "Mua theo FOMO"},
  "Far (Safe)": {"ko": "멀음 (안전)", "en": "Far (Safe)", "ja": "遠い(安全)", "es": "Lejos (Seguro)", "de": "Weit (Sicher)", "pt": "Longe (Seguro)", "tr": "Uzak (Güvenli)", "vi": "Xa (An toàn)"},
  "Far from ATH (Safe)": {"ko": "ATH와 멀음 (안전)", "en": "Far from ATH (Safe)", "ja": "ATHから遠い(安全)", "es": "Lejos del ATH (Seguro)", "de": "Weit vom ATH (Sicher)", "pt": "Longe do ATH (Seguro)", "tr": "ATH'den Uzak (Güvenli)", "vi": "Xa ATH (An toàn)"},
  "Fear (Safe)": {"ko": "공포 (안전)", "en": "Fear (Safe)", "ja": "恐怖(安全)", "es": "Miedo (Seguro)", "de": "Angst (Sicher)", "pt": "Medo (Seguro)", "tr": "Korku (Güvenli)", "vi": "Sợ hãi (An toàn)"},
  "Fear": {"ko": "공포", "en": "Fear", "ja": "恐怖", "es": "Miedo", "de": "Angst", "pt": "Medo", "tr": "Korku", "vi": "Sợ hãi"},
  "General": {"ko": "일반", "en": "General", "ja": "一般", "es": "General", "de": "Allgemein", "pt": "Geral", "tr": "Genel", "vi": "Chung"},
  "High": {"ko": "높음", "en": "High", "ja": "高い", "es": "Alto", "de": "Hoch", "pt": "Alto", "tr": "Yüksek", "vi": "Cao"},
  "Highly Correlated": {"ko": "높은 상관관계", "en": "Highly Correlated", "ja": "高い相関", "es": "Muy Correlacionado", "de": "Stark Korreliert", "pt": "Altamente Correlacionado", "tr": "Yüksek Korelasyonlu", "vi": "Tương quan Cao"},
  "Hope Bottom": {"ko": "희망 저점", "en": "Hope Bottom", "ja": "希望底値", "es": "Esperanza de Suelo", "de": "Hoffnung Boden", "pt": "Fundo de Esperança", "tr": "Umut Dibi", "vi": "Đáy Hy vọng"},
  "Hope": {"ko": "희망", "en": "Hope", "ja": "希望", "es": "Esperanza", "de": "Hoffnung", "pt": "Esperança", "tr": "Umut", "vi": "Hy vọng"},
  "Ideal": {"ko": "이상적", "en": "Ideal", "ja": "理想的", "es": "Ideal", "de": "Ideal", "pt": "Ideal", "tr": "İdeal", "vi": "Lý tưởng"},
  "Independent": {"ko": "독립적", "en": "Independent", "ja": "独立的", "es": "Independiente", "de": "Unabhängig", "pt": "Independente", "tr": "Bağımsız", "vi": "Độc lập"},
  "Institutional FOMO": {"ko": "기관 FOMO", "en": "Institutional FOMO", "ja": "機関FOMO", "es": "FOMO Institucional", "de": "Institutionelles FOMO", "pt": "FOMO Institucional", "tr": "Kurumsal FOMO", "vi": "FOMO Tổ chức"},
  "Long Overload": {"ko": "롱 과부하", "en": "Long Overload", "ja": "ロング過負荷", "es": "Sobrecarga de Largos", "de": "Long-Überlastung", "pt": "Sobrecarga de Longs", "tr": "Long Aşırı Yük", "vi": "Quá tải Long"},
  "Loss (Safe)": {"ko": "손실 (안전)", "en": "Loss (Safe)", "ja": "損失(安全)", "es": "Pérdida (Seguro)", "de": "Verlust (Sicher)", "pt": "Prejuízo (Seguro)", "tr": "Zarar (Güvenli)", "vi": "Lỗ (An toàn)"},
  "Low (Safe)": {"ko": "낮음 (안전)", "en": "Low (Safe)", "ja": "低い(安全)", "es": "Bajo (Seguro)", "de": "Niedrig (Sicher)", "pt": "Baixo (Seguro)", "tr": "Düşük (Güvenli)", "vi": "Thấp (An toàn)"},
  "Mid Range": {"ko": "중간 구간", "en": "Mid Range", "ja": "中間レンジ", "es": "Rango Medio", "de": "Mittlerer Bereich", "pt": "Faixa Média", "tr": "Orta Aralık", "vi": "Khoảng Giữa"},
  "Mild Buying": {"ko": "약한 매수", "en": "Mild Buying", "ja": "弱い買い", "es": "Compra Leve", "de": "Leichter Kauf", "pt": "Compra Leve", "tr": "Hafif Alım", "vi": "Mua Nhẹ"},
  "Mild Premium": {"ko": "약한 프리미엄", "en": "Mild Premium", "ja": "弱いプレミアム", "es": "Prima Leve", "de": "Leichte Prämie", "pt": "Prêmio Leve", "tr": "Hafif Prim", "vi": "Phần bù Nhẹ"},
  "Mild Profit": {"ko": "약한 수익", "en": "Mild Profit", "ja": "弱い利益", "es": "Ganancia Leve", "de": "Leichter Gewinn", "pt": "Lucro Leve", "tr": "Hafif Kar", "vi": "Lãi Nhẹ"},
  "Mild Selling": {"ko": "약한 매도", "en": "Mild Selling", "ja": "弱い売り", "es": "Venta Leve", "de": "Leichter Verkauf", "pt": "Venda Leve", "tr": "Hafif Satış", "vi": "Bán Nhẹ"},
  "Mild": {"ko": "약함", "en": "Mild", "ja": "弱い", "es": "Leve", "de": "Leicht", "pt": "Leve", "tr": "Hafif", "vi": "Nhẹ"},
  "Moderate": {"ko": "보통", "en": "Moderate", "ja": "中程度", "es": "Moderado", "de": "Moderat", "pt": "Moderado", "tr": "Orta", "vi": "Vừa phải"},
  "Near ATH": {"ko": "ATH 근접", "en": "Near ATH", "ja": "ATH近接", "es": "Cerca del ATH", "de": "Nahe ATH", "pt": "Perto do ATH", "tr": "ATH'ye Yakın", "vi": "Gần ATH"},
  "Near Bottom": {"ko": "저점 근접", "en": "Near Bottom", "ja": "底値近接", "es": "Cerca del Suelo", "de": "Nahe Boden", "pt": "Perto do Fundo", "tr": "Dibe Yakın", "vi": "Gần Đáy"},
  "Neutral": {"ko": "중립", "en": "Neutral", "ja": "中立", "es": "Neutral", "de": "Neutral", "pt": "Neutro", "tr": "Nötr", "vi": "Trung lập"},
  "Normal": {"ko": "정상", "en": "Normal", "ja": "正常", "es": "Normal", "de": "Normal", "pt": "Normal", "tr": "Normal", "vi": "Bình thường"},
  "Optimism": {"ko": "낙관", "en": "Optimism", "ja": "楽観", "es": "Optimismo", "de": "Optimismus", "pt": "Otimismo", "tr": "İyimserlik", "vi": "Lạc quan"},
  "Out of Range": {"ko": "범위 밖", "en": "Out of Range", "ja": "範囲外", "es": "Fuera de Rango", "de": "Außerhalb des Bereichs", "pt": "Fora da Faixa", "tr": "Aralık Dışı", "vi": "Ngoài Khoảng"},
  "Overbought (Top)": {"ko": "과매수 (고점)", "en": "Overbought (Top)", "ja": "買われすぎ(天井)", "es": "Sobrecompra (Techo)", "de": "Überkauft (Top)", "pt": "Sobrecompra (Topo)", "tr": "Aşırı Alım (Tepe)", "vi": "Quá mua (Đỉnh)"},
  "Overbought": {"ko": "과매수", "en": "Overbought", "ja": "買われすぎ", "es": "Sobrecompra", "de": "Überkauft", "pt": "Sobrecompra", "tr": "Aşırı Alım", "vi": "Quá mua"},
  "Overheated": {"ko": "과열", "en": "Overheated", "ja": "過熱", "es": "Sobrecalentado", "de": "Überhitzt", "pt": "Sobreaquecido", "tr": "Aşırı Isınmış", "vi": "Quá nóng"},
  "Oversold (Bottom)": {"ko": "과매도 (저점)", "en": "Oversold (Bottom)", "ja": "売られすぎ(底値)", "es": "Sobreventa (Suelo)", "de": "Überverkauft (Boden)", "pt": "Sobrevenda (Fundo)", "tr": "Aşırı Satım (Dip)", "vi": "Quá bán (Đáy)"},
  "Oversold": {"ko": "과매도", "en": "Oversold", "ja": "売られすぎ", "es": "Sobreventa", "de": "Überverkauft", "pt": "Sobrevenda", "tr": "Aşırı Satım", "vi": "Quá bán"},
  "Overvalued": {"ko": "고평가", "en": "Overvalued", "ja": "過大評価", "es": "Sobrevalorado", "de": "Überbewertet", "pt": "Sobrevalorizado", "tr": "Aşırı Değerli", "vi": "Định giá cao"},
  "Past Peak": {"ko": "고점 지남", "en": "Past Peak", "ja": "ピーク超過", "es": "Pasado el Pico", "de": "Über dem Höhepunkt", "pt": "Após o Pico", "tr": "Zirveyi Geçmiş", "vi": "Qua Đỉnh"},
  "Peak Zone": {"ko": "고점 구간", "en": "Peak Zone", "ja": "ピークゾーン", "es": "Zona de Pico", "de": "Höchststand-Zone", "pt": "Zona de Pico", "tr": "Zirve Bölgesi", "vi": "Vùng Đỉnh"},
  "Record Accumulation": {"ko": "역대급 매집", "en": "Record Accumulation", "ja": "記録的な蓄積", "es": "Acumulación Récord", "de": "Rekord-Akkumulation", "pt": "Acumulação Recorde", "tr": "Rekor Biriktirme", "vi": "Tích lũy Kỷ lục"},
  "Rising/Bottom": {"ko": "상승/저점", "en": "Rising/Bottom", "ja": "上昇/底値", "es": "Subiendo/Suelo", "de": "Steigend/Boden", "pt": "Subindo/Fundo", "tr": "Yükseliyor/Dip", "vi": "Tăng/Đáy"},
  "Seller-led (Safe)": {"ko": "매도 주도 (안전)", "en": "Seller-led (Safe)", "ja": "売り主導(安全)", "es": "Liderado por Venta (Seguro)", "de": "Verkäufergetrieben (Sicher)", "pt": "Liderado por Venda (Seguro)", "tr": "Satış Öncülüğünde (Güvenli)", "vi": "Do Bán dẫn dắt (An toàn)"},
  "Sideline (Safe)": {"ko": "관망 (안전)", "en": "Sideline (Safe)", "ja": "様子見(安全)", "es": "Al Margen (Seguro)", "de": "Abseits (Sicher)", "pt": "À Margem (Seguro)", "tr": "Kenarda (Güvenli)", "vi": "Đứng ngoài (An toàn)"},
  "Strong": {"ko": "강함", "en": "Strong", "ja": "強い", "es": "Fuerte", "de": "Stark", "pt": "Forte", "tr": "Güçlü", "vi": "Mạnh"},
  "Target Zone": {"ko": "목표 구간", "en": "Target Zone", "ja": "目標ゾーン", "es": "Zona Objetivo", "de": "Zielzone", "pt": "Zona Alvo", "tr": "Hedef Bölge", "vi": "Vùng Mục tiêu"},
  "Transitioning": {"ko": "전환 중", "en": "Transitioning", "ja": "転換中", "es": "Transición", "de": "Übergang", "pt": "Em Transição", "tr": "Geçiş Halinde", "vi": "Đang chuyển tiếp"},
  "Volume Dry-up": {"ko": "거래량 고갈", "en": "Volume Dry-up", "ja": "出来高枯渇", "es": "Volumen Agotado", "de": "Volumen versiegt", "pt": "Volume Esgotado", "tr": "Hacim Kuruması", "vi": "Cạn Khối lượng"},
  "Volume Spike": {"ko": "거래량 급증", "en": "Volume Spike", "ja": "出来高急増", "es": "Pico de Volumen", "de": "Volumenspike", "pt": "Pico de Volume", "tr": "Hacim Sıçraması", "vi": "Đột biến Khối lượng"},
  "Weak": {"ko": "약함", "en": "Weak", "ja": "弱い", "es": "Débil", "de": "Schwach", "pt": "Fraco", "tr": "Zayıf", "vi": "Yếu"},
};
const TARGET_MAP = {
  "12~24mo before = bottom zone": {"ko": "반감기 12~24개월 전 = 저점 구간", "en": "12~24mo before = bottom zone", "ja": "半減期12〜24ヶ月前 = 底値ゾーン", "es": "12-24 meses antes = zona de suelo", "de": "12-24 Monate vorher = Tiefzone", "pt": "12-24 meses antes = zona de fundo", "tr": "Yarılanmadan 12-24 ay önce = dip bölgesi", "vi": "12~24 tháng trước = vùng đáy"},
  "55~63% BTC season": {"ko": "55~63% BTC 시즌", "en": "55~63% BTC season", "ja": "55~63% BTCシーズン", "es": "55-63% temporada BTC", "de": "55-63% BTC-Season", "pt": "55-63% temporada BTC", "tr": "55-63% BTC sezonu", "vi": "55~63% mùa BTC"},
  "Alt season ≤ 50%": {"ko": "알트시즌 ≤ 50%", "en": "Alt season ≤ 50%", "ja": "アルトシーズン ≤ 50%", "es": "Temporada alt ≤ 50%", "de": "Alt-Season ≤ 50%", "pt": "Temporada alt ≤ 50%", "tr": "Alt sezon ≤ 50%", "vi": "Mùa alt ≤ 50%"},
  "Backwardation = short squeeze signal": {"ko": "백워데이션 = 숏스퀴즈 신호", "en": "Backwardation = short squeeze signal", "ja": "バックワーデーション = ショートスクイーズシグナル", "es": "Backwardation = señal de short squeeze", "de": "Backwardation = Short-Squeeze-Signal", "pt": "Backwardation = sinal de short squeeze", "tr": "Backwardation = short squeeze sinyali", "vi": "Backwardation = tín hiệu short squeeze"},
  "Below estimated realized price": {"ko": "추정 실현가 이하", "en": "Below estimated realized price", "ja": "推定実現価格以下", "es": "Bajo el precio realizado estimado", "de": "Unter geschätztem Realized Price", "pt": "Abaixo do preço realizado estimado", "tr": "Tahmini gerçekleşen fiyatın altında", "vi": "Dưới giá thực hiện ước tính"},
  "Bottom zone ≤ 0": {"ko": "저점 구간 ≤ 0", "en": "Bottom zone ≤ 0", "ja": "底値ゾーン ≤ 0", "es": "Zona de suelo ≤ 0", "de": "Tiefzone ≤ 0", "pt": "Zona de fundo ≤ 0", "tr": "Dip bölgesi ≤ 0", "vi": "Vùng đáy ≤ 0"},
  "Buy ratio ≥ 65% + volume spike + green candle (last 15m)": {"ko": "매수 비율 ≥ 65% + 거래량 급증 + 양봉 (최근 15분)", "en": "Buy ratio ≥ 65% + volume spike + green candle (last 15m)", "ja": "買い比率 ≥ 65% + 出来高急増 + 陽線(直近15分)", "es": "Ratio de compra ≥ 65% + pico de volumen + vela verde (últimos 15m)", "de": "Kaufquote ≥ 65% + Volumenspike + grüne Kerze (letzte 15m)", "pt": "Proporção de compra ≥ 65% + pico de volume + vela verde (últimos 15m)", "tr": "Alım oranı ≥ 65% + hacim sıçraması + yeşil mum (son 15d)", "vi": "Tỷ lệ mua ≥ 65% + đột biến khối lượng + nến xanh (15p qua)"},
  "Capitulation ≤0.95": {"ko": "항복 ≤0.95", "en": "Capitulation ≤0.95", "ja": "キャピチュレーション ≤0.95", "es": "Capitulación ≤0.95", "de": "Kapitulation ≤0,95", "pt": "Capitulação ≤0,95", "tr": "Kapitülasyon ≤0,95", "vi": "Đầu hàng ≤0,95"},
  "Fear zone ≤ 0%": {"ko": "공포 구간 ≤ 0%", "en": "Fear zone ≤ 0%", "ja": "恐怖ゾーン ≤ 0%", "es": "Zona de miedo ≤ 0%", "de": "Angstzone ≤ 0%", "pt": "Zona de medo ≤ 0%", "tr": "Korku bölgesi ≤ 0%", "vi": "Vùng sợ hãi ≤ 0%"},
  "High correlation = follows BTC weakness": {"ko": "높은 상관관계 = BTC 약세 추종", "en": "High correlation = follows BTC weakness", "ja": "高い相関 = BTCの弱さに追従", "es": "Alta correlación = sigue la debilidad de BTC", "de": "Hohe Korrelation = folgt BTC-Schwäche", "pt": "Alta correlação = segue a fraqueza do BTC", "tr": "Yüksek korelasyon = BTC zayıflığını izler", "vi": "Tương quan cao = theo điểm yếu BTC"},
  "High dominance = strong network": {"ko": "높은 도미넌스 = 강한 네트워크", "en": "High dominance = strong network", "ja": "高いドミナンス = 強いネットワーク", "es": "Alta dominancia = red fuerte", "de": "Hohe Dominanz = starkes Netzwerk", "pt": "Alta dominância = rede forte", "tr": "Yüksek dominans = güçlü ağ", "vi": "Thống trị cao = mạng mạnh"},
  "Low correlation = independent strength": {"ko": "낮은 상관관계 = 독자적 강세", "en": "Low correlation = independent strength", "ja": "低い相関 = 独自の強さ", "es": "Baja correlación = fortaleza independiente", "de": "Niedrige Korrelation = unabhängige Stärke", "pt": "Baixa correlação = força independente", "tr": "Düşük korelasyon = bağımsız güç", "vi": "Tương quan thấp = sức mạnh độc lập"},
  "Overbought ≥ 70": {"ko": "과매수 ≥ 70", "en": "Overbought ≥ 70", "ja": "買われすぎ ≥ 70", "es": "Sobrecompra ≥ 70", "de": "Überkauft ≥ 70", "pt": "Sobrecompra ≥ 70", "tr": "Aşırı alım ≥ 70", "vi": "Quá mua ≥ 70"},
  "Oversold ≤ 30": {"ko": "과매도 ≤ 30", "en": "Oversold ≤ 30", "ja": "売られすぎ ≤ 30", "es": "Sobreventa ≤ 30", "de": "Überverkauft ≤ 30", "pt": "Sobrevenda ≤ 30", "tr": "Aşırı satım ≤ 30", "vi": "Quá bán ≤ 30"},
  "Positive = institutional re-entry": {"ko": "양수 = 기관 재진입", "en": "Positive = institutional re-entry", "ja": "プラス = 機関再参入", "es": "Positivo = reingreso institucional", "de": "Positiv = institutioneller Wiedereinstieg", "pt": "Positivo = reentrada institucional", "tr": "Pozitif = kurumsal yeniden giriş", "vi": "Dương = tổ chức quay lại"},
  "Recovery cross (30MA>60MA)": {"ko": "회복 전환 (30MA>60MA)", "en": "Recovery cross (30MA>60MA)", "ja": "回復転換 (30MA>60MA)", "es": "Cruce de recuperación (30MA>60MA)", "de": "Erholungscross (30MA>60MA)", "pt": "Cruzamento de recuperação (30MA>60MA)", "tr": "Toparlanma kesişimi (30HO>60HO)", "vi": "Giao cắt phục hồi (30MA>60MA)"},
  "SHORT optimal: 12–18 months after halving": {"ko": "숏 최적: 반감기 후 12~18개월", "en": "SHORT optimal: 12–18 months after halving", "ja": "ショート最適: 半減期後12〜18ヶ月", "es": "Óptimo CORTO: 12-18 meses tras el halving", "de": "SHORT optimal: 12-18 Monate nach Halving", "pt": "SHORT ótimo: 12-18 meses após o halving", "tr": "SHORT optimal: yarılanmadan 12-18 ay sonra", "vi": "SHORT tối ưu: 12-18 tháng sau halving"},
  "SHORT zone > -20%": {"ko": "숏 구간 > -20%", "en": "SHORT zone > -20%", "ja": "ショートゾーン > -20%", "es": "Zona CORTO > -20%", "de": "SHORT-Zone > -20%", "pt": "Zona SHORT > -20%", "tr": "SHORT bölgesi > -20%", "vi": "Vùng SHORT > -20%"},
  "SHORT zone ≤ 50%": {"ko": "숏 구간 ≤ 50%", "en": "SHORT zone ≤ 50%", "ja": "ショートゾーン ≤ 50%", "es": "Zona CORTO ≤ 50%", "de": "SHORT-Zone ≤ 50%", "pt": "Zona SHORT ≤ 50%", "tr": "SHORT bölgesi ≤ 50%", "vi": "Vùng SHORT ≤ 50%"},
  "SHORT zone ≤ 70%": {"ko": "숏 구간 ≤ 70%", "en": "SHORT zone ≤ 70%", "ja": "ショートゾーン ≤ 70%", "es": "Zona CORTO ≤ 70%", "de": "SHORT-Zone ≤ 70%", "pt": "Zona SHORT ≤ 70%", "tr": "SHORT bölgesi ≤ 70%", "vi": "Vùng SHORT ≤ 70%"},
  "SHORT zone ≥ 0.10%": {"ko": "숏 구간 ≥ 0.10%", "en": "SHORT zone ≥ 0.10%", "ja": "ショートゾーン ≥ 0.10%", "es": "Zona CORTO ≥ 0.10%", "de": "SHORT-Zone ≥ 0,10%", "pt": "Zona SHORT ≥ 0,10%", "tr": "SHORT bölgesi ≥ 0,10%", "vi": "Vùng SHORT ≥ 0,10%"},
  "SHORT zone ≥ 0.15%": {"ko": "숏 구간 ≥ 0.15%", "en": "SHORT zone ≥ 0.15%", "ja": "ショートゾーン ≥ 0.15%", "es": "Zona CORTO ≥ 0.15%", "de": "SHORT-Zone ≥ 0,15%", "pt": "Zona SHORT ≥ 0,15%", "tr": "SHORT bölgesi ≥ 0,15%", "vi": "Vùng SHORT ≥ 0,15%"},
  "SHORT zone ≥ 1.04": {"ko": "숏 구간 ≥ 1.04", "en": "SHORT zone ≥ 1.04", "ja": "ショートゾーン ≥ 1.04", "es": "Zona CORTO ≥ 1.04", "de": "SHORT-Zone ≥ 1,04", "pt": "Zona SHORT ≥ 1,04", "tr": "SHORT bölgesi ≥ 1,04", "vi": "Vùng SHORT ≥ 1,04"},
  "SHORT zone ≥ 20% above realized": {"ko": "숏 구간: 실현가 대비 20% 이상", "en": "SHORT zone ≥ 20% above realized", "ja": "ショートゾーン: 実現価格比20%以上", "es": "Zona CORTO: 20% o más sobre el realizado", "de": "SHORT-Zone: 20%+ über Realized", "pt": "Zona SHORT: 20% ou mais acima do realizado", "tr": "SHORT bölgesi: gerçekleşenin %20+ üstünde", "vi": "Vùng SHORT: 20%+ trên thực hiện"},
  "SHORT zone ≥ 3.5": {"ko": "숏 구간 ≥ 3.5", "en": "SHORT zone ≥ 3.5", "ja": "ショートゾーン ≥ 3.5", "es": "Zona CORTO ≥ 3.5", "de": "SHORT-Zone ≥ 3,5", "pt": "Zona SHORT ≥ 3,5", "tr": "SHORT bölgesi ≥ 3,5", "vi": "Vùng SHORT ≥ 3,5"},
  "SHORT zone ≥ 60%": {"ko": "숏 구간 ≥ 60%", "en": "SHORT zone ≥ 60%", "ja": "ショートゾーン ≥ 60%", "es": "Zona CORTO ≥ 60%", "de": "SHORT-Zone ≥ 60%", "pt": "Zona SHORT ≥ 60%", "tr": "SHORT bölgesi ≥ 60%", "vi": "Vùng SHORT ≥ 60%"},
  "SHORT zone: within -15% of ATH": {"ko": "숏 구간: ATH 대비 -15% 이내", "en": "SHORT zone: within -15% of ATH", "ja": "ショートゾーン: ATH比-15%以内", "es": "Zona CORTO: dentro de -15% del ATH", "de": "SHORT-Zone: innerhalb -15% vom ATH", "pt": "Zona SHORT: dentro de -15% do ATH", "tr": "SHORT bölgesi: ATH'nin -15% içinde", "vi": "Vùng SHORT: trong -15% của ATH"},
  "Sell ratio ≥ 58% + volume spike + red candle (last 15m)": {"ko": "매도 비율 ≥ 58% + 거래량 급증 + 음봉 (최근 15분)", "en": "Sell ratio ≥ 58% + volume spike + red candle (last 15m)", "ja": "売り比率 ≥ 58% + 出来高急増 + 陰線(直近15分)", "es": "Ratio de venta ≥ 58% + pico de volumen + vela roja (últimos 15m)", "de": "Verkaufsquote ≥ 58% + Volumenspike + rote Kerze (letzte 15m)", "pt": "Proporção de venda ≥ 58% + pico de volume + vela vermelha (últimos 15m)", "tr": "Satış oranı ≥ 58% + hacim sıçraması + kırmızı mum (son 15d)", "vi": "Tỷ lệ bán ≥ 58% + đột biến khối lượng + nến đỏ (15p qua)"},
  "Volume spike near highs = distribution (selling) signal": {"ko": "고점 근처 거래량 급증 = 분산(매도) 신호", "en": "Volume spike near highs = distribution (selling) signal", "ja": "高値近くの出来高急増 = 分配(売り)シグナル", "es": "Pico de volumen cerca de máximos = señal de distribución (venta)", "de": "Volumenspike nahe Hochs = Distributionssignal (Verkauf)", "pt": "Pico de volume perto de máximas = sinal de distribuição (venda)", "tr": "Tepelere yakın hacim sıçraması = dağıtım (satış) sinyali", "vi": "Đột biến khối lượng gần đỉnh = tín hiệu phân phối (bán)"},
  "Volume spike near lows = capitulation-to-rebound signal": {"ko": "저점 근처 거래량 급증 = 항복 후 반등 신호", "en": "Volume spike near lows = capitulation-to-rebound signal", "ja": "安値近くの出来高急増 = キャピチュレーション後反発シグナル", "es": "Pico de volumen cerca de mínimos = señal de capitulación a rebote", "de": "Volumenspike nahe Tiefs = Kapitulations-zu-Rebound-Signal", "pt": "Pico de volume perto de mínimas = sinal de capitulação para recuperação", "tr": "Diplere yakın hacim sıçraması = kapitülasyondan toparlanmaya sinyali", "vi": "Đột biến khối lượng gần đáy = tín hiệu đầu hàng-hồi phục"},
  "≤5% or below": {"ko": "≤5% 이하", "en": "≤5% or below", "ja": "≤5%以下", "es": "≤5% o menos", "de": "≤5% oder darunter", "pt": "≤5% ou menos", "tr": "≤5% veya altı", "vi": "≤5% hoặc thấp hơn"},
  "≥70% drawdown from ATH": {"ko": "ATH 대비 ≥70% 하락", "en": "≥70% drawdown from ATH", "ja": "ATH比≥70%下落", "es": "≥70% de caída desde el ATH", "de": "≥70% Drawdown vom ATH", "pt": "≥70% de queda desde o ATH", "tr": "ATH'den ≥70% düşüş", "vi": "≥70% sụt giảm từ ATH"},
  "≥75% whale accumulation": {"ko": "≥75% 고래 매집", "en": "≥75% whale accumulation", "ja": "≥75%クジラ蓄積", "es": "≥75% acumulación de ballenas", "de": "≥75% Wal-Akkumulation", "pt": "≥75% acumulação de baleias", "tr": "≥75% balina biriktirmesi", "vi": "≥75% cá voi tích lũy"},
};
...
const TICKER_CURRENCY_MAP = {ko:'KRW', en:'USD', ja:'JPY', es:'EUR', de:'EUR', pt:'BRL', tr:'TRY', vi:'VND'};
...
function drawHistory() {
  ...
  const TZ = {ko:'Asia/Seoul', ja:'Asia/Tokyo', en:'America/New_York', es:'Europe/Madrid', de:'Europe/Berlin', pt:'America/Sao_Paulo', tr:'Europe/Istanbul', vi:'Asia/Ho_Chi_Minh'};
...
function attachHistoryHover() {
  ...
  function handleMove(clientX, clientY) {
    ...
    const shortR = ['1h','4h','6h','12h','1d'].includes(histPeriod);
    const dLoc = SUPPORTED_LANG_CODES.includes(currentLang) ? currentLang : 'en';
    const TZ2 = {ko:'Asia/Seoul', ja:'Asia/Tokyo', en:'America/New_York', es:'Europe/Madrid', de:'Europe/Berlin', pt:'America/Sao_Paulo', tr:'Europe/Istanbul', vi:'Asia/Ho_Chi_Minh'};
