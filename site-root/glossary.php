...
// ── 다국어 UI 라벨 ──
$CAT_LABEL = [
  'onchain'       => ['ko'=>'온체인 밸류에이션','en'=>'On-Chain Valuation','ja'=>'オンチェーン評価','es'=>'Valoración On-Chain','de'=>'On-Chain-Bewertung','fr'=>'Valorisation On-Chain','pt'=>'Avaliação On-Chain','tr'=>'Zincir Üstü Değerleme','vi'=>'Định giá On-Chain','id'=>'Valuasi On-Chain','pl'=>'Wycena On-Chain','it'=>'Valutazione On-Chain','ru'=>'On-Chain оценка','zh'=>'鏈上估值'],
  'miner'         => ['ko'=>'채굴·심리','en'=>'Miner / Sentiment','ja'=>'マイナー・センチメント','es'=>'Minería / Sentimiento','de'=>'Miner / Sentiment','fr'=>'Mineurs / Sentiment','pt'=>'Mineração / Sentimento','tr'=>'Madenci / Duyarlılık','vi'=>'Thợ đào / Tâm lý','id'=>'Penambang / Sentimen','pl'=>'Górnicy / Sentyment','it'=>'Miner / Sentiment','ru'=>'Майнеры / Настроения','zh'=>'礦工／情緒'],
  ...
  'cycle'         => ['ko'=>'사이클 위치','en'=>'Cycle Position','ja'=>'サイクル位置','es'=>'Posición del Ciclo','de'=>'Zyklusposition','fr'=>'Position du cycle','pt'=>'Posição do Ciclo','tr'=>'Döngü Konumu','vi'=>'Vị trí chu kỳ','id'=>'Posisi Siklus','pl'=>'Pozycja Cyklu','it'=>'Posizione del Ciclo','ru'=>'Позиция цикла','zh'=>'週期位置'],
  'altcoin'       => ['ko'=>'알트코인 지표','en'=>'Altcoin Metrics','ja'=>'アルトコイン指標','es'=>'Métricas de Altcoins','de'=>'Altcoin-Metriken','fr'=>'Indicateurs Altcoins','pt'=>'Métricas de Altcoins','tr'=>'Altcoin Metrikleri','vi'=>'Chỉ số Altcoin','id'=>'Metrik Altcoin','pl'=>'Metryki Altcoinów','it'=>'Metriche Altcoin','ru'=>'Метрики альткоинов','zh'=>'山寨幣指標'],
];
...
$TITLE_PAT = ['ko'=>'%s란? 뜻과 활용법','en'=>'What is %s? Meaning & How to Use','ja'=>'%sとは？意味と使い方','es'=>'¿Qué es %s? Significado y uso','de'=>'Was ist %s? Bedeutung & Nutzung','fr'=>'Qu\'est-ce que %s ? Signification et usage','pt'=>'O que é %s? Significado e uso','tr'=>'%s nedir? Anlamı ve kullanımı','vi'=>'%s là gì? Ý nghĩa và cách dùng','id'=>'Apa itu %s? Arti & Cara Pakai','pl'=>'Czym jest %s? Znaczenie i zastosowanie','it'=>'Cos\'è %s? Significato e uso','ru'=>'Что такое %s? Значение и применение','zh'=>'%s 是什麼？意義與用法'];
$HUB_TITLE = ['ko'=>'비트코인 온체인 지표 용어사전','en'=>'Bitcoin On-Chain Indicator Glossary','ja'=>'ビットコイン・オンチェーン指標用語集','es'=>'Glosario de Indicadores On-Chain de Bitcoin','de'=>'Bitcoin On-Chain-Indikator-Glossar','fr'=>'Glossaire des indicateurs on-chain Bitcoin','pt'=>'Glossário de Indicadores On-Chain do Bitcoin','tr'=>'Bitcoin Zincir Üstü Gösterge Sözlüğü','vi'=>'Từ điển chỉ báo on-chain Bitcoin','id'=>'Glosarium Indikator On-Chain Bitcoin','pl'=>'Słownik wskaźników on-chain Bitcoina','it'=>'Glossario degli Indicatori On-Chain di Bitcoin','ru'=>'Глоссарий on-chain индикаторов Bitcoin','zh'=>'比特幣鏈上指標術語表'];
$HUB_DESC = ['ko'=>'MVRV, NUPL, SOPR, 해시리본 등 비트코인 온체인 지표를 시각화와 실시간 값으로 쉽게 설명합니다. 각 지표의 뜻과 매수·매도 타이밍 활용법을 정리했습니다.','en'=>'Bitcoin on-chain indicators like MVRV, NUPL, SOPR, and Hash Ribbon explained with visuals and live values — what each means and how to use it for buy/sell timing.','ja'=>'MVRV、NUPL、SOPR、ハッシュリボンなどのビットコイン・オンチェーン指標を視覚化とリアルタイム値でわかりやすく解説。各指標の意味と売買タイミングへの活用法をまとめました。','es'=>'Indicadores on-chain de Bitcoin como MVRV, NUPL, SOPR y Hash Ribbon explicados con visuales y valores en vivo: qué significan y cómo usarlos para el timing de compra/venta.','de'=>'Bitcoin-On-Chain-Indikatoren wie MVRV, NUPL, SOPR und Hash Ribbon mit Grafiken und Live-Werten erklärt — was sie bedeuten und wie man sie für das Kauf-/Verkaufs-Timing nutzt.','fr'=>'Les indicateurs on-chain du Bitcoin comme MVRV, NUPL, SOPR et Hash Ribbon expliqués avec des visuels et des valeurs en direct : leur signification et leur usage pour le timing d\'achat/vente.','pt'=>'Indicadores on-chain do Bitcoin como MVRV, NUPL, SOPR e Hash Ribbon explicados com visuais e valores ao vivo — o que significam e como usá-los para o timing de compra/venda.','tr'=>'MVRV, NUPL, SOPR ve Hash Ribbon gibi Bitcoin zincir üstü göstergeleri görseller ve canlı değerlerle açıklanır — ne anlama geldikleri ve alım/satım zamanlamasında nasıl kullanılacağı.','vi'=>'Các chỉ báo on-chain của Bitcoin như MVRV, NUPL, SOPR và Hash Ribbon được giải thích bằng hình ảnh và giá trị trực tiếp — ý nghĩa và cách dùng để canh thời điểm mua/bán.','id'=>'Indikator on-chain Bitcoin seperti MVRV, NUPL, SOPR, dan Hash Ribbon dijelaskan dengan visual dan nilai langsung — arti masing-masing dan cara memakainya untuk timing beli/jual.','pl'=>'Wskaźniki on-chain Bitcoina jak MVRV, NUPL, SOPR i Hash Ribbon wyjaśnione za pomocą wizualizacji i wartości na żywo — co oznaczają i jak używać ich do timingu kupna/sprzedaży.','it'=>'Indicatori on-chain di Bitcoin come MVRV, NUPL, SOPR e Hash Ribbon spiegati con grafici e valori dal vivo — cosa significano e come usarli per il timing di acquisto/vendita.','ru'=>'On-chain индикаторы Bitcoin — MVRV, NUPL, SOPR и Hash Ribbon — объяснены с помощью визуализаций и значений в реальном времени: что означает каждый и как использовать для тайминга покупки/продажи.','zh'=>'MVRV、NUPL、SOPR、Hash Ribbon 等比特幣鏈上指標，以視覺化與即時數值解說 — 各自的意義以及如何用於買賣時機。'];

$T_BACKHUB = ['ko'=>'← 용어사전 전체','en'=>'← All terms','ja'=>'← 用語集トップ','es'=>'← Todos los términos','de'=>'← Alle Begriffe','fr'=>'← Tous les termes','pt'=>'← Todos os termos','tr'=>'← Tüm terimler','vi'=>'← Tất cả thuật ngữ','id'=>'← Semua istilah','pl'=>'← Wszystkie terminy','it'=>'← Tutti i termini','ru'=>'← Все термины','zh'=>'← 所有術語'];
$T_WHAT    = ['ko'=>'먼저, 이게 뭔가요?','en'=>'First, what is it?','ja'=>'まず、これは何ですか？','es'=>'Primero, ¿qué es?','de'=>'Zuerst: Was ist das?','fr'=>'D\'abord, qu\'est-ce que c\'est ?','pt'=>'Primeiro, o que é?','tr'=>'Önce, bu nedir?','vi'=>'Trước tiên, đây là gì?','id'=>'Pertama, apa itu?','pl'=>'Najpierw: czym to jest?','it'=>'Prima di tutto, cos\'è?','ru'=>'Сначала — что это?','zh'=>'首先，這是什麼？'];
$T_RANGES  = ['ko'=>'지금은 어느 구간일까?','en'=>'Which zone are we in?','ja'=>'今はどのレンジ？','es'=>'¿En qué zona estamos?','de'=>'In welcher Zone sind wir?','fr'=>'Dans quelle zone sommes-nous ?','pt'=>'Em que zona estamos?','tr'=>'Hangi bölgedeyiz?','vi'=>'Chúng ta đang ở vùng nào?','id'=>'Kita di zona mana?','pl'=>'W której strefie jesteśmy?','it'=>'In quale zona siamo?','ru'=>'В какой мы зоне?','zh'=>'我們在哪個區間？'];
$T_HOWUSE  = ['ko'=>'실전에서 어떻게 쓰나','en'=>'How to use it','ja'=>'実戦での使い方','es'=>'Cómo usarlo','de'=>'Wie man ihn nutzt','fr'=>'Comment l\'utiliser','pt'=>'Como usar','tr'=>'Nasıl kullanılır','vi'=>'Cách sử dụng','id'=>'Cara menggunakannya','pl'=>'Jak tego używać','it'=>'Come usarlo','ru'=>'Как это использовать','zh'=>'如何運用'];
$T_LIMITS  = ['ko'=>'맹신하면 안 되는 이유','en'=>'Why not to rely on it blindly','ja'=>'盲信してはいけない理由','es'=>'Por qué no confiar ciegamente','de'=>'Warum nicht blind vertrauen','fr'=>'Pourquoi ne pas s\'y fier aveuglément','pt'=>'Por que não confiar cegamente','tr'=>'Neden körü körüne güvenilmemeli','vi'=>'Vì sao không nên tin tưởng mù quáng','id'=>'Kenapa jangan andalkan secara buta','pl'=>'Dlaczego nie ufać mu ślepo','it'=>'Perché non affidarsi ciecamente','ru'=>'Почему нельзя слепо полагаться','zh'=>'為何不可盲目依賴'];
$T_RELATED = ['ko'=>'관련 지표','en'=>'Related Indicators','ja'=>'関連指標','es'=>'Indicadores relacionados','de'=>'Verwandte Indikatoren','fr'=>'Indicateurs liés','pt'=>'Indicadores relacionados','tr'=>'İlgili göstergeler','vi'=>'Chỉ báo liên quan','id'=>'Indikator Terkait','pl'=>'Powiązane wskaźniki','it'=>'Indicatori Correlati','ru'=>'Связанные индикаторы','zh'=>'相關指標'];
$T_CTA     = ['ko'=>'실시간 분석 보러가기 →','en'=>'Go to Live Analysis →','ja'=>'リアルタイム分析を見る →','es'=>'Ver Análisis en Vivo →','de'=>'Live-Analyse ansehen →','fr'=>'Voir l\'analyse en direct →','pt'=>'Ver análise ao vivo →','tr'=>'Canlı analizi gör →','vi'=>'Xem phân tích trực tiếp →','id'=>'Ke Analisis Langsung →','pl'=>'Przejdź do analizy na żywo →','it'=>'Vai all\'analisi dal vivo →','ru'=>'К анализу в реальном времени →','zh'=>'前往即時分析 →'];
$T_CTA_H   = ['ko'=>'실시간 타이밍 점수 대시보드','en'=>'The live timing score dashboard','ja'=>'リアルタイム・タイミングスコア ダッシュボード','es'=>'Panel de puntuación de timing en vivo','de'=>'Das Live-Timing-Score-Dashboard','fr'=>'Le tableau de bord des scores de timing en direct','pt'=>'O painel de pontuação de timing ao vivo','tr'=>'Canlı zamanlama puanı panosu','vi'=>'Bảng điểm thời điểm trực tiếp','id'=>'Dashboard skor timing langsung','pl'=>'Panel wyników timingu na żywo','it'=>'La dashboard dei punteggi di timing dal vivo','ru'=>'Панель оценок тайминга в реальном времени','zh'=>'即時時機分數儀表板'];
$T_CTA_P   = ['ko'=>'온체인·기술 지표를 종합해 비트코인과 알트코인의 매수·매도 타이밍을 0~10점으로 산출합니다. 지금 시장이 어느 국면에 있는지 대시보드에서 볼 수 있습니다.','en'=>'It combines on-chain and technical indicators into a 0–10 buy/sell timing score for Bitcoin and major altcoins, so you can see which phase the market is in right now.','ja'=>'オンチェーン・テクニカル指標を統合し、ビットコインと主要アルトコインの売買タイミングを0〜10点で算出します。今の市場がどの局面かをダッシュボードで確認できます。','es'=>'Combina indicadores on-chain y técnicos en una puntuación de compra/venta de 0 a 10 para Bitcoin y las principales altcoins, para ver en qué fase está el mercado ahora.','de'=>'Es fasst On-Chain- und technische Indikatoren zu einem Kauf-/Verkaufs-Timing-Score von 0 bis 10 für Bitcoin und große Altcoins zusammen, damit du siehst, in welcher Phase sich der Markt gerade befindet.','fr'=>'Il combine des indicateurs on-chain et techniques en un score de timing d\'achat/vente de 0 à 10 pour le Bitcoin et les principales altcoins, pour voir dans quelle phase se trouve le marché.','pt'=>'Combina indicadores on-chain e técnicos em uma pontuação de compra/venda de 0 a 10 para Bitcoin e as principais altcoins, para ver em que fase o mercado está agora.','tr'=>'Zincir üstü ve teknik göstergeleri Bitcoin ve başlıca altcoinler için 0–10 alım/satım zamanlama puanında birleştirir; piyasanın şu an hangi aşamada olduğunu görebilirsiniz.','vi'=>'Kết hợp các chỉ báo on-chain và kỹ thuật thành điểm thời điểm mua/bán từ 0–10 cho Bitcoin và các altcoin chính, để bạn thấy thị trường đang ở giai đoạn nào.','id'=>'Menggabungkan indikator on-chain dan teknikal menjadi skor timing beli/jual 0–10 untuk Bitcoin dan altcoin utama, sehingga Anda bisa melihat fase pasar saat ini.','pl'=>'Łączy wskaźniki on-chain i techniczne w wynik timingu kupna/sprzedaży 0–10 dla Bitcoina i głównych altcoinów, dzięki czemu widzisz, w jakiej fazie jest teraz rynek.','it'=>'Combina indicatori on-chain e tecnici in un punteggio di timing di acquisto/vendita 0–10 per Bitcoin e le principali altcoin, così puoi vedere in che fase si trova ora il mercato.','ru'=>'Объединяет on-chain и технические индикаторы в оценку тайминга покупки/продажи 0–10 для Bitcoin и основных альткоинов, чтобы вы видели, в какой фазе сейчас рынок.','zh'=>'將鏈上與技術指標整合為 0–10 的比特幣與主要山寨幣買賣時機分數，讓你看出市場目前處於哪個階段。'];
$T_LIVELABEL = ['ko'=>'현재 값','en'=>'Current value','ja'=>'現在値','es'=>'Valor actual','de'=>'Aktueller Wert','fr'=>'Valeur actuelle','pt'=>'Valor atual','tr'=>'Güncel değer','vi'=>'Giá trị hiện tại','id'=>'Nilai saat ini','pl'=>'Bieżąca wartość','it'=>'Valore attuale','ru'=>'Текущее значение','zh'=>'目前數值'];
$T_LOADING = ['ko'=>'불러오는 중…','en'=>'Loading…','ja'=>'読み込み中…','es'=>'Cargando…','de'=>'Laden…','fr'=>'Chargement…','pt'=>'Carregando…','tr'=>'Yükleniyor…','vi'=>'Đang tải…','id'=>'Memuat…','pl'=>'Ładowanie…','it'=>'Caricamento…','ru'=>'Загрузка…','zh'=>'載入中…'];
$T_COL_ZONE = ['ko'=>'구간','en'=>'Zone','ja'=>'レンジ','es'=>'Zona','de'=>'Zone','fr'=>'Zone','pt'=>'Zona','tr'=>'Bölge','vi'=>'Vùng','id'=>'Zona','pl'=>'Strefa','it'=>'Zona','ru'=>'Зона','zh'=>'區間'];
$T_COL_MEAN = ['ko'=>'의미','en'=>'Meaning','ja'=>'意味','es'=>'Significado','de'=>'Bedeutung','fr'=>'Signification','pt'=>'Significado','tr'=>'Anlam','vi'=>'Ý nghĩa','id'=>'Arti','pl'=>'Znaczenie','it'=>'Significato','ru'=>'Значение','zh'=>'意義'];
$T_COL_SIG  = ['ko'=>'신호','en'=>'Signal','ja'=>'シグナル','es'=>'Señal','de'=>'Signal','fr'=>'Signal','pt'=>'Sinal','tr'=>'Sinyal','vi'=>'Tín hiệu','id'=>'Sinyal','pl'=>'Sygnał','it'=>'Segnale','ru'=>'Сигнал','zh'=>'訊號'];
...
if ($isDetail) {
  $GUIDE_NAVBACK = [
    ...
    'labels' => ['ko'=>'← 용어사전 목록','en'=>'← Glossary','ja'=>'← 用語集','es'=>'← Glosario','de'=>'← Glossar','fr'=>'← Glossaire','pt'=>'← Glossário','tr'=>'← Sözlük','vi'=>'← Từ điển','id'=>'← Glosarium','pl'=>'← Słownik','it'=>'← Glossario','ru'=>'← Глоссарий','zh'=>'← 術語表'],
  ];
}
...
<?php else: // ── 허브 ── ?>
  <?php
    ...
    $__ui = [
      'n_ind'  => ['ko'=>'지표','en'=>'indicators','ja'=>'指標','es'=>'indicadores','de'=>'Indikatoren','fr'=>'indicateurs','pt'=>'indicadores','tr'=>'gösterge','vi'=>'chỉ báo','id'=>'indikator','pl'=>'wskaźniki','it'=>'indicatori','ru'=>'индикаторов','zh'=>'指標'],
      'n_live' => ['ko'=>'실시간','en'=>'live','ja'=>'リアルタイム','es'=>'en vivo','de'=>'live','fr'=>'en direct','pt'=>'ao vivo','tr'=>'canlı','vi'=>'trực tiếp','id'=>'langsung','pl'=>'na żywo','it'=>'dal vivo','ru'=>'вживую','zh'=>'即時'],
      'all'    => ['ko'=>'전체','en'=>'All','ja'=>'すべて','es'=>'Todos','de'=>'Alle','fr'=>'Tous','pt'=>'Todos','tr'=>'Tümü','vi'=>'Tất cả','id'=>'Semua','pl'=>'Wszystkie','it'=>'Tutti','ru'=>'Все','zh'=>'全部'],
      'live'   => ['ko'=>'실시간','en'=>'Live','ja'=>'リアルタイム','es'=>'En vivo','de'=>'Live','fr'=>'En direct','pt'=>'Ao vivo','tr'=>'Canlı','vi'=>'Trực tiếp','id'=>'Langsung','pl'=>'Na żywo','it'=>'Dal vivo','ru'=>'Вживую','zh'=>'即時'],
      'concept'=> ['ko'=>'개념','en'=>'Concept','ja'=>'概念','es'=>'Concepto','de'=>'Konzept','fr'=>'Concept','pt'=>'Conceito','tr'=>'Kavram','vi'=>'Khái niệm','id'=>'Konsep','pl'=>'Koncepcja','it'=>'Concetto','ru'=>'Концепция','zh'=>'概念'],
      'more'   => ['ko'=>'게이지 · 개념도 · 활용법','en'=>'Gauge · diagram · how-to','ja'=>'ゲージ · 概念図 · 使い方','es'=>'Medidor · diagrama · uso','de'=>'Anzeige · Diagramm · Nutzung','fr'=>'Jauge · schéma · usage','pt'=>'Medidor · diagrama · uso','tr'=>'Gösterge · şema · kullanım','vi'=>'Đồng hồ · sơ đồ · cách dùng','id'=>'Gauge · diagram · cara pakai','pl'=>'Wskaźnik · diagram · poradnik','it'=>'Indicatore · diagramma · guida','ru'=>'Шкала · диаграмма · инструкция','zh'=>'量表 · 圖解 · 用法'],
      'search' => ['ko'=>'지표 검색 — MVRV, 도미넌스, RSI…','en'=>'Search indicators — MVRV, dominance, RSI…','ja'=>'指標を検索 — MVRV, ドミナンス, RSI…','es'=>'Buscar — MVRV, dominancia, RSI…','de'=>'Suchen — MVRV, Dominanz, RSI…','fr'=>'Rechercher — MVRV, dominance, RSI…','pt'=>'Buscar — MVRV, dominância, RSI…','tr'=>'Ara — MVRV, dominans, RSI…','vi'=>'Tìm — MVRV, thống trị, RSI…','id'=>'Cari indikator — MVRV, dominasi, RSI…','pl'=>'Szukaj wskaźników — MVRV, dominacja, RSI…','it'=>'Cerca indicatori — MVRV, dominanza, RSI…','ru'=>'Поиск индикаторов — MVRV, доминация, RSI…','zh'=>'搜尋指標 — MVRV、市佔率、RSI…'],
    ];
  ?>
  <div class="ghub-head">
    <div>
