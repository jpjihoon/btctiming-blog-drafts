...
$T = [
  ...
  'id'=>['back'=>'Dashboard','h1'=>'Kelola Coin','lead'=>'Ketuk bintang untuk memilih coin yang tampil di dashboard. Hanya coin terpilih yang muncul di tab dashboard.','search'=>'Cari coin (nama/simbol)','reset'=>'Atur ulang ke default','empty'=>'Tidak ada hasil','open'=>'Buka di dashboard','tab_fav'=>'Favorit','tab_all'=>'Semua','empty_fav'=>'Belum ada favorit. Tambahkan dari tab Semua.','sitemap'=>'Peta Situs','privacy'=>'Kebijakan Privasi','terms'=>'Ketentuan','disclaimer'=>'Bukan nasihat keuangan'],
  'pl'=>['back'=>'Panel','h1'=>'Zarządzaj coinami','lead'=>'Dotknij gwiazdki, aby wybrać coiny widoczne na panelu. Tylko wybrane coiny pojawią się w zakładkach panelu.','search'=>'Szukaj coinów (nazwa/symbol)','reset'=>'Przywróć domyślne','empty'=>'Brak wyników','open'=>'Otwórz w panelu','tab_fav'=>'Ulubione','tab_all'=>'Wszystkie','empty_fav'=>'Brak ulubionych. Dodaj z zakładki Wszystko.','sitemap'=>'Mapa strony','privacy'=>'Polityka prywatności','terms'=>'Warunki','disclaimer'=>'To nie porada finansowa'],
  'it'=>['back'=>'Dashboard','h1'=>'Gestisci Coin','lead'=>'Tocca la stella per scegliere quali coin appaiono sulla dashboard. Solo le coin selezionate compaiono nelle schede.','search'=>'Cerca coin (nome/simbolo)','reset'=>'Ripristina predefiniti','empty'=>'Nessun risultato','open'=>'Apri nella dashboard','tab_fav'=>'Preferiti','tab_all'=>'Tutti','empty_fav'=>'Nessun preferito. Aggiungi dalla scheda Tutti.','sitemap'=>'Mappa del sito','privacy'=>'Privacy','terms'=>'Termini','disclaimer'=>'Non è consulenza finanziaria'],
  'ru'=>['back'=>'Дэшборд','h1'=>'Управление монетами','lead'=>'Нажмите звезду, чтобы выбрать монеты для дэшборда. В его вкладках показываются только выбранные монеты.','search'=>'Поиск монет (имя/символ)','reset'=>'Сбросить к стандартным','empty'=>'Ничего не найдено','open'=>'Открыть в дэшборде','tab_fav'=>'Избранное','tab_all'=>'Все','empty_fav'=>'Пока нет избранного. Добавьте на вкладке «Все».','sitemap'=>'Карта сайта','privacy'=>'Конфиденциальность','terms'=>'Условия','disclaimer'=>'Не финансовый совет'],
  'zh'=>['back'=>'儀表板','h1'=>'管理幣種','lead'=>'點星號選擇要顯示在儀表板的幣種。只有選取的幣種會出現在儀表板分頁。','search'=>'搜尋幣種（名稱/代號）','reset'=>'重設為預設','empty'=>'無結果','open'=>'在儀表板開啟','tab_fav'=>'收藏','tab_all'=>'全部','empty_fav'=>'尚無收藏。請從「全部」分頁新增。','sitemap'=>'網站地圖','privacy'=>'隱私政策','terms'=>'服務條款','disclaimer'=>'非投資建議'],
];
$t = $T[$lang] ?? $T['en'];
