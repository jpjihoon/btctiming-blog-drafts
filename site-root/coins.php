...
$COIN_META = [
  ...
  'LINK'=>['Chainlink','#2A5ADA'],'DOT'=>['Polkadot','#E6007A'],'MATIC'=>['Polygon','#8247E5'],
  ...
  'FIL'=>['Filecoin','#0090FF'],'HBAR'=>['Hedera','#222222'],'ARB'=>['Arbitrum','#28A0F0'],
  ...
  'FTM'=>['Fantom','#1969FF'],'TIA'=>['Celestia','#7B2BF9'],'IMX'=>['Immutable','#4361EE'],
