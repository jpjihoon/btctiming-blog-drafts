...
window.addEventListener('DOMContentLoaded',function(){
  var L={ko:'앱 설치',en:'Install',ja:'インストール',es:'Instalar',de:'Installieren',fr:'Installer',pt:'Instalar',tr:'Kur',vi:'Cài đặt',id:'Instal',pl:'Zainstaluj',it:'Installa',ru:'Установить',zh:'安裝'};
...
const LOCALE={ko:'ko-KR',en:'en-US',ja:'ja-JP',es:'es-ES',de:'de-DE',fr:'fr-FR',pt:'pt-BR',tr:'tr-TR',vi:'vi-VN',id:'id-ID',pl:'pl-PL',it:'it-IT',ru:'ru-RU',zh:'zh-TW'}[LANG]||'en-US';
let cache={};
...
const DESC={
'FULL LONG':{ko:'역대급 저점. 목표 비중 100% 전량 진입.',en:'Historical bottom. Maximum position entry.',ja:'歴史的な底値。目標比率100%で全力エントリー。',es:'Suelo histórico. Entrada de posición máxima.',de:'Historischer Boden. Maximaler Positionseinstieg.',fr:'Plancher historique. Entrée maximale.',pt:'Fundo histórico. Entrada de posição máxima.',tr:'Tarihi dip. Maksimum pozisyon girişi.',vi:'Đáy lịch sử. Vào lệnh tối đa.',id:'Dasar historis. Entry posisi maksimal.',pl:'Historyczne dno. Maksymalne wejście.',it:'Minimo storico. Ingresso massimo.',ru:'Исторический минимум. Максимальный вход.',zh:'歷史底部。全力進場。'},
'ADD LONG':{ko:'강한 저점. 목표 비중 70~100% 확대.',en:'Strong buy zone. Scale up to 70–100%.',ja:'強い買い場。目標比率70〜100%へ拡大。',es:'Zona de compra fuerte. Aumentar a 70–100%.',de:'Starke Kaufzone. Auf 70–100% erhöhen.',fr:'Zone d\'achat forte. Monter à 70–100%.',pt:'Zona de compra forte. Aumentar para 70–100%.',tr:'Güçlü alım bölgesi. %70–100\'e çıkar.',vi:'Vùng mua mạnh. Tăng lên 70–100%.',id:'Zona beli kuat. Naikkan ke 70–100%.',pl:'Silna strefa kupna. Zwiększ do 70–100%.',it:'Zona di acquisto forte. Aumenta al 70–100%.',ru:'Сильная зона покупки. Наращивайте до 70–100%.',zh:'強力買進區。加碼至 70–100%。'},
'SPLIT LONG':{ko:'분할 진입 시작. 목표 비중 30~50%.',en:'Start staged entries. 30–50% initial.',ja:'分割エントリー開始。目標比率30〜50%。',es:'Inicia entradas escalonadas. 30–50%.',de:'Gestaffelter Einstieg. 30–50% anfangs.',fr:'Débuter les entrées échelonnées. 30–50%.',pt:'Iniciar entradas em etapas. 30–50%.',tr:'Kademeli girişe başla. %30–50.',vi:'Bắt đầu vào lệnh từng phần. 30–50%.',id:'Mulai entry bertahap. 30–50% awal.',pl:'Zacznij wejścia etapami. 30–50% na start.',it:'Inizia ingressi scaglionati. 30–50% iniziale.',ru:'Начните дробный вход. 30–50% сначала.',zh:'開始分批進場。初始 30–50%。'},
'WATCH':{ko:'중립 관찰.',en:'Neutral zone. Monitor and wait.',ja:'中立ゾーン。様子見。',es:'Zona neutral. Observar y esperar.',de:'Neutrale Zone. Beobachten.',fr:'Zone neutre. Observer.',pt:'Zona neutra. Observar.',tr:'Nötr bölge. İzle ve bekle.',vi:'Vùng trung lập. Quan sát.',id:'Zona netral. Pantau dan tunggu.',pl:'Strefa neutralna. Obserwuj i czekaj.',it:'Zona neutrale. Monitora e attendi.',ru:'Нейтральная зона. Наблюдайте и ждите.',zh:'中性區。觀察等待。'},
'SPLIT EXIT':{ko:'분할 익절. 고평가·과열 → 보유분 일부 매도.',en:'Overheated. Start taking partial profits.',ja:'過熱。一部利益確定を開始。',es:'Sobrecalentado. Toma ganancias parciales.',de:'Überhitzt. Teilgewinne mitnehmen.',fr:'Surchauffe. Prendre des profits partiels.',pt:'Sobreaquecido. Realize lucros parciais.',tr:'Aşırı ısındı. Kısmi kâr al.',vi:'Quá nóng. Chốt lời một phần.',id:'Overheat. Mulai ambil profit sebagian.',pl:'Przegrzanie. Zacznij realizować część zysków.',it:'Surriscaldato. Inizia a prendere profitti parziali.',ru:'Перегрев. Начните частичную фиксацию прибыли.',zh:'過熱。開始部分獲利了結。'},
'EXIT':{ko:'고위험. 익절 또는 청산 고려.',en:'High risk. Consider exiting.',ja:'高リスク。利確・撤退を検討。',es:'Alto riesgo. Considera salir.',de:'Hohes Risiko. Ausstieg erwägen.',fr:'Risque élevé. Envisager la sortie.',pt:'Alto risco. Considere sair.',tr:'Yüksek risk. Çıkışı düşün.',vi:'Rủi ro cao. Cân nhắc thoát.',id:'Risiko tinggi. Pertimbangkan keluar.',pl:'Wysokie ryzyko. Rozważ wyjście.',it:'Rischio alto. Valuta l\'uscita.',ru:'Высокий риск. Рассмотрите выход.',zh:'高風險。考慮出場。'}};
...
(function(){
  var SL={
    title:{ko:'설정',en:'Settings',ja:'設定',es:'Ajustes',de:'Einstellungen',fr:'Réglages',pt:'Ajustes',tr:'Ayarlar',vi:'Cài đặt',id:'Pengaturan',pl:'Ustawienia',it:'Impostazioni',ru:'Настройки',zh:'設定'},
    mycoins:{ko:'내 코인 (즐겨찾기)',en:'My coins (favorites)',ja:'マイコイン（お気に入り）',es:'Mis monedas (favoritas)',de:'Meine Coins (Favoriten)',fr:'Mes cryptos (favoris)',pt:'Minhas moedas (favoritas)',tr:'Coinlerim (favoriler)',vi:'Coin của tôi (yêu thích)',id:'Coin saya (favorit)',pl:'Moje coiny (ulubione)',it:'Le mie coin (preferiti)',ru:'Мои монеты (избранное)',zh:'我的幣種（收藏）'},
    ph:{ko:'🔍 코인 검색해서 추가 (ETH, SOL…)',en:'🔍 Search to add a coin (ETH, SOL, PEPE…)',ja:'🔍 コインを検索して追加 (ETH, SOL…)',es:'🔍 Busca para añadir (ETH, SOL…)',de:'🔍 Coin suchen & hinzufügen',fr:'🔍 Rechercher pour ajouter',pt:'🔍 Buscar para adicionar',tr:'🔍 Coin ara ve ekle',vi:'🔍 Tìm coin để thêm',id:'🔍 Cari untuk menambah coin (ETH, SOL, PEPE…)',pl:'🔍 Szukaj, aby dodać coina (ETH, SOL, PEPE…)',it:'🔍 Cerca per aggiungere una coin (ETH, SOL, PEPE…)',ru:'🔍 Найдите, чтобы добавить монету (ETH, SOL, PEPE…)',zh:'🔍 搜尋以新增幣種（ETH、SOL、PEPE…）'},
    options:{ko:'옵션',en:'Options',ja:'オプション',es:'Opciones',de:'Optionen',fr:'Options',pt:'Opções',tr:'Seçenekler',vi:'Tùy chọn',id:'Opsi',pl:'Opcje',it:'Opzioni',ru:'Опции',zh:'選項'},
    blog:{ko:'최신 블로그 글 표시',en:'Show latest blog posts',ja:'最新のブログ記事を表示',es:'Mostrar últimos artículos',de:'Neueste Blogposts anzeigen',fr:'Afficher les derniers articles',pt:'Mostrar posts recentes',tr:'Son blog yazılarını göster',vi:'Hiện bài blog mới nhất',id:'Tampilkan pos blog terbaru',pl:'Pokaż najnowsze wpisy na blogu',it:'Mostra gli ultimi post del blog',ru:'Показывать последние посты блога',zh:'顯示最新部落格文章'},
    apply:{ko:'적용',en:'Apply',ja:'適用',es:'Aplicar',de:'Übernehmen',fr:'Appliquer',pt:'Aplicar',tr:'Uygula',vi:'Áp dụng',id:'Terapkan',pl:'Zastosuj',it:'Applica',ru:'Применить',zh:'套用'},
    add:{ko:'+ 추가',en:'+ add',ja:'+ 追加',es:'+ añadir',de:'+ hinzufügen',fr:'+ ajouter',pt:'+ adicionar',tr:'+ ekle',vi:'+ thêm',id:'+ tambah',pl:'+ dodaj',it:'+ aggiungi',ru:'+ добавить',zh:'+ 新增'},
    none:{ko:'일치 없음 또는 이미 추가됨',en:'No match, or already added.',ja:'該当なし／追加済み',es:'Sin resultados o ya añadido',de:'Kein Treffer / bereits hinzugefügt',fr:'Aucun résultat / déjà ajouté',pt:'Sem correspondência / já adicionado',tr:'Eşleşme yok / zaten ekli',vi:'Không khớp / đã thêm',id:'Tidak cocok, atau sudah ditambahkan.',pl:'Brak dopasowania lub już dodano.',it:'Nessun risultato, o già aggiunta.',ru:'Нет совпадений или уже добавлено.',zh:'無相符，或已新增。'},
    allin:{ko:'인기 코인 모두 추가됨',en:'All popular coins added.',ja:'人気コインは追加済み',es:'Todas añadidas',de:'Alle hinzugefügt',fr:'Toutes ajoutées',pt:'Todas adicionadas',tr:'Hepsi eklendi',vi:'Đã thêm hết',id:'Semua coin populer sudah ditambahkan.',pl:'Dodano wszystkie popularne coiny.',it:'Tutte le coin popolari aggiunte.',ru:'Все популярные монеты добавлены.',zh:'熱門幣種已全部新增。'},
    max:{ko:'최대 10개',en:'Max 10 coins',ja:'最大10',es:'Máx. 10',de:'Max. 10',fr:'Max 10',pt:'Máx. 10',tr:'En fazla 10',vi:'Tối đa 10',id:'Maks 10 coin',pl:'Maks. 10 coinów',it:'Max 10 coin',ru:'Максимум 10 монет',zh:'最多 10 個幣種'}
  };
