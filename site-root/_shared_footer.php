...
<footer class="site-footer">
 <div class="sf-wrap">
  ...
  <div class="sf-links" role="navigation" aria-label="Footer">
    <span class="sf-group">
      <a href="/blog/" class="sf-link sf-legal" data-base="/blog/"><span class="ko">블로그</span><span class="en">Blog</span><span class="ja">ブログ</span><span class="es">Blog</span><span class="de">Blog</span><span class="fr">Blog</span><span class="pt">Blog</span><span class="tr">Blog</span><span class="vi">Blog</span><span class="id">Blog</span><span class="pl">Blog</span><span class="it">Blog</span><span class="ru">Блог</span><span class="zh">部落格</span></a>
      <span class="sf-sep">·</span>
      <a href="/glossary" class="sf-link sf-legal" data-base="/glossary"><span class="ko">용어사전</span><span class="en">Glossary</span><span class="ja">用語集</span><span class="es">Glosario</span><span class="de">Glossar</span><span class="fr">Glossaire</span><span class="pt">Glossário</span><span class="tr">Sözlük</span><span class="vi">Từ điển</span><span class="id">Glosarium</span><span class="pl">Słownik</span><span class="it">Glossario</span><span class="ru">Глоссарий</span><span class="zh">術語表</span></a>
      <span class="sf-sep">·</span>
      <a href="/rss-guide" class="sf-link sf-legal" data-base="/rss-guide">RSS</a>
      <span class="sf-sep">·</span>
      <a href="/sitemap-guide" class="sf-link sf-legal" data-base="/sitemap-guide"><span class="ko">사이트맵</span><span class="en">Sitemap</span><span class="ja">サイトマップ</span><span class="es">Mapa del sitio</span><span class="de">Sitemap</span><span class="fr">Plan du site</span><span class="pt">Mapa do site</span><span class="tr">Site haritası</span><span class="vi">Sơ đồ trang</span><span class="id">Peta Situs</span><span class="pl">Mapa strony</span><span class="it">Mappa del sito</span><span class="ru">Карта сайта</span><span class="zh">網站地圖</span></a>
    </span>
    <span class="sf-div">|</span>
    <span class="sf-group">
      <a href="/about" class="sf-link sf-legal" data-base="/about"><span class="ko">서비스 소개</span><span class="en">About</span><span class="ja">概要</span><span class="es">Acerca de</span><span class="de">Über uns</span><span class="fr">À propos</span><span class="pt">Sobre</span><span class="tr">Hakkında</span><span class="vi">Giới thiệu</span><span class="id">Tentang</span><span class="pl">O nas</span><span class="it">Chi siamo</span><span class="ru">О нас</span><span class="zh">關於</span></a>
      <span class="sf-sep">·</span>
      <a href="/privacy" class="sf-link sf-legal" data-base="/privacy"><span class="ko">개인정보처리방침</span><span class="en">Privacy Policy</span><span class="ja">プライバシーポリシー</span><span class="es">Política de Privacidad</span><span class="de">Datenschutzerklärung</span><span class="fr">Confidentialité</span><span class="pt">Privacidade</span><span class="tr">Gizlilik Politikası</span><span class="vi">Chính sách bảo mật</span><span class="id">Kebijakan Privasi</span><span class="pl">Polityka prywatności</span><span class="it">Privacy</span><span class="ru">Конфиденциальность</span><span class="zh">隱私政策</span></a>
      <span class="sf-sep">·</span>
      <a href="/terms" class="sf-link sf-legal" data-base="/terms"><span class="ko">이용약관</span><span class="en">Terms of Service</span><span class="ja">利用規約</span><span class="es">Términos de Servicio</span><span class="de">Nutzungsbedingungen</span><span class="fr">Conditions d'utilisation</span><span class="pt">Termos de Serviço</span><span class="tr">Hizmet Şartları</span><span class="vi">Điều khoản dịch vụ</span><span class="id">Ketentuan Layanan</span><span class="pl">Warunki usługi</span><span class="it">Termini di servizio</span><span class="ru">Условия использования</span><span class="zh">服務條款</span></a>
    </span>
  </div>
  <div class="sf-meta">© 2026 BTCtiming.com<span class="sf-dis"><span class="ko"> · 본 사이트의 모든 정보는 투자 조언이 아닙니다.</span><span class="en"> · The information on this site is not investment advice.</span><span class="ja"> · 本サイトのすべての情報は投資助言ではありません。</span><span class="es"> · La información de este sitio no es asesoramiento financiero.</span><span class="de"> · Die Informationen auf dieser Website sind keine Finanzberatung.</span><span class="fr"> · Les informations de ce site ne constituent pas un conseil financier.</span><span class="pt"> · As informações deste site não são aconselhamento financeiro.</span><span class="tr"> · Bu sitedeki bilgiler yatırım tavsiyesi değildir.</span><span class="vi"> · Thông tin trên trang này không phải là lời khuyên đầu tư.</span><span class="id"> · Informasi di situs ini bukan nasihat investasi.</span><span class="pl"> · Informacje na tej stronie nie są poradą inwestycyjną.</span><span class="it"> · Le informazioni su questo sito non sono consigli di investimento.</span><span class="ru"> · Информация на этом сайте не является инвестиционным советом.</span><span class="zh"> · 本網站所有資訊皆非投資建議。</span></span></div>
  </div>
  <a class="app-mini app-mini--fixed" id="appBanner" href="https://play.google.com/store/apps/details?id=com.btctiming.app" target="_blank" rel="noopener" hidden>
    ...
    <span class="am-text">
      <span class="am-top"><span class="ko">앱으로도 만나보세요</span><span class="en">Also on the app</span><span class="ja">アプリでも</span><span class="es">También en la app</span><span class="de">Auch als App</span><span class="fr">Aussi sur l'app</span><span class="pt">Também no app</span><span class="tr">Uygulamada da</span><span class="vi">Có trên ứng dụng</span><span class="id">Juga di aplikasi</span><span class="pl">Także w aplikacji</span><span class="it">Anche sull'app</span><span class="ru">Также в приложении</span><span class="zh">也可在 App 上使用</span></span>
...
.app-mini .ko,.app-mini .en,.app-mini .ja,.app-mini .es,.app-mini .de,.app-mini .fr,.app-mini .pt,.app-mini .tr,.app-mini .vi,.app-mini .id,.app-mini .pl,.app-mini .it,.app-mini .ru,.app-mini .zh{display:none}
...
html[lang="vi"] .app-mini .vi,
html[lang="id"] .app-mini .id,
html[lang="pl"] .app-mini .pl,
html[lang="it"] .app-mini .it,
html[lang="ru"] .app-mini .ru,
html[lang="zh"] .app-mini .zh{display:inline}
...
.site-footer .ko,.site-footer .en,.site-footer .ja,.site-footer .es,.site-footer .de,.site-footer .fr,.site-footer .pt,.site-footer .tr,.site-footer .vi,.site-footer .id,.site-footer .pl,.site-footer .it,.site-footer .ru,.site-footer .zh{display:none}
...
html[lang="vi"] .site-footer .vi,
html[lang="id"] .site-footer .id,
html[lang="pl"] .site-footer .pl,
html[lang="it"] .site-footer .it,
html[lang="ru"] .site-footer .ru,
html[lang="zh"] .site-footer .zh{display:inline}
