...
.sb-blog-item{display:flex;gap:10px;align-items:flex-start;padding:14px 0 14px 11px;border-top:1px solid var(--b1);border-left:3px solid var(--b2);text-decoration:none;color:inherit;transition:padding-left .12s}
