...
.nav-inner{max-width:1280px;margin:0 auto;width:100%;display:flex;align-items:center;padding:0;gap:12px}
...
<div id="tickerBar" class="ticker-bar" style="background:#0a0a0a;border-bottom:1px solid var(--b1)">
  <div class="ticker-scroll" style="max-width:1280px;margin:0 auto;padding:6px 0;
...
<div id="blogTickerBar" style="background:#0a0a0a;border-bottom:1px solid var(--b1)">
  <div style="max-width:1280px;margin:0 auto;padding:6px 0;font-size:12px;color:var(--t2);
