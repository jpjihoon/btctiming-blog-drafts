...
<footer>© 2026 BTCtiming.com · <a href="/rss-guide.php" style="color:#666;text-decoration:underline">RSS</a> · <a href="/sitemap-guide.php<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline"><span class="ko">사이트맵</span><span class="en">Sitemap</span><span class="ja">サイトマップ</span><span class="es">Mapa del sitio</span><span class="de">Sitemap</span></a> · <a href="/privacy<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="ko">개인정보처리방침</a><a href="/privacy<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="en">Privacy Policy</a><a href="/privacy<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="ja">プライバシーポリシー</a><a href="/privacy<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="es">Política de Privacidad</a><a href="/privacy<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="de">Datenschutzerklärung</a> · <a href="/terms<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="ko">이용약관</a><a href="/terms<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="en">Terms of Service</a><a href="/terms<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="ja">利用規約</a><a href="/terms<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="es">Términos de Servicio</a><a href="/terms<?= h($legalSuffix) ?>" style="color:#666;text-decoration:underline" class="de">Nutzungsbedingungen</a> · <span class="ko">투자 조언이 아닙니다</span><span class="en">Not financial advice</span><span class="ja">投資助言ではありません</span><span class="es">No es asesoramiento financiero</span><span class="de">Keine Finanzberatung</span>.</footer>
<script>
function L(l){
