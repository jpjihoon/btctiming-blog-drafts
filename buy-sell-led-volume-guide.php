...
<p class="ko">이 사이트의 대부분 온체인 지표는 하루 단위(일봉)로 갱신돼요. 정확하지만, 최대 24시간 지연될 수 있다는 단점이 있습니다. <strong>매수·매도 주도 거래량</strong>은 이 지연을 없애려고 만든 지표예요 — 15분봉 데이터를 써서, 지금 이 순간의 심리를 거의 실시간으로 잡아냅니다.</p>
  ...
  <p class="fr">Efficace lorsqu'il est combiné à des indicateurs plus lents comme <a href="/blog/sth-sopr.html">STH-SOPR</a> ou <a href="/blog/hash-ribbon-indicator.html">Hash Ribbon</a>, qui confirment la "capitulation dans la vue d'ensemble", pendant que cet indicateur confirme "si ce moment précis est le sommet de cette capitulation", à la minute près.</p>
  <p class="pt">Eficaz quando combinado com indicadores mais lentos como <a href="/blog/sth-sopr.html">STH-SOPR</a> ou <a href="/blog/hash-ribbon-indicator.html">Hash Ribbon</a>, que confirmam a "capitulação no panorama geral", enquanto este indicador confirma "se este exato momento é o pico dessa capitulação", com precisão de minutos.</p>
  <p class="tr"><a href="/blog/sth-sopr.html">STH-SOPR</a> veya <a href="/blog/hash-ribbon-indicator.html">Hash Ribbon</a> gibi daha yavaş göstergelerin "büyük resimde kapitülasyon" olduğunu doğrulamasıyla birlikte kullanıldığında etkilidir; bu gösterge ise "tam olarak şu anın o kapitülasyonun zirvesi olup olmadığını" dakika hassasiyetiyle doğrular.</p>
  <p class="vi">Hiệu quả khi kết hợp với các chỉ báo chậm hơn như <a href="/blog/sth-sopr.html">STH-SOPR</a> hoặc <a href="/blog/hash-ribbon-indicator.html">Hash Ribbon</a> để xác nhận "sự đầu hàng trong bức tranh toàn cảnh", trong khi chỉ báo này xác nhận "liệu chính khoảnh khắc này có phải là đỉnh điểm của sự đầu hàng đó hay không" chính xác đến từng phút.</p>
