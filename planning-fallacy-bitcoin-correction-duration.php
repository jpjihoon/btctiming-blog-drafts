<?php $slug = 'planning-fallacy-bitcoin-correction-duration'; require __DIR__.'/_header.php'; ?>
  ...
  <p class="ja">もちろん、「今回は違う」という言葉が毎回間違っているわけではない。ETFの資金流入のように、サイクルごとに実際に構造が変わる部分は確かに存在し、<a href="/ja/blog/this-time-is-different">その言葉がなぜ毎回繰り返されるのかを扱った記事</a>が指摘するように、その違いを無視することも同じように怠慢な態度だ。しかし計画の誤謬の教訓は、その違いを否定せよということではなく、その違いを反映した調整幅そのものが構造的に過大評価されるという点にある。実践で使える原則はシンプルだ — レバレッジの規模やマージンバッファー、保有期間の計画を立てる際、「今回は数日」という自分の直感ではなく、556日と376日という実測基準線をまず置き、その上に今回のサイクルの特殊性を保守的に上乗せすることである。8年かかるプロジェクトを2年だと信じた委員会のようにならない唯一の方法は、自分の楽観を根拠にしないことだけだ。</p>
  <p class="es">Por supuesto, "esta vez es diferente" no siempre está equivocado. Existen cambios estructurales que realmente varían de un ciclo a otro — los flujos de los ETF, por ejemplo — y como señala <a href="/es/blog/this-time-is-different">el artículo sobre por qué esa frase se repite en cada ciclo</a>, descartar esa diferencia sin más también es igual de perezoso. Pero la lección de la falacia de la planificación no es negar la diferencia — es que el tamaño del ajuste que se hace por esa diferencia está, en sí mismo, estructuralmente sobreestimado. La regla práctica es simple: al dimensionar el apalancamiento, los colchones de margen o un plan de período de tenencia, hay que partir de los puntos de referencia medidos — 556 días, 376 días — en lugar de la intuición propia de "esta vez son solo unos días", y luego añadir con conservadurismo las particularidades de este ciclo encima. La única forma de no acabar como el comité que creyó que un proyecto de ocho años tomaría dos es dejar de tratar el propio optimismo como evidencia.</p>
  <p class="de">Natürlich liegt "diesmal ist es anders" nicht immer falsch. Strukturelle Verschiebungen, die sich tatsächlich von Zyklus zu Zyklus ändern — ETF-Zuflüsse zum Beispiel — gibt es wirklich, und wie <a href="/de/blog/this-time-is-different">der Beitrag darüber, warum dieser Satz jeden Zyklus wiederkehrt</a> feststellt, ist es ebenso faul, diesen Unterschied einfach abzutun. Aber die Lehre aus dem Planungsfehlschluss besteht nicht darin, den Unterschied zu leugnen — sie besteht darin, dass das Ausmaß der Anpassung, die man für diesen Unterschied vornimmt, selbst strukturell überschätzt wird. Die praktische Regel ist einfach: Bei der Bemessung von Hebel, Margin-Puffern oder einem Halteplan sollte man von den gemessenen Basislinien ausgehen — 556 Tage, 376 Tage — statt vom eigenen Bauchgefühl "diesmal sind es nur ein paar Tage", und dann die Besonderheiten dieses Zyklus konservativ obendrauf legen. Der einzige Weg, nicht wie das Komitee zu enden, das glaubte, ein Achtjahresprojekt würde zwei Jahre dauern, ist, den eigenen Optimismus nicht als Beweis zu behandeln.</p>
  <p class="fr">Bien sûr, « cette fois c'est différent » n'a pas toujours tort. Des changements structurels qui varient réellement d'un cycle à l'autre — les flux entrants des ETF, par exemple — existent bel et bien, et comme le souligne <a href="/fr/blog/this-time-is-different">l'article sur pourquoi cette expression revient à chaque cycle</a>, rejeter cette différence d'emblée est tout aussi paresseux. Mais la leçon du biais de planification n'est pas de nier la différence — c'est que l'ampleur de l'ajustement qu'on fait pour cette différence est elle-même structurellement surestimée. La règle pratique est simple : pour dimensionner le levier, les marges de sécurité ou un plan de durée de détention, il faut partir des références mesurées — 556 jours, 376 jours — plutôt que de son propre instinct de « cette fois, ce n'est que quelques jours », puis ajouter prudemment par-dessus les particularités de ce cycle. La seule façon de ne pas finir comme le comité qui croyait qu'un projet de huit ans en prendrait deux est d'arrêter de traiter son propre optimisme comme une preuve.</p>
