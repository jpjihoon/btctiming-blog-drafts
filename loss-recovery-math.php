...
<p class="ko">퀴즈 하나 낼게요. 100만 원이 -50% 하락해서 50만 원이 됐어요. 다시 100만 원으로 돌아오려면 몇 % 올라야 할까요? 직관적으로 "+50%"라고 답하기 쉬운데, 정답은 <strong>+100%</strong>예요. 50만 원의 100%가 딱 50만 원이니까, 원금 100만 원을 채우려면 정확히 두 배가 필요합니다.</p>
  ...
  <p class="ko">다른 하나는, 반대로 이미 크게 하락한 자산을 보고 "이 정도 빠졌으면 반등도 크겠지"라며 과도하게 낙관하는 거예요. -70% 빠진 자산이 원금을 회복하려면 +233%가 필요한데, 이게 "쉽게 일어날 일"처럼 느껴지지 않아야 정상이에요. <a href="/blog/ath-drawdown">ATH 대비 하락률 가이드</a>에서 다룬 과거 사이클 회복 사례들도, 실제로는 수년에 걸쳐 이 정도 배율의 상승이 필요했다는 걸 기억할 필요가 있습니다.</p>
  <p class="en">The other mistake runs the opposite direction — looking at an already-crushed asset and assuming "it's fallen this much, the rebound must be big too." An asset down -70% needs +233% just to get even, and that should not feel like something that happens easily. The historical cycle recoveries covered in the <a href="/en/blog/ath-drawdown">ATH drawdown guide</a> genuinely took years to produce gains of that magnitude — worth keeping in mind.</p>
  <p class="ja">もう一つは逆に、すでに大きく下落した資産を見て「これだけ下がったなら反発も大きいだろう」と過度に楽観することです。-70%下落した資産が元本を回復するには+233%が必要ですが、これは「簡単に起こること」のように感じられてはいけません。<a href="/ja/blog/ath-drawdown">ATH比下落率ガイド</a>で扱った過去のサイクルの回復事例も、実際には数年かけてこの倍率の上昇が必要だったことを覚えておく必要があります。</p>

  <p class="es">El otro error va en la dirección opuesta — mirar un activo ya destrozado y asumir "ha caído tanto, el rebote también debe ser grande." Un activo caído -70% necesita +233% solo para nivelarse, y eso no debería sentirse como algo que sucede fácilmente. Las recuperaciones de ciclos históricos cubiertas en la <a href="/es/blog/ath-drawdown">guía de drawdown desde ATH</a> genuinamente tomaron años para producir ganancias de esa magnitud — vale la pena tenerlo presente.</p>
  <p class="de">Der andere Fehler geht in die entgegengesetzte Richtung — ein bereits zerschlagenes Asset zu betrachten und anzunehmen "es ist so stark gefallen, die Erholung muss auch groß sein." Ein Asset, das um -70% gefallen ist, braucht +233%, nur um den Ausgleich zu schaffen, und das sollte sich nicht wie etwas anfühlen, das leicht passiert. Die in der <a href="/de/blog/ath-drawdown">ATH-Drawdown-Anleitung</a> behandelten historischen Zykluserholungen brauchten tatsächlich Jahre, um Gewinne dieser Größenordnung zu erzielen — es lohnt sich, das im Hinterkopf zu behalten.</p>
  <p class="fr">L'autre erreur va dans le sens opposé — regarder un actif déjà écrasé et se dire « il est tellement tombé que le rebond sera forcément énorme aussi ». Un actif en baisse de -70 % a besoin de +233 % rien que pour revenir à l'équilibre, et cela ne devrait pas sembler être quelque chose qui arrive facilement. Les redressements historiques évoqués dans le <a href="/fr/blog/ath-drawdown">guide sur le repli depuis l'ATH</a> ont réellement demandé des années pour produire des gains de cette ampleur — c'est utile de le garder en tête.</p>
  <p class="pt">O outro erro vai na direção oposta — olhar para um ativo já muito desvalorizado e presumir "já caiu tanto, a recuperação também deve ser grande." Um ativo que caiu -70% precisa de +233% só para empatar, e isso não deveria parecer algo que acontece facilmente. As recuperações históricas de ciclos abordadas no <a href="/pt/blog/ath-drawdown">guia de queda em relação à ATH</a> realmente levaram anos para produzir ganhos dessa magnitude — vale a pena ter isso em mente.</p>
  <p class="tr">Diğer hata ise tam tersi yönde işler — çoktan çökmüş bir varlığa bakıp "bu kadar düştüyse, toparlanma da büyük olmalı" diye düşünmek. %-70 düşen bir varlığın sadece başa baş noktasına dönmesi için %+233 gerekir ve bunun kolayca gerçekleşen bir şey gibi hissettirmemesi gerekir. <a href="/tr/blog/ath-drawdown">ATH'ye göre düşüş rehberinde</a> ele alınan geçmiş döngü toparlanmaları, bu büyüklükte kazanç üretmek için gerçekten yıllar aldı — bunu akılda tutmakta fayda var.</p>
  <p class="vi">Sai lầm còn lại đi theo hướng ngược lại — nhìn một tài sản đã giảm sâu và cho rằng "đã giảm nhiều như vậy thì cú hồi phục cũng phải lớn tương xứng." Một tài sản giảm -70% cần +233% chỉ để hòa vốn, và điều đó không nên bị xem là chuyện dễ xảy ra. Các đợt hồi phục chu kỳ trong lịch sử được đề cập trong <a href="/vi/blog/ath-drawdown">hướng dẫn về mức giảm so với đỉnh ATH</a> thực tế đã mất nhiều năm mới tạo ra mức tăng lớn như vậy — điều đáng ghi nhớ.</p>
  ...
  <p class="ko">이 곡선을 <a href="/blog/hard-to-cut-losses">손절선을 미리 정하는 것</a>과 같이 쓰면 좋아요. "-20%까지는 버틴다"는 계획을 세울 때, "-20%에서 원금 회복엔 +25%가 필요하다"는 걸 같이 계산해두면, 손절 라인을 훨씬 더 현실적인 숫자로 잡을 수 있습니다. 감으로 "이 정도는 버틸 수 있다"고 정하는 것보다, 회복에 필요한 실제 배율을 계산기 두드려보고 정하는 게 훨씬 냉정한 판단이 돼요.</p>
  <p class="en">Pair this curve with <a href="/en/blog/hard-to-cut-losses">deciding your stop-loss line in advance</a>. When planning "I'll hold through -20%," calculating that -20% requires +25% to break even alongside it lets you set a far more realistic stop-loss level. Deciding "I can handle this much" by gut feel is a much shakier judgment than running the actual recovery math first.</p>
  <p class="ja">このグラフは<a href="/ja/blog/hard-to-cut-losses">損切りラインを事前に決めること</a>と一緒に使うと良いです。「-20%までは耐える」という計画を立てる時、「-20%からの元本回復には+25%が必要」ということを併せて計算しておけば、損切りラインをはるかに現実的な数字に設定できます。感覚で「これくらいは耐えられる」と決めるより、回復に必要な実際の倍率を計算してから決める方がはるかに冷静な判断になります。</p>
  <p class="es">Combina esta curva con <a href="/es/blog/hard-to-cut-losses">decidir tu línea de stop-loss de antemano</a>. Al planificar "aguantaré hasta -20%," calcular que -20% requiere +25% para recuperar el equilibrio junto con eso te permite fijar un nivel de stop-loss mucho más realista. Decidir "puedo soportar esto" por instinto es un juicio mucho más inestable que calcular primero las matemáticas reales de recuperación.</p>
  <p class="de">Kombiniere diese Kurve mit <a href="/de/blog/hard-to-cut-losses">deine Stop-Loss-Linie im Voraus festzulegen</a>. Wenn du planst "ich halte bis -20% durch," lässt dich die gleichzeitige Berechnung, dass -20% +25% zum Ausgleich braucht, ein weit realistischeres Stop-Loss-Niveau festlegen. "Das kann ich aushalten" aus dem Bauch heraus zu entscheiden, ist ein viel wackligeres Urteil, als zuerst die tatsächliche Erholungsmathematik durchzurechnen.</p>
  <p class="fr">Associez cette courbe à la <a href="/fr/blog/hard-to-cut-losses">décision de fixer votre seuil de stop-loss à l'avance</a>. Quand vous prévoyez de « tenir jusqu'à -20 % », calculer en même temps qu'un -20 % exige +25 % pour revenir à l'équilibre vous permet de fixer un niveau de stop-loss bien plus réaliste. Décider « je peux encaisser ça » au feeling est un jugement bien plus fragile que de faire d'abord le vrai calcul de récupération.</p>
  <p class="pt">Combine essa curva com a <a href="/pt/blog/hard-to-cut-losses">decisão de definir sua linha de stop-loss com antecedência</a>. Ao planejar "vou aguentar até -20%," calcular junto que -20% exige +25% para empatar permite definir um nível de stop-loss muito mais realista. Decidir "eu aguento isso" apenas no instinto é um julgamento muito mais instável do que fazer antes a conta real de recuperação.</p>
  <p class="tr">Bu eğriyi <a href="/tr/blog/hard-to-cut-losses">stop-loss seviyenizi önceden belirleme</a> kararıyla birlikte kullanın. "%-20'ye kadar dayanırım" diye planlarken, %-20'nin başa baş noktasına dönmek için %+25 gerektirdiğini de hesaba katmak çok daha gerçekçi bir stop-loss seviyesi belirlemenizi sağlar. "Bu kadarına dayanabilirim" diye içgüdüyle karar vermek, önce gerçek toparlanma hesaplamasını yapmaktan çok daha zayıf bir karardır.</p>
  <p class="vi">Kết hợp đường cong này với việc <a href="/vi/blog/hard-to-cut-losses">xác định trước ngưỡng cắt lỗ</a>. Khi lên kế hoạch "mình sẽ chịu đựng đến -20%," việc tính thêm rằng -20% cần +25% để hòa vốn sẽ giúp bạn đặt ra một mức cắt lỗ thực tế hơn nhiều. Quyết định "mình chịu được mức này" theo cảm tính là một phán đoán mong manh hơn nhiều so với việc tính toán con số hồi phục thực tế trước.</p>
