...
<p class="ko"><a href="/blog/clarity-act-stalled.html">CLARITY 법안</a> 얘기가 나오면 다들 반응이 비슷해요. "통과되면 알트코인 오르겠네." 틀린 말은 아니에요. 근데 딱 거기서 생각이 멈춰버리는 게 아쉬워요. 진짜 재밌는 건 그다음부터거든요. 1차 효과 말고, 그 1차 효과가 다시 만들어내는 2차, 3차 효과까지 따라가보면 완전히 다른 그림이 나옵니다.</p>
  <p class="en">Mention <a href="/blog/clarity-act-stalled.html">the CLARITY Act</a> and the reaction is almost always the same: "altcoins will pump if it passes." Not wrong. But stopping there misses the interesting part. Follow the first-order effect into the second- and third-order effects it triggers, and a very different picture emerges.</p>
  <p class="ja"><a href="/blog/clarity-act-stalled.html">CLARITY法案</a>の話が出ると皆の反応はほぼ同じです。「成立すればアルトコインが上がるね」。間違いではありません。しかしそこで思考が止まってしまうのが惜しいです。本当に面白いのはその先です。一次効果だけでなく、その一次効果がさらに生む二次、三次効果まで追いかけると、まったく違う絵が見えてきます。</p>
