<?php $slug = 'nupl'; require __DIR__.'/_header.php'; ?>
  ...
  <p class="fr">Un graphique de prix seul ne permet pas de savoir si le marché est saisi par la peur ou grisé par la cupidité. Mais la blockchain enregistre <strong>à quel prix chaque investisseur a acheté</strong> ses pièces. Le <strong>NUPL (Net Unrealized Profit/Loss, profit/perte net non réalisé)</strong> utilise ces données pour condenser l'état de profit ou de perte de l'ensemble du marché en un seul chiffre. C'est l'un des indicateurs de sentiment les plus fiables, ayant marqué à la fois le creux et le sommet lors des trois derniers cycles.</p>
  <p class="pt">Um gráfico de preços por si só não revela se o mercado está dominado pelo medo ou embriagado de ganância. Mas a blockchain registra <strong>a que preço cada investidor comprou</strong> suas moedas. O <strong>NUPL (Net Unrealized Profit/Loss, lucro/prejuízo líquido não realizado)</strong> usa esses dados para condensar o estado de lucro ou prejuízo de todo o mercado em um único número. É um dos indicadores de sentimento mais confiáveis, tendo marcado tanto o fundo quanto o topo nos últimos três ciclos.</p>
  <p class="tr">Yalnızca bir fiyat grafiğine bakarak piyasanın korkuya mı yoksa açgözlülüğe mi kapıldığını anlayamazsınız. Ancak blok zinciri, her yatırımcının paralarını <strong>ne fiyattan aldığını</strong> kaydeder. <strong>NUPL (Net Unrealized Profit/Loss, Net Gerçekleşmemiş Kâr/Zarar)</strong>, bu veriyi kullanarak tüm piyasanın kâr veya zarar durumunu tek bir sayıya sıkıştırır. Son üç döngüde hem dibi hem de tepeyi işaretlemiş, en güvenilir duyarlılık göstergelerinden biridir.</p>
  <p class="vi">Chỉ nhìn biểu đồ giá thôi thì không thể biết thị trường đang chìm trong sợ hãi hay say sưa trong lòng tham. Nhưng blockchain lại ghi lại <strong>mức giá mà mỗi nhà đầu tư đã mua</strong> đồng coin của họ. <strong>NUPL (Net Unrealized Profit/Loss, Lãi/Lỗ chưa thực hiện ròng)</strong> sử dụng dữ liệu này để nén trạng thái lãi hay lỗ của toàn bộ thị trường thành một con số duy nhất. Đây là một trong những chỉ báo tâm lý đáng tin cậy nhất, từng đánh dấu cả đáy lẫn đỉnh trong ba chu kỳ gần nhất.</p>
  ...
  <div class="box fr">💡 <strong>À retenir :</strong> NUPL = (Capitalisation boursière − Capitalisation réalisée) ÷ Capitalisation boursière. En dessous de 0, l'ensemble du marché est en perte (signal de capitulation/creux) ; au-dessus de 0,5, c'est la cupidité ; au-dessus de 0,75, c'est l'euphorie (avertissement de sommet). Les creux de 2018 et 2022 se situaient près de 0 ou en dessous ; les sommets de 2017 et 2021 avoisinaient 0,75.</div>
  <div class="box pt">💡 <strong>Resumo:</strong> NUPL = (Cap. de Mercado − Cap. Realizada) ÷ Cap. de Mercado. Abaixo de 0, todo o mercado está no prejuízo (sinal de capitulação/fundo); acima de 0,5 é ganância; acima de 0,75 é euforia (aviso de topo). Os fundos de 2018 e 2022 ficaram perto de 0 ou abaixo; os topos de 2017 e 2021 ficaram em torno de 0,75.</div>
  <div class="box tr">💡 <strong>Önemli çıkarım:</strong> NUPL = (Piyasa Değeri − Gerçekleşen Değer) ÷ Piyasa Değeri. 0'ın altı, tüm piyasanın zararda olduğu anlamına gelir (kapitülasyon/dip sinyali); 0,5 üzeri açgözlülük; 0,75 üzeri ise coşku (tepe uyarısı) anlamına gelir. 2018 ve 2022 dipleri 0 civarında veya altındaydı; 2017 ve 2021 tepeleri ise 0,75 civarında seyretti.</div>
  <div class="box vi">💡 <strong>Tóm tắt:</strong> NUPL = (Vốn hóa thị trường − Vốn hóa thực hiện) ÷ Vốn hóa thị trường. Dưới 0 nghĩa là toàn thị trường đang lỗ (tín hiệu đầu hàng/đáy); trên 0,5 là lòng tham; trên 0,75 là hưng phấn thái quá (cảnh báo đỉnh). Đáy năm 2018 và 2022 nằm quanh hoặc dưới mức 0; đỉnh năm 2017 và 2021 dao động quanh mức 0,75.</div>
  ...
  <h2 class="fr">Visualisé par zone</h2>
  <h2 class="pt">Visualizado por zona</h2>
  <h2 class="tr">Bölgelere göre görselleştirme</h2>
  <h2 class="vi">Trực quan hóa theo vùng</h2>
  ...
  <h2 class="fr">Qu'est-ce que le NUPL ?</h2>
  <h2 class="pt">O que é o NUPL?</h2>
  <h2 class="tr">NUPL Nedir?</h2>
  <h2 class="vi">NUPL Là Gì?</h2>
  ...
  <p class="fr">Pour comprendre le NUPL, il faut connaître trois concepts, dans l'ordre. Décomposons chacun d'eux.</p>
  <p class="pt">Para entender o NUPL, você precisa de três conceitos em sequência. Vamos detalhar cada um.</p>
  <p class="tr">NUPL'ı anlamak için sırasıyla üç kavramı bilmeniz gerekir. Her birini tek tek inceleyelim.</p>
  <p class="vi">Để hiểu NUPL, bạn cần nắm ba khái niệm theo thứ tự. Hãy cùng phân tích từng khái niệm.</p>
  ...
  <h3 class="fr">1. Valeur de marché (Market Cap)</h3>
  <h3 class="pt">1. Valor de Mercado (Market Cap)</h3>
  <h3 class="tr">1. Piyasa Değeri (Market Cap)</h3>
  <h3 class="vi">1. Giá trị thị trường (Market Cap)</h3>
  ...
  <p class="fr">Prix actuel de la pièce × offre en circulation. C'est la fameuse « capitalisation boursière » — la valorisation du marché à cet instant précis. Si le Bitcoin est à 60 000 $ avec 19,6 millions de pièces en circulation, la valeur de marché est d'environ 1,18 billion de dollars.</p>
  <p class="pt">Preço atual da moeda × oferta em circulação. É a conhecida "capitalização de mercado" — a avaliação do mercado neste momento. Se o Bitcoin está a $60.000 com 19,6 milhões de moedas em circulação, o valor de mercado é de cerca de $1,18 trilhão.</p>
  <p class="tr">Güncel coin fiyatı × dolaşımdaki arz. Bu, bildiğimiz "piyasa değeri"dir — piyasanın şu anki değerlemesi. Bitcoin 60.000 $ değerinde ve dolaşımda 19,6 milyon coin varsa, piyasa değeri yaklaşık 1,18 trilyon dolardır.</p>
  <p class="vi">Giá coin hiện tại × nguồn cung lưu hành. Đây chính là "vốn hóa thị trường" quen thuộc — mức định giá của thị trường tại thời điểm hiện tại. Nếu Bitcoin ở mức 60.000 đô la với 19,6 triệu coin đang lưu hành, giá trị thị trường vào khoảng 1,18 nghìn tỷ đô la.</p>
  ...
  <h3 class="fr">2. Valeur réalisée (Realized Cap)</h3>
  <h3 class="pt">2. Valor Realizado (Realized Cap)</h3>
  <h3 class="tr">2. Gerçekleşen Değer (Realized Cap)</h3>
  <h3 class="vi">2. Giá trị đã thực hiện (Realized Cap)</h3>
  ...
  <p class="fr">Chaque pièce n'est pas évaluée au « prix du jour », mais au « prix au moment de son dernier transfert entre portefeuilles », puis ces valeurs sont additionnées. Cela représente le capital total réellement payé par le marché. Une pièce achetée 10 000 $ il y a cinq ans et jamais déplacée depuis compte toujours pour 10 000 $. C'est le coût d'acquisition total du marché.</p>
  <p class="pt">Cada moeda é avaliada não pelo "preço de hoje", mas pelo "preço no momento em que se moveu pela última vez entre carteiras", e depois somada. Isso representa o capital total que o mercado efetivamente pagou. Uma moeda comprada a $10.000 há cinco anos e nunca movimentada ainda conta como $10.000. Esse é o custo total de aquisição do mercado.</p>
  <p class="tr">Her coin, "bugünün fiyatından" değil, "cüzdanlar arasında son kez taşındığı andaki fiyattan" değerlenir ve ardından toplanır. Bu, piyasanın fiilen ödediği toplam sermayeyi temsil eder. Beş yıl önce 10.000 dolardan alınıp bir daha hiç taşınmamış bir coin, hâlâ 10.000 dolar olarak sayılır. Bu, piyasanın toplam maliyet tabanıdır.</p>
  <p class="vi">Mỗi đồng coin không được định giá theo "giá hôm nay" mà theo "mức giá tại lần cuối cùng nó di chuyển giữa các ví", sau đó được cộng tổng lại. Con số này thể hiện tổng vốn mà thị trường thực sự đã bỏ ra. Một đồng coin được mua với giá 10.000 đô la cách đây năm năm và chưa từng di chuyển vẫn được tính là 10.000 đô la. Đây chính là tổng giá vốn của thị trường.</p>
  ...
  <h3 class="fr">3. Normaliser le P&L non réalisé</h3>
  <h3 class="pt">3. Normalizando o P&L Não Realizado</h3>
  <h3 class="tr">3. Gerçekleşmemiş Kâr/Zararı Normalleştirme</h3>
  <h3 class="vi">3. Chuẩn hóa Lãi/Lỗ chưa thực hiện</h3>
  ...
  <p class="fr">En soustrayant la valeur réalisée de la valeur de marché, on obtient le <strong>profit/perte non réalisé (gains/pertes latents)</strong> total du marché. En divisant ce montant par la capitalisation boursière, on obtient un ratio compris entre −1 et +1 — c'est le NUPL. Comme il s'agit d'un ratio et non d'un chiffre absolu, on peut le comparer directement d'un cycle à l'autre, même lorsque la capitalisation boursière augmente. C'est la principale force du NUPL.</p>
  <p class="pt">Subtrair o valor realizado do valor de mercado dá o <strong>lucro/prejuízo não realizado (ganhos/perdas no papel)</strong> total do mercado. Dividir isso pela capitalização de mercado transforma o resultado em uma proporção de −1 a +1 — esse é o NUPL. Por ser uma proporção, e não um valor absoluto, é possível comparar diretamente entre ciclos mesmo quando a capitalização de mercado cresce. Essa é a principal força do NUPL.</p>
  <p class="tr">Piyasa değerinden gerçekleşen değeri çıkarmak, piyasanın toplam <strong>gerçekleşmemiş kâr/zararını (kağıt üzerindeki kazanç/kayıp)</strong> verir. Bunu piyasa değerine bölmek, sonucu −1 ile +1 arasında bir orana dönüştürür — bu da NUPL'dır. Mutlak bir rakam değil, bir oran olduğu için, piyasa değeri büyüse bile döngüler arasında doğrudan karşılaştırma yapılabilir. NUPL'ın temel gücü de budur.</p>
  <p class="vi">Lấy giá trị thị trường trừ đi giá trị đã thực hiện sẽ cho ra tổng <strong>lãi/lỗ chưa thực hiện (lãi/lỗ trên giấy)</strong> của thị trường. Chia con số đó cho vốn hóa thị trường sẽ biến nó thành một tỷ lệ từ −1 đến +1 — đó chính là NUPL. Vì đây là một tỷ lệ chứ không phải con số tuyệt đối, bạn có thể so sánh trực tiếp giữa các chu kỳ ngay cả khi vốn hóa thị trường tăng lên. Đây chính là điểm mạnh cốt lõi của NUPL.</p>
  ...
  <h2 class="tr">Bölge Yorumlaması</h2>
  ...
  <table class="zt fr">
    <tr><th>NUPL</th><th>Phase de sentiment</th><th>Signification</th><th>Signal</th></tr>
    <tr><td class="g">Sous 0</td><td>Capitulation</td><td>Majorité en perte, vente panique</td><td class="g">Achat fort</td></tr>
    <tr><td class="g">0 – 0,25</td><td>Espoir / Peur</td><td>Proche du seuil de rentabilité, formation d'un plancher</td><td class="g">Zone d'achat</td></tr>
    <tr><td class="y">0,25 – 0,5</td><td>Optimisme / Déni</td><td>Profit moyen en hausse</td><td class="y">Neutre / Conserver</td></tr>
    <tr><td class="r">0,5 – 0,75</td><td>Cupidité</td><td>Surchauffe, prises de profit</td><td class="r">Envisager une prise de profit</td></tr>
    <tr><td class="r">Au-dessus de 0,75</td><td>Euphorie</td><td>Zone de sommet historique</td><td class="r">Avertissement de sommet / Réduction</td></tr>
  </table>
  <table class="zt pt">
    <tr><th>NUPL</th><th>Fase de Sentimento</th><th>Significado</th><th>Sinal</th></tr>
    <tr><td class="g">Abaixo de 0</td><td>Capitulação</td><td>Maioria no prejuízo, venda em pânico</td><td class="g">Compra Forte</td></tr>
    <tr><td class="g">0 – 0,25</td><td>Esperança / Medo</td><td>Próximo do ponto de equilíbrio, formando fundo</td><td class="g">Zona de Compra</td></tr>
    <tr><td class="y">0,25 – 0,5</td><td>Otimismo / Negação</td><td>Lucro médio em expansão</td><td class="y">Neutro / Manter</td></tr>
    <tr><td class="r">0,5 – 0,75</td><td>Ganância</td><td>Sobreaquecimento, oferta de realização de lucro</td><td class="r">Considerar Realizar Lucro</td></tr>
    <tr><td class="r">Acima de 0,75</td><td>Euforia</td><td>Zona de topo histórica</td><td class="r">Aviso de Topo / Reduzir Posição</td></tr>
  </table>
  <table class="zt tr">
    <tr><th>NUPL</th><th>Duyarlılık Aşaması</th><th>Anlamı</th><th>Sinyal</th></tr>
    <tr><td class="g">0'ın altı</td><td>Kapitülasyon</td><td>Çoğunluk zararda, panik satışı</td><td class="g">Güçlü Al</td></tr>
    <tr><td class="g">0 – 0,25</td><td>Umut / Korku</td><td>Başabaşa yakın, taban oluşumu</td><td class="g">Alım Bölgesi</td></tr>
    <tr><td class="y">0,25 – 0,5</td><td>İyimserlik / İnkâr</td><td>Ortalama kâr genişliyor</td><td class="y">Nötr / Tut</td></tr>
    <tr><td class="r">0,5 – 0,75</td><td>Açgözlülük</td><td>Aşırı ısınma, kâr satışı arzı</td><td class="r">Kâr Almayı Değerlendir</td></tr>
    <tr><td class="r">0,75 üzeri</td><td>Coşku</td><td>Tarihsel tepe bölgesi</td><td class="r">Tepe Uyarısı / Kademeli Sat</td></tr>
  </table>
  <table class="zt vi">
    <tr><th>NUPL</th><th>Giai Đoạn Tâm Lý</th><th>Ý Nghĩa</th><th>Tín Hiệu</th></tr>
    <tr><td class="g">Dưới 0</td><td>Đầu hàng</td><td>Đa số lỗ, bán tháo hoảng loạn</td><td class="g">Mua Mạnh</td></tr>
    <tr><td class="g">0 – 0,25</td><td>Hy vọng / Sợ hãi</td><td>Gần điểm hòa vốn, tạo đáy</td><td class="g">Vùng Mua</td></tr>
    <tr><td class="y">0,25 – 0,5</td><td>Lạc quan / Phủ nhận</td><td>Lợi nhuận trung bình mở rộng</td><td class="y">Trung Lập / Giữ</td></tr>
    <tr><td class="r">0,5 – 0,75</td><td>Lòng tham</td><td>Quá nóng, nguồn cung chốt lời</td><td class="r">Cân Nhắc Chốt Lời</td></tr>
    <tr><td class="r">Trên 0,75</td><td>Hưng phấn thái quá</td><td>Vùng đỉnh lịch sử</td><td class="r">Cảnh Báo Đỉnh / Giảm Dần Vị Thế</td></tr>
  </table>
  ...
  <p class="fr"><strong>Déc. 2017 (Euphorie) :</strong> Lorsque le Bitcoin a culminé à 20 000 $, le NUPL a franchi la barre de 0,75 pour entrer en euphorie. Une baisse de 84 % a suivi au cours de l'année suivante. <strong>Déc. 2018 (Capitulation) :</strong> Au plancher de 3 200 $, le NUPL est tombé près de 0 — une opportunité d'achat historique. <strong>2021 (Euphorie) :</strong> Les deux sommets ont enregistré un NUPL supérieur à 0,7. <strong>Nov. 2022 (Capitulation) :</strong> L'effondrement de FTX a fait chuter le NUPL sous −0,1, plaçant l'ensemble du marché en perte — et ce point a marqué le creux du cycle.</p>
  <p class="pt"><strong>Dez 2017 (Euforia):</strong> Quando o Bitcoin atingiu o topo de $20.000, o NUPL ultrapassou 0,75, entrando em euforia. Uma queda de 84% se seguiu ao longo do ano seguinte. <strong>Dez 2018 (Capitulação):</strong> No fundo de $3.200, o NUPL caiu perto de 0 — uma oportunidade de compra histórica. <strong>2021 (Euforia):</strong> Ambos os picos registraram NUPL acima de 0,7. <strong>Nov 2022 (Capitulação):</strong> O colapso da FTX arrastou o NUPL para abaixo de −0,1, deixando todo o mercado no prejuízo — e esse foi o fundo do ciclo.</p>
  <p class="tr"><strong>Ara. 2017 (Coşku):</strong> Bitcoin 20.000 dolarla zirve yaptığında, NUPL 0,75'in üzerine çıkarak coşku bölgesine girdi. Ardından gelen bir yıl içinde %84'lük bir düşüş yaşandı. <strong>Ara. 2018 (Kapitülasyon):</strong> 3.200 dolarlık dipte NUPL 0'a yakın bir seviyeye düştü — tarihi bir alım fırsatıydı. <strong>2021 (Coşku):</strong> Her iki zirvede de NUPL 0,7'nin üzerinde kaydedildi. <strong>Kas. 2022 (Kapitülasyon):</strong> FTX'in çöküşü NUPL'ı −0,1'in altına çekti ve tüm piyasayı zarara soktu — bu nokta döngünün dibini işaret etti.</p>
  <p class="vi"><strong>Tháng 12/2017 (Hưng phấn thái quá):</strong> Khi Bitcoin lập đỉnh ở mức 20.000 đô la, NUPL vượt mốc 0,75 để bước vào vùng hưng phấn. Sau đó thị trường giảm 84% trong năm tiếp theo. <strong>Tháng 12/2018 (Đầu hàng):</strong> Tại đáy 3.200 đô la, NUPL rơi xuống gần mức 0 — một cơ hội mua mang tính lịch sử. <strong>Năm 2021 (Hưng phấn thái quá):</strong> Cả hai đỉnh đều ghi nhận NUPL trên mức 0,7. <strong>Tháng 11/2022 (Đầu hàng):</strong> Sự sụp đổ của FTX đã kéo NUPL xuống dưới −0,1, khiến toàn bộ thị trường rơi vào trạng thái lỗ — và đây chính là đáy của chu kỳ.</p>
  ...
  <h2 class="fr">En quoi diffère-t-il du MVRV ?</h2>
  <h2 class="pt">Qual a Diferença para o MVRV?</h2>
  <h2 class="tr">MVRV'den Farkı Nedir?</h2>
  <h2 class="vi">Khác Gì So Với MVRV?</h2>
  ...
  <p class="fr">Le NUPL et le MVRV s'appuient tous deux sur la valeur réalisée, mais l'expriment différemment. Le MVRV est la capitalisation boursière <em>divisée</em> par la valeur réalisée (un multiple) ; le NUPL est la <em>différence</em> normalisée par la capitalisation boursière (un ratio). La ligne zéro du NUPL sépare nettement le profit de la perte, rendant les phases de sentiment intuitives ; le MVRV excelle à exprimer le degré de surchauffe sous forme de multiple (par ex. 3x). En pratique, la confiance augmente fortement lorsque les deux indicateurs donnent le même signal.</p>
  <p class="pt">NUPL e MVRV se baseiam ambos no valor realizado, mas expressam isso de forma diferente. O MVRV é a capitalização de mercado <em>dividida</em> pelo valor realizado (um múltiplo); o NUPL é a <em>diferença</em> normalizada pela capitalização de mercado (uma proporção). A linha zero do NUPL separa claramente lucro de prejuízo, tornando as fases de sentimento intuitivas; o MVRV se destaca ao expressar o grau de sobreaquecimento como um múltiplo (ex.: 3x). Na prática, a confiança aumenta muito quando ambos apontam o mesmo sinal.</p>
  <p class="tr">NUPL ve MVRV, ikisi de gerçekleşen değere dayanır ancak farklı şekilde ifade edilir. MVRV, piyasa değerinin gerçekleşen değere <em>bölünmesiyle</em> elde edilen bir katsayıdır; NUPL ise bu <em>farkın</em> piyasa değerine göre normalleştirilmiş halidir (bir oran). NUPL'ın sıfır çizgisi kâr ile zararı net biçimde ayırır ve duyarlılık aşamalarını sezgisel hale getirir; MVRV ise aşırı ısınma derecesini bir katsayı (örn. 3x) olarak ifade etmede güçlüdür. Pratikte, ikisi aynı sinyali verdiğinde güven büyük ölçüde artar.</p>
  <p class="vi">NUPL và MVRV đều dựa trên giá trị đã thực hiện nhưng thể hiện theo cách khác nhau. MVRV là vốn hóa thị trường <em>chia</em> cho giá trị đã thực hiện (một hệ số bội); NUPL là <em>hiệu số</em> được chuẩn hóa theo vốn hóa thị trường (một tỷ lệ). Đường số 0 của NUPL phân tách rõ ràng giữa lãi và lỗ, giúp các giai đoạn tâm lý trở nên trực quan; MVRV lại nổi bật khi thể hiện mức độ quá nóng dưới dạng hệ số bội (ví dụ: 3 lần). Trong thực tế, độ tin cậy tăng mạnh khi cả hai cùng đưa ra tín hiệu giống nhau.</p>
  ...
  <p class="fr">Le NUPL est efficace pour juger les cycles à moyen et long terme, mais lent comme signal à court terme. Dans les marchés haussiers, il peut rester dans la zone de cupidité pendant des mois, donc une utilisation mécanique (« au-dessus de 0,75, tout vendre immédiatement ») fait manquer une hausse majeure. Les pièces perdues et l'offre des baleines dormante depuis des années peuvent aussi fausser la valeur réalisée. Associez-le toujours à des indicateurs à court terme (SOPR, taux de financement) et privilégiez la tendance et la direction plutôt que les niveaux absolus.</p>
  <p class="pt">O NUPL é forte para avaliar ciclos de médio a longo prazo, mas lento como sinal de curto prazo. Em mercados de alta, pode permanecer na zona de ganância por meses, então o uso mecânico ("acima de 0,75, vender tudo agora") faz perder grandes altas. Moedas perdidas e a oferta de baleias inativa por anos também podem distorcer o valor realizado. Combine-o sempre com indicadores de curto prazo (SOPR, taxa de financiamento) e leia a tendência e a direção, não os níveis absolutos.</p>
  <p class="tr">NUPL, orta-uzun vadeli döngü değerlendirmesinde güçlüdür ancak kısa vadeli bir sinyal olarak yavaştır. Boğa piyasalarında aylarca açgözlülük bölgesinde kalabilir, bu yüzden "0,75 üzerinde, hemen her şeyi sat" gibi mekanik bir kullanım büyük yükselişleri kaçırmanıza neden olabilir. Kaybolan coinler ve yıllardır hareket etmeyen balina arzı da gerçekleşen değeri çarpıtabilir. Her zaman kısa vadeli göstergelerle (SOPR, fonlama oranı) birlikte kullanın ve mutlak seviyeler yerine trend ve yönü okuyun.</p>
  <p class="vi">NUPL mạnh trong việc đánh giá chu kỳ trung đến dài hạn nhưng chậm khi dùng làm tín hiệu ngắn hạn. Trong thị trường tăng giá, nó có thể duy trì ở vùng lòng tham trong nhiều tháng, vì vậy việc áp dụng máy móc ("trên 0,75 thì bán hết ngay") sẽ khiến bạn bỏ lỡ những đợt tăng lớn. Các đồng coin bị mất và nguồn cung của cá voi nằm im nhiều năm cũng có thể làm sai lệch giá trị đã thực hiện. Luôn kết hợp với các chỉ báo ngắn hạn (SOPR, tỷ lệ funding) và đọc theo xu hướng, hướng đi thay vì các mức tuyệt đối.</p>
  ...
  <h2 class="fr">Indicateurs à combiner</h2>
  <h2 class="pt">Indicadores Complementares</h2>
  <h2 class="tr">Birlikte Kullanılabilecek Göstergeler</h2>
  <h2 class="vi">Các Chỉ Báo Nên Kết Hợp</h2>
  ...
  <p class="fr">Le NUPL est le plus puissant lorsqu'il est associé au <a href="/blog/mvrv-z-score.php<?= h(langSuffix($lang)) ?>">MVRV Z-Score</a> (valorisation), au <a href="/blog/sth-sopr.php<?= h(langSuffix($lang)) ?>">STH-SOPR</a> (P&L des détenteurs à court terme), et au <a href="/blog/realized-price.php<?= h(langSuffix($lang)) ?>">Prix réalisé</a> (coût d'acquisition du marché). Découvrez comment superposer tous les indicateurs dans le <a href="/blog/onchain-indicators-guide.php<?= h(langSuffix($lang)) ?>">Guide complet des indicateurs on-chain</a>.</p>
  <p class="pt">O NUPL é mais forte junto com o <a href="/blog/mvrv-z-score.php<?= h(langSuffix($lang)) ?>">MVRV Z-Score</a> (avaliação), o <a href="/blog/sth-sopr.php<?= h(langSuffix($lang)) ?>">STH-SOPR</a> (P&L dos detentores de curto prazo) e o <a href="/blog/realized-price.php<?= h(langSuffix($lang)) ?>">Preço Realizado</a> (custo de aquisição do mercado). Veja como combinar todos os indicadores no <a href="/blog/onchain-indicators-guide.php<?= h(langSuffix($lang)) ?>">Guia Completo de Indicadores On-Chain</a>.</p>
  <p class="tr">NUPL, <a href="/blog/mvrv-z-score.php<?= h(langSuffix($lang)) ?>">MVRV Z-Score</a> (değerleme), <a href="/blog/sth-sopr.php<?= h(langSuffix($lang)) ?>">STH-SOPR</a> (kısa vadeli sahip kâr/zararı) ve <a href="/blog/realized-price.php<?= h(langSuffix($lang)) ?>">Gerçekleşen Fiyat</a> (piyasa maliyet tabanı) ile birlikte kullanıldığında en güçlü halini alır. Tüm göstergelerin nasıl bir araya getirileceğini <a href="/blog/onchain-indicators-guide.php<?= h(langSuffix($lang)) ?>">Zincir Üzeri Göstergeler Eksiksiz Rehberi</a>'nde görebilirsiniz.</p>
  <p class="vi">NUPL phát huy sức mạnh cao nhất khi kết hợp với <a href="/blog/mvrv-z-score.php<?= h(langSuffix($lang)) ?>">MVRV Z-Score</a> (định giá), <a href="/blog/sth-sopr.php<?= h(langSuffix($lang)) ?>">STH-SOPR</a> (lãi/lỗ của người nắm giữ ngắn hạn), và <a href="/blog/realized-price.php<?= h(langSuffix($lang)) ?>">Giá Đã Thực Hiện</a> (giá vốn của thị trường). Xem cách kết hợp tất cả các chỉ báo trong <a href="/blog/onchain-indicators-guide.php<?= h(langSuffix($lang)) ?>">Hướng Dẫn Toàn Diện Về Chỉ Báo On-Chain</a>.</p>
  ...
  <div class="box fr">📊 <strong>Sur le tableau de bord BTCtiming,</strong> le NUPL alimente directement le score d'achat/vente. Consultez la valeur NUPL en temps réel et l'ampleur avec laquelle elle fait monter ou descendre le score actuel.</div>
  <div class="box pt">📊 <strong>No painel do BTCtiming,</strong> o NUPL alimenta diretamente a pontuação de compra/venda. Confira o valor do NUPL em tempo real e o quanto ele está elevando ou reduzindo a pontuação atual.</div>
  <div class="box tr">📊 <strong>BTCtiming panosunda</strong> NUPL, alım/satım puanını doğrudan besler. Canlı NUPL değerini ve bunun mevcut puanı ne kadar yukarı veya aşağı çektiğini kontrol edin.</div>
  <div class="box vi">📊 <strong>Trên bảng điều khiển BTCtiming,</strong> NUPL đóng góp trực tiếp vào điểm số mua/bán. Hãy kiểm tra giá trị NUPL theo thời gian thực và mức độ nó đang kéo điểm số hiện tại lên hoặc xuống.</div>
