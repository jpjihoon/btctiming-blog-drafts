...
<p class="id">DBR, token tata kelola (governance) dari protokol interoperabilitas lintas-chain deBridge, membuka kunci 618.33 juta token — sekitar 6.2% dari total pasokan — dalam satu kali rilis pada 17 Juli, senilai sekitar $10.6 juta. Bitget News (mengutip RootData), Odaily, CryptoRank, dan BeInCrypto melaporkan rilis ini.</p>
<p class="pl">DBR, token zarządzający protokołu interoperacyjności międzyłańcuchowej deBridge, odblokował 618.33 miliona tokenów — około 6.2% całkowitej podaży — w jednorazowym uwolnieniu 17 lipca, o wartości około $10.6 miliona. Bitget News (powołując się na RootData), Odaily, CryptoRank i BeInCrypto poinformowały o tym uwolnieniu.</p>
<p class="it">DBR, il token di governance del protocollo di interoperabilità cross-chain deBridge, ha sbloccato 618.33 milioni di token — circa il 6.2% dell'offerta totale — in un unico rilascio il 17 luglio, per un valore di circa $10.6 milioni. Bitget News (citando RootData), Odaily, CryptoRank e BeInCrypto hanno riportato il rilascio.</p>
<p class="ru">DBR, управляющий токен протокола межцепочечной совместимости deBridge, разблокировал 618.33 миллиона токенов — около 6.2% от общего предложения — единовременно 17 июля, на сумму примерно $10.6 миллиона. Bitget News (со ссылкой на RootData), Odaily, CryptoRank и BeInCrypto сообщили об этом релизе.</p>
<p class="zh">跨鏈互通協議deBridge的治理代幣DBR於7月17日一次性解鎖6.1833億枚代幣——約占總發行量的6.2%——價值約1060萬美元。Bitget News(引用RootData)、Odaily、CryptoRank與BeInCrypto均報導了此次解鎖。</p>
...
<p class="id">Token-token tersebut didistribusikan berdasarkan struktur vesting cliff. Menurut rincian Odaily, alokasi Ekosistem melepaskan porsi terbesar sejumlah 191.67 juta token, diikuti oleh Core Contributors sejumlah 133.33 juta, Mitra Strategis sejumlah 113.33 juta, Yayasan deBridge dan kategori Community & Launch masing-masing sejumlah 83.33 juta, serta Validator sejumlah 13.33 juta.</p>
<p class="pl">Tokeny zostały rozdystrybuowane w ramach struktury cliff vesting. Według zestawienia Odaily, alokacja dla Ecosystem uwolniła największą część — 191.67 miliona tokenów, następnie Core Contributors — 133.33 miliona, Strategic Partners — 113.33 miliona, Fundacja deBridge oraz kategoria Community & Launch — po 83.33 miliona każda, oraz Walidatorzy — 13.33 miliona.</p>
<p class="it">I token sono stati distribuiti secondo una struttura di cliff vesting. Secondo la ripartizione di Odaily, l'allocazione Ecosystem ha rilasciato la quota maggiore con 191.67 milioni di token, seguita da Core Contributors con 133.33 milioni, Strategic Partners con 113.33 milioni, dalla Fondazione deBridge e dalla categoria Community & Launch con 83.33 milioni ciascuna, e dai Validatori con 13.33 milioni.</p>
<p class="ru">Токены были распределены по схеме cliff-вестинга. Согласно разбивке Odaily, наибольшая доля пришлась на распределение Ecosystem — 191.67 миллиона токенов, далее следуют Core Contributors — 133.33 миллиона, Strategic Partners — 113.33 миллиона, Фонд deBridge и категория Community & Launch — по 83.33 миллиона каждая, и Валидаторы — 13.33 миллиона.</p>
<p class="zh">這批代幣依照懸崖式(cliff)歸屬結構分配。根據Odaily的細分數據,生態系統(Ecosystem)分配釋放的份額最大,達1.9167億枚,其次是核心貢獻者(Core Contributors)1.3333億枚、策略夥伴(Strategic Partners)1.1333億枚、deBridge基金會與社群暨啟動(Community & Launch)類別各8333萬枚,以及驗證者(Validators)1333萬枚。</p>
...
<h2 class="id">Apa Itu Cliff Unlock — Bedanya Dengan Jadwal Linear WLD</h2>
<h2 class="pl">Czym Jest Odblokowanie Typu Cliff — Czym Różni Się Od Liniowego Harmonogramu WLD</h2>
<h2 class="it">Cos'è uno Sblocco Cliff — In Cosa Differisce Dal Calendario Lineare di WLD</h2>
<h2 class="ru">Что Такое Cliff-Разблокировка — Чем Она Отличается От Линейного Графика WLD</h2>
<h2 class="zh">什麼是懸崖式解鎖 — 與WLD線性排程的差異</h2>
...
<p class="id">Cliff vesting berarti tidak ada token yang dirilis selama periode tunggu tertentu, lalu satu blok besar masuk ke pasar sekaligus pada tanggal yang telah ditetapkan. Ini berbeda dengan vesting linear, di mana jumlah tertentu terbuka secara bertahap setiap hari. Seperti dicatat situs ini pekan lalu dalam liputannya tentang <a href="/id/blog/worldcoin-wld-unlock-rate-43-percent-cut">pemangkasan unlock WLD milik World</a>, WLD mengikuti jadwal linear tanpa cliff yang merilis jumlah tetap setiap hari. Rilis 6.2% deBridge ini merupakan contoh kasus dari filosofi desain yang berlawanan.</p>
<p class="pl">Cliff vesting oznacza, że przez ustalony okres oczekiwania nie uwalnia się żadnych tokenów, a następnie w ustalonym dniu na rynek trafia od razu duża pula. Kontrastuje to z vestingiem liniowym, w którym stała ilość odblokowuje się stopniowo każdego dnia. Jak zauważył ten serwis w zeszłym tygodniu, opisując <a href="/pl/blog/worldcoin-wld-unlock-rate-43-percent-cut">cięcie tempa odblokowań WLD przez World</a>, WLD stosuje harmonogram liniowy bez cliffu, uwalniający stałą ilość codziennie. Uwolnienie 6.2% przez deBridge to studium przypadku przeciwnej filozofii projektowania.</p>
<p class="it">Il cliff vesting significa che nessun token viene rilasciato per un periodo di attesa prestabilito, dopodiché un grande blocco arriva sul mercato tutto in una volta in una data fissa. Ciò contrasta con il vesting lineare, in cui una quantità prestabilita si sblocca gradualmente ogni giorno. Come questo sito ha osservato la scorsa settimana nella sua copertura del <a href="/it/blog/worldcoin-wld-unlock-rate-43-percent-cut">taglio al tasso di unlock di WLD da parte di World</a>, WLD segue un calendario lineare senza cliff che rilascia una quantità fissa ogni giorno. Il rilascio del 6.2% di deBridge è un caso di studio della filosofia di design opposta.</p>
<p class="ru">Cliff-вестинг означает, что в течение установленного периода ожидания токены не выпускаются вовсе, а затем в фиксированную дату на рынок сразу поступает крупный блок. Это контрастирует с линейным вестингом, при котором фиксированное количество разблокируется постепенно каждый день. Как этот сайт отмечал на прошлой неделе в материале о <a href="/ru/blog/worldcoin-wld-unlock-rate-43-percent-cut">сокращении темпов разблокировки WLD компанией World</a>, WLD следует линейному графику без cliff, выпуская фиксированное количество токенов ежедневно. Релиз deBridge на 6.2% — это пример противоположной философии дизайна.</p>
<p class="zh">懸崖式(cliff)歸屬指的是在固定等待期內完全不釋放代幣,之後在指定日期一次性向市場釋出一大筆代幣。這與線性(linear)歸屬形成對比,後者是每天按固定數量逐步解鎖。正如本站上週在報導<a href="/zh/blog/worldcoin-wld-unlock-rate-43-percent-cut">World旗下WLD解鎖速度調降</a>時所指出,WLD採用的是無懸崖、每日釋放固定數量的線性排程。deBridge此次6.2%的釋放正是相反設計理念的典型案例。</p>
...
<p class="id">deBridge adalah protokol lintas-chain yang menghubungkan lebih dari 26 blockchain dan, tidak seperti bridge tradisional, tidak mengunci likuiditas di muka. Sebagai gantinya, deBridge menggunakan model berbasis intent, di mana 'solver' yang saling bersaing langsung memenuhi pesanan lintas-chain pengguna. Menurut Phemex Academy, volume transfer kumulatif telah melampaui $2.35 billion dari 385,000 pengguna, dengan biaya protokol harian sekitar $100,000. Namun, kapitalisasi pasar DBR sangat bervariasi tergantung angka pasokan beredar mana yang digunakan — CoinMarketCap menghitung sekitar 1.92 billion token beredar untuk kapitalisasi pasar sekitar $31.4 juta, sementara CoinGecko dan Tokenomist menghitung kumpulan token yang sudah dibuka kuncinya secara lebih luas, sehingga kapitalisasi pasar mendekati $86.3 juta (dengan valuasi terdilusi penuh sebesar $162.1 juta).</p>
<p class="pl">deBridge to protokół międzyłańcuchowy łączący ponad 26 blockchainów, który — w przeciwieństwie do tradycyjnych mostów — nie blokuje płynności z góry. Zamiast tego wykorzystuje model oparty na intencjach (intent-based), w którym konkurujący ze sobą 'solverzy' bezpośrednio realizują zlecenia użytkowników między łańcuchami. Według Phemex Academy skumulowany wolumen transferów przekroczył $2.35 billion wśród 385,000 użytkowników, przy dziennych opłatach protokołu na poziomie około $100,000. Kapitalizacja rynkowa DBR różni się jednak znacznie w zależności od tego, jaką liczbę podaży w obiegu przyjmiemy — CoinMarketCap liczy około 1.92 billion tokenów w obiegu, co daje kapitalizację bliską $31.4 miliona, podczas gdy CoinGecko i Tokenomist uwzględniają szerszą pulę już odblokowanych tokenów, co daje kapitalizację bliższą $86.3 miliona (przy w pełni rozwodnionej wycenie $162.1 miliona).</p>
<p class="it">deBridge è un protocollo cross-chain che collega più di 26 blockchain e che, a differenza dei bridge tradizionali, non blocca liquidità in anticipo. Utilizza invece un modello basato sull'intento, in cui 'solver' concorrenti eseguono direttamente gli ordini cross-chain degli utenti. Secondo Phemex Academy, il volume cumulativo dei trasferimenti ha superato $2.35 billion tra 385,000 utenti, con commissioni di protocollo giornaliere di circa $100,000. La capitalizzazione di mercato di DBR, tuttavia, varia notevolmente a seconda della cifra di offerta circolante utilizzata — CoinMarketCap conta circa 1.92 billion token in circolazione per una capitalizzazione vicina a $31.4 milioni, mentre CoinGecko e Tokenomist conteggiano un insieme più ampio di token già sbloccati, portando la capitalizzazione più vicina a $86.3 milioni (con una valutazione completamente diluita di $162.1 milioni).</p>
<p class="ru">deBridge — это межцепочечный протокол, соединяющий более 26 блокчейнов, который, в отличие от традиционных мостов, не блокирует ликвидность заранее. Вместо этого он использует модель на основе намерений (intent-based), в которой конкурирующие «солверы» напрямую исполняют межцепочечные заявки пользователей. По данным Phemex Academy, накопленный объём переводов превысил $2.35 billion среди 385,000 пользователей, при дневных комиссиях протокола около $100,000. Рыночная капитализация DBR, однако, сильно различается в зависимости от того, какая цифра оборотного предложения используется — CoinMarketCap учитывает около 1.92 billion токенов в обращении при капитализации около $31.4 миллиона, тогда как CoinGecko и Tokenomist учитывают более широкий пул уже разблокированных токенов, что даёт капитализацию ближе к $86.3 миллиона (при полностью разводнённой оценке в $162.1 миллиона).</p>
<p class="zh">deBridge是連接超過26條區塊鏈的跨鏈協議,與傳統橋接不同,它不會預先鎖定流動性。相反,它採用基於意圖(intent)的模式,由相互競爭的「solver」直接執行用戶的跨鏈訂單。根據Phemex Academy的數據,累計轉帳量已突破23.5億美元,使用者達38.5萬人,每日協議手續費約10萬美元。然而,DBR的市值會因採用哪種流通量口徑而出現顯著差異——CoinMarketCap以約19.2億枚流通代幣計算,市值約3140萬美元;而CoinGecko與Tokenomist則納入更廣泛的已解鎖代幣範圍,將市值計算為接近8630萬美元(完全稀釋估值為1.621億美元)。</p>
...
<h2 class="id">Perdebatan Pasokan Beredar, Dalam Angka — Cara Menghitung Token yang Sudah Dibuka Kuncinya</h2>
<h2 class="pl">Debata o Podaży w Obiegu, w Liczbach — Jak Liczyć Tokeny, Które Są Już Odblokowane</h2>
<h2 class="it">Il Dibattito Sull'Offerta Circolante, in Numeri — Come Contare i Token Già Sbloccati</h2>
<h2 class="ru">Спор о Циркулирующем Предложении в Цифрах — Как Считать Уже Разблокированные Токены</h2>
<h2 class="zh">以數字看流通量爭議 — 如何計算已解鎖的代幣</h2>
...
<p class="id">Kesenjangan hampir tiga kali lipat dalam kapitalisasi pasar ini bukanlah kebetulan. Ini adalah pola yang berulang pada token dengan float rendah dan FDV tinggi, muncul dari kesenjangan antara token yang "sudah dibuka kuncinya" dan token yang benar-benar telah berpindah ke dompet yang bisa menjualnya. Seperti dicatat dalam liputan situs ini sebelumnya tentang Worldcoin, ketika sebuah yayasan atau investor awal menahan token yang sudah dibuka kuncinya alih-alih langsung melepasnya ke pasar — hanya menjualnya secara over-the-counter saat mereka memilih untuk melakukannya — pelacak data pasti berbeda pendapat soal apakah pasokan yang ditahan namun sudah terbuka itu dihitung sebagai beredar. Dalam kasus deBridge, CoinMarketCap mengambil pandangan konservatif, sementara CoinGecko dan Tokenomist menghitung lebih luas.</p>
<p class="pl">Ta niemal trzykrotna różnica w kapitalizacji rynkowej to nie przypadek. To wzorzec powtarzający się wśród tokenów o niskim float i wysokim FDV, wynikający z rozbieżności między tokenami "odblokowanymi" a tokenami, które faktycznie trafiły do portfeli umożliwiających ich sprzedaż. Jak zauważono we wcześniejszym materiale tego serwisu o Worldcoin, gdy fundacja lub wcześni inwestorzy przetrzymują już odblokowane tokeny zamiast kierować je od razu na rynek — sprzedając je pozagiełdowo (OTC) tylko wtedy, gdy sami zdecydują — serwisy śledzące dane nieuchronnie różnią się w ocenie, czy taką przetrzymywaną, lecz odblokowaną podaż liczyć jako będącą w obiegu. W przypadku deBridge CoinMarketCap przyjmuje podejście konserwatywne, podczas gdy CoinGecko i Tokenomist liczą szerzej.</p>
<p class="it">Questo divario quasi triplo nella capitalizzazione di mercato non è una coincidenza. È uno schema che si ripete tra i token a basso float e alto FDV, derivante da un divario tra i token "sbloccati" e quelli effettivamente trasferiti in wallet da cui potrebbero essere venduti. Come già osservato dalla precedente copertura di questo sito su Worldcoin, quando una fondazione o i primi investitori trattengono token già sbloccati invece di immetterli direttamente sul mercato — vendendoli over-the-counter solo quando scelgono di farlo — i tracker di dati sono inevitabilmente in disaccordo sul se contare quell'offerta trattenuta ma sbloccata come circolante. Nel caso di deBridge, CoinMarketCap adotta la visione prudente, mentre CoinGecko e Tokenomist allargano il conteggio.</p>
<p class="ru">Этот почти трёхкратный разрыв в рыночной капитализации — не совпадение. Это паттерн, повторяющийся у токенов с низким флоатом и высоким FDV, возникающий из-за разрыва между токенами, которые «разблокированы», и токенами, которые фактически переместились в кошельки, откуда их можно продать. Как отмечалось в более раннем материале этого сайта о Worldcoin, когда фонд или ранние инвесторы удерживают уже разблокированные токены вместо того, чтобы сразу выпускать их на рынок — продавая их внебиржево (OTC) только по своему усмотрению, — сервисы отслеживания данных неизбежно расходятся во мнениях, считать ли такое удерживаемое, но разблокированное предложение циркулирующим. В случае deBridge CoinMarketCap придерживается консервативного взгляда, тогда как CoinGecko и Tokenomist используют более широкий подход.</p>
<p class="zh">這近三倍的市值差距並非巧合。這是低流通量、高完全稀釋估值(low-float, high-FDV)代幣中反覆出現的模式,源自「已解鎖」代幣與實際已轉入可供出售錢包的代幣之間的落差。正如本站先前報導World幣時所指出,當基金會或早期投資人持有已解鎖代幣卻不直接投放市場——只在自己選擇的時機進行場外(OTC)交易——數據追蹤機構在是否將這類「持有但已解鎖」的供應量計入流通量時,勢必會出現分歧。就deBridge而言,CoinMarketCap採取保守估算,而CoinGecko與Tokenomist則採用更寬鬆的統計範圍。</p>
...
<p class="id">Meski begitu, apakah rilis 618.33-million-token ini sendiri akan berujung pada aksi jual besar-besaran adalah pertanyaan lain. Rincian menunjukkan Core Contributors, Strategic Partners, dan Foundation bersama-sama mencakup lebih dari setengah total, dan pemegang-pemegang ini umumnya memiliki insentif untuk menahan dalam jangka panjang — pertimbangan reputasi dan tata kelola yang tetap ada bahkan setelah unlock — yang membatasi kemungkinan aksi jual besar-besaran secara langsung. Sebaliknya, alokasi Ecosystem sebesar 191.67 million token bisa mengalir relatif cepat ke program insentif atau penyediaan likuiditas, yang berarti tekanan jual sesungguhnya kemungkinan akan berbeda menurut kategori.</p>
<p class="pl">Niemniej jednak, czy samo to uwolnienie 618.33 miliona tokenów przełoży się na silną wyprzedaż, to osobna kwestia. Zestawienie pokazuje, że Core Contributors, Strategic Partners i Foundation razem odpowiadają za ponad połowę całości, a posiadacze ci na ogół mają motywację do długoterminowego przetrzymywania — względy reputacyjne i związane z zarządzaniem, które utrzymują się nawet po odblokowaniu — co ogranicza prawdopodobieństwo natychmiastowej, masowej wyprzedaży. Z kolei alokacja Ecosystem w wysokości 191.67 miliona tokenów mogłaby stosunkowo szybko trafić do programów motywacyjnych lub zasilania płynności, co oznacza, że rzeczywista presja sprzedażowa może się różnić w zależności od kategorii.</p>
<p class="it">Resta comunque da vedere se questo rilascio di 618.33 milioni di token si tradurrà di per sé in forti vendite. La ripartizione mostra che Core Contributors, Strategic Partners e Foundation insieme rappresentano oltre la metà del totale, e questi detentori hanno generalmente incentivi a mantenere una posizione a lungo termine — considerazioni reputazionali e di governance che persistono anche dopo lo sblocco — il che limita la probabilità di vendite immediate e massicce. L'allocazione Ecosystem di 191.67 milioni di token, al contrario, potrebbe fluire relativamente in fretta verso programmi di incentivo o fornitura di liquidità, il che significa che la pressione di vendita effettiva potrebbe differire a seconda della categoria.</p>
<p class="ru">Тем не менее, приведёт ли сам этот релиз в 618.33 миллиона токенов к сильным продажам — отдельный вопрос. Разбивка показывает, что на Core Contributors, Strategic Partners и Foundation вместе приходится более половины общего объёма, а эти держатели, как правило, заинтересованы в долгосрочном удержании — репутационные и управленческие соображения сохраняются даже после разблокировки, — что снижает вероятность немедленной массовой распродажи. Распределение Ecosystem в размере 191.67 миллиона токенов, напротив, может относительно быстро направляться в программы стимулирования или обеспечение ликвидности, а значит, реальное давление продаж, вероятно, будет различаться по категориям.</p>
<p class="zh">不過,這6.1833億枚代幣的釋放本身是否會轉化為大量拋售,是另一個問題。細分數據顯示,核心貢獻者、策略夥伴與基金會合計占總量一半以上,而這些持有者通常有長期持有的誘因——即使解鎖後,聲譽與治理方面的考量依然存在——這降低了立即大規模拋售的可能性。相對地,1.9167億枚的生態系統分配,較有可能相對快速地流入激勵計畫或流動性供應,意味著實際賣壓很可能因類別而異。</p>
...
<h2 class="id">Yang Perlu Diperhatikan — deBridge Muncul di Tengah Musim Unlock</h2>
<h2 class="pl">Na Co Zwrócić Uwagę — deBridge Trafia w Sam Środek Sezonu Odblokowań</h2>
<h2 class="it">Cosa Osservare — deBridge Arriva Nel Bel Mezzo Della Stagione degli Unlock</h2>
<h2 class="ru">На Что Обратить Внимание — deBridge Выходит в Разгар Сезона Разблокировок</h2>
<h2 class="zh">值得關注的重點 — deBridge正值解鎖季高峰期</h2>
...
<p class="id">Unlock deBridge bukan peristiwa yang berdiri sendiri. Menurut catatan BeInCrypto, pasar secara keseluruhan melihat $660.8 million token baru dirilis sepanjang minggu 12-19 Juli, dengan Connex (CONX), deBridge (DBR), dan Arbitrum (ARB) termasuk di antara yang melepas pasokan. Hanya sehari sebelumnya, pada 16 Juli, Arbitrum membuka kunci 96.24 million token — 0.96% dari total pasokan, senilai sekitar $8.87 million. Ketika jadwal unlock beberapa proyek mengelompok pada minggu yang sama, pelaku pasar secara luas khawatir bahwa tekanan jual yang tumpang tindih di berbagai token dapat memperbesar tekanan pada likuiditas altcoin secara keseluruhan.</p>
<p class="pl">Odblokowanie deBridge nie jest wydarzeniem odosobnionym. Według zestawienia BeInCrypto, w tygodniu 12-19 lipca na całym rynku pojawia się $660.8 million nowo uwolnionych tokenów, a wśród podmiotów uwalniających podaż są Connex (CONX), deBridge (DBR) oraz Arbitrum (ARB). Zaledwie dzień wcześniej, 16 lipca, Arbitrum odblokowało 96.24 million tokenów — 0.96% całkowitej podaży, o wartości około $8.87 million. Gdy harmonogramy odblokowań wielu projektów kumulują się w tym samym tygodniu, uczestnicy rynku powszechnie obawiają się, że nakładająca się presja sprzedażowa na poszczególne tokeny może pogłębiać obciążenie ogólnej płynności altcoinów.</p>
<p class="it">Lo sblocco di deBridge non è un evento isolato. Secondo il conteggio di BeInCrypto, l'intero mercato registra $660.8 million in token appena rilasciati nella settimana dal 12 al 19 luglio, con Connex (CONX), deBridge (DBR) e Arbitrum (ARB) tra quelli che rilasciano offerta. Appena un giorno prima, il 16 luglio, Arbitrum ha sbloccato 96.24 million token — lo 0.96% dell'offerta totale, per un valore di circa $8.87 million. Quando i calendari di sblocco di più progetti si concentrano nella stessa settimana, i partecipanti al mercato temono diffusamente che la pressione di vendita sovrapposta tra i singoli token possa aggravare la tensione sulla liquidità complessiva delle altcoin.</p>
<p class="ru">Разблокировка deBridge — не изолированное событие. По подсчётам BeInCrypto, за неделю с 12 по 19 июля рынок в целом увидит выпуск новых токенов на сумму $660.8 million, причём среди тех, кто высвобождает предложение, — Connex (CONX), deBridge (DBR) и Arbitrum (ARB). Всего днём ранее, 16 июля, Arbitrum разблокировал 96.24 million токенов — 0.96% от общего предложения, на сумму около $8.87 million. Когда графики разблокировки нескольких проектов совпадают в одну неделю, участники рынка часто опасаются, что накладывающееся друг на друга давление продаж по отдельным токенам может усилить общую нагрузку на ликвидность альткоинов.</p>
<p class="zh">deBridge的解鎖並非孤立事件。根據BeInCrypto的統計,整體市場在7月12日至19日這一週共有6.608億美元的新代幣釋出,Connex(CONX)、deBridge(DBR)與Arbitrum(ARB)皆在釋放供應量之列。就在前一天,即7月16日,Arbitrum也解鎖了9624萬枚代幣——占總發行量的0.96%,價值約887萬美元。當多個項目的解鎖排程集中於同一週時,市場參與者普遍擔心個別代幣重疊的賣壓,可能加劇整體山寨幣流動性的緊繃。</p>
...
<p class="id">Ada tiga hal yang patut diperhatikan mulai sekarang. Pertama, bagaimana pergerakan sebenarnya deposit di bursa dan harga DBR pada hari-hari segera setelah rilis ini. Kedua, apakah kesenjangan antara hitungan pasokan beredar CoinMarketCap dan CoinGecko/Tokenomist menyempit atau terus melebar. Ketiga, seberapa besar efek kumulatif terhadap likuiditas altcoin secara keseluruhan jika protokol lain dengan unlock bergaya cliff mengelompok pada periode yang sama. Sejauh ini belum ada laporan penurunan harga jangka pendek yang tajam terkait rilis ini, tetapi mengingat cara kerja struktur cliff, dibutuhkan waktu berhari-hari hingga berminggu-minggu bagi token untuk benar-benar berpindah ke dompet dan berujung pada penjualan — sehingga masih terlalu dini untuk menarik kesimpulan pasti.</p>
<p class="pl">Od teraz warto obserwować trzy rzeczy. Po pierwsze, jak faktycznie zachowują się wpłaty na giełdy i cena DBR w dniach bezpośrednio po tym uwolnieniu. Po drugie, czy różnica między szacunkami podaży w obiegu CoinMarketCap a CoinGecko/Tokenomist się zmniejsza, czy wciąż rośnie. Po trzecie, jak duży okaże się skumulowany efekt dla ogólnej płynności altcoinów, jeśli inne protokoły z odblokowaniami typu cliff skupią się w tym samym okresie. Jak dotąd nie zgłoszono gwałtownego krótkoterminowego spadku ceny związanego z tym uwolnieniem, ale biorąc pod uwagę sposób działania struktur cliff, przeniesienie tokenów do portfeli i przełożenie tego na sprzedaż może zająć od kilku dni do kilku tygodni — dlatego wyciąganie ostatecznych wniosków jest jeszcze przedwczesne.</p>
<p class="it">Da qui in avanti vale la pena osservare tre cose. Primo, come si muovono effettivamente i depositi sugli exchange e il prezzo di DBR nei giorni immediatamente successivi a questo rilascio. Secondo, se il divario tra i conteggi dell'offerta circolante di CoinMarketCap e di CoinGecko/Tokenomist si riduce o continua ad allargarsi. Terzo, quanto grande diventerà l'effetto cumulativo sulla liquidità complessiva delle altcoin se altri protocolli con sblocchi in stile cliff si concentreranno nello stesso periodo. Finora non è stato segnalato alcun brusco calo di prezzo a breve termine legato a questo rilascio, ma dato il funzionamento delle strutture cliff, possono volerci giorni o settimane prima che i token si spostino effettivamente nei wallet e si traducano in vendite — il che rende ancora prematuro trarre conclusioni definitive.</p>
<p class="ru">Отсюда стоит следить за тремя вещами. Во-первых, как на самом деле будут вести себя депозиты на биржах и цена DBR в дни сразу после этого релиза. Во-вторых, сократится ли разрыв между показателями оборотного предложения CoinMarketCap и CoinGecko/Tokenomist или продолжит расти. В-третьих, насколько велик будет совокупный эффект на общую ликвидность альткоинов, если другие протоколы с cliff-разблокировками сконцентрируются в тот же период. Пока не сообщалось о резком краткосрочном падении цены, связанном с этим релизом, но учитывая, как работают cliff-структуры, может пройти от нескольких дней до нескольких недель, прежде чем токены реально переместятся в кошельки и превратятся в продажи, — поэтому делать однозначные выводы пока рано.</p>
<p class="zh">從現在起有三件事值得關注。第一,DBR的交易所入金量與價格在此次釋放後的幾天內實際會如何變動。第二,CoinMarketCap與CoinGecko/Tokenomist之間流通量統計的差距會縮小,還是持續擴大。第三,若其他採用懸崖式解鎖的協議在同一時期集中出現,對整體山寨幣流動性的累積影響會有多大。目前尚未有與此次釋放相關的短期價格急跌報導,但鑑於懸崖結構的運作方式,代幣實際轉入錢包並轉化為賣壓可能需要數天到數週時間——因此現在就下定論仍為時過早。</p>
...
<div class="id">
<svg viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">Rincian Unlock Cliff DBR — 618.33M Token (6.2%)</text>
  <g font-family="sans-serif">
    <text x="20" y="70" fill="#e4e4e7" font-size="13.5">Ekosistem</text>
    <rect x="20" y="78" width="500" height="24" rx="4" fill="#06b6d4"/>
    <text x="530" y="95" fill="#f4f4f5" font-size="13.5" font-weight="700">191.67M</text>
    <text x="20" y="128" fill="#e4e4e7" font-size="13.5">Kontributor Inti</text>
    <rect x="20" y="136" width="348" height="24" rx="4" fill="#22d3ee"/>
    <text x="378" y="153" fill="#f4f4f5" font-size="13.5" font-weight="700">133.33M</text>
    <text x="20" y="186" fill="#e4e4e7" font-size="13.5">Mitra Strategis</text>
    <rect x="20" y="194" width="296" height="24" rx="4" fill="#38bdf8"/>
    <text x="326" y="211" fill="#f4f4f5" font-size="13.5" font-weight="700">113.33M</text>
    <text x="20" y="244" fill="#e4e4e7" font-size="13.5">Yayasan deBridge</text>
    <rect x="20" y="252" width="217" height="24" rx="4" fill="#0ea5e9"/>
    <text x="247" y="269" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="302" fill="#e4e4e7" font-size="13.5">Komunitas &amp; Peluncuran</text>
    <rect x="20" y="310" width="217" height="24" rx="4" fill="#0284c7"/>
    <text x="247" y="327" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="360" fill="#e4e4e7" font-size="13.5">Validator</text>
    <rect x="20" y="368" width="35" height="24" rx="4" fill="#0369a1"/>
    <text x="65" y="385" fill="#f4f4f5" font-size="13.5" font-weight="700">13.33M</text>
    <rect x="20" y="410" width="660" height="36" rx="8" fill="#1e2a3a" stroke="#60a5fa" stroke-width="1.2"/>
    <text x="35" y="433" fill="#93c5fd" font-size="14" font-weight="700">Total: 618.33M Token · ~$10.6M · 6.2% dari Pasokan</text>
  </g>
</svg>
</div>
<div class="pl">
<svg viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">Podział Odblokowania Cliff DBR — 618.33M Tokenów (6.2%)</text>
  <g font-family="sans-serif">
    <text x="20" y="70" fill="#e4e4e7" font-size="13.5">Ekosystem</text>
    <rect x="20" y="78" width="500" height="24" rx="4" fill="#06b6d4"/>
    <text x="530" y="95" fill="#f4f4f5" font-size="13.5" font-weight="700">191.67M</text>
    <text x="20" y="128" fill="#e4e4e7" font-size="13.5">Główni Współtwórcy</text>
    <rect x="20" y="136" width="348" height="24" rx="4" fill="#22d3ee"/>
    <text x="378" y="153" fill="#f4f4f5" font-size="13.5" font-weight="700">133.33M</text>
    <text x="20" y="186" fill="#e4e4e7" font-size="13.5">Partnerzy Strategiczni</text>
    <rect x="20" y="194" width="296" height="24" rx="4" fill="#38bdf8"/>
    <text x="326" y="211" fill="#f4f4f5" font-size="13.5" font-weight="700">113.33M</text>
    <text x="20" y="244" fill="#e4e4e7" font-size="13.5">Fundacja deBridge</text>
    <rect x="20" y="252" width="217" height="24" rx="4" fill="#0ea5e9"/>
    <text x="247" y="269" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="302" fill="#e4e4e7" font-size="13.5">Społeczność i Uruchomienie</text>
    <rect x="20" y="310" width="217" height="24" rx="4" fill="#0284c7"/>
    <text x="247" y="327" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="360" fill="#e4e4e7" font-size="13.5">Walidatorzy</text>
    <rect x="20" y="368" width="35" height="24" rx="4" fill="#0369a1"/>
    <text x="65" y="385" fill="#f4f4f5" font-size="13.5" font-weight="700">13.33M</text>
    <rect x="20" y="410" width="660" height="36" rx="8" fill="#1e2a3a" stroke="#60a5fa" stroke-width="1.2"/>
    <text x="35" y="433" fill="#93c5fd" font-size="14" font-weight="700">Razem: 618.33M Tokenów · ~$10.6M · 6.2% Podaży</text>
  </g>
</svg>
</div>
<div class="it">
<svg viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">Ripartizione Sblocco Cliff DBR — 618.33M Token (6.2%)</text>
  <g font-family="sans-serif">
    <text x="20" y="70" fill="#e4e4e7" font-size="13.5">Ecosistema</text>
    <rect x="20" y="78" width="500" height="24" rx="4" fill="#06b6d4"/>
    <text x="530" y="95" fill="#f4f4f5" font-size="13.5" font-weight="700">191.67M</text>
    ...
    <rect x="20" y="136" width="348" height="24" rx="4" fill="#22d3ee"/>
    <text x="378" y="153" fill="#f4f4f5" font-size="13.5" font-weight="700">133.33M</text>
    <text x="20" y="186" fill="#e4e4e7" font-size="13.5">Partner Strategici</text>
    <rect x="20" y="194" width="296" height="24" rx="4" fill="#38bdf8"/>
    <text x="326" y="211" fill="#f4f4f5" font-size="13.5" font-weight="700">113.33M</text>
    <text x="20" y="244" fill="#e4e4e7" font-size="13.5">Fondazione deBridge</text>
    <rect x="20" y="252" width="217" height="24" rx="4" fill="#0ea5e9"/>
    <text x="247" y="269" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="302" fill="#e4e4e7" font-size="13.5">Community &amp; Launch</text>
    <rect x="20" y="310" width="217" height="24" rx="4" fill="#0284c7"/>
    <text x="247" y="327" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="360" fill="#e4e4e7" font-size="13.5">Validatori</text>
    <rect x="20" y="368" width="35" height="24" rx="4" fill="#0369a1"/>
    <text x="65" y="385" fill="#f4f4f5" font-size="13.5" font-weight="700">13.33M</text>
    <rect x="20" y="410" width="660" height="36" rx="8" fill="#1e2a3a" stroke="#60a5fa" stroke-width="1.2"/>
    <text x="35" y="433" fill="#93c5fd" font-size="14" font-weight="700">Totale: 618.33M Token · ~$10.6M · 6.2% dell'Offerta</text>
  </g>
</svg>
</div>
<div class="ru">
<svg viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">Разбивка Cliff-Разблокировки DBR — 618.33M Токенов (6.2%)</text>
  <g font-family="sans-serif">
    <text x="20" y="70" fill="#e4e4e7" font-size="13.5">Экосистема</text>
    <rect x="20" y="78" width="500" height="24" rx="4" fill="#06b6d4"/>
    <text x="530" y="95" fill="#f4f4f5" font-size="13.5" font-weight="700">191.67M</text>
    <text x="20" y="128" fill="#e4e4e7" font-size="13.5">Основные контрибьюторы</text>
    <rect x="20" y="136" width="348" height="24" rx="4" fill="#22d3ee"/>
    <text x="378" y="153" fill="#f4f4f5" font-size="13.5" font-weight="700">133.33M</text>
    <text x="20" y="186" fill="#e4e4e7" font-size="13.5">Стратегические партнёры</text>
    <rect x="20" y="194" width="296" height="24" rx="4" fill="#38bdf8"/>
    <text x="326" y="211" fill="#f4f4f5" font-size="13.5" font-weight="700">113.33M</text>
    <text x="20" y="244" fill="#e4e4e7" font-size="13.5">Фонд deBridge</text>
    <rect x="20" y="252" width="217" height="24" rx="4" fill="#0ea5e9"/>
    <text x="247" y="269" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="302" fill="#e4e4e7" font-size="13.5">Сообщество и запуск</text>
    <rect x="20" y="310" width="217" height="24" rx="4" fill="#0284c7"/>
    <text x="247" y="327" fill="#f4f4f5" font-size="13.5" font-weight="700">83.33M</text>
    <text x="20" y="360" fill="#e4e4e7" font-size="13.5">Валидаторы</text>
    <rect x="20" y="368" width="35" height="24" rx="4" fill="#0369a1"/>
    <text x="65" y="385" fill="#f4f4f5" font-size="13.5" font-weight="700">13.33M</text>
    <rect x="20" y="410" width="660" height="36" rx="8" fill="#1e2a3a" stroke="#60a5fa" stroke-width="1.2"/>
    <text x="35" y="433" fill="#93c5fd" font-size="14" font-weight="700">Итого: 618.33M Токенов · ~$10.6M · 6.2% Предложения</text>
  </g>
</svg>
</div>
<div class="zh">
<svg viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">DBR懸崖式解鎖分配 — 6.1833億枚代幣(6.2%)</text>
  <g font-family="sans-serif">
    <text x="20" y="70" fill="#e4e4e7" font-size="13.5">生態系統</text>
    <rect x="20" y="78" width="500" height="24" rx="4" fill="#06b6d4"/>
    <text x="530" y="95" fill="#f4f4f5" font-size="13.5" font-weight="700">1.9167億</text>
    <text x="20" y="128" fill="#e4e4e7" font-size="13.5">核心貢獻者</text>
    <rect x="20" y="136" width="348" height="24" rx="4" fill="#22d3ee"/>
    <text x="378" y="153" fill="#f4f4f5" font-size="13.5" font-weight="700">1.3333億</text>
    <text x="20" y="186" fill="#e4e4e7" font-size="13.5">策略夥伴</text>
    <rect x="20" y="194" width="296" height="24" rx="4" fill="#38bdf8"/>
    <text x="326" y="211" fill="#f4f4f5" font-size="13.5" font-weight="700">1.1333億</text>
    <text x="20" y="244" fill="#e4e4e7" font-size="13.5">deBridge基金會</text>
    <rect x="20" y="252" width="217" height="24" rx="4" fill="#0ea5e9"/>
    <text x="247" y="269" fill="#f4f4f5" font-size="13.5" font-weight="700">8333萬</text>
    <text x="20" y="302" fill="#e4e4e7" font-size="13.5">社群暨啟動</text>
    <rect x="20" y="310" width="217" height="24" rx="4" fill="#0284c7"/>
    <text x="247" y="327" fill="#f4f4f5" font-size="13.5" font-weight="700">8333萬</text>
    <text x="20" y="360" fill="#e4e4e7" font-size="13.5">驗證者</text>
    <rect x="20" y="368" width="35" height="24" rx="4" fill="#0369a1"/>
    <text x="65" y="385" fill="#f4f4f5" font-size="13.5" font-weight="700">1333萬</text>
    <rect x="20" y="410" width="660" height="36" rx="8" fill="#1e2a3a" stroke="#60a5fa" stroke-width="1.2"/>
    <text x="35" y="433" fill="#93c5fd" font-size="14" font-weight="700">總計:6.1833億枚代幣・約1060萬美元・佔供應量6.2%</text>
  </g>
</svg>
</div>
...
<div class="box id">💡 <strong>Yang perlu diperhatikan sekarang:</strong> DBR milik deBridge membuka kunci 6.2% dari total pasokan (618.33 million token, sekitar $10.6 million) dalam satu kali rilis cliff pada 17 Juli. Perhatikan (1) deposit di bursa dan pergerakan harga tepat setelah unlock, (2) apakah kesenjangan pasokan beredar antara CoinMarketCap dan CoinGecko/Tokenomist menyempit atau melebar, dan (3) efek kumulatif terhadap likuiditas altcoin seiring bertumpuknya unlock proyek lain, termasuk Arbitrum pada minggu yang sama.</div>
<div class="box pl">💡 <strong>Co obserwować teraz:</strong> DBR firmy deBridge odblokował 6.2% całkowitej podaży (618.33 miliona tokenów, około $10.6 million) w jednorazowym uwolnieniu typu cliff 17 lipca. Obserwuj (1) wpłaty na giełdy i ruch ceny tuż po odblokowaniu, (2) czy różnica podaży w obiegu między CoinMarketCap a CoinGecko/Tokenomist się zmniejsza czy powiększa, oraz (3) skumulowany efekt dla płynności altcoinów, gdy nakłada się to na odblokowania innych projektów, w tym Arbitrum w tym samym tygodniu.</div>
<div class="box it">💡 <strong>Cosa osservare ora:</strong> Il DBR di deBridge ha sbloccato il 6.2% dell'offerta totale (618.33 milioni di token, circa $10.6 million) in un unico rilascio cliff il 17 luglio. Osserva (1) i depositi sugli exchange e il movimento del prezzo subito dopo lo sblocco, (2) se il divario di offerta circolante tra CoinMarketCap e CoinGecko/Tokenomist si riduce o si allarga, e (3) l'effetto cumulativo sulla liquidità delle altcoin mentre ciò si sovrappone agli sblocchi di altri progetti, incluso Arbitrum nella stessa settimana.</div>
<div class="box ru">💡 <strong>На что смотреть сейчас:</strong> DBR от deBridge разблокировал 6.2% общего предложения (618.33 миллиона токенов, около $10.6 million) в единовременном cliff-релизе 17 июля. Следите за (1) депозитами на биржах и движением цены сразу после разблокировки, (2) сокращается ли разрыв в оценке циркулирующего предложения между CoinMarketCap и CoinGecko/Tokenomist или растёт, и (3) совокупным эффектом на ликвидность альткоинов по мере наложения на разблокировки других проектов, включая Arbitrum на той же неделе.</div>
<div class="box zh">💡 <strong>現在該關注什麼:</strong> deBridge的DBR於7月17日以懸崖式一次性解鎖總發行量的6.2%(6.1833億枚代幣,約1060萬美元)。請關注:(1)解鎖後交易所入金量與價格變化,(2)CoinMarketCap與CoinGecko/Tokenomist之間流通量統計差距的走向,(3)此次解鎖與同週Arbitrum等其他項目解鎖重疊時,對山寨幣流動性的累積影響。</div>
...
<p class="id" style="font-size:12px;color:#52525b;margin-top:24px">Sumber: RootData, Bitget News, Odaily, CryptoRank, BeInCrypto, Tokenomist, CoinMarketCap, CoinGecko, Phemex Academy.</p>
<p class="pl" style="font-size:12px;color:#52525b;margin-top:24px">Źródła: RootData, Bitget News, Odaily, CryptoRank, BeInCrypto, Tokenomist, CoinMarketCap, CoinGecko, Phemex Academy.</p>
<p class="it" style="font-size:12px;color:#52525b;margin-top:24px">Fonti: RootData, Bitget News, Odaily, CryptoRank, BeInCrypto, Tokenomist, CoinMarketCap, CoinGecko, Phemex Academy.</p>
<p class="ru" style="font-size:12px;color:#52525b;margin-top:24px">Источники: RootData, Bitget News, Odaily, CryptoRank, BeInCrypto, Tokenomist, CoinMarketCap, CoinGecko, Phemex Academy.</p>
<p class="zh" style="font-size:12px;color:#52525b;margin-top:24px">資料來源:RootData、Bitget News、Odaily、CryptoRank、BeInCrypto、Tokenomist、CoinMarketCap、CoinGecko、Phemex Academy。</p>
