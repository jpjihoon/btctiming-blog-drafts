<?php $slug = 'patch-symmetry-trap'; require __DIR__.'/_header.php'; ?>
  ...
  <p class="fr">Le premier score short était simple. Nous le traitions comme l'inverse du score long. Long à 8 signifiait short à 2 ; long à 3 signifiait short à 7. Une symétrie parfaite. Mais cette symétrie dépeignait mal le marché — car « ce n'est pas un endroit pour acheter » et « c'est un endroit pour vendre » ne sont pas la même chose.</p>
  <p class="pt">A pontuação short inicial era simples. Nós a tratávamos como o inverso da pontuação long. Long em 8 significava short em 2; long em 3 significava short em 7. Uma simetria perfeita. Mas essa simetria retratava o mercado de forma errada — porque "não é lugar para comprar" e "é lugar para vender" não são a mesma coisa.</p>
  <p class="tr">İlk short skoru basitti. Onu long skorunun tersi olarak ele alıyorduk. Long 8 olduğunda short 2, long 3 olduğunda short 7 demekti. Temiz bir simetri. Ama bu simetri piyasayı yanlış resmediyordu — çünkü "alım yeri değil" ile "satış yeri" aynı şey değildir.</p>
  <p class="vi">Điểm short ban đầu rất đơn giản. Chúng tôi coi nó là nghịch đảo của điểm long. Long ở mức 8 nghĩa là short ở mức 2; long ở mức 3 nghĩa là short ở mức 7. Một sự đối xứng gọn gàng. Nhưng sự đối xứng này đã mô tả sai thị trường — bởi vì "không phải nơi để mua" và "nơi để bán" không phải là một.</p>
  ...
  <svg viewBox="0 0 720 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    ...
    <g font-family="sans-serif">
      ...
      <text x="30" y="112" fill="#71717a" font-size="10">→ un signal short s'active dans une zone sans direction</text>
      <line x1="30" y1="135" x2="660" y2="135" stroke="#3f3f46"/>
      <text x="30" y="168" fill="#4ade80" font-size="12" font-weight="700">Nouveau · long et short sont deux axes indépendants</text>
      <text x="30" y="195" fill="#a1a1aa" font-size="11">Long 4 (neutre) + short 4 (neutre) → les deux peuvent être « observer »</text>
      <text x="30" y="215" fill="#71717a" font-size="10">→ long seulement à un plancher clair, short seulement à un sommet clair, aucune position entre les deux</text>
    </g>
  </svg>
  </div>
  <div class="pt">
  <svg viewBox="0 0 720 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    ...
    <g font-family="sans-serif">
      ...
      <text x="30" y="112" fill="#71717a" font-size="10">→ um sinal de short dispara em uma zona sem direção</text>
      <line x1="30" y1="135" x2="660" y2="135" stroke="#3f3f46"/>
      ...
      <text x="30" y="215" fill="#71717a" font-size="10">→ long somente em um fundo claro, short somente em um topo claro, sem posição no meio</text>
    </g>
  </svg>
  </div>
  <div class="tr">
  <svg viewBox="0 0 720 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    ...
    <g font-family="sans-serif">
      ...
      <text x="30" y="195" fill="#a1a1aa" font-size="11">Long 4 (nötr) + short 4 (nötr) → ikisi de "bekle" olabilir</text>
  ...
  <svg viewBox="0 0 720 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    ...
    <g font-family="sans-serif">
      <text x="30" y="65" fill="#f87171" font-size="12" font-weight="700">Cũ · short = 10 − long (đối lập như gương)</text>
      <text x="30" y="92" fill="#a1a1aa" font-size="11">Long 4 (trung lập mơ hồ) → short 6 (chuẩn bị short?!)</text>
      <text x="30" y="112" fill="#71717a" font-size="10">→ tín hiệu short kích hoạt ở vùng không có hướng</text>
      <line x1="30" y1="135" x2="660" y2="135" stroke="#3f3f46"/>
      ...
      <text x="30" y="215" fill="#71717a" font-size="10">→ chỉ long tại đáy rõ ràng, chỉ short tại đỉnh rõ ràng, không có vị thế ở giữa</text>
    </g>
  </svg>
  </div>
  ...
  <p class="fr">Le plus gros problème d'une structure symétrique est qu'elle élimine le terrain intermédiaire. Un long de 4 fait automatiquement un short de 6. Mais 4 est une zone ambiguë — « ni un plancher clair ni un sommet clair ». Quand un short de 6 apparaît là et que « préparer un short » s'allume, on est forcé d'entrer en position sur un marché sans direction établie. Une grande partie d'un marché réel est exactement cette zone neutre, et pourtant le modèle symétrique refusait de la reconnaître.</p>
  <p class="pt">O maior problema de uma estrutura simétrica é que ela elimina o terreno intermediário. Um long de 4 automaticamente resulta em um short de 6. Mas 4 é uma zona ambígua — "nem um fundo claro nem um topo claro". Quando um short de 6 surge ali e "preparar short" se acende, você é forçado a entrar em uma posição em um mercado sem direção definida. Grande parte de um mercado real é exatamente essa zona neutra, mas o modelo simétrico se recusava a reconhecê-la.</p>
  <p class="tr">Simetrik bir yapının en büyük sorunu, ortadaki bölgeyi ortadan kaldırmasıdır. Long 4 olduğunda otomatik olarak short 6 olur. Ama 4, "ne net bir dip ne de net bir tepe" olan belirsiz bir bölgedir. Orada short 6 ortaya çıkıp "short'a hazırlan" yandığında, yönü belirsiz bir piyasada pozisyona zorlanırsınız. Gerçek bir piyasanın büyük bölümü tam olarak bu nötr bölgedir, ama simetrik model bunu kabul etmeyi reddediyordu.</p>
  <p class="vi">Vấn đề lớn nhất của cấu trúc đối xứng là nó loại bỏ vùng trung gian. Long ở mức 4 tự động khiến short ở mức 6. Nhưng 4 là một vùng mơ hồ — "không phải đáy rõ ràng cũng không phải đỉnh rõ ràng". Khi short 6 xuất hiện ở đó và "chuẩn bị short" bật sáng, bạn bị buộc phải vào vị thế trong một thị trường không có hướng ổn định. Phần lớn thị trường thực tế chính là vùng trung lập này, nhưng mô hình đối xứng lại từ chối thừa nhận nó.</p>
  ...
  <p class="fr">Nous avons divisé long et short en deux scores indépendants. Le score long calcule « est-ce bon marché maintenant » à partir de ses propres indicateurs ; le score short calcule « est-ce cher et en train de se retourner » à partir d'un ensemble distinct. Les deux ne sont pas l'opposé l'un de l'autre. Ainsi, un état où le long et le short sont tous deux bas — une phase neutre signifiant « aucun des deux côtés n'est certain, donc restez à l'écart » — peut enfin être exprimé.</p>
  <p class="pt">Dividimos long e short em duas pontuações independentes. A pontuação long calcula "está barato agora" a partir de seus próprios indicadores; a pontuação short calcula "está caro e revertendo" a partir de um conjunto separado. As duas não são opostas uma da outra. Assim, um estado em que tanto long quanto short estão baixos — uma fase neutra que significa "nenhum dos lados é certo, então fique de fora" — finalmente pode ser expresso.</p>
  <p class="tr">Long ve short'u iki bağımsız skora ayırdık. Long skoru kendi göstergelerinden "şu an ucuz mu" hesaplar; short skoru ayrı bir göstergeler kümesinden "şu an pahalı mı ve dönüyor mu" hesaplar. İkisi birbirinin tersi değildir. Böylece hem long hem short'un düşük olduğu bir durum — "hiçbir taraf kesin değil, o yüzden dışarıda kal" anlamına gelen nötr bir evre — sonunda ifade edilebilir hale gelir.</p>
  <p class="vi">Chúng tôi tách long và short thành hai điểm số độc lập. Điểm long tính toán "liệu bây giờ có rẻ không" từ các chỉ báo riêng của nó; điểm short tính toán "liệu bây giờ có đắt và đang đảo chiều không" từ một tập chỉ báo khác. Hai điểm số này không đối lập với nhau. Vì vậy, trạng thái mà cả long lẫn short đều thấp — một giai đoạn trung lập nghĩa là "không bên nào chắc chắn, nên đứng ngoài" — cuối cùng cũng có thể được thể hiện.</p>
  ...
  <div class="box fr">Les marchés ne se déplacent pas toujours selon la binarité acheter ou vendre. Les phases sans direction sont bien plus longues. Une fois long et short séparés, cet outil a pu dire « ce n'est pas certain en ce moment ». Pouvoir ne rien dire du tout est précisément l'honnêteté qu'un indicateur devrait avoir.</div>
  <div class="box pt">Os mercados nem sempre se movem pela binariedade de comprar ou vender. Os trechos sem direção são muito mais longos. Uma vez que long e short foram separados, esta ferramenta passou a poder dizer "não é certo agora". Poder não dizer nada é precisamente a honestidade que um indicador deveria ter.</div>
  <div class="box tr">Piyasalar her zaman al ya da sat ikiliğiyle hareket etmez. Yönsüz dönemler çok daha uzundur. Long ve short ayrıldıktan sonra, bu araç "şu an kesin değil" diyebilir hale geldi. Hiçbir şey söyleyememek, tam olarak bir göstergenin sahip olması gereken dürüstlüktür.</div>
  <div class="box vi">Thị trường không phải lúc nào cũng vận động theo tính nhị phân mua hoặc bán. Những giai đoạn không có hướng dài hơn nhiều. Sau khi long và short được tách ra, công cụ này đã có thể nói "hiện tại chưa chắc chắn". Có thể không nói gì cả chính là sự trung thực mà một chỉ báo nên có.</div>
