...
<p class="ko">"오늘 거래량이 어제보다 많다"는 정보는 유용하지만, 이미 하루가 다 지난 뒤의 요약일 뿐이에요. <strong>거래량 가속도</strong>는 훨씬 짧은 시간 단위로 이 질문을 다시 던집니다 — "지금 이 순간, 거래가 평소보다 빨라지고 있는가?"</p>
  ...
  <p class="fr">« Le volume d'aujourd'hui a dépassé celui d'hier » est utile, mais ce n'est qu'un résumé d'une journée déjà entièrement écoulée. L'<strong>Accélération du Volume</strong> pose la même question sur un intervalle de temps bien plus court — « en ce moment même, les échanges s'accélèrent-ils par rapport à la normale ? »</p>
  <p class="pt">«O volume de hoje superou o de ontem» é útil, mas é apenas o resumo de um dia já totalmente passado. A <strong>Aceleração de Volume</strong> faz a mesma pergunta numa escala de tempo muito mais curta — «neste exato momento, as negociações estão acelerando em relação ao normal?»</p>
  <p class="tr">"Bugünkü hacim dünkünü geçti" bilgisi faydalıdır, ancak bu zaten tamamen geride kalmış bir günün özetidir. <strong>Hacim İvmesi</strong> aynı soruyu çok daha kısa bir zaman diliminde yeniden sorar — "tam şu anda, işlemler normale kıyasla hızlanıyor mu?"</p>
  <p class="vi">"Khối lượng hôm nay vượt hôm qua" là thông tin hữu ích, nhưng đó chỉ là bản tóm tắt của một ngày đã trôi qua hoàn toàn. <strong>Gia tốc Khối lượng</strong> đặt lại câu hỏi đó trên một khung thời gian ngắn hơn nhiều — "ngay lúc này, giao dịch có đang tăng tốc so với bình thường không?"</p>
  ...
  <div class="box fr">💡 <strong>À retenir :</strong> Compare le volume de la dernière bougie de 15 minutes aux moyennes sur 1 heure et 4 heures. Un ratio bien supérieur à 1 signifie que « les échanges affluent plus vite que la normale en ce moment » — près d'un creux, cela se lit comme un signal de rebond ; près d'un sommet, comme de la distribution (vente).</div>
  <div class="box pt">💡 <strong>Resumo:</strong> Compara o volume do candle de 15 minutos mais recente com as médias de 1 hora e 4 horas. Uma proporção bem acima de 1 significa que «as negociações estão se concentrando mais rápido que o normal agora» — perto de um fundo, isso se lê como sinal de recuperação; perto de um topo, como distribuição (venda).</div>
  <div class="box tr">💡 <strong>Özet:</strong> En son 15 dakikalık mumun hacmini 1 saatlik ve 4 saatlik ortalamalarla karşılaştırır. 1'in oldukça üzerinde bir oran, "işlemler şu anda normalden daha hızlı birikiyor" anlamına gelir — bir dip noktasına yakınken bu bir toparlanma sinyali olarak, bir tepe noktasına yakınken ise dağıtım (satış) sinyali olarak yorumlanır.</div>
  <div class="box vi">💡 <strong>Tóm tắt:</strong> So sánh khối lượng của nến 15 phút gần nhất với mức trung bình 1 giờ và 4 giờ. Tỷ lệ vượt xa 1 có nghĩa là "giao dịch đang dồn vào nhanh hơn bình thường ngay lúc này" — gần vùng đáy, điều đó được hiểu là tín hiệu hồi phục; gần vùng đỉnh, đó là tín hiệu phân phối (bán ra).</div>
  ...
  <h2 class="fr">Le ratio d'accélération, en image</h2>
  <h2 class="pt">A proporção de aceleração, visualizada</h2>
  <h2 class="tr">İvme oranı, görselleştirildi</h2>
  <h2 class="vi">Tỷ lệ gia tốc, minh họa trực quan</h2>
  ...
  <p class="fr">Les lectures traditionnelles de variation de volume comparent généralement « le volume d'aujourd'hui par rapport à la moyenne sur 7 jours » — une comparaison quotidienne qui réagit lentement aux situations qui évoluent vite. L'Accélération du Volume utilise une fenêtre bien plus resserrée — « les 15 dernières minutes par rapport aux 1 et 4 dernières heures » — spécifiquement pour ne pas manquer le moment exact où les conditions changent.</p>
  <p class="pt">As leituras tradicionais de variação de volume geralmente comparam «o volume de hoje vs. a média de 7 dias» — uma comparação diária que reage lentamente a situações que mudam rápido. A Aceleração de Volume usa uma janela muito mais estreita — «os últimos 15 minutos vs. a última 1 e 4 horas» — especificamente para não perder o momento exato em que as condições mudam.</p>
  <p class="tr">Geleneksel hacim değişimi okumaları genellikle "bugünkü hacim ile 7 günlük ortalamayı" karşılaştırır — hızlı değişen durumlara yavaş tepki veren günlük bir karşılaştırmadır bu. Hacim İvmesi çok daha dar bir pencere kullanır — "son 15 dakika ile geçtiğimiz 1 ve 4 saat" — özellikle koşulların değiştiği tam anı kaçırmamak için.</p>
  <p class="vi">Các chỉ số thay đổi khối lượng truyền thống thường so sánh "khối lượng hôm nay so với mức trung bình 7 ngày" — một phép so sánh theo ngày phản ứng chậm với các tình huống biến động nhanh. Gia tốc Khối lượng sử dụng một khung thời gian hẹp hơn nhiều — "15 phút gần nhất so với 1 và 4 giờ vừa qua" — nhằm mục đích không bỏ lỡ đúng thời điểm điều kiện thay đổi.</p>
  ...
  <h2 class="fr">Pourquoi deux ratios sont suivis ensemble</h2>
  <h2 class="pt">Por que duas proporções são monitoradas juntas</h2>
  <h2 class="tr">İki oranın birlikte takip edilme nedeni</h2>
  <h2 class="vi">Vì sao hai tỷ lệ được theo dõi cùng nhau</h2>
  ...
  <p class="fr">Le ratio sur 1 heure capte les évolutions très récentes ; le ratio sur 4 heures confirme si le moment présent est réellement inhabituel dans une fenêtre un peu plus large. Lorsque les deux ratios grimpent en même temps, la confiance augmente qu'il se passe vraiment quelque chose et non un simple bruit de fond.</p>
  <p class="pt">A proporção de 1 hora capta mudanças muito recentes; a proporção de 4 horas confirma se o momento atual é genuinamente incomum dentro de uma janela um pouco mais ampla. Quando ambas as proporções disparam juntas, aumenta a confiança de que algo real está acontecendo, e não apenas ruído.</p>
  <p class="tr">1 saatlik oran çok yakın zamandaki değişimleri yakalar; 4 saatlik oran ise şu anki durumun biraz daha geniş bir pencere içinde gerçekten olağandışı olup olmadığını doğrular. Her iki oran birlikte yükseldiğinde, bunun salt gürültü değil gerçek bir şey olduğuna dair güven artar.</p>
  <p class="vi">Tỷ lệ 1 giờ nắm bắt những biến động rất gần đây; tỷ lệ 4 giờ xác nhận liệu thời điểm hiện tại có thực sự bất thường trong một khung nhìn rộng hơn một chút hay không. Khi cả hai tỷ lệ cùng tăng vọt, độ tin cậy rằng một điều gì đó thực sự đang xảy ra — chứ không chỉ là nhiễu — sẽ tăng lên.</p>
  ...
  <h2 class="fr">Un exemple pratique</h2>
  <h2 class="pt">Um exemplo prático</h2>
  <h2 class="tr">Pratik bir örnek</h2>
  <h2 class="vi">Một ví dụ thực tế</h2>
  ...
  <p class="fr">Supposons que le prix évolue latéralement près d'un creux de court terme, puis que le volume d'une bougie de 15 minutes bondisse simultanément à 2x la moyenne sur 1 heure et 1,5x la moyenne sur 4 heures, en clôturant en vert — cela se lit comme « la pression acheteuse vient de commencer à s'accumuler ». Le même schéma exact (pic de volume + bougie verte) près d'un nouveau sommet peut en revanche se lire comme un dernier achat de panique (FOMO) surchauffé. Le contexte — creux ou sommet — change complètement l'interprétation.</p>
  <p class="pt">Suponha que o preço esteja se movendo lateralmente perto de um fundo de curto prazo, e então o volume de um candle de 15 minutos dispare simultaneamente para 2x a média de 1 hora e 1,5x a média de 4 horas, fechando em verde — isso se lê como «a pressão compradora acabou de começar a se acumular». O mesmo padrão idêntico (pico de volume + candle verde) perto de uma nova máxima, porém, pode ser lido em vez disso como uma última compra por FOMO superaquecida. O contexto — se é um fundo ou um topo — muda completamente a interpretação.</p>
  <p class="tr">Diyelim ki fiyat kısa vadeli bir dip noktası yakınında yatay seyrediyor, ardından 15 dakikalık bir mumun hacmi aynı anda 1 saatlik ortalamanın 2 katına ve 4 saatlik ortalamanın 1,5 katına sıçrıyor ve yeşil kapanıyor — bu, "alım baskısı az önce birikmeye başladı" şeklinde yorumlanır. Ancak yeni bir zirve yakınında ortaya çıkan aynı desen (hacim sıçraması + yeşil mum), bunun yerine son bir aşırı ısınmış FOMO alımı olarak da okunabilir. Bağlam — dip mi zirve mi olduğu — yorumu tamamen değiştirir.</p>
  <p class="vi">Giả sử giá đang đi ngang gần một đáy ngắn hạn, sau đó khối lượng của một nến 15 phút đồng thời tăng vọt lên gấp 2 lần mức trung bình 1 giờ và gấp 1,5 lần mức trung bình 4 giờ, đóng nến xanh — điều đó được hiểu là "áp lực mua vừa mới bắt đầu dồn vào." Tuy nhiên, cùng một mô hình y hệt (khối lượng tăng vọt + nến xanh) xuất hiện gần một đỉnh mới lại có thể được hiểu là một đợt mua FOMO quá nhiệt cuối cùng. Bối cảnh — dù là đáy hay đỉnh — làm thay đổi hoàn toàn cách diễn giải.</p>
  ...
  <p class="fr">Étant donné le court intervalle de temps, les faux signaux sont fréquents. Une seule annonce ou un ordre important peut à lui seul faire grimper le ratio — toujours croiser avec le <a href="/blog/buy-sell-led-volume-guide.html">Volume Dirigé par les Achats/Ventes</a> ou la direction de la bougie pour une lecture plus fiable.</p>
  <p class="pt">Dado o curto intervalo de tempo, sinais falsos são comuns. Uma única manchete ou uma ordem grande pode disparar a proporção por conta própria — sempre confira cruzando com o <a href="/blog/buy-sell-led-volume-guide.html">Volume Liderado por Compra/Venda</a> ou a direção do candle para uma leitura mais confiável.</p>
  <p class="tr">Kısa zaman dilimi göz önüne alındığında, yanlış sinyaller yaygındır. Tek bir haber başlığı veya büyük bir emir, oranı tek başına sıçratabilir — daha güvenilir bir okuma için her zaman <a href="/blog/buy-sell-led-volume-guide.html">Alış/Satış Odaklı Hacim</a> veya mum yönüyle çapraz kontrol yapın.</p>
  <p class="vi">Do khung thời gian ngắn, tín hiệu giả khá phổ biến. Chỉ một tin tức lớn hoặc một lệnh khối lượng lớn cũng có thể khiến tỷ lệ tăng vọt — luôn đối chiếu với <a href="/blog/buy-sell-led-volume-guide.html">Khối lượng theo hướng Mua/Bán</a> hoặc hướng của nến để có kết quả đáng tin cậy hơn.</p>
