<?php $slug = 'mvrv-z-score'; require __DIR__.'/_header.php'; ?>
  ...
  <p class="fr">La question la plus difficile de l'investissement en Bitcoin est toujours la même : <strong>« Est-ce le point bas, ou va-t-il encore baisser ? »</strong> Le MVRV Z-Score répond à cette question par les données — il a su repérer chaque creux et chaque sommet majeurs du Bitcoin au cours de la dernière décennie avec une précision remarquable.</p>
  <p class="pt">A pergunta mais difícil no investimento em Bitcoin é sempre a mesma: <strong>"Este é o fundo, ou ainda vai cair mais?"</strong> O MVRV Z-Score responde a isso com dados — capturando cada fundo e topo importantes do Bitcoin na última década com notável precisão.</p>
  <p class="tr">Bitcoin yatırımındaki en zor soru her zaman aynıdır: <strong>"Bu dip mi, yoksa daha da mı düşecek?"</strong> MVRV Z-Score bu soruyu verilerle yanıtlar — son on yılda bitcoin'in her büyük dip ve tepe noktasını dikkat çekici bir doğrulukla yakalamıştır.</p>
  <p class="vi">Câu hỏi khó nhất trong đầu tư Bitcoin luôn giống nhau: <strong>"Đây đã là đáy hay còn giảm tiếp?"</strong> MVRV Z-Score trả lời câu hỏi này bằng dữ liệu — nắm bắt mọi đáy và đỉnh lớn của Bitcoin trong suốt thập kỷ qua với độ chính xác đáng kinh ngạc.</p>
  ...
  <div class="box fr">💡 <strong>Point clé :</strong> Un MVRV Z-Score inférieur à 0 signale une sous-évaluation historique ; au-dessus de 3,5, il signale une surchauffe. Les trois principaux points bas de Bitcoin — 2015, 2018, 2022 — ont tous enregistré des valeurs inférieures à 0.</div>
  <div class="box pt">💡 <strong>Resumo principal:</strong> Um MVRV Z-Score abaixo de 0 sinaliza subvalorização histórica; acima de 3,5 sinaliza sobreaquecimento. Os três principais fundos do Bitcoin — 2015, 2018, 2022 — registraram valores abaixo de 0.</div>
  <div class="box tr">💡 <strong>Ana çıkarım:</strong> MVRV Z-Score'un 0'ın altında olması tarihsel olarak düşük değerlemeyi, 3,5'in üzerinde olması ise aşırı ısınmayı işaret eder. Bitcoin'in üç büyük dip noktası — 2015, 2018, 2022 — hepsi 0'ın altında değerler kaydetti.</div>
  ...
  <p class="tr">Bilindik piyasa değeri: mevcut fiyat × dolaşımdaki arz. Korku ve açgözlülükle şiddetli şekilde dalgalanır.</p>
  ...
  <h3 class="vi">Giá trị Đã Thực hiện (RV)</h3>
  ...
  <p class="fr">Valeur totale de tous les Bitcoin évaluée au prix du moment où chaque pièce a été déplacée on-chain pour la dernière fois — essentiellement la base de coût agrégée de tous les détenteurs. Bien plus stable que la valeur de marché.</p>
  <p class="pt">Valor total de todo o Bitcoin precificado no momento em que cada moeda se moveu on-chain pela última vez — essencialmente a base de custo agregada de todos os detentores. Muito mais estável do que o valor de mercado.</p>
  <p class="tr">Her bir coin'in on-chain olarak son hareket ettiği andaki fiyatla değerlenen toplam bitcoin değeri — esasen tüm sahiplerin toplam maliyet tabanı. Piyasa değerinden çok daha istikrarlı.</p>
  <p class="vi">Tổng giá trị của toàn bộ Bitcoin được định giá tại thời điểm mỗi đồng coin di chuyển on-chain lần cuối — về cơ bản là tổng giá vốn của tất cả người nắm giữ. Ổn định hơn nhiều so với giá trị thị trường.</p>
  ...
  <h3 class="fr">Z-Score (Normalisation par l'écart-type)</h3>
  ...
  <p class="fr">(Valeur de Marché − Valeur Réalisée) ÷ écart-type de la Valeur de Marché — un seul chiffre indiquant à quel point les valorisations actuelles sont extrêmes d'un point de vue historique.</p>
  <p class="pt">(Valor de Mercado − Valor Realizado) ÷ desvio padrão do Valor de Mercado — um único número que mostra o quão extremas as valorizações atuais são historicamente.</p>
  <p class="tr">(Piyasa Değeri − Gerçekleşen Değer) ÷ Piyasa Değeri'nin standart sapması — mevcut değerlemelerin tarihsel olarak ne kadar aşırı olduğunu gösteren tek bir sayı.</p>
  <p class="vi">(Giá trị Thị trường − Giá trị Đã Thực hiện) ÷ độ lệch chuẩn của Giá trị Thị trường — một con số duy nhất cho biết mức định giá hiện tại cực đoan đến đâu xét theo lịch sử.</p>
  ...
  <div class="box vi"><strong>Công thức:</strong> MVRV Z-Score = (Giá trị Thị trường − Giá trị Đã Thực hiện) ÷ ĐộLệchChuẩn(Giá trị Thị trường)</div>
  ...
  <table class="zt fr">
    ...
    <tr><td class="r">Au-dessus de 3,5</td><td>Surchauffe</td><td class="r">Envisager de vendre</td></tr>
  ...
  <table class="zt tr">
    ...
    <tr><td class="g">−1 altı</td><td>Aşırı düşük değerleme</td><td class="g">Güçlü Al</td></tr>
    <tr><td class="g">0 altı</td><td>Tarihsel düşük değerleme</td><td class="g">Alım Bölgesi</td></tr>
    <tr><td class="y">0 – 1</td><td>Hafif düşük değerli</td><td class="y">Biriktir</td></tr>
    <tr><td class="y">1 – 3</td><td>Adil ile aşırı değerli arası</td><td class="y">Nötr / Dikkat</td></tr>
    <tr><td class="r">3,5 üzeri</td><td>Aşırı ısınmış</td><td class="r">Satışı Değerlendir</td></tr>
    <tr><td class="r">7 üzeri</td><td>Aşırı ısınma</td><td class="r">Güçlü Sat</td></tr>
  </table>
  <table class="zt vi">
    ...
    <tr><td class="g">Dưới 0</td><td>Định giá thấp mang tính lịch sử</td><td class="g">Vùng Mua</td></tr>
  ...
  <p class="fr">En janvier 2015, alors que le Bitcoin avoisinait 150 $, le MVRV Z-Score a atteint −0,8. Le Bitcoin a ensuite progressé d'environ 130 fois pour atteindre 20 000 $ en 2017.</p>
  <p class="pt">Em janeiro de 2015, com o Bitcoin próximo de US$ 150, o MVRV Z-Score atingiu −0,8. O Bitcoin subsequentemente subiu cerca de 130x até US$ 20.000 em 2017.</p>
  <p class="tr">Bitcoin'in 150 dolar civarında olduğu Ocak 2015'te MVRV Z-Score −0,8'e ulaştı. Bitcoin daha sonra 2017 yılına kadar yaklaşık 130 kat yükselerek 20.000 dolara ulaştı.</p>
  <p class="vi">Vào tháng 1 năm 2015, khi Bitcoin ở gần mức 150 đô la, MVRV Z-Score chạm mức −0,8. Sau đó Bitcoin tăng khoảng 130 lần lên 20.000 đô la vào năm 2017.</p>
  ...
  <p class="fr">Au point bas de 3 200 $ en décembre 2018, le score a atteint −0,2. Les acheteurs à ce niveau ont vu des gains d'environ 20 fois d'ici au sommet de 2021.</p>
  <p class="pt">No fundo de US$ 3.200 em dezembro de 2018, o índice atingiu −0,2. Os compradores nesse nível viram ganhos de cerca de 20x até o pico de 2021.</p>
  ...
  <p class="vi">Tại đáy 3.200 đô la vào tháng 12 năm 2018, chỉ số này chạm mức −0,2. Những người mua ở mức này đã chứng kiến mức lợi nhuận khoảng 20 lần tính đến đỉnh năm 2021.</p>
  ...
  <p class="fr">Pendant l'effondrement de FTX en novembre 2022, alors que le Bitcoin se situait à 15 500 $, le score était de 0,1 — proche de la zone de point bas historique.</p>
  <p class="pt">Durante o colapso da FTX em novembro de 2022, com o Bitcoin em US$ 15.500, o índice foi 0,1 — próximo à zona de fundo histórico.</p>
  <p class="tr">Kasım 2022'de FTX çöküşü sırasında Bitcoin 15.500 dolardayken skor 0,1 oldu — tarihsel dip bölgesine yakın.</p>
  <p class="vi">Trong đợt sụp đổ của FTX vào tháng 11 năm 2022, khi Bitcoin ở mức 15.500 đô la, chỉ số này là 0,1 — gần vùng đáy lịch sử.</p>
  ...
  <ul class="fr">
    <li><strong>Pas un indicateur avancé :</strong> n'indique pas quand le rebond commencera. Les prix peuvent continuer à baisser pendant des mois, même dans la zone de sous-évaluation.</li>
  ...
  <ul class="pt">
    <li><strong>Não é um indicador antecedente:</strong> não indica quando a recuperação começará. Os preços podem continuar caindo por meses mesmo na zona de subvalorização.</li>
    <li><strong>Alta correlação com o NUPL:</strong> ambos são baseados no valor realizado e tendem a se mover juntos.</li>
    <li><strong>Nunca usar sozinho:</strong> sempre combinar com outros indicadores para uma visão completa.</li>
  </ul>
  <ul class="tr">
    <li><strong>Öncü gösterge değildir:</strong> Toparlanmanın ne zaman başlayacağını söylemez. Fiyatlar düşük değerleme bölgesinde bile aylarca daha düşebilir.</li>
    ...
    <li><strong>Asla tek başına kullanmayın:</strong> Eksiksiz bir tablo için her zaman diğer göstergelerle birleştirin.</li>
  </ul>
  <ul class="vi">
    <li><strong>Không phải chỉ báo dẫn dắt:</strong> Không cho biết khi nào sự phục hồi bắt đầu. Giá có thể tiếp tục giảm thêm nhiều tháng ngay cả trong vùng định giá thấp.</li>
    <li><strong>Tương quan cao với NUPL:</strong> Cả hai đều dựa trên giá trị đã thực hiện và có xu hướng di chuyển cùng nhau.</li>
    <li><strong>Không bao giờ sử dụng đơn lẻ:</strong> Luôn kết hợp với các chỉ báo khác để có bức tranh toàn diện.</li>
  </ul>
  ...
  <h2 class="fr">Meilleures combinaisons avec</h2>
  ...
  <ul class="fr">
    <li><strong><a href="/blog/hash-ribbon-indicator.html">Croisement de reprise du Hash Ribbon</a>:</strong> Le signal d'achat avancé le plus fort</li>
    <li><strong><a href="/blog/sth-sopr.html">STH-SOPR sous 0,95</a>:</strong> Vente de panique des détenteurs à court terme</li>
    <li><strong><a href="/blog/coinbase-premium.html">Coinbase Premium devient positif</a>:</strong> Signal de retour des institutionnels américains</li>
    <li><strong><a href="/blog/funding-rate-futures-gap.html">Écart Futures-Spot négatif</a>:</strong> Positions longues à effet de levier liquidées</li>
  </ul>
  <ul class="pt">
    ...
    <li><strong><a href="/blog/coinbase-premium.html">Coinbase Premium torna-se positivo</a>:</strong> Sinal de reentrada institucional dos EUA</li>
    <li><strong><a href="/blog/funding-rate-futures-gap.html">Gap Futuros-Spot negativo</a>:</strong> Posições longas alavancadas liquidadas</li>
  </ul>
  <ul class="tr">
    <li><strong><a href="/blog/hash-ribbon-indicator.html">Hash Ribbon toparlanma kesişimi</a>:</strong> En güçlü öncü alım sinyali</li>
    <li><strong><a href="/blog/sth-sopr.html">STH-SOPR 0,95 altında</a>:</strong> Kısa vadeli sahiplerin panik satışı</li>
    <li><strong><a href="/blog/coinbase-premium.html">Coinbase Premium pozitife dönüyor</a>:</strong> ABD kurumsal yeniden giriş sinyali</li>
    <li><strong><a href="/blog/funding-rate-futures-gap.html">Vadeli-Spot farkı negatif</a>:</strong> Kaldıraçlı long pozisyonların tasfiyesi</li>
  </ul>
  <ul class="vi">
    <li><strong><a href="/blog/hash-ribbon-indicator.html">Hash Ribbon chuyển sang phục hồi</a>:</strong> Tín hiệu mua dẫn dắt mạnh nhất</li>
    <li><strong><a href="/blog/sth-sopr.html">STH-SOPR dưới 0,95</a>:</strong> Người nắm giữ ngắn hạn bán tháo hoảng loạn</li>
    <li><strong><a href="/blog/coinbase-premium.html">Coinbase Premium chuyển dương</a>:</strong> Tín hiệu tổ chức Mỹ quay lại</li>
    <li><strong><a href="/blog/funding-rate-futures-gap.html">Chênh lệch Futures-Spot âm</a>:</strong> Vị thế long đòn bẩy bị thanh lý</li>
  </ul>
