...
<p class="ko">이 사이트에서 다룬 <a href="/blog/mvrv-z-score">MVRV Z-Score</a>와 <a href="/blog/nupl-indicator">NUPL</a> 둘 다 같은 재료를 씁니다 — 바로 <strong>실현시가총액(Realized Cap)</strong>이에요. 이 지표 자체를 제대로 이해하면, 파생된 다른 지표들도 훨씬 직관적으로 읽힙니다.</p>
  <p class="en">Two indicators covered on this blog — <a href="/en/blog/mvrv-z-score">MVRV Z-Score</a> and <a href="/en/blog/nupl-indicator">NUPL</a> — both share the same core ingredient: <strong>Realized Cap</strong>. Understand this base metric well, and every indicator built on top of it becomes far more intuitive.</p>
  <p class="ja">このブログで扱った<a href="/ja/blog/mvrv-z-score">MVRV Zスコア</a>と<a href="/ja/blog/nupl-indicator">NUPL</a>はどちらも同じ材料を使っています — それが<strong>実現時価総額(Realized Cap)</strong>です。この指標自体をしっかり理解すれば、派生する他の指標もはるかに直感的に読めるようになります。</p>

  <p class="es">Dos indicadores cubiertos en este blog — <a href="/es/blog/mvrv-z-score">MVRV Z-Score</a> y <a href="/es/blog/nupl-indicator">NUPL</a> — comparten el mismo ingrediente base: la <strong>Capitalización Realizada (Realized Cap)</strong>. Entender bien esta métrica base hace que cada indicador construido sobre ella sea mucho más intuitivo.</p>
  <p class="de">Zwei in diesem Blog behandelte Indikatoren — <a href="/de/blog/mvrv-z-score">MVRV Z-Score</a> und <a href="/de/blog/nupl-indicator">NUPL</a> — teilen sich dieselbe Grundzutat: die <strong>Realized Cap</strong>. Wer diese Basiskennzahl gut versteht, findet jeden darauf aufbauenden Indikator weit intuitiver.</p>
  <p class="fr">Deux indicateurs traités sur ce blog — <a href="/fr/blog/mvrv-z-score">MVRV Z-Score</a> et <a href="/fr/blog/nupl-indicator">NUPL</a> — partagent le même ingrédient de base : le <strong>Realized Cap</strong>. Bien comprendre cette métrique de base rend beaucoup plus intuitif chaque indicateur construit à partir d'elle.</p>
  <p class="pt">Dois indicadores abordados neste blog — <a href="/pt/blog/mvrv-z-score">MVRV Z-Score</a> e <a href="/pt/blog/nupl-indicator">NUPL</a> — compartilham o mesmo ingrediente básico: o <strong>Realized Cap</strong>. Compreender bem essa métrica base torna muito mais intuitivo cada indicador construído sobre ela.</p>
  <p class="tr">Bu blogda ele alınan iki gösterge — <a href="/tr/blog/mvrv-z-score">MVRV Z-Score</a> ve <a href="/tr/blog/nupl-indicator">NUPL</a> — aynı temel bileşeni paylaşır: <strong>Realized Cap</strong>. Bu temel metriği iyi anlarsanız, üzerine inşa edilen her gösterge çok daha sezgisel hale gelir.</p>
  <p class="vi">Hai chỉ báo được đề cập trên blog này — <a href="/vi/blog/mvrv-z-score">MVRV Z-Score</a> và <a href="/vi/blog/nupl-indicator">NUPL</a> — đều dùng chung một thành phần cốt lõi: <strong>Realized Cap</strong>. Hiểu rõ chỉ số nền tảng này, mọi chỉ báo được xây dựng dựa trên nó sẽ trở nên trực quan hơn nhiều.</p>
  ...
  <p class="ko"><a href="/blog/mvrv-z-score">MVRV Z-Score</a>와 <a href="/blog/nupl-indicator">NUPL</a>은 이 실현시가총액을 서로 다른 방식으로 정규화한 것뿐이라, 원리를 이해하고 나면 두 지표를 훨씬 빠르게 해석할 수 있습니다.</p>
  <p class="en"><a href="/en/blog/mvrv-z-score">MVRV Z-Score</a> and <a href="/en/blog/nupl-indicator">NUPL</a> are really just two different normalizations of this same realized cap concept — understanding the base metric makes reading both far faster.</p>
  <p class="ja"><a href="/ja/blog/mvrv-z-score">MVRV Zスコア</a>と<a href="/ja/blog/nupl-indicator">NUPL</a>は、この実現時価総額を異なる方法で正規化しただけのものなので、原理を理解すれば両方の指標をはるかに速く解釈できるようになります。</p>
<p class="es"><a href="/es/blog/mvrv-z-score">MVRV Z-Score</a> y <a href="/es/blog/nupl-indicator">NUPL</a> son en realidad solo dos normalizaciones diferentes de este mismo concepto de capitalización realizada — entender la métrica base hace que leer ambos indicadores sea mucho más rápido.</p>
<p class="de"><a href="/de/blog/mvrv-z-score">MVRV Z-Score</a> und <a href="/de/blog/nupl-indicator">NUPL</a> sind eigentlich nur zwei unterschiedliche Normalisierungen desselben Realized-Cap-Konzepts — wer die Basiskennzahl versteht, kann beide Indikatoren weit schneller lesen.</p>
<p class="fr"><a href="/fr/blog/mvrv-z-score">MVRV Z-Score</a> et <a href="/fr/blog/nupl-indicator">NUPL</a> ne sont en réalité que deux normalisations différentes de ce même concept de Realized Cap — comprendre la métrique de base permet de lire les deux beaucoup plus rapidement.</p>
<p class="pt"><a href="/pt/blog/mvrv-z-score">MVRV Z-Score</a> e <a href="/pt/blog/nupl-indicator">NUPL</a> são, na verdade, apenas duas normalizações diferentes desse mesmo conceito de capitalização realizada — entender a métrica base torna a leitura de ambos muito mais rápida.</p>
<p class="tr"><a href="/tr/blog/mvrv-z-score">MVRV Z-Score</a> ve <a href="/tr/blog/nupl-indicator">NUPL</a>, aslında bu aynı realized cap kavramının iki farklı normalleştirilmiş halinden başka bir şey değildir — temel metriği anlamak, ikisini de çok daha hızlı okumanızı sağlar.</p>
<p class="vi"><a href="/vi/blog/mvrv-z-score">MVRV Z-Score</a> và <a href="/vi/blog/nupl-indicator">NUPL</a> thực chất chỉ là hai cách chuẩn hóa khác nhau của cùng khái niệm realized cap này — hiểu rõ chỉ số nền tảng giúp đọc hiểu cả hai chỉ báo nhanh hơn nhiều.</p>
