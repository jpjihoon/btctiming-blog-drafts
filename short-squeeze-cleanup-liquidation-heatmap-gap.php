...
<p class="id">Bitcoin diperdagangkan di $64.600-$65.300 pada sore hari 16 Juli (KST), melanjutkan reli yang didorong short squeeze yang dimulai setelah kejutan CPI AS Juni pada 14 Juli. Menurut CoinGlass, dari $37,32 juta yang dilikuidasi di seluruh pasar derivatif kripto dalam 24 jam terakhir, $31,66 juta (84,8%) berasal dari posisi short — pola short squeeze klasik di mana penutupan short paksa mendorong harga naik.</p>
<p class="pl">Bitcoin jest wyceniany na 64 600-65 300 dolarów po południu 16 lipca (czas koreański), kontynuując rajd napędzany short squeeze, który rozpoczął się po niespodziance CPI USA za czerwiec 14 lipca. Według CoinGlass, z 37,32 mln dolarów zlikwidowanych na całym rynku kryptowalutowych instrumentów pochodnych w ciągu ostatnich 24 godzin, 31,66 mln dolarów (84,8%) pochodziło z pozycji krótkich — podręcznikowy wzorzec short squeeze, w którym wymuszone zamknięcia krótkich pozycji windują cenę w górę.</p>
<p class="it">Il bitcoin è scambiato a 64.600-65.300 dollari nel pomeriggio del 16 luglio (KST), proseguendo il rally guidato dallo short squeeze iniziato dopo la sorpresa del CPI di giugno negli USA il 14 luglio. Secondo CoinGlass, dei 37,32 milioni di dollari liquidati sull'intero mercato dei derivati crypto nelle ultime 24 ore, 31,66 milioni di dollari (84,8%) provenivano da posizioni short — un classico schema di short squeeze in cui le chiusure forzate delle posizioni short spingono il prezzo più in alto.</p>
<p class="ru">Биткоин торгуется в диапазоне $64 600-$65 300 по состоянию на вторую половину дня 16 июля (по корейскому времени), продолжая ралли, вызванное шорт-сквизом после сюрприза по июньскому CPI США 14 июля. По данным CoinGlass, из $37,32 млн, ликвидированных на всём рынке криптодеривативов за последние 24 часа, $31,66 млн (84,8%) пришлись на короткие позиции — классический паттерн шорт-сквиза, при котором принудительное закрытие шортов толкает цену вверх.</p>
<p class="zh">截至7月16日(韓國時間)下午,比特幣交易於64,600至65,300美元之間,延續7月14日美國6月CPI意外數據後由軋空(short squeeze)帶動的漲勢。根據CoinGlass數據,過去24小時內加密貨幣衍生品市場共有3,732萬美元遭清算,其中3,166萬美元(84.8%)來自空頭部位——這是典型的軋空模式,強制平倉的空單推高了價格。</p>
...
<p class="id">Namun apakah likuidasi ini hanya berakhir sebagai pembersihan sederhana atau benar-benar mengubah struktur pasar adalah pertanyaan berbeda. Rasio long/short dan open interest tetap relatif netral bahkan setelah penyapuan ini, dan heatmap likuidasi CoinGlass sudah menunjukkan klaster baru terbentuk kembali baik di atas maupun di bawah harga saat ini. Kini setelah short tersapu bersih, tulisan ini memeriksa — melalui data likuidasi, indikator posisi, dan peta likuidasi — apakah pasar derivatif benar-benar menjadi lebih ringan.</p>
<p class="pl">Jednak to, czy ta likwidacja zakończyła się jedynie prostym porządkowaniem, czy faktycznie zmieniła strukturę rynku, to inna kwestia. Wskaźnik long/short i open interest pozostały w miarę neutralne nawet po tej wyprzedaży, a mapa cieplna likwidacji CoinGlass już pokazuje nowe skupiska odbudowujące się zarówno powyżej, jak i poniżej obecnej ceny. Teraz, gdy krótkie pozycje zostały wyczyszczone, ten tekst sprawdza — poprzez dane o likwidacjach, wskaźniki pozycjonowania i mapę likwidacji — czy rynek instrumentów pochodnych faktycznie stał się lżejszy.</p>
<p class="it">Tuttavia, se questa liquidazione si sia conclusa come una semplice pulizia o abbia effettivamente cambiato la struttura del mercato è una questione diversa. Il rapporto long/short e l'open interest sono rimasti pressoché neutrali anche dopo questa ondata di liquidazioni, e la heatmap delle liquidazioni di CoinGlass mostra già nuovi cluster che si ricostituiscono sia sopra che sotto il prezzo attuale. Ora che gli short sono stati eliminati, questo articolo verifica — attraverso i dati di liquidazione, gli indicatori di posizionamento e la mappa delle liquidazioni — se il mercato dei derivati sia davvero diventato più leggero.</p>
<p class="ru">Но завершилась ли эта ликвидация простой чисткой или действительно изменила структуру рынка — это другой вопрос. Соотношение long/short и открытый интерес остались примерно нейтральными даже после этой волны, а тепловая карта ликвидаций CoinGlass уже показывает новые кластеры, восстанавливающиеся как выше, так и ниже текущей цены. Теперь, когда шорты вычищены, в этом материале проверяется — через данные о ликвидациях, индикаторы позиционирования и карту ликвидаций, — действительно ли рынок деривативов стал легче.</p>
<p class="zh">然而,這次清算究竟只是單純的整理,還是真正改變了市場結構,是另一個問題。即使在這波清算之後,多空比與未平倉合約仍大致維持中性,而CoinGlass的清算熱力圖已顯示新的密集區在目前價格上下重新形成。既然空頭已被清空,本文透過清算數據、部位指標與清算地圖三方面來檢視,衍生品市場是否真的變輕了。</p>
...
<h2 class="id">Angka Likuidasi Dulu — Short Menyumbang 84,8%</h2>
<h2 class="pl">Najpierw liczby likwidacji — krótkie pozycje stanowiły 84,8%</h2>
<h2 class="it">Prima i numeri delle liquidazioni — gli short hanno rappresentato l'84,8%</h2>
<h2 class="ru">Сначала цифры ликвидаций — шорты составили 84,8%</h2>
<h2 class="zh">先看清算數據——空頭佔84.8%</h2>
...
<p class="id">Menurut CoinGlass, $37,32 juta dilikuidasi di seluruh pasar derivatif kripto selama 24 jam terakhir, dengan $31,66 juta (84,8%) berasal dari posisi short dan $5,66 juta (15,2%) dari long. Kontras dengan kasus yang berjalan ke arah berlawanan sangat mencolok: ketika harga anjlok pada 6 Juli, long menyumbang sebagian besar dari $61,57 juta likuidasi hari itu dengan $47,91 juta, artinya pembelilah yang tersingkir paksa. Dalam sekitar sepuluh hari, pihak yang dilikuidasi berbalik total dari long ke short.</p>
<p class="pl">Według CoinGlass, w ciągu ostatnich 24 godzin na całym rynku kryptowalutowych instrumentów pochodnych zlikwidowano 37,32 mln dolarów, z czego 31,66 mln dolarów (84,8%) pochodziło z pozycji krótkich, a 5,66 mln dolarów (15,2%) z długich. Kontrast z przypadkiem przebiegającym w przeciwnym kierunku jest wyraźny: gdy 6 lipca cena spadła, pozycje długie odpowiadały za większość tegodniowej likwidacji w wysokości 61,57 mln dolarów, czyli 47,91 mln dolarów, co oznacza, że to kupujący zostali zmuszeni do wyjścia. W ciągu około dziesięciu dni to, kto jest likwidowany, całkowicie się odwróciło — z długich na krótkie.</p>
<p class="it">Secondo CoinGlass, negli ultimi 24 ore sono stati liquidati 37,32 milioni di dollari sull'intero mercato dei derivati crypto, con 31,66 milioni di dollari (84,8%) provenienti da posizioni short e 5,66 milioni di dollari (15,2%) da posizioni long. Il contrasto con un caso nella direzione opposta è netto: quando il prezzo è crollato il 6 luglio, le posizioni long rappresentavano la maggior parte dei 61,57 milioni di dollari liquidati quel giorno, per un totale di 47,91 milioni di dollari, il che significa che a essere costretti a uscire furono i compratori. In circa dieci giorni, chi viene liquidato si è completamente ribaltato, passando dai long agli short.</p>
<p class="ru">По данным CoinGlass, за последние 24 часа на всём рынке криптодеривативов было ликвидировано $37,32 млн, из которых $31,66 млн (84,8%) пришлись на короткие позиции и $5,66 млн (15,2%) — на длинные. Контраст со случаем противоположной направленности разителен: когда 6 июля цена обвалилась, длинные позиции составили основную часть тогдашних ликвидаций в $61,57 млн — $47,91 млн, а значит, именно покупателей вынудили выйти из рынка. Примерно за десять дней то, кого ликвидируют, полностью изменилось — с длинных на короткие позиции.</p>
<p class="zh">根據CoinGlass數據,過去24小時內整個加密貨幣衍生品市場共清算3,732萬美元,其中3,166萬美元(84.8%)來自空頭部位,566萬美元(15.2%)來自多頭部位。與方向相反的案例相比對比鮮明:7月6日價格下跌時,當天6,157萬美元清算中多頭佔了大部分,達4,791萬美元,意味著買方才是被強制出場的一方。短短約十天內,被清算的一方已從多頭完全翻轉為空頭。</p>
...
<p class="id">Meski begitu, membaca angka itu semata sebagai "pembeli menang" mengandung jebakan. Short squeeze adalah struktur yang memperkuat dirinya sendiri: likuidasi paksa berubah menjadi order beli yang mendorong harga naik, dan harga yang lebih tinggi memicu putaran likuidasi short berikutnya. Bagaimana harga likuidasi dihitung, dan mengapa likuidasi beruntun begitu terpicu, dibahas dalam tulisan situs ini tentang <a href="/id/blog/liquidation-price-math">cara kerja harga likuidasi leverage</a>. Dengan kata lain, 84,8% hanya menunjukkan berapa banyak short yang tersingkir paksa — bukan seberapa besar pembelian baru yang benar-benar masuk.</p>
<p class="pl">Mimo to odczytywanie samej tej liczby jako „zwycięstwa kupujących" kryje w sobie pułapkę. Short squeeze to struktura samowzmacniająca się: wymuszone likwidacje zamieniają się w zlecenia kupna, które windują cenę, a wyższa cena wyzwala kolejną rundę likwidacji krótkich pozycji. Sposób obliczania cen likwidacji i przyczyny, dla których po uruchomieniu tworzą kaskadę, opisano w tekście tej witryny o <a href="/pl/blog/liquidation-price-math">działaniu cen likwidacji z dźwignią</a>. Innymi słowy, 84,8% mówi jedynie, ile krótkich pozycji zmuszono do zamknięcia — a nie, ile nowego kapitału kupującego faktycznie napłynęło.</p>
<p class="it">Tuttavia, leggere quel numero solo come "hanno vinto i compratori" nasconde una trappola. Uno short squeeze è una struttura autorafforzante: le liquidazioni forzate si trasformano in ordini di acquisto che spingono il prezzo verso l'alto, e il prezzo più alto innesca il round successivo di liquidazioni short. Come vengono calcolati i prezzi di liquidazione, e perché una volta innescati si propagano a cascata, è spiegato nell'articolo di questo sito su <a href="/it/blog/liquidation-price-math">come funzionano i prezzi di liquidazione con leva</a>. In altre parole, l'84,8% indica solo quanti short sono stati costretti a uscire, non quanti nuovi acquisti siano effettivamente entrati.</p>
<p class="ru">Тем не менее, воспринимать это число просто как «победу покупателей» — ловушка. Шорт-сквиз — это самоусиливающаяся структура: принудительные ликвидации превращаются в заявки на покупку, которые толкают цену вверх, а более высокая цена запускает следующий раунд ликвидаций шортов. О том, как рассчитываются цены ликвидации и почему они каскадно распространяются после срабатывания, рассказывается в материале этого сайта о <a href="/ru/blog/liquidation-price-math">работе цен ликвидации с плечом</a>. Другими словами, 84,8% говорит лишь о том, сколько шортов было принудительно закрыто, — а не о том, сколько реально пришло новых покупок.</p>
<p class="zh">不過,若僅將這個數字解讀為「買方獲勝」,其中暗藏陷阱。軋空是一種自我強化的結構:強制平倉轉化為買單推高價格,而更高的價格又觸發下一輪空頭清算。清算價格如何計算、以及一旦觸發為何會連鎖擴散,本站已在<a href="/zh/blog/liquidation-price-math">槓桿清算價格運作原理</a>一文中說明。換句話說,84.8%只顯示有多少空頭被強制出場——並不代表實際有多少新買盤真正進場。</p>
...
<h2 class="id">Rasio Long/Short dan Open Interest — Tersapu Bersih, Tapi Posisi Tetap Netral</h2>
<h2 class="pl">Wskaźnik long/short i open interest — wyczyszczone, ale pozycjonowanie pozostało neutralne</h2>
<h2 class="it">Rapporto long/short e open interest — ripulito, ma il posizionamento è rimasto neutrale</h2>
<h2 class="ru">Соотношение long/short и открытый интерес — вычищено, но позиционирование осталось нейтральным</h2>
<h2 class="zh">多空比與未平倉合約——已清空,但部位仍維持中性</h2>
...
<p class="id">Menurut Coinalyze, rasio long/short Bitcoin secara keseluruhan berada di 1,0986 — long hanya unggul tipis, yang secara praktis mendekati netral. Bahkan jika hanya melihat kontrak perpetual BTCUSDT Binance, tempat trader ritel mendominasi, long berada di 54,1% berbanding 45,9% short (rasio 1,18) — masih dalam pita "seimbang". Open interest berada di $48,93 miliar, hanya naik 3,92% selama 30 hari terakhir, dan funding berjalan di 0,0043% per hari (sekitar 1,56% setahun) — level netral di mana baik long maupun short tidak membayar premi yang jelas.</p>
<p class="pl">Według Coinalyze ogólny wskaźnik long/short Bitcoina wynosi 1,0986 — długie pozycje mają jedynie niewielką przewagę, co w praktyce jest bliskie neutralności. Nawet patrząc wyłącznie na kontrakty wieczyste BTCUSDT na Binance, gdzie dominują inwestorzy detaliczni, długie pozycje stanowią 54,1% wobec 45,9% krótkich (wskaźnik 1,18) — nadal w paśmie „zrównoważonym". Open interest wynosi 48,93 mld dolarów, wzrastając zaledwie o 3,92% w ciągu ostatnich 30 dni, a finansowanie utrzymuje się na poziomie 0,0043% dziennie (około 1,56% w skali roku) — poziom neutralny, przy którym ani długie, ani krótkie pozycje nie płacą wyraźnej premii.</p>
<p class="it">Secondo Coinalyze, il rapporto long/short complessivo di Bitcoin è a 1,0986 — i long hanno solo un lieve vantaggio, praticamente vicino alla neutralità. Anche isolando i perpetual BTCUSDT di Binance, dove dominano i trader retail, i long sono al 54,1% contro il 45,9% degli short (rapporto 1,18) — ancora nella fascia "equilibrata". L'open interest è a 48,93 miliardi di dollari, in aumento di appena il 3,92% negli ultimi 30 giorni, e il funding gira allo 0,0043% al giorno (circa l'1,56% annualizzato) — un livello neutrale in cui né i long né gli short pagano un premio evidente.</p>
<p class="ru">По данным Coinalyze, общее соотношение long/short по биткоину составляет 1,0986 — у длинных позиций лишь небольшое преимущество, что на практике близко к нейтральному. Даже если рассматривать только бессрочные контракты BTCUSDT на Binance, где доминируют розничные трейдеры, длинные позиции составляют 54,1% против 45,9% коротких (соотношение 1,18) — всё ещё в пределах «сбалансированной» полосы. Открытый интерес составляет $48,93 млрд, увеличившись всего на 3,92% за последние 30 дней, а фандинг держится на уровне 0,0043% в день (около 1,56% в годовом выражении) — нейтральный уровень, при котором ни длинные, ни короткие позиции не платят явной премии.</p>
<p class="zh">根據Coinalyze數據,比特幣整體多空比為1.0986——多頭僅略佔優勢,實際上接近中性。即使只看散戶主導的幣安BTCUSDT永續合約,多頭佔54.1%、空頭佔45.9%(比率1.18),仍落在「平衡」區間內。未平倉合約為489.3億美元,過去30天僅增加3.92%,資金費率則維持在每日0.0043%(年化約1.56%)——這是一個多空雙方都未支付明顯溢價的中性水準。</p>
...
<p class="id">Dalam reli pasca-short-squeeze yang khas, long baru yang mengikuti tren mengisi ruang yang ditinggalkan short yang terlikuidasi, memiringkan rasio long/short jelas ke arah long sementara open interest ikut naik. Mengingat <a href="/id/blog/open-interest-guide">open interest</a> mewakili total taruhan leverage di pasar, total yang nyaris tidak bergerak bahkan setelah likuidasi ini menunjukkan belum banyak leverage baru yang benar-benar naik ke atas reli ini. Short pergi, tapi long juga sebenarnya tidak banyak muncul — leverage, untuk saat ini, berdiri di pinggir lapangan.</p>
<p class="pl">W typowym rajdzie po short squeeze nowe długie pozycje podążające za trendem wypełniają miejsce po zlikwidowanych krótkich, wyraźnie przechylając wskaźnik long/short w stronę długich, podczas gdy open interest rośnie razem z nim. Ponieważ <a href="/pl/blog/open-interest-guide">open interest</a> reprezentuje łączną kwotę lewarowanych zakładów na rynku, to, że ta suma ledwo drgnęła nawet po tej likwidacji, sugeruje, że niewiele świeżej dźwigni faktycznie dołączyło do rajdu. Krótkie pozycje odeszły, ale długie tak naprawdę też się nie pojawiły — dźwignia na razie stoi z boku.</p>
<p class="it">In un tipico rally post-short-squeeze, nuovi long che seguono il trend riempiono lo spazio lasciato dagli short liquidati, inclinando chiaramente il rapporto long/short verso i long mentre l'open interest sale insieme a esso. Dato che l'<a href="/it/blog/open-interest-guide">open interest</a> rappresenta l'importo totale delle scommesse a leva sul mercato, il fatto che quel totale sia rimasto quasi fermo anche dopo questa liquidazione suggerisce che non molta nuova leva sia effettivamente salita a bordo del rally. Gli short se ne sono andati, ma nemmeno i long si sono davvero presentati — la leva, per ora, resta a bordo campo.</p>
<p class="ru">В типичном ралли после шорт-сквиза новые длинные позиции, следующие за трендом, заполняют пространство, оставленное ликвидированными шортами, явно смещая соотношение long/short в сторону лонгов, при этом открытый интерес растёт вместе с ним. Учитывая, что <a href="/ru/blog/open-interest-guide">открытый интерес</a> представляет собой общий объём заёмных ставок на рынке, то, что этот показатель почти не сдвинулся даже после этой ликвидации, говорит о том, что немного свежего плеча реально присоединилось к ралли. Шорты ушли, но лонги тоже толком не появились — заёмные средства пока стоят в стороне.</p>
<p class="zh">在典型的軋空後行情中,追隨趨勢的新多頭會填補被清算空頭留下的空缺,使多空比明顯傾向多頭,同時未平倉合約也隨之攀升。鑑於<a href="/zh/blog/open-interest-guide">未平倉合約</a>代表市場上槓桿押注的總量,即使在這次清算之後這個總量幾乎沒有變動,意味著並沒有太多新槓桿真正加入這波行情。空頭離場了,但多頭也沒有真正進場——槓桿目前仍在場邊觀望。</p>
...
<h2 class="id">Heatmap Likuidasi — Klaster Baru Terbentuk Kembali Segera Setelah yang Lama Tersapu</h2>
<h2 class="pl">Mapa cieplna likwidacji — nowe skupiska odbudowane, gdy tylko stare zniknęły</h2>
<h2 class="it">La heatmap delle liquidazioni — nuovi cluster ricostruiti non appena i vecchi sono spariti</h2>
<h2 class="ru">Тепловая карта ликвидаций — новые кластеры восстановились сразу после исчезновения старых</h2>
<h2 class="zh">清算熱力圖——舊密集區一消失,新密集區立刻重建</h2>
...
<p class="id">Heatmap likuidasi CoinGlass, dikutip oleh media seperti DailyForex, menunjukkan klaster padat baru sudah terbentuk hanya satu-dua hari setelah penyapuan likuidasi ini membersihkan leverage. Di atas harga saat ini, posisi terkait likuidasi telah menumpuk di pita $65.000-$65.500; di bawahnya, klaster lain berada di sekitar $63.000. Kontrak futures Juli CME diperdagangkan di $65.090 (+0,58% dari sesi sebelumnya), bergerak di kisaran yang kurang lebih sama dengan spot tanpa celah besar.</p>
<p class="pl">Mapa cieplna likwidacji CoinGlass, cytowana przez media takie jak DailyForex, pokazuje, że nowe gęste skupiska uformowały się już zaledwie dzień lub dwa po tym, jak ta fala likwidacji wyczyściła dźwignię. Powyżej obecnej ceny pozycje powiązane z likwidacją nagromadziły się w paśmie 65 000-65 500 dolarów; poniżej kolejne skupisko znajduje się w okolicach 63 000 dolarów. Lipcowy kontrakt futures CME jest notowany po 65 090 dolarów (+0,58% wobec poprzedniej sesji), poruszając się mniej więcej w tym samym przedziale co rynek spot, bez większej luki.</p>
<p class="it">La heatmap delle liquidazioni di CoinGlass, citata da testate come DailyForex, mostra che nuovi cluster densi si sono già formati appena uno o due giorni dopo che questa ondata di liquidazioni ha ripulito la leva. Sopra il prezzo attuale, le posizioni legate alle liquidazioni si sono accumulate nella fascia 65.000-65.500 dollari; sotto, un altro cluster si trova intorno a 63.000 dollari. Il contratto future di luglio del CME è scambiato a 65.090 dollari (+0,58% rispetto alla sessione precedente), muovendosi grosso modo nello stesso range dello spot senza un gap significativo.</p>
<p class="ru">Тепловая карта ликвидаций CoinGlass, на которую ссылаются такие издания, как DailyForex, показывает, что новые плотные кластеры уже сформировались всего через день-два после того, как эта волна ликвидаций вычистила плечо. Выше текущей цены позиции, связанные с ликвидацией, скопились в диапазоне $65 000-$65 500; ниже — ещё один кластер около $63 000. Июльский фьючерс CME торгуется на уровне $65 090 (+0,58% к предыдущей сессии), двигаясь примерно в том же диапазоне, что и спот, без значительного разрыва.</p>
<p class="zh">DailyForex等媒體引用的CoinGlass清算熱力圖顯示,在這波清算掃平槓桿後僅一兩天,新的密集區已經形成。目前價格上方,與清算相關的部位已堆積在65,000至65,500美元區間;下方則在63,000美元附近出現另一個密集區。CME的7月期貨合約報65,090美元(較前一交易日+0.58%),與現貨走勢大致同步,並無明顯落差。</p>
...
<p class="id">Apa yang dimaksud struktur ini cukup sederhana. Jika harga menembus di atas $65.500, short yang menumpuk di sana bisa ditutup paksa lagi, memicu babak squeeze lainnya; jika sebaliknya turun di bawah $63.000, long yang naik dalam beberapa hari terakhir bisa dilikuidasi, mempercepat penurunan. Dengan kata lain, likuidasi 14-15 Juli tidak menghilangkan leverage dari pasar — ia hanya mengosongkan satu titik agar trader lain mengisi kembali zona yang kurang lebih sama hampir seketika.</p>
<p class="pl">To, co oznacza ta struktura, jest proste. Jeśli cena wybije się powyżej 65 500 dolarów, nagromadzone tam krótkie pozycje mogą zostać ponownie zamknięte przymusowo, wywołując kolejną falę squeeze; jeśli zamiast tego spadnie poniżej 63 000 dolarów, długie pozycje, które dołączyły w ciągu ostatnich kilku dni, mogą zostać zlikwidowane, przyspieszając spadek. Innymi słowy, likwidacja z 14-15 lipca nie usunęła dźwigni z rynku — jedynie opróżniła jedno miejsce, aby inni traderzy niemal natychmiast ponownie wypełnili mniej więcej te same strefy.</p>
<p class="it">Il significato di questa struttura è semplice. Se il prezzo sfonda sopra 65.500 dollari, gli short accumulati lì potrebbero essere chiusi forzatamente di nuovo, innescando un'altra fase di squeeze; se invece scivola sotto 63.000 dollari, i long saliti a bordo negli ultimi giorni potrebbero essere liquidati, accelerando il calo. In altre parole, la liquidazione del 14-15 luglio non ha rimosso leva dal mercato — ha semplicemente svuotato un punto perché altri trader riempissero quasi subito più o meno le stesse zone.</p>
<p class="ru">Смысл этой структуры прост. Если цена пробьёт выше $65 500, скопившиеся там шорты могут быть снова принудительно закрыты, что запустит ещё один этап сквиза; если же она соскользнёт ниже $63 000, лонги, вошедшие за последние несколько дней, могут быть ликвидированы, ускоряя падение. Другими словами, ликвидация 14-15 июля не убрала плечо с рынка — она лишь освободила одно место, чтобы другие трейдеры почти сразу заново заполнили примерно те же зоны.</p>
<p class="zh">這種結構的意義很簡單。如果價格突破65,500美元,堆積在那裡的空頭可能再次被強制平倉,觸發另一輪軋空;反之若跌破63,000美元,過去幾天進場的多頭可能被清算,加速跌勢。換句話說,7月14至15日的清算並未真正將槓桿從市場中移除——它只是清空了一個位置,幾乎立刻又被其他交易者填回大致相同的區域。</p>
...
<div class="id"><svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="28" fill="#fafafa" font-family="sans-serif" font-size="16" font-weight="700">Short Menyumbang 84,8% Likuidasi — Namun Posisi Tetap Netral</text>
  <text x="20" y="48" fill="#a1a1aa" font-family="sans-serif" font-size="13">Memeriksa likuidasi, rasio long/short, dan heatmap likuidasi per 16 Juli</text>
  <text x="20" y="76" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Pembagian Likuidasi (24 Jam Terakhir, CoinGlass)</text>
  <rect x="20" y="86" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="86" width="560" height="32" rx="6" fill="#f87171"/>
  <text x="300" y="107" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="14" font-weight="800">Short 84,8% · $31,66Jt</text>
  <rect x="20" y="128" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="128" width="100" height="32" rx="6" fill="#34d399"/>
  <text x="70" y="149" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="13" font-weight="800">15,2%</text>
  <text x="135" y="149" fill="#a1a1aa" font-family="sans-serif" font-size="13">Long $5,66Jt</text>
  <text x="20" y="176" fill="#71717a" font-family="sans-serif" font-size="12">* Terbalik pada 6 Juli: long menyumbang $47,91Jt (78%) dari $61,57Jt likuidasi hari itu</text>
  <text x="20" y="212" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Indikator Posisi — Masih Netral Setelah Penyapuan</text>
  <rect x="20" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="35" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Rasio Long/Short</text>
  <text x="35" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">1,10 (netral)</text>
  <rect x="248" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="263" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">OI (30 Hari)</text>
  <text x="263" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">+3,92% · $48,9M</text>
  <rect x="476" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="491" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Funding</text>
  <text x="491" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">0,0043%/hari</text>
  <text x="20" y="322" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Heatmap Likuidasi — Klaster Baru di Atas dan Bawah (CoinGlass)</text>
  <rect x="20" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="35" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">Area $63.000</text>
  <text x="35" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Klaster likuidasi long</text>
  <text x="35" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Tembus bisa percepat penurunan</text>
  <rect x="252" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#fbbf24"/>
  <text x="267" y="360" fill="#fbbf24" font-family="sans-serif" font-size="14" font-weight="700">$64.600-65.300</text>
  <text x="267" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Harga saat ini (sore 16/7)</text>
  <rect x="484" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="499" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">$65.000-65.500</text>
  <text x="499" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Klaster likuidasi short</text>
  <text x="499" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Tembus bisa picu squeeze ulang</text>
  <text x="20" y="452" fill="#71717a" font-family="sans-serif" font-size="12">* Angka merupakan perkiraan sesuai penyedia data dan dapat bervariasi menurut sumber/waktu. Bukan saran investasi.</text>
</svg></div>
<div class="pl"><svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="28" fill="#fafafa" font-family="sans-serif" font-size="16" font-weight="700">Short Stanowiły 84,8% Likwidacji — Ale Pozycjonowanie Pozostało Neutralne</text>
  <text x="20" y="48" fill="#a1a1aa" font-family="sans-serif" font-size="13">Sprawdzenie likwidacji, wskaźnika long/short i mapy cieplnej likwidacji na 16 lipca</text>
  <text x="20" y="76" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Podział Likwidacji (Ostatnie 24h, CoinGlass)</text>
  <rect x="20" y="86" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="86" width="560" height="32" rx="6" fill="#f87171"/>
  <text x="300" y="107" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="14" font-weight="800">Short 84,8% · 31,66 mln $</text>
  <rect x="20" y="128" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="128" width="100" height="32" rx="6" fill="#34d399"/>
  <text x="70" y="149" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="13" font-weight="800">15,2%</text>
  <text x="135" y="149" fill="#a1a1aa" font-family="sans-serif" font-size="13">Long 5,66 mln $</text>
  <text x="20" y="176" fill="#71717a" font-family="sans-serif" font-size="12">* Odwrotnie 6 lipca: długie pozycje stanowiły 47,91 mln $ (78%) z 61,57 mln $ likwidacji tego dnia</text>
  <text x="20" y="212" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Wskaźniki Pozycjonowania — Wciąż Neutralne Po Wyprzedaży</text>
  <rect x="20" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="35" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Wskaźnik Long/Short</text>
  <text x="35" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">1,10 (neutralny)</text>
  <rect x="248" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="263" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">OI (30 dni)</text>
  <text x="263" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">+3,92% · 48,9 mld $</text>
  <rect x="476" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="491" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Finansowanie</text>
  <text x="491" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">0,0043%/dzień</text>
  <text x="20" y="322" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Mapa Cieplna Likwidacji — Nowe Skupiska Powyżej i Poniżej (CoinGlass)</text>
  <rect x="20" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="35" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">Okolice 63 000 $</text>
  <text x="35" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Skupisko likwidacji długich</text>
  <text x="35" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Wybicie może przyspieszyć spadek</text>
  <rect x="252" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#fbbf24"/>
  <text x="267" y="360" fill="#fbbf24" font-family="sans-serif" font-size="14" font-weight="700">64 600-65 300 $</text>
  <text x="267" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Obecna cena (popołudnie 16/7)</text>
  <rect x="484" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="499" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">65 000-65 500 $</text>
  <text x="499" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Skupisko likwidacji krótkich</text>
  <text x="499" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Wybicie może wywołać nowy squeeze</text>
  <text x="20" y="452" fill="#71717a" font-family="sans-serif" font-size="12">* Liczby są przybliżone według dostawcy danych i mogą się różnić w zależności od źródła/czasu. To nie jest porada inwestycyjna.</text>
</svg></div>
<div class="it"><svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="28" fill="#fafafa" font-family="sans-serif" font-size="16" font-weight="700">Gli Short Hanno Rappresentato l'84,8% delle Liquidazioni — Ma il Posizionamento È Rimasto Neutrale</text>
  <text x="20" y="48" fill="#a1a1aa" font-family="sans-serif" font-size="13">Verifica di liquidazioni, rapporto long/short e heatmap delle liquidazioni al 16 luglio</text>
  <text x="20" y="76" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Ripartizione delle Liquidazioni (Ultime 24h, CoinGlass)</text>
  <rect x="20" y="86" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="86" width="560" height="32" rx="6" fill="#f87171"/>
  <text x="300" y="107" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="14" font-weight="800">Short 84,8% · 31,66 mln $</text>
  <rect x="20" y="128" width="660" height="32" rx="6" fill="#27272a"/>
  ...
  <text x="70" y="149" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="13" font-weight="800">15,2%</text>
  <text x="135" y="149" fill="#a1a1aa" font-family="sans-serif" font-size="13">Long 5,66 mln $</text>
  <text x="20" y="176" fill="#71717a" font-family="sans-serif" font-size="12">* Invertito il 6 luglio: i long rappresentavano 47,91 mln $ (78%) dei 61,57 mln $ liquidati quel giorno</text>
  <text x="20" y="212" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Indicatori di Posizionamento — Ancora Neutrali Dopo l'Ondata</text>
  <rect x="20" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="35" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Rapporto Long/Short</text>
  <text x="35" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">1,10 (neutrale)</text>
  <rect x="248" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="263" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">OI (30gg)</text>
  <text x="263" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">+3,92% · 48,9 Mld $</text>
  <rect x="476" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="491" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Funding</text>
  <text x="491" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">0,0043%/giorno</text>
  <text x="20" y="322" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Heatmap delle Liquidazioni — Nuovi Cluster Sopra e Sotto (CoinGlass)</text>
  <rect x="20" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="35" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">Area 63.000 $</text>
  <text x="35" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Cluster di liquidazione long</text>
  <text x="35" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Una rottura potrebbe accelerare il calo</text>
  <rect x="252" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#fbbf24"/>
  <text x="267" y="360" fill="#fbbf24" font-family="sans-serif" font-size="14" font-weight="700">64.600-65.300 $</text>
  <text x="267" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Prezzo attuale (pomeriggio 16/7)</text>
  <rect x="484" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="499" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">65.000-65.500 $</text>
  <text x="499" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Cluster di liquidazione short</text>
  <text x="499" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Una rottura potrebbe innescare un nuovo squeeze</text>
  <text x="20" y="452" fill="#71717a" font-family="sans-serif" font-size="12">* Le cifre sono approssimative secondo il fornitore dei dati e possono variare per fonte/momento. Non è consulenza di investimento.</text>
</svg></div>
<div class="ru"><svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="28" fill="#fafafa" font-family="sans-serif" font-size="16" font-weight="700">Шорты Составили 84,8% Ликвидаций — Но Позиционирование Осталось Нейтральным</text>
  <text x="20" y="48" fill="#a1a1aa" font-family="sans-serif" font-size="13">Проверка ликвидаций, соотношения long/short и тепловой карты ликвидаций на 16 июля</text>
  <text x="20" y="76" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Разбивка Ликвидаций (Последние 24ч, CoinGlass)</text>
  <rect x="20" y="86" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="86" width="560" height="32" rx="6" fill="#f87171"/>
  <text x="300" y="107" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="14" font-weight="800">Шорт 84,8% · $31,66М</text>
  <rect x="20" y="128" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="128" width="100" height="32" rx="6" fill="#34d399"/>
  <text x="70" y="149" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="13" font-weight="800">15,2%</text>
  <text x="135" y="149" fill="#a1a1aa" font-family="sans-serif" font-size="13">Лонг $5,66М</text>
  <text x="20" y="176" fill="#71717a" font-family="sans-serif" font-size="12">* Обратная картина 6 июля: лонги составили $47,91М (78%) из $61,57М ликвидаций в тот день</text>
  <text x="20" y="212" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Индикаторы Позиционирования — Всё Ещё Нейтральны После Волны</text>
  <rect x="20" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="35" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Соотношение Long/Short</text>
  <text x="35" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">1,10 (нейтрально)</text>
  <rect x="248" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="263" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">OI (30д)</text>
  <text x="263" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">+3,92% · $48,9Мрд</text>
  <rect x="476" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="491" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">Фандинг</text>
  <text x="491" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">0,0043%/день</text>
  <text x="20" y="322" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">Тепловая Карта Ликвидаций — Новые Кластеры Сверху и Снизу (CoinGlass)</text>
  <rect x="20" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="35" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">Область $63 000</text>
  <text x="35" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Кластер ликвидации лонгов</text>
  <text x="35" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Пробой может ускорить падение</text>
  <rect x="252" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#fbbf24"/>
  <text x="267" y="360" fill="#fbbf24" font-family="sans-serif" font-size="14" font-weight="700">$64 600-65 300</text>
  <text x="267" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Текущая цена (день, 16.07)</text>
  <rect x="484" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="499" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">$65 000-65 500</text>
  <text x="499" y="382" fill="#71717a" font-family="sans-serif" font-size="12">Кластер ликвидации шортов</text>
  <text x="499" y="402" fill="#71717a" font-family="sans-serif" font-size="12">Пробой может вызвать новый сквиз</text>
  <text x="20" y="452" fill="#71717a" font-family="sans-serif" font-size="12">* Цифры приблизительны по данным поставщика и могут отличаться в зависимости от источника/времени. Не является инвестиционной рекомендацией.</text>
</svg></div>
<div class="zh"><svg viewBox="0 0 700 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="28" fill="#fafafa" font-family="sans-serif" font-size="16" font-weight="700">空頭佔清算量的84.8%——但部位仍維持中性</text>
  <text x="20" y="48" fill="#a1a1aa" font-family="sans-serif" font-size="13">截至7月16日檢視清算數據、多空比與清算熱力圖</text>
  <text x="20" y="76" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">清算佔比(過去24小時,CoinGlass)</text>
  <rect x="20" y="86" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="86" width="560" height="32" rx="6" fill="#f87171"/>
  <text x="300" y="107" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="14" font-weight="800">空頭84.8%‧3,166萬美元</text>
  <rect x="20" y="128" width="660" height="32" rx="6" fill="#27272a"/>
  <rect x="20" y="128" width="100" height="32" rx="6" fill="#34d399"/>
  <text x="70" y="149" text-anchor="middle" fill="#111113" font-family="sans-serif" font-size="13" font-weight="800">15.2%</text>
  <text x="135" y="149" fill="#a1a1aa" font-family="sans-serif" font-size="13">多頭566萬美元</text>
  <text x="20" y="176" fill="#71717a" font-family="sans-serif" font-size="12">* 7月6日情況相反:當日6,157萬美元清算中,多頭佔4,791萬美元(78%)</text>
  <text x="20" y="212" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">部位指標——清算後仍維持中性</text>
  <rect x="20" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="35" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">多空比</text>
  <text x="35" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">1.10(中性)</text>
  <rect x="248" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="263" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">未平倉合約(30天)</text>
  <text x="263" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">+3.92%‧489.3億美元</text>
  <rect x="476" y="224" width="204" height="68" rx="8" fill="#18181b" stroke="#3f3f46"/>
  <text x="491" y="248" fill="#a1a1aa" font-family="sans-serif" font-size="13">資金費率</text>
  <text x="491" y="274" fill="#fbbf24" font-family="sans-serif" font-size="17" font-weight="800">0.0043%/天</text>
  <text x="20" y="322" fill="#d4d4d8" font-family="sans-serif" font-size="14" font-weight="700">清算熱力圖——上下皆有新密集區(CoinGlass)</text>
  <rect x="20" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="35" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">63,000美元附近</text>
  <text x="35" y="382" fill="#71717a" font-family="sans-serif" font-size="12">多頭清算密集區</text>
  <text x="35" y="402" fill="#71717a" font-family="sans-serif" font-size="12">跌破恐加速下跌</text>
  <rect x="252" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#fbbf24"/>
  <text x="267" y="360" fill="#fbbf24" font-family="sans-serif" font-size="14" font-weight="700">64,600-65,300美元</text>
  <text x="267" y="382" fill="#71717a" font-family="sans-serif" font-size="12">目前價格(7/16下午)</text>
  <rect x="484" y="334" width="196" height="86" rx="8" fill="#18181b" stroke="#ef4444"/>
  <text x="499" y="360" fill="#f87171" font-family="sans-serif" font-size="14" font-weight="700">65,000-65,500美元</text>
  <text x="499" y="382" fill="#71717a" font-family="sans-serif" font-size="12">空頭清算密集區</text>
  <text x="499" y="402" fill="#71717a" font-family="sans-serif" font-size="12">突破恐觸發再次軋空</text>
  <text x="20" y="452" fill="#71717a" font-family="sans-serif" font-size="12">*數字為各資料來源之近似值,依來源與統計時點可能有所差異。非投資建議。</text>
</svg></div>
...
<h2 class="id">Menumpuk Ketiganya — Sudah Dibersihkan, Tapi Struktur Belum Berubah</h2>
<h2 class="pl">Nakładając te trzy elementy — wyczyszczone, ale struktura się nie zmieniła</h2>
<h2 class="it">Sovrapponendo i tre elementi — ripulito, ma la struttura non è cambiata</h2>
<h2 class="ru">Накладываем три показателя — вычищено, но структура не изменилась</h2>
<h2 class="zh">三項數據疊加來看——清乾淨了,但結構未變</h2>
...
<p class="id">Data likuidasi (sesuatu yang sudah terjadi, short 84,8%), indikator posisi (rasio long/short, OI, funding — masih netral), dan heatmap likuidasi (klaster sudah terbentuk kembali) masing-masing menunjuk ke titik waktu yang berbeda. Satu menunjukkan masa lalu, satu masa kini, satu lagi masa depan yang mungkin terjadi — tapi jika digabungkan, ada satu kesimpulan: short squeeze ini membersihkan short yang ada, tapi sebenarnya tidak membuat struktur leverage pasar menjadi lebih aman.</p>
<p class="pl">Dane o likwidacjach (coś, co już się wydarzyło, 84,8% short), wskaźniki pozycjonowania (wskaźnik long/short, OI, finansowanie — wciąż neutralne) oraz mapa cieplna likwidacji (skupiska już odbudowane) wskazują na różne momenty w czasie. Jedno pokazuje przeszłość, jedno teraźniejszość, jedno potencjalną przyszłość — ale połączone dają jeden wniosek: ten short squeeze uporządkował istniejące krótkie pozycje, ale w rzeczywistości nie uczynił struktury dźwigni rynku bezpieczniejszą.</p>
<p class="it">I dati sulle liquidazioni (qualcosa già accaduto, 84,8% short), gli indicatori di posizionamento (rapporto long/short, OI, funding — ancora neutrali) e la heatmap delle liquidazioni (cluster già ricostruiti) indicano ciascuno un momento diverso nel tempo. Uno mostra il passato, uno il presente, uno un potenziale futuro — ma combinandoli emerge una sola conclusione: questo short squeeze ha ripulito gli short esistenti, ma non ha reso davvero più sicura la struttura di leva del mercato.</p>
<p class="ru">Данные о ликвидациях (то, что уже произошло, 84,8% шорт), индикаторы позиционирования (соотношение long/short, OI, фандинг — всё ещё нейтральны) и тепловая карта ликвидаций (кластеры уже восстановлены) указывают каждый на свою точку во времени. Один показывает прошлое, другой настоящее, третий — потенциальное будущее, но, объединив их, получаем один вывод: этот шорт-сквиз вычистил существующие шорты, но не сделал структуру рыночного плеча реально безопаснее.</p>
<p class="zh">清算數據(已經發生的事,空頭佔84.8%)、部位指標(多空比、未平倉合約、資金費率——仍維持中性)與清算熱力圖(密集區已重新形成)三者各自指向不同的時間點。一個呈現過去,一個呈現現在,一個呈現潛在的未來——但三者合併只得出一個結論:這次軋空清掉了既有的空頭,但並未真正讓市場的槓桿結構變得更安全。</p>
...
<p class="id">Jika pemeriksaan sebelumnya di situs ini tentang <a href="/id/blog/feargreed-funding-etf-conviction-gap">kesenjangan keyakinan pada funding, arus ETF, dan Indeks Fear & Greed</a> membahas siapa yang masih belum yakin rebound ini nyata, tulisan ini melangkah lebih jauh: bahkan jika akhirnya semua orang yakin, struktur derivatif itu sendiri tetap rapuh di kedua sisi. Likuidasi dan keyakinan adalah dua persoalan yang terpisah.</p>
<p class="pl">Jeśli wcześniejsza analiza tej witryny dotycząca <a href="/pl/blog/feargreed-funding-etf-conviction-gap">luki przekonania między finansowaniem, przepływami ETF a Indeksem Strachu i Chciwości</a> dotyczyła tego, kto wciąż nie jest przekonany, że to odbicie jest prawdziwe, ten tekst idzie o krok dalej: nawet jeśli w końcu wszyscy się przekonają, sama struktura instrumentów pochodnych pozostaje krucha po obu stronach. Likwidacja i przekonanie to odrębne kwestie.</p>
<p class="it">Se la precedente analisi di questo sito su <a href="/it/blog/feargreed-funding-etf-conviction-gap">il divario di convinzione tra funding, flussi ETF e l'Indice Paura e Avidità</a> riguardava chi non è ancora convinto che questo rimbalzo sia reale, questo articolo va un passo oltre: anche se alla fine tutti si convincono, la struttura dei derivati stessa resta fragile su entrambi i lati. Liquidazione e convinzione sono questioni separate.</p>
<p class="ru">Если предыдущий материал этого сайта о <a href="/ru/blog/feargreed-funding-etf-conviction-gap">разрыве убеждённости между фандингом, потоками ETF и Индексом страха и жадности</a> касался того, кто всё ещё не убеждён в реальности этого отскока, то этот материал идёт на шаг дальше: даже если в итоге убедятся все, сама структура деривативов остаётся хрупкой с обеих сторон. Ликвидация и убеждённость — разные вопросы.</p>
<p class="zh">若本站先前針對<a href="/zh/blog/feargreed-funding-etf-conviction-gap">資金費率、ETF資金流與恐懼貪婪指數之間信念落差</a>的檢視,探討的是誰仍不相信這波反彈是真實的,那麼本文則更進一步指出:即使最終所有人都被說服,衍生品結構本身在兩個方向上依然脆弱。清算與信念是兩個不同的問題。</p>
...
<h2 class="id">Yang Perlu Dipantau dari Sini</h2>
...
<p class="id">Pertama, apakah open interest mulai tumbuh dengan arah yang jelas. Jika OI tetap terbatas di kisaran pertumbuhan 3-4% sementara harga berkutat di kisaran $65.000-an, penilaian bahwa belum banyak leverage yang menempel pada reli ini tetap berlaku. Jika sebaliknya OI melonjak pada saat bersamaan harga menembus di atas $65.500, itu akan menunjukkan leverage long baru benar-benar telah masuk.</p>
<p class="pl">Po pierwsze, czy open interest zacznie rosnąć z wyraźnym kierunkiem. Jeśli OI pozostanie ograniczone do przedziału wzrostu 3-4%, podczas gdy cena utrzymuje się w okolicach 65 000 dolarów, odczyt mówiący, że do tego rajdu nie dołączyło zbyt wiele dźwigni, wciąż się utrzymuje. Jeśli zamiast tego OI skoczy w tym samym momencie, gdy cena wybije się powyżej 65 500 dolarów, sugerowałoby to, że faktycznie weszła świeża długa dźwignia.</p>
<p class="it">Primo, se l'open interest inizierà a crescere con una direzione chiara. Se l'OI resta limitato nella fascia di crescita del 3-4% mentre il prezzo oscilla intorno ai 65.000 dollari, la lettura secondo cui non molta leva si è unita a questo rally regge ancora. Se invece l'OI balza nello stesso momento in cui il prezzo sfonda sopra i 65.500 dollari, ciò suggerirebbe che è effettivamente entrata nuova leva long.</p>
<p class="ru">Во-первых, начнёт ли открытый интерес расти в чётко выраженном направлении. Если OI останется в диапазоне роста 3-4%, пока цена держится в районе $65 000, вывод о том, что к этому ралли не присоединилось много нового плеча, останется в силе. Если же OI резко подскочит в тот же момент, когда цена пробьёт выше $65 500, это будет говорить о том, что реально вошло свежее длинное плечо.</p>
<p class="zh">首先,未平倉合約是否開始出現明確方向性的增長。若OI持續被限制在3%至4%的增幅區間,同時價格徘徊在6.5萬美元上下,那麼「這波行情尚未吸引太多槓桿」的判斷就依然成立。反之,若OI在價格突破65,500美元的同一時刻同步跳升,則意味著確實有新的多頭槓桿進場。</p>
...
<p class="id">Kedua, mana dari dua klaster likuidasi — $65.000-$65.500 di atas, $63.000 di bawah — yang diuji lebih dulu. Apakah pita atas tembus untuk squeeze lagi, atau pita bawah tembus dan giliran long yang terlikuidasi, akan menentukan arah volatilitas dalam beberapa hari ke depan. Tulisan ini bukan saran investasi — tujuannya untuk mendiagnosis kondisi pasar derivatif saat ini, bukan memprediksi ke mana harga akan bergerak dari sini.</p>
<p class="pl">Po drugie, które z dwóch skupisk likwidacji — 65 000-65 500 dolarów powyżej, 63 000 dolarów poniżej — zostanie przetestowane jako pierwsze. To, czy górne pasmo pęknie, wywołując kolejny short squeeze, czy dolne pasmo pęknie i tym razem zlikwidowane zostaną długie pozycje, zadecyduje, w którą stronę pójdzie zmienność w ciągu najbliższych kilku dni. Ten tekst nie jest poradą inwestycyjną — ma na celu zdiagnozowanie obecnego stanu rynku instrumentów pochodnych, a nie przewidywanie, dokąd zmierza cena od teraz.</p>
<p class="it">Secondo, quale dei due cluster di liquidazione — 65.000-65.500 dollari sopra, 63.000 dollari sotto — verrà testato per primo. Che la banda superiore ceda per un altro short squeeze, o che quella inferiore ceda e stavolta vengano liquidati i long, deciderà in che direzione andrà la volatilità nei prossimi giorni. Questo articolo non è consulenza di investimento — serve a diagnosticare lo stato attuale del mercato dei derivati, non a prevedere dove andrà il prezzo da qui.</p>
<p class="ru">Во-вторых, какой из двух кластеров ликвидации — $65 000-$65 500 сверху, $63 000 снизу — будет протестирован первым. От того, пробьётся ли верхняя граница для очередного сквиза или пробьётся нижняя и на этот раз будут ликвидированы лонги, зависит, в каком направлении пойдёт волатильность в ближайшие дни. Этот материал не является инвестиционной рекомендацией — его цель диагностировать текущее состояние рынка деривативов, а не предсказывать, куда пойдёт цена дальше.</p>
<p class="zh">第二,兩個清算密集區——上方65,000至65,500美元、下方63,000美元——哪一個會先被測試。若上緣被突破觸發另一輪軋空,或下緣被跌破轉而清算多頭,將決定接下來幾天波動的方向。本文並非投資建議——其目的是診斷衍生品市場當前的狀態,而非預測價格接下來的走向。</p>
...
<p class="id" style="font-size:12px;color:#52525b;margin-top:24px">Sumber: CoinGlass (data likuidasi dan heatmap likuidasi, perbandingan 16 Juli vs 6 Juli), Coinalyze (rasio long/short, funding rate), Mudrex Learn ("Bitcoin Long-Short Ratio: What is it and How to Use It?", pembagian long/short ritel BTCUSDT Binance), CoinStats AI ("Bitcoin (BTC) Daily Market Analysis 16 July 2026", open interest dan funding rate), DailyForex ("Bitcoin Price Snubs Strategy's $216M BTC Sale as Bulls Defend $63K", klaster likuidasi), Yahoo Finance (harga spot), CNBC dan Barchart (harga futures Juli CME), CFGI.io (Indeks Fear & Greed). Angka merupakan perkiraan menurut masing-masing penyedia data dan dapat bervariasi menurut sumber dan waktu. Ini bukan saran investasi — tujuannya untuk mendiagnosis kondisi pasar saat ini, bukan memprediksi ke mana harga bergerak selanjutnya.</p>
<p class="pl" style="font-size:12px;color:#52525b;margin-top:24px">Źródła: CoinGlass (dane o likwidacjach i mapa cieplna likwidacji, porównanie 16 lipca z 6 lipca), Coinalyze (wskaźnik long/short, stopa finansowania), Mudrex Learn („Bitcoin Long-Short Ratio: What is it and How to Use It?", podział long/short detalicznych inwestorów BTCUSDT na Binance), CoinStats AI („Bitcoin (BTC) Daily Market Analysis 16 July 2026", open interest i stopa finansowania), DailyForex („Bitcoin Price Snubs Strategy's $216M BTC Sale as Bulls Defend $63K", skupiska likwidacji), Yahoo Finance (cena spot), CNBC i Barchart (cena lipcowych futures CME), CFGI.io (Indeks Strachu i Chciwości). Liczby są przybliżone według poszczególnych dostawców danych i mogą się różnić w zależności od źródła i czasu. To nie jest porada inwestycyjna — ma na celu zdiagnozowanie obecnego stanu rynku, a nie przewidywanie, dokąd dalej podąży cena.</p>
<p class="it" style="font-size:12px;color:#52525b;margin-top:24px">Fonti: CoinGlass (dati di liquidazione e heatmap delle liquidazioni, confronto 16 luglio vs 6 luglio), Coinalyze (rapporto long/short, tasso di funding), Mudrex Learn ("Bitcoin Long-Short Ratio: What is it and How to Use It?", ripartizione long/short retail di BTCUSDT su Binance), CoinStats AI ("Bitcoin (BTC) Daily Market Analysis 16 July 2026", open interest e tasso di funding), DailyForex ("Bitcoin Price Snubs Strategy's $216M BTC Sale as Bulls Defend $63K", cluster di liquidazione), Yahoo Finance (prezzo spot), CNBC e Barchart (prezzo dei future di luglio del CME), CFGI.io (Indice Paura e Avidità). Le cifre sono approssimative secondo ciascun fornitore di dati e possono variare per fonte e momento. Non è consulenza di investimento — serve a diagnosticare lo stato attuale del mercato, non a prevedere dove andrà il prezzo in seguito.</p>
<p class="ru" style="font-size:12px;color:#52525b;margin-top:24px">Источники: CoinGlass (данные о ликвидациях и тепловая карта ликвидаций, сравнение 16 июля и 6 июля), Coinalyze (соотношение long/short, ставка фандинга), Mudrex Learn («Bitcoin Long-Short Ratio: What is it and How to Use It?», розничное соотношение long/short по BTCUSDT на Binance), CoinStats AI («Bitcoin (BTC) Daily Market Analysis 16 July 2026», открытый интерес и ставка фандинга), DailyForex («Bitcoin Price Snubs Strategy's $216M BTC Sale as Bulls Defend $63K», кластеры ликвидации), Yahoo Finance (спотовая цена), CNBC и Barchart (цена июльского фьючерса CME), CFGI.io (Индекс страха и жадности). Цифры приблизительны по данным каждого поставщика и могут отличаться в зависимости от источника и времени. Это не является инвестиционной рекомендацией — цель материала — диагностировать текущее состояние рынка, а не предсказывать дальнейшее движение цены.</p>
<p class="zh" style="font-size:12px;color:#52525b;margin-top:24px">資料來源:CoinGlass(清算數據與清算熱力圖,7月16日與7月6日比較)、Coinalyze(多空比、資金費率)、Mudrex Learn(〈Bitcoin Long-Short Ratio: What is it and How to Use It?〉,幣安BTCUSDT散戶多空分布)、CoinStats AI(〈Bitcoin (BTC) Daily Market Analysis 16 July 2026〉,未平倉合約與資金費率)、DailyForex(〈Bitcoin Price Snubs Strategy's $216M BTC Sale as Bulls Defend $63K〉,清算密集區)、Yahoo Finance(現貨價格)、CNBC與Barchart(CME 7月期貨價格)、CFGI.io(恐懼與貪婪指數)。數字為各資料來源之近似值,依來源與統計時點可能有所差異。本文並非投資建議——目的是診斷市場當前狀態,而非預測價格接下來的走向。</p>
