...
<p class="id">Bitcoin diperdagangkan di kisaran $64.600-$65.300 pada sore hari 16 Juli (waktu Korea), melanjutkan reli yang didorong short squeeze yang dimulai setelah kejutan CPI Juni AS pada 14 Juli. Menurut CoinGlass, dari $37,32 juta yang dilikuidasi di seluruh pasar derivatif kripto dalam 24 jam terakhir, $31,66 juta (84,8%) berasal dari posisi short — pola short squeeze klasik di mana penutupan short paksa mendorong harga naik.</p>
<p class="pl">Bitcoin jest notowany w przedziale 64 600-65 300 USD po południu 16 lipca (czasu koreańskiego), kontynuując rajd napędzany przez short squeeze, który rozpoczął się po niespodziance inflacyjnej CPI w USA za czerwiec 14 lipca. Według CoinGlass z 37,32 mln USD zlikwidowanych na całym rynku instrumentów pochodnych kryptowalut w ciągu ostatnich 24 godzin, 31,66 mln USD (84,8%) pochodziło z pozycji krótkich — klasyczny wzorzec short squeeze, w którym wymuszone zamknięcia krótkich pozycji windują cenę w górę.</p>
<p class="it">Bitcoin viene scambiato tra $64.600 e $65.300 nel pomeriggio del 16 luglio (ora coreana), proseguendo il rally trainato dallo short squeeze iniziato dopo la sorpresa del CPI di giugno negli Stati Uniti il 14 luglio. Secondo CoinGlass, dei $37,32 milioni liquidati sull'intero mercato dei derivati crypto nelle ultime 24 ore, $31,66 milioni (84,8%) provenivano da posizioni short — uno schema classico di short squeeze in cui le chiusure forzate delle posizioni short spingono il prezzo verso l'alto.</p>
<p class="ru">Биткоин торгуется в диапазоне $64 600-65 300 во второй половине дня 16 июля (по корейскому времени), продолжая ралли, вызванное шорт-сквизом, который начался после неожиданных данных по июньскому индексу потребительских цен в США 14 июля. По данным CoinGlass, из $37,32 млн, ликвидированных на всём рынке криптодеривативов за последние 24 часа, $31,66 млн (84,8%) пришлось на короткие позиции — классическая модель шорт-сквиза, при которой принудительное закрытие шортов толкает цену вверх.</p>
<p class="zh">截至7月16日下午(韓國時間),比特幣在6.46萬至6.53萬美元區間交易,延續了7月14日美國6月CPI意外數據公布後由軋空推動的漲勢。根據CoinGlass數據,過去24小時加密貨幣衍生品市場共有3,732萬美元遭到清算,其中3,166萬美元(84.8%)來自空頭部位——這是典型的軋空模式,強制平倉的空頭轉為買盤,推動價格走高。</p>
...
<p class="id">Namun, apakah likuidasi ini berakhir sebagai pembersihan sederhana atau benar-benar mengubah struktur pasar adalah pertanyaan lain. Rasio long/short dan open interest tetap kurang lebih netral bahkan setelah pembersihan ini, dan peta panas likuidasi CoinGlass sudah menunjukkan klaster baru yang terbentuk kembali baik di atas maupun di bawah harga saat ini. Sekarang setelah short tersapu bersih, tulisan ini memeriksa — melalui data likuidasi, indikator posisi, dan peta likuidasi — apakah pasar derivatif benar-benar menjadi lebih ringan.</p>
<p class="pl">Jednak to, czy ta likwidacja zakończyła się jedynie prostym porządkowaniem, czy rzeczywiście zmieniła strukturę rynku, to inna sprawa. Wskaźnik long/short i otwarte pozycje pozostały w przybliżeniu neutralne nawet po tej czystce, a mapa cieplna likwidacji CoinGlass już pokazuje nowe skupiska odbudowujące się zarówno powyżej, jak i poniżej obecnej ceny. Teraz, gdy krótkie pozycje zostały wyczyszczone, ten tekst sprawdza — poprzez dane o likwidacjach, wskaźniki pozycjonowania i mapę likwidacji — czy rynek instrumentów pochodnych rzeczywiście stał się lżejszy.</p>
<p class="it">Ma se questa liquidazione si sia conclusa come una semplice pulizia o abbia effettivamente cambiato la struttura del mercato è un'altra questione. Il rapporto long/short e l'open interest sono rimasti pressoché neutrali anche dopo il flush, e la heatmap delle liquidazioni di CoinGlass mostra già nuovi cluster che si ricostruiscono sia sopra che sotto il prezzo attuale. Ora che gli short sono stati eliminati, questo articolo verifica — attraverso i dati di liquidazione, gli indicatori di posizionamento e la mappa di liquidazione — se il mercato dei derivati sia davvero diventato più leggero.</p>
<p class="ru">Но завершилась ли эта ликвидация простой чисткой или действительно изменила структуру рынка — вопрос другой. Соотношение long/short и открытый интерес остались примерно нейтральными даже после этой волны ликвидаций, а тепловая карта ликвидаций CoinGlass уже показывает новые кластеры, формирующиеся как выше, так и ниже текущей цены. Теперь, когда шорты были вычищены, в этом материале проверяется — через данные о ликвидациях, индикаторы позиционирования и карту ликвидаций — действительно ли рынок деривативов стал легче.</p>
<p class="zh">然而,這次清算究竟只是單純的整理,還是真正改變了市場結構,則是另一回事。多空比與未平倉合約在這波清算後仍大致維持中性,而CoinGlass的清算熱力圖已顯示新的密集區正在目前價格上下重新堆積。既然空頭已被清空,本文透過清算數據、部位指標與清算地圖三方面檢視,衍生品市場是否真的變輕鬆了。</p>
...
<h2 class="id">Data Likuidasi Dulu — Short Menyumbang 84,8%</h2>
<h2 class="pl">Najpierw Dane o Likwidacjach — Krótkie Pozycje Stanowiły 84,8%</h2>
<h2 class="it">Prima i Dati sulle Liquidazioni — Gli Short Hanno Rappresentato l'84,8%</h2>
<h2 class="ru">Сначала Данные о Ликвидациях — На Шорты Пришлось 84,8%</h2>
<h2 class="zh">先看清算數據——空頭占了84.8%</h2>
