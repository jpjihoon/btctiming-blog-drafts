...
<p class="fr">Se marie bien avec le <a href="/blog/funding-rate-futures-gap.html">funding rate</a> — un OI important combiné à un funding extrême confirme doublement que l'effet de levier est fortement penché dans une direction.</p>
<p class="pt">Combina bem com a <a href="/blog/funding-rate-futures-gap.html">taxa de financiamento</a> — um OI grande somado a um funding extremo confirma duplamente que a alavancagem está fortemente inclinada em uma direção.</p>
<p class="tr"><a href="/blog/funding-rate-futures-gap.html">Fonlama oranı</a> ile iyi eşleşir — büyük bir OI ile aşırı fonlamanın birleşimi, kaldıracın tek bir yöne ağır bastığını çifte doğrular.</p>
<p class="vi">Kết hợp tốt với <a href="/blog/funding-rate-futures-gap.html">funding rate</a> — OI lớn cộng với funding cực đoan xác nhận kép rằng đòn bẩy đang nghiêng mạnh về một hướng.</p>
