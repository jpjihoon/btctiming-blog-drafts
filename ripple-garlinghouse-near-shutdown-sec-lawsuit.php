...
<p class="ko" style="font-size:12px;color:#52525b;margin-top:24px">관련 배경은 <a href="/blog/sec-digital-commodity-interpretive-release">SEC "대부분 크립토는 증권 아니다" 공식 해석 발표</a> 기사에서도 다뤘다. 출처: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive, SEC.gov 소송 기록.</p>
<p class="en" style="font-size:12px;color:#52525b;margin-top:24px">Related background: <a href="/en/blog/sec-digital-commodity-interpretive-release">SEC's "Most Crypto Isn't a Security" Interpretive Release</a>. Sources: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive, and SEC.gov litigation records.</p>
<p class="ja" style="font-size:12px;color:#52525b;margin-top:24px">関連背景は<a href="/ja/blog/sec-digital-commodity-interpretive-release">SEC「暗号資産の大半は証券でない」公式解釈発表</a>でも取り上げた。出典: CoinDesk、Coinpedia、CoinGape、CNBC、Banking Dive、SEC.gov訴訟記録。</p>
<p class="es" style="font-size:12px;color:#52525b;margin-top:24px">Contexto relacionado: <a href="/es/blog/sec-digital-commodity-interpretive-release">La SEC declara que "la mayoría de las criptomonedas no son valores"</a>. Fuentes: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive y los registros judiciales de SEC.gov.</p>
<p class="de" style="font-size:12px;color:#52525b;margin-top:24px">Verwandter Hintergrund: <a href="/de/blog/sec-digital-commodity-interpretive-release">SECs Auslegung „Die meisten Kryptowerte sind keine Wertpapiere"</a>. Quellen: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive und Gerichtsunterlagen von SEC.gov.</p>
<p class="fr" style="font-size:12px;color:#52525b;margin-top:24px">Contexte connexe : <a href="/fr/blog/sec-digital-commodity-interpretive-release">La SEC déclare que « la plupart des cryptos ne sont pas des titres »</a>. Sources : CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive et les dossiers judiciaires de SEC.gov.</p>
<p class="pt" style="font-size:12px;color:#52525b;margin-top:24px">Contexto relacionado: <a href="/pt/blog/sec-digital-commodity-interpretive-release">SEC declara que "a maioria das criptomoedas não é valor mobiliário"</a>. Fontes: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive e registros judiciais da SEC.gov.</p>
<p class="tr" style="font-size:12px;color:#52525b;margin-top:24px">İlgili arka plan: <a href="/tr/blog/sec-digital-commodity-interpretive-release">SEC'in "Kriptoların Çoğu Menkul Kıymet Değildir" Yorum Genelgesi</a>. Kaynaklar: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive ve SEC.gov dava kayıtları.</p>
<p class="vi" style="font-size:12px;color:#52525b;margin-top:24px">Bối cảnh liên quan: <a href="/vi/blog/sec-digital-commodity-interpretive-release">Thông báo diễn giải "Phần lớn tiền mã hóa không phải chứng khoán" của SEC</a>. Nguồn: CoinDesk, Coinpedia, CoinGape, CNBC, Banking Dive và hồ sơ tố tụng trên SEC.gov.</p>
