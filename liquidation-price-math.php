...
<p class="ko">"레버리지는 위험하다"는 말, 너무 많이 들어서 이제 아무 감흥이 없죠. 근데 진짜 숫자로 한번 계산해보면 얘기가 좀 달라져요.</p>
  ...
  <p class="fr">« Le levier est risqué » est une phrase qu'on a tous entendue tant de fois qu'elle a perdu son impact. Mais faire le calcul avec les vrais chiffres change la donne.</p>
  <p class="pt">"Alavancagem é arriscada" é uma frase que todos já ouvimos tantas vezes que perdeu o impacto. Mas fazer as contas com os números reais é diferente.</p>
  <p class="tr">"Kaldıraç risklidir" sözünü hepimiz o kadar çok duyduk ki artık hiçbir etkisi kalmadı. Ama gerçek sayılarla hesap yapınca durum farklı hissettiriyor.</p>
  <p class="vi">"Đòn bẩy rất rủi ro" là câu nói mà ai cũng đã nghe quá nhiều lần đến mức không còn cảm giác gì nữa. Nhưng khi tính toán bằng những con số thực tế, mọi chuyện lại khác hẳn.</p>
  ...
  <h2 class="fr">Un levier x10 signifie qu'une baisse de 10% vous liquide</h2>
  <h2 class="pt">Alavancagem de 10x significa que uma queda de 10% liquida você</h2>
  <h2 class="tr">10x kaldıraçta, sadece %10'luk düşüş sizi tasfiye eder</h2>
  <h2 class="vi">Đòn bẩy 10x nghĩa là chỉ cần giảm 10% là bị thanh lý</h2>
  ...
  <p class="fr">Imaginez que vous ouvrez un long x10. Si le Bitcoin chute de seulement <strong>10% par rapport à votre entrée, vous êtes liquidé</strong>. Le Bitcoin bouge couramment de 5 à 8% en une seule journée. Ce qui signifie que les chances d'atteindre cette ligne de liquidation en un jour ou deux ne sont absolument pas négligeables.</p>
  <p class="pt">Digamos que você abra uma posição comprada com alavancagem de 10x. Se o Bitcoin cair apenas <strong>10% em relação à sua entrada, você é liquidado</strong>. O Bitcoin costuma se mover de 5 a 8% em um único dia. O que significa que as chances de atingir essa linha de liquidação em um ou dois dias não são nada desprezíveis.</p>
  <p class="tr">Diyelim ki 10x kaldıraçla long pozisyon açtınız. Bitcoin giriş fiyatınızdan sadece <strong>%10 düşerse tasfiye edilirsiniz</strong>. Bitcoin, tek bir günde %5-8 hareket etmesi sık görülen bir varlıktır. Bu da bir iki gün içinde tasfiye seviyesine ulaşma olasılığının hiç de düşük olmadığı anlamına gelir.</p>
  <p class="vi">Giả sử bạn mở một lệnh long với đòn bẩy 10x. Nếu Bitcoin giảm chỉ <strong>10% so với giá vào lệnh, bạn sẽ bị thanh lý</strong>. Bitcoin thường xuyên biến động 5-8% chỉ trong một ngày. Điều đó có nghĩa là khả năng chạm mức thanh lý trong vòng một hai ngày là hoàn toàn không hề nhỏ.</p>
  ...
  <table class="zt fr">
    <tr><th>Levier</th><th>Baisse jusqu'à la liquidation</th><th>Probabilité réelle</th></tr>
    <tr><td class="g">2x</td><td class="g">~50%</td><td class="g">Nécessite un krach de niveau bas de cycle</td></tr>
    <tr><td class="y">5x</td><td class="y">~20%</td><td class="y">Pas rare en l'espace d'un mois</td></tr>
    <tr><td class="r">10x</td><td class="r">~10%</td><td class="r">Peut se produire en quelques jours</td></tr>
    <tr><td class="r">20x</td><td class="r">~5%</td><td class="r">La volatilité d'une seule journée peut suffire</td></tr>
  </table>
  <table class="zt pt">
    <tr><th>Alavancagem</th><th>Queda até a Liquidação</th><th>Probabilidade Real</th></tr>
    <tr><td class="g">2x</td><td class="g">~50%</td><td class="g">Exige uma queda em nível de fundo de ciclo</td></tr>
    <tr><td class="y">5x</td><td class="y">~20%</td><td class="y">Não é incomum dentro de um mês</td></tr>
    <tr><td class="r">10x</td><td class="r">~10%</td><td class="r">Pode acontecer em poucos dias</td></tr>
    <tr><td class="r">20x</td><td class="r">~5%</td><td class="r">A volatilidade de um único dia pode ser suficiente</td></tr>
  </table>
  <table class="zt tr">
    <tr><th>Kaldıraç</th><th>Tasfiyeye Kadar Düşüş</th><th>Gerçek Olasılık</th></tr>
    <tr><td class="g">2x</td><td class="g">~%50</td><td class="g">Döngü dibi seviyesinde bir çöküş gerekir</td></tr>
    <tr><td class="y">5x</td><td class="y">~%20</td><td class="y">Bir ay içinde bile sık görülür</td></tr>
    <tr><td class="r">10x</td><td class="r">~%10</td><td class="r">Birkaç gün içinde bile gerçekleşebilir</td></tr>
    <tr><td class="r">20x</td><td class="r">~%5</td><td class="r">Tek bir günün oynaklığı bile yeterli olabilir</td></tr>
  </table>
  <table class="zt vi">
    <tr><th>Đòn bẩy</th><th>Mức Giảm Đến Khi Thanh Lý</th><th>Xác Suất Thực Tế</th></tr>
    <tr><td class="g">2x</td><td class="g">~50%</td><td class="g">Cần một cú sập ở mức đáy chu kỳ</td></tr>
    <tr><td class="y">5x</td><td class="y">~20%</td><td class="y">Không hiếm khi xảy ra trong vòng một tháng</td></tr>
    <tr><td class="r">10x</td><td class="r">~10%</td><td class="r">Có thể xảy ra trong vài ngày</td></tr>
    <tr><td class="r">20x</td><td class="r">~5%</td><td class="r">Chỉ biến động trong một ngày cũng đủ để đạt tới</td></tr>
  </table>
  ...
  <h2 class="fr">Alors pourquoi tout le monde continue à l'utiliser ?</h2>
  <h2 class="pt">Então por que todo mundo ainda usa alavancagem?</h2>
  <h2 class="tr">Peki o zaman neden herkes hâlâ kullanıyor?</h2>
  <h2 class="vi">Vậy tại sao mọi người vẫn dùng đòn bẩy?</h2>
  ...
  <p class="fr">Simple — si vous avez la bonne direction, les gains évoluent de la même manière. Un levier x10 sur un mouvement de 10% signifie 100% de profit. Le problème, c'est que la psychologie humaine surestime systématiquement le « je suis plutôt sûr cette fois ». Regardez la plupart des histoires de liquidation et vous constaterez que la direction était en réalité correcte — seul le timing était décalé de quelques jours, la personne a été liquidée en plein mouvement, et le prix est ensuite allé exactement là où elle l'attendait.</p>
  <p class="pt">Simples — acerte a direção e os ganhos crescem na mesma proporção. Uma alavancagem de 10x em um movimento de 10% significa 100% de lucro. O problema é que a psicologia humana sempre superestima o "desta vez tenho certeza". Observe a maioria das histórias de liquidação e você verá que a direção estava, na verdade, correta — o timing é que ficou alguns dias errado, a pessoa foi liquidada no meio do movimento, e o preço depois foi exatamente para onde ela esperava.</p>
  <p class="tr">Basit — yönü doğru bilirseniz kazanç da aynı oranda büyür. %10'luk bir harekette 10x kaldıraç, %100 kâr demektir. Sorun şu ki insan psikolojisi her zaman "bu sefer eminim" hissini fazla değerli görür. Çoğu tasfiye hikâyesine bakarsanız, yönün aslında doğru olduğunu görürsünüz — sadece zamanlama birkaç gün kaymış, kişi hareketin ortasında tasfiye edilmiş ve fiyat sonrasında tam olarak beklediği yöne gitmiştir.</p>
  <p class="vi">Đơn giản thôi — nếu đoán đúng hướng thì lợi nhuận cũng tăng theo tỷ lệ tương ứng. Đòn bẩy 10x trên một biến động 10% nghĩa là lợi nhuận 100%. Vấn đề là tâm lý con người luôn đánh giá quá cao cảm giác "lần này chắc mình đúng". Nhìn vào phần lớn các câu chuyện bị thanh lý, bạn sẽ thấy hướng dự đoán thực ra là đúng — chỉ là thời điểm bị lệch vài ngày, họ bị thanh lý ngay giữa chừng biến động, rồi sau đó giá lại đi đúng theo hướng họ đã kỳ vọng.</p>
  ...
  <div class="box fr">💡 <strong>Une chose à retenir de cet article :</strong> Avoir la bonne direction est plus facile que de survivre assez longtemps sans être liquidé. Si vous utilisez le levier, calculez au minimum votre prix de liquidation et vérifiez s'il se situe dans la fourchette de prix typique du dernier mois.</div>
  <div class="box pt">💡 <strong>Uma coisa para lembrar deste artigo:</strong> Acertar a direção é mais fácil do que sobreviver tempo suficiente sem ser liquidado. Se você usa alavancagem, no mínimo calcule seu preço de liquidação e verifique se ele está dentro da faixa de preço típica do último mês.</div>
  <div class="box tr">💡 <strong>Bu yazıdan akılda kalması gereken tek şey:</strong> Yönü doğru bilmek, tasfiye edilmeden yeterince uzun süre dayanmaktan daha kolaydır. Kaldıraç kullanıyorsanız en azından tasfiye fiyatınızı kendiniz hesaplayın ve bunun son bir aylık tipik fiyat aralığının içinde olup olmadığını kontrol edin.</div>
  <div class="box vi">💡 <strong>Một điều cần nhớ từ bài viết này:</strong> Đoán đúng hướng còn dễ hơn là sống sót đủ lâu mà không bị thanh lý. Nếu bạn dùng đòn bẩy, ít nhất hãy tự tính giá thanh lý của mình và kiểm tra xem nó có nằm trong biên độ giá điển hình của tháng gần nhất hay không.</div>
  ...
  <h2 class="fr">Indicateurs à surveiller</h2>
  <h2 class="pt">Indicadores que vale a pena verificar</h2>
  <h2 class="tr">Kontrol edilmesi gereken göstergeler</h2>
  <h2 class="vi">Các chỉ báo đáng theo dõi</h2>
  ...
  <p class="fr">Consulter <a href="/blog/funding-rate-futures-gap.html">le taux de financement et l'écart futures-spot</a> vous donne une idée approximative du niveau de levier de l'ensemble du marché actuellement. Un financement extrêmement élevé signifie que vous n'êtes pas le seul à utiliser du levier — l'ensemble du marché est penché d'un côté, et cette configuration a tendance à se terminer par des cascades de liquidation.</p>
  <p class="pt">Verificar <a href="/blog/funding-rate-futures-gap.html">a taxa de financiamento e o gap entre futuros e à vista</a> dá uma ideia aproximada de quão alavancado está o mercado como um todo no momento. Um financiamento extremamente alto significa que não é só você usando alavancagem — o mercado inteiro está inclinado para um lado, e essa configuração costuma terminar em cascatas de liquidação.</p>
  <p class="tr"><a href="/blog/funding-rate-futures-gap.html">Fonlama oranı ve vadeli işlem-spot farkına</a> bakmak, şu anda piyasanın genelinin ne kadar kaldıraçlı olduğu konusunda size kabaca bir fikir verir. Aşırı yüksek fonlama oranı, sadece sizin değil tüm piyasanın kaldıraç kullandığı ve bir yöne yaslandığı anlamına gelir — bu tür bir kurulum genellikle zincirleme tasfiyelerle sonuçlanır.</p>
  <p class="vi">Theo dõi <a href="/blog/funding-rate-futures-gap.html">tỷ lệ funding và khoảng cách giữa hợp đồng tương lai và giá giao ngay</a> sẽ cho bạn cảm nhận sơ bộ về mức độ đòn bẩy của toàn bộ thị trường hiện tại. Funding cực kỳ cao có nghĩa là không chỉ riêng bạn đang dùng đòn bẩy — cả thị trường đang nghiêng về một phía, và tình huống này thường dẫn đến các đợt thanh lý dây chuyền.</p>
