<?php $slug = 'puell-multiple'; require __DIR__.'/_header.php'; ?>

  <p class="ko">채굴자는 비트코인 생태계에서 가장 먼저 매도 압박을 받는 참여자입니다. 이들의 수익성을 추적하면 시장의 구조적 저점과 고점을 미리 읽을 수 있는데, 이걸 정량화한 지표가 바로 <strong>Puell Multiple</strong>입니다.</p>
  <p class="en">Miners are usually the first participants in the Bitcoin ecosystem to face selling pressure. Tracking their profitability can reveal structural market bottoms and tops early — and that's exactly what the <strong>Puell Multiple</strong> quantifies.</p>
  <p class="ja">マイナーはビットコインエコシステムの中で最初に売り圧力を受ける参加者です。彼らの収益性を追跡すれば、市場の構造的な底値と天井を早期に読み取れます。これを定量化した指標が<strong>Puell Multiple</strong>です。</p>
  ...
  <p class="fr">Les mineurs sont généralement les premiers participants de l'écosystème Bitcoin à subir une pression de vente. Suivre leur rentabilité permet de repérer précocement les creux et sommets structurels du marché — c'est exactement ce que quantifie le <strong>Puell Multiple</strong>.</p>
  <p class="pt">Os mineradores costumam ser os primeiros participantes do ecossistema Bitcoin a enfrentar pressão de venda. Acompanhar sua rentabilidade pode revelar fundos e topos estruturais do mercado com antecedência — e é exatamente isso que o <strong>Puell Multiple</strong> quantifica.</p>
  <p class="tr">Madenciler genellikle Bitcoin ekosisteminde satış baskısıyla karşılaşan ilk katılımcılardır. Karlılıklarını takip etmek, piyasanın yapısal dip ve tepe noktalarını erkenden ortaya çıkarabilir — ve <strong>Puell Multiple</strong>'ın ölçtüğü tam olarak budur.</p>
  <p class="vi">Thợ đào thường là những người tham gia đầu tiên trong hệ sinh thái Bitcoin phải chịu áp lực bán. Theo dõi khả năng sinh lời của họ có thể tiết lộ sớm các đáy và đỉnh mang tính cấu trúc của thị trường — và đó chính xác là những gì <strong>Puell Multiple</strong> đo lường.</p>
  ...
  <div class="box fr">💡 <strong>Point clé :</strong> Puell Multiple = Revenus quotidiens d'émission minière (USD) ÷ moyenne sur 365 jours. En dessous de 0,5, cela signale une rentabilité minière au plus bas (zone de creux) ; au-dessus de 4, cela signale des profits exceptionnels pour les mineurs (zone de sommet).</div>
  <div class="box pt">💡 <strong>Resumo:</strong> Puell Multiple = Receita diária de emissão de mineração (USD) ÷ média de 365 dias. Abaixo de 0,5 sinaliza rentabilidade mínima dos mineradores (zona de fundo); acima de 4 sinaliza lucros extraordinários dos mineradores (zona de topo).</div>
  <div class="box tr">💡 <strong>Özet:</strong> Puell Multiple = Günlük madencilik ihraç geliri (USD) ÷ 365 günlük ortalama. 0,5'in altı, madenci karlılığının dip noktasını (dip bölgesi) işaret eder; 4'ün üstü, madencilerin beklenmedik aşırı kârını (tepe bölgesi) işaret eder.</div>
  <div class="box vi">💡 <strong>Tóm tắt:</strong> Puell Multiple = Doanh thu phát hành khai thác hàng ngày (USD) ÷ trung bình 365 ngày. Dưới 0,5 báo hiệu khả năng sinh lời của thợ đào chạm đáy (vùng đáy); trên 4 báo hiệu thợ đào thu lợi nhuận bất thường (vùng đỉnh).</div>
  ...
  <h2 class="tr">Madenci Karlılığı Neden Önemli?</h2>
  ...
  <p class="fr">Les mineurs doivent couvrir des coûts fixes — électricité, amortissement des équipements — de sorte que lorsque la rentabilité baisse, ils vendent leurs bitcoins détenus pour financer leurs opérations. Cela ajoute une pression de vente, mais le point où cette vente s'épuise coïncide souvent avec un creux. À l'inverse, les périodes de forte hausse des revenus des mineurs coïncident généralement avec des flambées de prix et sont interprétées comme des signaux de surchauffe.</p>
  <p class="pt">Os mineradores precisam cobrir custos fixos — eletricidade, depreciação de equipamentos — então, quando a rentabilidade cai, eles vendem Bitcoin em posse para financiar as operações. Isso aumenta a pressão de venda, mas o ponto em que essa venda se esgota costuma coincidir com um fundo. Por outro lado, os períodos de forte alta na receita dos mineradores tendem a coincidir com picos de preço e são interpretados como sinais de sobreaquecimento.</p>
  <p class="tr">Madenciler elektrik, ekipman amortismanı gibi sabit maliyetleri karşılamak zorundadır; bu nedenle karlılık düştüğünde, faaliyetlerini finanse etmek için ellerindeki Bitcoin'i satarlar. Bu durum satış baskısını artırır, ancak bu satışın tükendiği nokta genellikle bir dip noktasıyla örtüşür. Bunun tersine, madenci gelirlerinin hızla arttığı dönemler genellikle fiyat sıçramalarıyla örtüşür ve aşırı ısınma sinyali olarak yorumlanır.</p>
  <p class="vi">Thợ đào phải trang trải chi phí cố định — tiền điện, khấu hao thiết bị — nên khi khả năng sinh lời giảm, họ bán Bitcoin đang nắm giữ để tài trợ cho hoạt động. Điều này làm tăng áp lực bán, nhưng thời điểm đợt bán này cạn kiệt thường trùng với đáy thị trường. Ngược lại, các giai đoạn doanh thu thợ đào tăng vọt thường trùng với các đợt tăng giá và được xem là tín hiệu quá nhiệt.</p>
  ...
  <div class="rc">
    ...
    <div class="rt en">All three cycle bottoms saw Puell Multiple fall below 0.5, confirming miner capitulation.</div>
    ...
    <div class="rt fr">Lors des trois creux de cycle, le Puell Multiple est tombé sous 0,5, confirmant la capitulation des mineurs.</div>
    ...
    <div class="rt tr">Üç döngü dibinde de Puell Multiple 0,5'in altına düştü ve madenci teslimiyetini doğruladı.</div>
  ...
  <div class="rc">
    ...
    <div class="rt ko">두 번의 사이클 고점 부근에서 Puell Multiple이 4 이상까지 상승, 채굴자 초과이익 구간.</div>
    <div class="rt en">Near both cycle tops, Puell Multiple rose above 4, marking a miner windfall zone.</div>
    ...
    <div class="rt pt">Perto dos dois topos de ciclo, o Puell Multiple subiu acima de 4, marcando uma zona de lucros extraordinários dos mineradores.</div>
    <div class="rt tr">Her iki döngü zirvesine yakın dönemde Puell Multiple 4'ün üzerine çıkarak madenci beklenmedik kâr bölgesini işaret etti.</div>
    <div class="rt vi">Gần cả hai đỉnh chu kỳ, Puell Multiple tăng lên trên 4, đánh dấu vùng lợi nhuận bất thường của thợ đào.</div>
    ...
    <div class="rr tr">→ Ardından sırasıyla -%84 ve -%77'lik düzeltmeler geldi</div>
  ...
  <ul class="en">
    <li><strong>Can be distorted right after a halving.</strong> Since issuance is cut in half, Puell Multiple can read artificially low temporarily.</li>
    <li><strong>Affected by hashrate/difficulty changes.</strong> Intensifying mining competition can structurally shift baseline profitability.</li>
  </ul>
  <ul class="ja">
    <li><strong>半減期直後は歪む可能性。</strong> 発行量が半分に減るため、Puell Multipleが一時的に低く出ることがあります。</li>
    <li><strong>ハッシュレート・難易度変化の影響。</strong> マイニング競争の激化により、採算性自体が構造的に変化することがあります。</li>
  </ul>
  <ul class="es">
    <li><strong>Puede distorsionarse justo después de un halving.</strong> Como la emisión se reduce a la mitad, el Puell Multiple puede leerse artificialmente bajo temporalmente.</li>
    <li><strong>Afectado por cambios en hashrate/dificultad.</strong> La intensificación de la competencia minera puede desplazar estructuralmente la rentabilidad base.</li>
  </ul>
  <ul class="de">
  ...
  <ul class="fr">
    <li><strong>Peut être faussé juste après un halving.</strong> Comme l'émission est réduite de moitié, le Puell Multiple peut afficher temporairement une valeur artificiellement basse.</li>
    <li><strong>Sensible aux variations de hashrate/difficulté.</strong> L'intensification de la concurrence minière peut modifier structurellement la rentabilité de référence.</li>
  </ul>
  <ul class="pt">
    ...
    <li><strong>Afetado por mudanças no hashrate/dificuldade.</strong> A intensificação da concorrência entre mineradores pode alterar estruturalmente a rentabilidade de base.</li>
  </ul>
  <ul class="tr">
    <li><strong>Halving sonrasında hemen çarpıtılabilir.</strong> İhraç miktarı yarıya indiği için Puell Multiple geçici olarak yapay şekilde düşük görünebilir.</li>
    <li><strong>Hashrate/zorluk değişimlerinden etkilenir.</strong> Yoğunlaşan madencilik rekabeti, temel karlılığı yapısal olarak değiştirebilir.</li>
  </ul>
  <ul class="vi">
    ...
    <li><strong>Bị ảnh hưởng bởi thay đổi hashrate/độ khó.</strong> Sự cạnh tranh khai thác ngày càng gay gắt có thể làm thay đổi cấu trúc khả năng sinh lời cơ bản.</li>
  </ul>
  ...
  <ul class="tr">
    <li><strong><a href="/blog/hash-ribbon-indicator.html">Hash Ribbon</a>:</strong> Madenci teslimiyetinin sona erdiği noktayla çapraz kontrol</li>
    <li><strong><a href="/blog/mvrv-z-score.html">MVRV Z-Score</a>:</strong> Değerlemeyi hem madenci hem de yatırımcı perspektifinden karşılaştırma</li>
  </ul>
  <ul class="vi">
    ...
    <li><strong><a href="/blog/mvrv-z-score.html">MVRV Z-Score</a>:</strong> So sánh định giá theo cả góc nhìn của thợ đào và nhà đầu tư</li>
  </ul>
