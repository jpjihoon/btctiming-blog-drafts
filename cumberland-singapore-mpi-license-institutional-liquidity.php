<?php $slug = 'cumberland-singapore-mpi-license-institutional-liquidity'; require __DIR__.'/_header.php'; ?>

<p class="ko">시카고 소재 트레이딩 회사 DRW의 암호화폐 자회사 커버랜드(Cumberland)가 싱가포르 통화청(MAS)으로부터 주요결제기관(Major Payment Institution, MPI) 라이선스를 취득했다고 크립토뉴스(crypto.news)가 7월 14일 보도했다. 싱가포르 법인 커버랜드SG(Cumberland SG Pte. Ltd.)는 이번 라이선스로 결제서비스법(Payment Services Act)에 따른 디지털결제토큰(DPT) 서비스와 국경간 송금 서비스를 제공할 수 있게 됐다. 이는 지난 3월 MAS가 원칙승인(in-principle approval)을 내준 지 약 4개월 만에 완료된 절차다.</p>
<p class="en">Cumberland, the crypto trading arm of Chicago-based DRW, has received a Major Payment Institution (MPI) licence from Singapore's Monetary Authority (MAS), crypto.news reported on July 14. The licence, granted to its local entity Cumberland SG Pte. Ltd., authorizes Digital Payment Token (DPT) services and cross-border money transfer services under the Payment Services Act. The approval completes a process that began in March, when MAS granted Cumberland SG in-principle approval — a roughly four-month gap between the two milestones.</p>
<p class="ja">シカゴ拠点のトレーディング会社DRWの暗号資産子会社カンバーランド(Cumberland)が、シンガポール通貨庁(MAS)から主要決済機関(Major Payment Institution、MPI)ライセンスを取得したとクリプトニュース(crypto.news)が7月14日に報じた。現地法人カンバーランドSG(Cumberland SG Pte. Ltd.)は今回のライセンスにより、決済サービス法(Payment Services Act)に基づくデジタル決済トークン(DPT)サービスと国境を越えた送金サービスを提供できるようになった。これは3月にMASが原則承認(in-principle approval)を出してから約4カ月で完了した手続きだ。</p>
<p class="es">Cumberland, el brazo de trading cripto de la firma de Chicago DRW, ha recibido una licencia de Institución de Pagos Principal (Major Payment Institution, MPI) de la Autoridad Monetaria de Singapur (MAS), informó crypto.news el 14 de julio. La licencia, otorgada a su entidad local Cumberland SG Pte. Ltd., autoriza servicios de Token de Pago Digital (DPT) y transferencias de dinero transfronterizas bajo la Ley de Servicios de Pago. La aprobación completa un proceso que comenzó en marzo, cuando MAS concedió a Cumberland SG la aprobación en principio, un intervalo de aproximadamente cuatro meses entre ambos hitos.</p>
<p class="de">Cumberland, der Krypto-Handelsarm der in Chicago ansässigen Firma DRW, hat von der Währungsbehörde Singapurs (MAS) eine Lizenz als Major Payment Institution (MPI) erhalten, berichtete crypto.news am 14. Juli. Die Lizenz, die der lokalen Einheit Cumberland SG Pte. Ltd. erteilt wurde, erlaubt Dienstleistungen für Digital Payment Tokens (DPT) sowie grenzüberschreitende Geldtransfers nach dem Payment Services Act. Die Genehmigung schließt einen Prozess ab, der im März begann, als die MAS Cumberland SG eine grundsätzliche Genehmigung (in-principle approval) erteilte — eine Lücke von rund vier Monaten zwischen den beiden Etappen.</p>
<p class="fr">Cumberland, la branche de trading crypto de la société de Chicago DRW, a obtenu une licence d'Institution de Paiement Majeure (Major Payment Institution, MPI) auprès de l'Autorité monétaire de Singapour (MAS), a rapporté crypto.news le 14 juillet. Cette licence, accordée à son entité locale Cumberland SG Pte. Ltd., autorise les services de jetons de paiement numérique (DPT) et les transferts d'argent transfrontaliers en vertu du Payment Services Act. L'approbation achève un processus entamé en mars, lorsque la MAS avait accordé à Cumberland SG une approbation de principe — un écart d'environ quatre mois entre les deux étapes.</p>
...
<h2 class="ja">MPIとは何か、なぜ4カ月かかったのか — 決済サービス法の二段階の壁</h2>
<h2 class="es">Qué es una licencia MPI y por qué tardó cuatro meses — el doble umbral de la Ley de Servicios de Pago</h2>
<h2 class="de">Was eine MPI-Lizenz ist und warum es vier Monate dauerte — die zweistufige Schwelle des Payment Services Act</h2>
<h2 class="fr">Qu'est-ce qu'une licence MPI, et pourquoi quatre mois ont été nécessaires — le double seuil du Payment Services Act</h2>
...
<p class="en">Singapore's Payment Services Act splits digital-payment-token operators into two tiers. Firms below a monthly transaction threshold can register as a Standard Payment Institution (SPI), but crossing that line requires upgrading to MPI status. MPI licensing demands far stricter capital requirements, anti-money-laundering and counter-terrorism-financing compliance frameworks, and fit-and-proper reviews of directors and management than SPI registration. Even a firm like Cumberland — already registered as a CFTC swap dealer and licensed in multiple jurisdictions globally — has to pass Singapore's own review from scratch, and after in-principle approval must still satisfy follow-on conditions such as depositing capital, hiring local compliance staff, and passing internal-controls audits before the full licence is granted.</p>
<p class="en">As of June 19, 37 firms held an active MPI licence for DPT services in Singapore. Coinbase, Circle, Ripple, GSR Markets and QCP Capital are already on that list, and Cumberland is the latest addition. Reading that number purely as evidence of a low regulatory bar would only be half the story, though. Over the same period, MAS has also taken enforcement action — including licence revocations and suspensions — against firms that fell short of its standards. The more accurate reading is that 37 is less a sign of leniency than a list of survivors who cleared a demanding review.</p>
<p class="ja">シンガポールの決済サービス法は、デジタル決済トークン取扱業者を2段階に分類する。月間取引額が一定の基準を下回る業者はスタンダード決済機関(Standard Payment Institution、SPI)として登録できるが、その基準を超えるとMPIへの昇格が義務付けられる。MPIはSPIに比べ、資本要件、資金洗浄・テロ資金供与対策(AML/CFT)の体制、役員・経営陣の適格性審査がはるかに厳格だ。カンバーランドのように米CFTCのスワップディーラー登録を含め複数法域で既にライセンスを保有する機関でも、シンガポール独自の審査を一から通過する必要があり、原則承認後も資本金の預託、現地コンプライアンス人員の採用、内部統制システムの監査といった追加条件を満たして初めて本ライセンスに至る。</p>
<p class="ja">6月19日時点で、シンガポールでDPTサービスのMPIライセンスを保有する業者は37社に上る。コインベース、サークル、リップル、GSRマーケッツ、QCPキャピタルなどが既に名を連ねており、カンバーランドは今回そこに加わった最新の事例だ。ただし、これを「規制の敷居が低い」証拠とだけ読むのは半分の解釈にすぎない。同じ期間、MASは基準を満たさなかった業者に対してライセンス取消や営業停止といった執行措置も並行して取ってきた。つまり37社という数字は寛容さの表れというより、厳格な審査を通過した生存者リストに近いというのがより正確な見方だ。</p>
<p class="es">La Ley de Servicios de Pago de Singapur divide a los operadores de tokens de pago digital en dos niveles. Las firmas por debajo de un umbral de transacciones mensuales pueden registrarse como Institución de Pagos Estándar (Standard Payment Institution, SPI), pero superar ese límite obliga a ascender al estatus MPI. La licencia MPI exige requisitos de capital, marcos de cumplimiento contra el lavado de dinero y la financiación del terrorismo, y evaluaciones de idoneidad de directivos mucho más estrictos que el registro como SPI. Incluso una firma como Cumberland —ya registrada como agente de swaps ante la CFTC y con licencias en múltiples jurisdicciones— debe superar desde cero la revisión propia de Singapur, y tras la aprobación en principio aún debe cumplir condiciones adicionales como depositar capital, contratar personal de cumplimiento local y superar auditorías de controles internos antes de obtener la licencia plena.</p>
<p class="es">Al 19 de junio, 37 firmas contaban con una licencia MPI activa para servicios DPT en Singapur. Coinbase, Circle, Ripple, GSR Markets y QCP Capital ya figuraban en esa lista, y Cumberland es la última incorporación. Sin embargo, leer esa cifra solo como evidencia de un listón regulatorio bajo sería contar apenas la mitad de la historia. Durante el mismo período, MAS también ha tomado medidas de aplicación —incluidas revocaciones y suspensiones de licencias— contra firmas que no alcanzaron sus estándares. La lectura más precisa es que el 37 es menos una señal de indulgencia que una lista de sobrevivientes de una revisión exigente.</p>
<p class="de">Singapurs Payment Services Act unterteilt Anbieter von Digital Payment Tokens in zwei Stufen. Firmen unterhalb einer monatlichen Transaktionsschwelle können sich als Standard Payment Institution (SPI) registrieren, doch wer diese Grenze überschreitet, muss auf MPI-Status aufsteigen. Die MPI-Lizenzierung verlangt weit strengere Kapitalanforderungen, Rahmenwerke zur Bekämpfung von Geldwäsche und Terrorismusfinanzierung sowie Eignungsprüfungen von Direktoren und Management als die SPI-Registrierung. Selbst eine Firma wie Cumberland — bereits als CFTC-Swap-Dealer registriert und in mehreren Rechtsordnungen weltweit lizenziert — muss Singapurs eigene Prüfung von Grund auf durchlaufen und nach der grundsätzlichen Genehmigung noch Folgebedingungen wie Kapitalhinterlegung, die Einstellung lokaler Compliance-Mitarbeiter und Audits der internen Kontrollsysteme erfüllen, bevor die volle Lizenz erteilt wird.</p>
<p class="de">Zum 19. Juni hielten 37 Firmen eine aktive MPI-Lizenz für DPT-Dienste in Singapur. Coinbase, Circle, Ripple, GSR Markets und QCP Capital stehen bereits auf dieser Liste, Cumberland ist der jüngste Neuzugang. Diese Zahl allein als Beleg für eine niedrige Regulierungshürde zu lesen, wäre jedoch nur die halbe Geschichte. Im selben Zeitraum hat die MAS auch Durchsetzungsmaßnahmen — einschließlich Lizenzentzug und -aussetzung — gegen Firmen ergriffen, die ihre Standards nicht erfüllten. Die treffendere Lesart: 37 ist weniger ein Zeichen von Nachsicht als eine Liste von Überlebenden einer anspruchsvollen Prüfung.</p>
<p class="fr">La loi singapourienne sur les services de paiement répartit les opérateurs de jetons de paiement numérique en deux niveaux. Les entreprises en dessous d'un certain seuil de transactions mensuelles peuvent s'enregistrer comme Institution de Paiement Standard (Standard Payment Institution, SPI), mais dépasser ce seuil impose de passer au statut MPI. La licence MPI exige des conditions de capital, des dispositifs de conformité anti-blanchiment et anti-financement du terrorisme, ainsi que des contrôles d'aptitude des dirigeants bien plus stricts que l'enregistrement SPI. Même une entreprise comme Cumberland — déjà enregistrée comme swap dealer auprès de la CFTC et titulaire de licences dans plusieurs juridictions — doit repartir de zéro pour l'examen propre à Singapour, et après l'approbation de principe, doit encore satisfaire des conditions supplémentaires : dépôt de capital, recrutement de personnel de conformité local et audits des contrôles internes, avant l'obtention de la licence complète.</p>
<p class="fr">Au 19 juin, 37 entreprises détenaient une licence MPI active pour les services DPT à Singapour. Coinbase, Circle, Ripple, GSR Markets et QCP Capital figurent déjà sur cette liste, et Cumberland en est le dernier ajout. Mais lire ce chiffre uniquement comme la preuve d'un seuil réglementaire bas ne raconterait que la moitié de l'histoire. Sur la même période, la MAS a également pris des mesures coercitives — révocations et suspensions de licences comprises — contre des entreprises n'ayant pas atteint ses standards. La lecture la plus juste est que ce chiffre de 37 est moins un signe de clémence qu'une liste de survivants ayant franchi un examen exigeant.</p>
<p class="pt">A Lei de Serviços de Pagamento de Singapura divide os operadores de tokens de pagamento digital em dois níveis. Empresas abaixo de um limite mensal de transações podem se registrar como Instituição de Pagamento Padrão (Standard Payment Institution, SPI), mas ultrapassar esse limite exige a promoção ao status MPI. A licença MPI exige requisitos de capital, estruturas de conformidade contra lavagem de dinheiro e financiamento do terrorismo, e avaliações de adequação de diretores muito mais rígidas do que o registro SPI. Mesmo uma empresa como a Cumberland — já registrada como dealer de swaps na CFTC e licenciada em múltiplas jurisdições — precisa passar do zero pela revisão própria de Singapura, e após a aprovação em princípio ainda deve cumprir condições adicionais, como depositar capital, contratar equipe de compliance local e passar por auditorias de controles internos, antes de obter a licença plena.</p>
<p class="pt">Em 19 de junho, 37 empresas detinham licença MPI ativa para serviços DPT em Singapura. Coinbase, Circle, Ripple, GSR Markets e QCP Capital já constavam dessa lista, e a Cumberland é a mais recente adição. Mas interpretar esse número apenas como evidência de uma barreira regulatória baixa seria contar só metade da história. No mesmo período, a MAS também tomou medidas de fiscalização — incluindo revogações e suspensões de licenças — contra empresas que não atenderam seus padrões. A leitura mais precisa é que o 37 é menos um sinal de leniência do que uma lista de sobreviventes de uma revisão exigente.</p>
<p class="tr">Singapur Ödeme Hizmetleri Yasası, dijital ödeme tokeni işletmecilerini iki kademeye ayırır. Aylık işlem eşiğinin altındaki firmalar Standart Ödeme Kurumu (Standard Payment Institution, SPI) olarak kayıt olabilir, ancak bu sınırı aşmak MPI statüsüne yükselmeyi zorunlu kılar. MPI lisanslaması, SPI kaydına kıyasla çok daha katı sermaye gereksinimleri, kara para aklamayla ve terörün finansmanıyla mücadele uyum çerçeveleri ile yönetici ve müdürlerin uygunluk incelemelerini talep eder. Cumberland gibi zaten CFTC'ye swap komisyoncusu olarak kayıtlı ve birden fazla yargı bölgesinde lisanslı bir kurum bile Singapur'un kendi incelemesini sıfırdan geçmek zorundadır; ilke onayının ardından da sermaye yatırma, yerel uyum personeli istihdam etme ve iç kontrol sistemi denetimlerinden geçme gibi ek koşulları tam lisans verilmeden önce karşılamalıdır.</p>
...
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">커버랜드 싱가포르 MPI 라이선스 취득 타임라인</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">3월</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS 원칙승인</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">(in-principle)</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">6월 19일</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">싱가포르 MPI</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">누적 37개사 집계</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">7월 14일</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">커버랜드 MPI</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">본허가 취득</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">동종업계 싱가포르 MPI 보유사 (DPT 서비스)</text>
    <rect x="20" y="180" width="140" height="30" rx="6" fill="#27272a"/>
    <text x="90" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">코인베이스</text>
    <rect x="170" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="230" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">서클</text>
    <rect x="300" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="360" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">리플</text>
    <rect x="430" y="180" width="130" height="30" rx="6" fill="#27272a"/>
    <text x="495" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">GSR마켓츠</text>
    <rect x="570" y="180" width="110" height="30" rx="6" fill="#27272a"/>
    <text x="625" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP캐피탈</text>
    <rect x="20" y="222" width="150" height="30" rx="6" fill="#f7931a"/>
    <text x="95" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">커버랜드 (신규)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">싱가포르 결제서비스법(PSA) 2단계 라이선스 구조</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (표준결제기관)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">월 거래액 제한 이하</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (주요결제기관)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">자본·AML·적합성 심사 강화</text>
    <text x="20" y="408" fill="#52525b" font-size="12">출처: 크립토뉴스(crypto.news), 싱가포르통화청(MAS)</text>
  </g>
</svg>
</div>
<div class="en">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="16" font-weight="700" font-family="sans-serif">Cumberland's path to a Singapore MPI licence</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">March</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS grants</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">in-principle approval</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Jun 19</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapore MPI</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">count hits 37 firms</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Jul 14</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland gets</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">full MPI licence</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Peer Singapore MPI holders (DPT services)</text>
    ...
    <rect x="20" y="222" width="160" height="30" rx="6" fill="#f7931a"/>
    <text x="100" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (new)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Singapore's two-tier Payment Services Act structure</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Standard Payment Inst.)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Below monthly volume cap</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Major Payment Inst.)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Stricter capital/AML/fit-and-proper review</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Sources: crypto.news, Monetary Authority of Singapore</text>
  </g>
</svg>
</div>
<div class="ja">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">カンバーランド シンガポールMPIライセンス取得タイムライン</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">3月</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS原則承認</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">(in-principle)</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">6月19日</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">シンガポールMPI</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">累計37社</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">7月14日</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">カンバーランド</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">本ライセンス取得</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">同業のシンガポールMPI保有社(DPTサービス)</text>
    <rect x="20" y="180" width="140" height="30" rx="6" fill="#27272a"/>
    <text x="90" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">コインベース</text>
    <rect x="170" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="230" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">サークル</text>
    <rect x="300" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="360" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">リップル</text>
    <rect x="430" y="180" width="130" height="30" rx="6" fill="#27272a"/>
    <text x="495" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">GSRマーケッツ</text>
    <rect x="570" y="180" width="110" height="30" rx="6" fill="#27272a"/>
    <text x="625" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCPキャピタル</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">カンバーランド(新規)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">シンガポール決済サービス法(PSA)の2段階ライセンス構造</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI(標準決済機関)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">月間取引額が基準未満</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI(主要決済機関)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">資本・AML・適格性審査が厳格化</text>
    <text x="20" y="408" fill="#52525b" font-size="12">出典: クリプトニュース(crypto.news)、シンガポール通貨庁(MAS)</text>
  </g>
</svg>
</div>
<div class="es">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Cronología de la licencia MPI de Cumberland en Singapur</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Marzo</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS otorga</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">aprobación en principio</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19 jun</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapur llega a</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">37 firmas con MPI</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14 jul</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland recibe</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">licencia MPI plena</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Otras firmas con MPI en Singapur (servicios DPT)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (nueva)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Estructura de dos niveles de la Ley de Servicios de Pago</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Institución Estándar)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Bajo el tope mensual</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Institución Principal)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Capital/AML/idoneidad más estrictos</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Fuentes: crypto.news, Autoridad Monetaria de Singapur</text>
  </g>
</svg>
</div>
<div class="de">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Cumberlands Weg zur Singapur-MPI-Lizenz</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">März</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS erteilt</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">Grundsatzgenehmigung</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19. Juni</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapur erreicht</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">37 MPI-Firmen</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14. Juli</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland erhält</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">volle MPI-Lizenz</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Weitere Singapur-MPI-Inhaber (DPT-Dienste)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (neu)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Singapurs zweistufige Struktur des Payment Services Act</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Standard-Institut)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Unter monatlicher Obergrenze</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Haupt-Institut)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Strengere Kapital-/AML-/Eignungsprüfung</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Quellen: crypto.news, Monetary Authority of Singapore</text>
  </g>
</svg>
</div>
<div class="fr">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Chronologie de la licence MPI de Cumberland à Singapour</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Mars</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">La MAS accorde</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">l'approbation de principe</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19 juin</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapour atteint</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">37 titulaires MPI</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14 juil.</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland obtient</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">la licence MPI complète</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Autres titulaires MPI à Singapour (services DPT)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (nouveau)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Structure à deux niveaux du Payment Services Act</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Institution Standard)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Sous le seuil mensuel</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Institution Majeure)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Capital/AML/aptitude renforcés</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Sources : crypto.news, Autorité monétaire de Singapour</text>
  </g>
</svg>
</div>
<div class="pt">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Linha do tempo da licença MPI da Cumberland em Singapura</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Março</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS concede</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">aprovação em princípio</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19 jun</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapura atinge</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">37 detentores de MPI</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14 jul</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland recebe</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">licença MPI plena</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Outros detentores de MPI em Singapura (serviços DPT)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (nova)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Estrutura de dois níveis da Payment Services Act</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Instituição Padrão)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Abaixo do limite mensal</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Instituição Principal)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Capital/AML/adequação mais rígidos</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Fontes: crypto.news, Autoridade Monetária de Singapura</text>
  </g>
</svg>
</div>
<div class="tr">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Cumberland'ın Singapur MPI lisansı yolculuğu</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Mart</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS ilke onayı</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">verdi</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19 Haz</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapur'da MPI</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">sayısı 37'ye ulaştı</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14 Tem</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland tam</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">MPI lisansı aldı</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Singapur'daki diğer MPI sahipleri (DPT hizmetleri)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (yeni)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Singapur Ödeme Hizmetleri Yasası'nın iki kademeli yapısı</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Standart Kurum)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Aylık üst sınırın altında</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Büyük Kurum)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Daha sıkı sermaye/AML/uygunluk incelemesi</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Kaynaklar: crypto.news, Singapur Para Otoritesi</text>
  </g>
</svg>
</div>
<div class="vi">
<svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
  <text x="20" y="32" fill="#fafafa" font-size="15" font-weight="700" font-family="sans-serif">Hành trình giấy phép MPI của Cumberland tại Singapore</text>
  <g font-family="sans-serif">
    <line x1="50" y1="80" x2="650" y2="80" stroke="#3f3f46" stroke-width="2"/>
    <circle cx="90" cy="80" r="7" fill="#f7931a"/>
    <text x="90" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">Tháng 3</text>
    <text x="90" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">MAS cấp phê duyệt</text>
    <text x="90" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">nguyên tắc</text>
    <circle cx="370" cy="80" r="7" fill="#38bdf8"/>
    <text x="370" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">19/6</text>
    <text x="370" y="105" fill="#a1a1aa" font-size="13" text-anchor="middle">Singapore đạt</text>
    <text x="370" y="123" fill="#a1a1aa" font-size="13" text-anchor="middle">37 đơn vị có MPI</text>
    <circle cx="620" cy="80" r="8" fill="#22c55e"/>
    <text x="620" y="60" fill="#e4e4e7" font-size="14" font-weight="700" text-anchor="middle">14/7</text>
    <text x="620" y="105" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">Cumberland nhận</text>
    <text x="620" y="123" fill="#4ade80" font-size="13" font-weight="700" text-anchor="middle">giấy phép MPI đầy đủ</text>
    <text x="20" y="165" fill="#e4e4e7" font-size="14" font-weight="700">Các đơn vị có MPI khác tại Singapore (dịch vụ DPT)</text>
    <rect x="20" y="180" width="120" height="30" rx="6" fill="#27272a"/>
    <text x="80" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Coinbase</text>
    <rect x="150" y="180" width="100" height="30" rx="6" fill="#27272a"/>
    <text x="200" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">Circle</text>
    ...
    <text x="590" y="200" fill="#e4e4e7" font-size="13" text-anchor="middle" font-weight="600">QCP Capital</text>
    <rect x="20" y="222" width="170" height="30" rx="6" fill="#f7931a"/>
    <text x="105" y="242" fill="#0a0a0a" font-size="13" text-anchor="middle" font-weight="700">Cumberland (mới)</text>
    <line x1="20" y1="280" x2="680" y2="280" stroke="#27272a" stroke-width="1"/>
    <text x="20" y="308" fill="#e4e4e7" font-size="14" font-weight="700">Cấu trúc hai cấp của Đạo luật Dịch vụ Thanh toán Singapore</text>
    <rect x="20" y="325" width="300" height="60" rx="8" fill="#1c1c1f" stroke="#3f3f46"/>
    <text x="170" y="350" fill="#a1a1aa" font-size="13" text-anchor="middle" font-weight="700">SPI (Tổ chức Tiêu chuẩn)</text>
    <text x="170" y="370" fill="#71717a" font-size="12" text-anchor="middle">Dưới ngưỡng hằng tháng</text>
    <rect x="340" y="325" width="330" height="60" rx="8" fill="#1c1c1f" stroke="#f7931a"/>
    <text x="505" y="350" fill="#fbbf24" font-size="13" text-anchor="middle" font-weight="700">MPI (Tổ chức Chính)</text>
    <text x="505" y="370" fill="#a1a1aa" font-size="12" text-anchor="middle">Vốn/AML/tư cách phù hợp khắt khe hơn</text>
    <text x="20" y="408" fill="#52525b" font-size="12">Nguồn: crypto.news, Cơ quan Tiền tệ Singapore</text>
  </g>
</svg>
</div>
<div class="id">
...
<h2 class="ja">なぜオンショアのライセンスがオフショアOTCより重要なのか — 機関投資家向け流動性のカウンターパーティリスク問題</h2>
<h2 class="es">Por qué una licencia local supera al OTC extraterritorial — el problema del riesgo de contraparte para la liquidez institucional</h2>
<h2 class="de">Warum eine Onshore-Lizenz besser ist als Offshore-OTC — das Kontrahentenrisiko-Problem für institutionelle Liquidität</h2>
<h2 class="fr">Pourquoi une licence locale l'emporte sur l'OTC offshore — le problème du risque de contrepartie pour la liquidité institutionnelle</h2>
...
<p class="en">Cumberland already supplies block-trade liquidity to institutional clients worldwide through voice, chat, its own API, and Marea, its real-time two-way streaming platform. So why bother with a local Singapore licence at all? Because regulated asset managers and banks take on compliance risk when trading with an unlicensed offshore counterparty. Singapore-based asset managers, family offices and private banks often can't even get internal risk-policy approval to execute large trades with a counterparty that lacks an MAS licence. This MPI grant effectively opens Cumberland's first formal door to that exact client base.</p>
<p class="en">There's a counterargument worth weighing, though. Cumberland is already a registered CFTC swap dealer and one of the largest OTC liquidity providers in crypto, licensed across multiple jurisdictions — so whether a Singapore MPI actually generates new volume, or simply reclassifies order flow that was already routing offshore, is something next quarter's data will have to answer. For context, Hong Kong's VASP regime has a reputation for longer review timelines and steeper requirements, which makes the case that Singapore currently holds an edge in processing speed in the race for Asia's institutional licensing business.</p>
<p class="ja">カンバーランドは既に、音声、チャット、独自API、リアルタイム双方向ストリーミングプラットフォーム「マレア(Marea)」を通じて、世界中の機関投資家顧客にブロックトレードの流動性を供給してきた企業だ。それでもなぜシンガポール現地のライセンスが必要なのか。規制対象の資産運用会社や銀行が、無免許のオフショアカウンターパーティと取引する際にコンプライアンス上のリスクを負うからだ。シンガポールに拠点を置く資産運用会社、ファミリーオフィス、プライベートバンクは、社内のリスク方針上、MASライセンスを持たない相手との大口取引自体を承認できないケースが多い。今回のMPI取得は、カンバーランドがまさにこの規制順守顧客層への正式な扉を初めて開いた措置と見ることができる。</p>
<p class="ja">ただし反論の余地もある。カンバーランドは既に米CFTCのスワップディーラーとして登録されており、複数の法域でライセンスを保有する世界最大級のOTC流動性提供者の一つであるため、シンガポールのMPIが実質的に新たな取引量を生み出すのか、それとも既にオフショアに流れていた注文フローを単に「再分類」するだけに終わるのかは、来四半期の実データで確認する必要がある。参考までに、香港の仮想資産サービス提供者(VASP)制度は審査期間が長く要件も厳しいと評されてきたため、処理速度の面ではシンガポールがアジアの機関投資家向けライセンス獲得競争で優位に立っているという見方もできる。</p>
<p class="es">Cumberland ya suministra liquidez para operaciones en bloque a clientes institucionales de todo el mundo mediante voz, chat, su propia API y Marea, su plataforma de streaming bidireccional en tiempo real. Entonces, ¿por qué molestarse con una licencia local en Singapur? Porque los gestores de activos y bancos regulados asumen riesgo de cumplimiento al operar con una contraparte extraterritorial sin licencia. Los gestores de activos, family offices y bancos privados con sede en Singapur a menudo ni siquiera obtienen la aprobación interna de política de riesgo para ejecutar grandes operaciones con una contraparte que carece de licencia de MAS. Esta concesión de MPI abre efectivamente la primera puerta formal de Cumberland a esa base de clientes exacta.</p>
<p class="es">Sin embargo, hay un contraargumento que vale la pena considerar. Cumberland ya es un agente de swaps registrado ante la CFTC y uno de los mayores proveedores de liquidez OTC en cripto, con licencias en múltiples jurisdicciones, así que si una MPI en Singapur realmente genera volumen nuevo, o simplemente reclasifica un flujo de órdenes que ya se dirigía offshore, es algo que los datos del próximo trimestre tendrán que responder. Para contextualizar, el régimen VASP de Hong Kong tiene fama de plazos de revisión más largos y requisitos más exigentes, lo que respalda la idea de que Singapur mantiene actualmente una ventaja en velocidad de tramitación en la carrera por el negocio de licencias institucionales en Asia.</p>
<p class="de">Cumberland versorgt institutionelle Kunden weltweit bereits mit Blocktrade-Liquidität über Voice, Chat, die eigene API und Marea, seine Echtzeit-Zweiweg-Streaming-Plattform. Warum also überhaupt eine lokale Singapur-Lizenz? Weil regulierte Vermögensverwalter und Banken beim Handel mit einer unlizenzierten Offshore-Gegenpartei ein Compliance-Risiko eingehen. Vermögensverwalter, Family Offices und Privatbanken mit Sitz in Singapur erhalten aufgrund interner Risikorichtlinien oft nicht einmal die Freigabe, große Trades mit einer Gegenpartei ohne MAS-Lizenz auszuführen. Diese MPI-Erteilung öffnet Cumberland faktisch die erste formale Tür zu genau dieser Kundenbasis.</p>
<p class="de">Es gibt jedoch ein Gegenargument, das man abwägen sollte. Cumberland ist bereits ein registrierter CFTC-Swap-Dealer und einer der größten OTC-Liquiditätsanbieter im Kryptobereich, lizenziert in mehreren Rechtsordnungen — ob eine Singapur-MPI-Lizenz tatsächlich neues Volumen generiert oder lediglich Orderflow umklassifiziert, der ohnehin schon offshore lief, müssen die Daten des nächsten Quartals zeigen. Zum Vergleich: Hongkongs VASP-Regime gilt als langwieriger in der Prüfung und anspruchsvoller in den Anforderungen, was dafürspricht, dass Singapur derzeit im Tempo-Wettbewerb um Asiens institutionelles Lizenzgeschäft die Nase vorn hat.</p>
<p class="fr">Cumberland fournit déjà de la liquidité pour les transactions en bloc à des clients institutionnels du monde entier via la voix, le chat, sa propre API et Marea, sa plateforme de streaming bidirectionnel en temps réel. Alors pourquoi s'embêter avec une licence locale à Singapour ? Parce que les gestionnaires d'actifs et banques réglementés assument un risque de conformité en traitant avec une contrepartie offshore non licenciée. Les gestionnaires d'actifs, family offices et banques privées basés à Singapour ne peuvent souvent même pas obtenir l'approbation interne de leur politique de risque pour exécuter de grosses opérations avec une contrepartie dépourvue de licence MAS. Cette licence MPI ouvre en pratique la première porte formelle de Cumberland vers exactement cette clientèle.</p>
<p class="fr">Un contre-argument mérite toutefois d'être pesé. Cumberland est déjà un swap dealer enregistré auprès de la CFTC et l'un des plus grands fournisseurs de liquidité OTC en crypto, licencié dans plusieurs juridictions — savoir si une licence MPI à Singapour génère réellement un nouveau volume, ou reclasse simplement un flux d'ordres déjà acheminé offshore, est une question à laquelle les données du prochain trimestre devront répondre. Pour situer le contexte, le régime VASP de Hong Kong a la réputation d'avoir des délais d'examen plus longs et des exigences plus lourdes, ce qui accrédite l'idée que Singapour détient actuellement un avantage de rapidité dans la course aux licences institutionnelles en Asie.</p>
<p class="pt">A Cumberland já fornece liquidez para operações em bloco a clientes institucionais em todo o mundo por meio de voz, chat, sua própria API e Marea, sua plataforma de streaming bidirecional em tempo real. Então por que se preocupar com uma licença local em Singapura? Porque gestores de ativos e bancos regulados assumem risco de compliance ao negociar com uma contraparte offshore sem licença. Gestores de ativos, family offices e bancos privados sediados em Singapura frequentemente nem conseguem aprovação interna de política de risco para executar grandes operações com uma contraparte sem licença da MAS. Essa concessão de MPI efetivamente abre a primeira porta formal da Cumberland para exatamente essa base de clientes.</p>
<p class="pt">Há, porém, um contra-argumento que vale considerar. A Cumberland já é dealer de swaps registrada na CFTC e uma das maiores provedoras de liquidez OTC em cripto, licenciada em múltiplas jurisdições — então se uma MPI em Singapura realmente gera volume novo, ou apenas reclassifica um fluxo de ordens que já seguia para offshore, é algo que os dados do próximo trimestre terão de responder. Para contextualizar, o regime VASP de Hong Kong tem fama de prazos de revisão mais longos e exigências mais rígidas, o que sustenta a ideia de que Singapura atualmente leva vantagem em velocidade de processamento na corrida pelo negócio de licenciamento institucional na Ásia.</p>
<p class="tr">Cumberland zaten dünya çapındaki kurumsal müşterilere sesli iletişim, sohbet, kendi API'si ve gerçek zamanlı çift yönlü akış platformu Marea aracılığıyla blok işlem likiditesi sağlıyor. Peki neden Singapur'da yerel bir lisansla uğraşsın? Çünkü düzenlemeye tabi varlık yöneticileri ve bankalar, lisanssız bir offshore karşı tarafla işlem yaparken uyum riski üstlenir. Singapur merkezli varlık yöneticileri, aile ofisleri ve özel bankalar, iç risk politikaları gereği MAS lisansı olmayan bir karşı tarafla büyük işlemler yapmak için genellikle iç onay bile alamaz. Bu MPI lisansı, Cumberland'ın tam da bu müşteri tabanına açtığı ilk resmi kapı olarak görülebilir.</p>
...
<div class="box ja">💡 <strong>示唆:</strong> カンバーランドのライセンス取得そのものより重要なのは「4カ月」という処理期間と「37社」という累計数字だ。シンガポールが着実なペースで機関投資家向けライセンスを発給し、アジアの機関投資家向け流動性ハブとしての地位を固めつつある兆候と読める。ただしこれが実際の取引量増加につながるかは、カンバーランドの来四半期のシンガポール向け取引データを見て初めて確認できる。</div>
<div class="box es">💡 <strong>Conclusión:</strong> más revelador que la licencia en sí son el plazo de tramitación de cuatro meses y el recuento acumulado de 37 firmas. Eso se lee como Singapur otorgando de forma constante licencias de nivel institucional mientras afianza su posición como centro de liquidez institucional de Asia. Si eso realmente se traduce en más volumen de negociación es algo que solo confirmarán los datos de Cumberland orientados a Singapur del próximo trimestre.</div>
<div class="box de">💡 <strong>Fazit:</strong> Aufschlussreicher als die Lizenz selbst sind die viermonatige Bearbeitungszeit und die kumulierte Zahl von 37 Firmen. Das liest sich so, als würde Singapur beständig institutionelle Lizenzen erteilen und dabei seine Position als Asiens Hub für institutionelle Liquidität festigen. Ob sich das tatsächlich in höherem Handelsvolumen niederschlägt, können erst Cumberlands Singapur-Daten des nächsten Quartals bestätigen.</div>
<div class="box fr">💡 <strong>À retenir :</strong> plus révélateurs que la licence elle-même sont le délai de traitement de quatre mois et le décompte cumulé de 37 entreprises. Cela se lit comme Singapour délivrant régulièrement des licences de niveau institutionnel tout en consolidant sa position de hub de liquidité institutionnelle en Asie. Reste à savoir si cela se traduit réellement par un volume de transactions plus élevé — seules les données de Cumberland pour Singapour au prochain trimestre le confirmeront.</div>
...
<p class="ja" style="font-size:12px;color:#52525b;margin-top:24px">出典: クリプトニュース(crypto.news)、クリプトニュース・ドットコム(cryptonews.com)、ビットコインワールド(BitcoinWorld)、デクリプト(Decrypt)、シンガポール通貨庁(MAS)公式ライセンス一覧</p>
<p class="es" style="font-size:12px;color:#52525b;margin-top:24px">Fuentes: crypto.news, cryptonews.com, BitcoinWorld, Decrypt, lista oficial de licenciatarios de la Autoridad Monetaria de Singapur</p>
<p class="de" style="font-size:12px;color:#52525b;margin-top:24px">Quellen: crypto.news, cryptonews.com, BitcoinWorld, Decrypt, offizielle Lizenznehmerliste der Monetary Authority of Singapore</p>
<p class="fr" style="font-size:12px;color:#52525b;margin-top:24px">Sources : crypto.news, cryptonews.com, BitcoinWorld, Decrypt, liste officielle des titulaires de licence de la Monetary Authority of Singapore</p>
