...
<p class="ko">2019년, 익명 트위터 계정 "PlanB"가 발표한 논문 하나가 비트코인 커뮤니티를 뒤집어놨어요. 채굴량이 줄어드는 반감기 구조만으로 미래 가격을 예측할 수 있다는 주장이었죠. 이게 <strong>Stock-to-Flow(S2F) 모델</strong>입니다. 한동안 무서울 정도로 잘 맞았고, 그다음엔 완전히 틀렸어요. 둘 다 사실이에요.</p>
  ...
  <p class="fr">En 2019, un article publié par un compte Twitter anonyme appelé "PlanB" a bouleversé la communauté Bitcoin. L'affirmation : il serait possible de prédire le prix futur uniquement à partir de la structure de rareté induite par le halving. C'est le <strong>modèle Stock-to-Flow (S2F)</strong>. Pendant un temps, il s'est révélé étonnamment précis. Puis il s'est complètement trompé. Ces deux affirmations sont vraies.</p>
  <p class="pt">Em 2019, um artigo de uma conta anônima do Twitter chamada "PlanB" revirou a comunidade Bitcoin do avesso. A afirmação: seria possível prever o preço futuro apenas a partir da estrutura de escassez determinada pelo halving. Este é o <strong>modelo Stock-to-Flow (S2F)</strong>. Por um tempo, foi assustadoramente preciso. Depois, ficou completamente errado. Ambas as afirmações são verdadeiras.</p>
  <p class="tr">2019 yılında, "PlanB" adlı anonim bir Twitter hesabının yayımladığı bir makale, Bitcoin topluluğunu alt üst etti. İddia şuydu: gelecekteki fiyat, yalnızca yarılanmanın (halving) yönlendirdiği kıtlık yapısından tahmin edilebilirdi. Bu, <strong>Stock-to-Flow (S2F) modeli</strong>dir. Bir süre ürkütücü derecede isabetliydi. Sonra tamamen yanıldı. Her iki durum da doğru.</p>
  <p class="vi">Năm 2019, một bài viết từ một tài khoản Twitter ẩn danh có tên "PlanB" đã làm đảo lộn cộng đồng Bitcoin. Tuyên bố: có thể dự đoán giá tương lai chỉ dựa trên cấu trúc khan hiếm do halving thúc đẩy. Đây chính là <strong>mô hình Stock-to-Flow (S2F)</strong>. Trong một thời gian, nó chính xác đến mức đáng sợ. Sau đó nó hoàn toàn sai. Cả hai điều đó đều đúng.</p>
  ...
  <p class="fr">Le Stock-to-Flow mesurait à l'origine la rareté de métaux précieux comme l'or et l'argent. La formule :</p>
  <p class="pt">O Stock-to-Flow originalmente media a escassez de metais preciosos como o ouro e a prata. A fórmula:</p>
  <p class="tr">Stock-to-Flow, başlangıçta altın ve gümüş gibi değerli metallerin kıtlığını ölçmek için kullanılan bir gösterge. Formül şöyle:</p>
  ...
  <div class="box tr"><strong>S2F = Toplam mevcut arz (Stock) ÷ Yıllık yeni üretim (Flow)</strong><br>Daha yüksek bir sayı, "mevcut miktara göre daha az yeni arz" anlamına gelir — yani daha kıt</div>
  ...
  <p class="fr">Le halving de Bitcoin réduit exactement de moitié le Flow (nouvelle émission) tous les 4 ans, si bien que le S2F double par sauts en escalier. PlanB a réalisé une régression sur échelle logarithmique entre cette valeur S2F et le prix historique, produisant une formule : "à ce niveau de S2F, le prix devrait être à peu près celui-ci."</p>
  <p class="pt">O halving do Bitcoin corta o Flow (nova emissão) exatamente pela metade a cada 4 anos, de modo que o S2F salta em duplicações escalonadas. A PlanB executou uma regressão em escala logarítmica entre esse valor de S2F e o preço histórico, produzindo uma fórmula: "neste nível de S2F, o preço deveria ser aproximadamente este."</p>
  <p class="tr">Bitcoin'in yarılanması, her 4 yılda bir Flow'u (yeni arzı) tam olarak yarıya indiriyor, bu yüzden S2F basamaklı ikiye katlanmalarla sıçrıyor. PlanB, bu S2F değeri ile geçmiş fiyat arasında logaritmik ölçekte bir regresyon yaptı ve şu formülü ortaya çıkardı: "bu S2F seviyesinde fiyat yaklaşık şu olmalı."</p>
  <p class="vi">Halving của Bitcoin cắt giảm chính xác một nửa Flow (lượng phát hành mới) sau mỗi 4 năm, vì vậy S2F tăng vọt theo từng bậc gấp đôi. PlanB đã thực hiện hồi quy trên thang log giữa giá trị S2F này và giá lịch sử, tạo ra một công thức: "ở mức S2F này, giá nên vào khoảng mức này."</p>
  ...
  <h2 class="pt">Veja como isso se parece quando representado graficamente</h2>
  <h2 class="tr">Grafiğe döküldüğünde şöyle görünüyor</h2>
  <h2 class="vi">Đây là hình ảnh khi được vẽ thành biểu đồ</h2>
  ...
  <p class="fr">Entre 2019 et 2020, le prix réel a oscillé près de cette ligne prédite. Les croyants se sont multipliés rapidement — il y avait même des blagues disant que "le S2F est fondamentalement parole d'évangile."</p>
  ...
  <p class="tr">2019-2020 boyunca, gerçek fiyat bu tahmin çizgisine yakın seyretti. İnananlar hızla çoğaldı — hatta "S2F aslında kutsal bir gerçek" diye şakalar bile yapılıyordu.</p>
  <p class="vi">Trong suốt năm 2019-2020, giá thực tế dao động gần với đường dự đoán đó. Những người tin tưởng vào mô hình này tăng lên nhanh chóng — thậm chí còn có những câu đùa rằng "S2F về cơ bản là chân lý."</p>
  ...
  <h2 class="pt">Então, em 2021, tudo saiu completamente dos trilhos</h2>
  <h2 class="tr">Sonra, 2021'de tamamen raydan çıktı</h2>
  <h2 class="vi">Sau đó, vào năm 2021, mọi thứ hoàn toàn trật bánh</h2>
  ...
  <p class="fr">À partir de fin 2021, le prix réel a continué à s'écarter de plus en plus en dessous de la ligne de prédiction S2F. Même pendant le marché haussier de 2024-2025, le prix réel est resté bien en dessous de la trajectoire projetée par le modèle. L'objectif de prix initial de PlanB pour 2021 (288 000 $) ne s'est jamais concrétisé.</p>
  <p class="pt">A partir do final de 2021, o preço real continuou divergindo cada vez mais abaixo da linha de previsão do S2F. Mesmo durante o mercado altista de 2024-2025, o preço real permaneceu bem abaixo da trajetória projetada pelo modelo. A meta de preço original da PlanB para 2021 ($288.000) nunca se concretizou.</p>
  <p class="tr">2021'in sonlarından itibaren, gerçek fiyat S2F tahmin çizgisinin giderek daha altına düşmeye devam etti. 2024-2025 boğa piyasası sırasında bile gerçek fiyat, modelin öngördüğü yörüngenin oldukça altında kaldı. PlanB'nin 2021 için belirlediği orijinal fiyat hedefi (288.000 $) hiçbir zaman gerçekleşmedi.</p>
  <p class="vi">Từ cuối năm 2021, giá thực tế tiếp tục lệch ngày càng xa xuống dưới đường dự đoán S2F. Ngay cả trong đợt tăng giá 2024-2025, giá thực tế vẫn thấp hơn nhiều so với quỹ đạo mà mô hình dự báo. Mục tiêu giá ban đầu của PlanB cho năm 2021 (288.000 USD) chưa bao giờ trở thành hiện thực.</p>
  ...
  <h2 class="fr">Pourquoi il s'est effondré — la critique centrale</h2>
  <h2 class="pt">Por que falhou — a crítica central</h2>
  <h2 class="tr">Neden başarısız oldu — temel eleştiri</h2>
  <h2 class="vi">Vì sao mô hình này sai — chỉ trích cốt lõi</h2>
  ...
  <p class="fr">La réfutation la plus largement citée est le problème de la <strong>"régression fallacieuse"</strong>, soulevé par des critiques de type économétrique et divers analystes quantitatifs. Lorsque deux séries temporelles suivent toutes deux simplement une tendance haussière au fil du temps, elles peuvent afficher une forte corrélation statistique même en l'absence de tout lien causal réel. Le prix du Bitcoin monte ; le S2F progresse également par paliers à chaque halving — superposez les deux, et un coefficient de corrélation élevé est presque garanti, que l'un influence réellement l'autre ou non.</p>
  <p class="pt">A refutação mais citada é o problema da <strong>"regressão espúria"</strong>, levantado por críticos de estilo econométrico e diversos analistas quantitativos. Quando duas séries temporais simplesmente seguem uma tendência de alta ao longo do tempo, elas podem exibir uma forte correlação estatística mesmo sem nenhuma relação causal real. O preço do Bitcoin sobe; o S2F também sobe em degraus a cada halving — sobreponha os dois, e um coeficiente de correlação alto é quase garantido, independentemente de um realmente impulsionar o outro.</p>
  <p class="tr">En yaygın olarak öne sürülen karşı görüş, ekonometri tarzı eleştirmenler ve çeşitli kantitatif analistler tarafından dile getirilen <strong>"sahte regresyon"</strong> sorunudur. İki zaman serisi zamanla sadece yukarı yönlü bir eğilim gösteriyorsa, aralarında gerçek bir nedensellik ilişkisi olmasa bile güçlü bir istatistiksel korelasyon ortaya çıkabilir. Bitcoin fiyatı yükseliyor; S2F de her yarılanmada basamaklı şekilde yükseliyor — ikisini üst üste koyduğunuzda, biri diğerini gerçekten yönlendirse de yönlendirmese de yüksek bir korelasyon katsayısı neredeyse garantidir.</p>
  <p class="vi">Lập luận phản bác được trích dẫn rộng rãi nhất là vấn đề <strong>"hồi quy giả tạo" (spurious regression)</strong>, được nêu ra bởi các nhà phê bình theo hướng kinh tế lượng và nhiều nhà phân tích định lượng khác. Khi hai chuỗi thời gian đều chỉ đơn giản có xu hướng tăng theo thời gian, chúng có thể cho thấy mối tương quan thống kê mạnh ngay cả khi không hề có quan hệ nhân quả thực sự. Giá Bitcoin có xu hướng tăng; S2F cũng tăng theo bậc thang sau mỗi lần halving — chồng hai đường này lên nhau, hệ số tương quan cao gần như chắc chắn xuất hiện bất kể một yếu tố có thực sự chi phối yếu tố kia hay không.</p>
  ...
  <p class="fr">Autre critique : il est purement du côté de l'offre. Le S2F mesure seulement "combien de nouvelle offre apparaît" — il ne dit rien sur "combien de demande existe pour l'acheter." Les conditions macroéconomiques, la réglementation, la participation institutionnelle influencent toutes le prix réel, et le modèle est structurellement aveugle à chacune d'entre elles.</p>
  <p class="pt">Outra crítica: é puramente do lado da oferta. O S2F mede apenas "quanta nova oferta surge" — não diz nada sobre "quanta demanda existe para comprá-la." As condições macroeconômicas, a regulação, a participação institucional movem o preço real, e o modelo é estruturalmente cego a todas elas.</p>
  <p class="tr">Bir diğer eleştiri: model tamamen arz odaklı. S2F yalnızca "ne kadar yeni arz ortaya çıkıyor" sorusunu ölçüyor — "onu satın almak için ne kadar talep var" konusunda hiçbir şey söylemiyor. Makro koşullar, düzenlemeler, kurumsal katılım gerçek fiyatı hareket ettiriyor ve model bunların hiçbirini yapısal olarak göremiyor.</p>
  <p class="vi">Một chỉ trích khác: mô hình này hoàn toàn thiên về phía cung. S2F chỉ đo lường "có bao nhiêu nguồn cung mới xuất hiện" — nó không nói gì về "có bao nhiêu nhu cầu tồn tại để mua nó." Các điều kiện vĩ mô, quy định pháp lý, sự tham gia của các tổ chức đều tác động đến giá thực tế, và mô hình này về bản chất không thể nhìn thấy bất kỳ yếu tố nào trong số đó.</p>
  ...
  <h2 class="fr">Faut-il donc l'abandonner complètement ?</h2>
  <h2 class="pt">Então, deve ser totalmente descartado?</h2>
  <h2 class="tr">Peki tamamen bir kenara mı bırakılmalı?</h2>
  ...
  <p class="fr">Je le retirerais en tant qu'"outil de prédiction précise des prix" tout en le conservant comme "visualisation de l'impact structurel du halving sur l'offre." Comme évoqué dans le <a href="/blog/bitcoin-halving-timing.html">guide du cycle de halving</a>, le choc d'offre en lui-même est bien réel. Ce que le S2F nous a réellement appris, c'est que traduire ce choc d'offre en "exactement ce prix" est tout simplement impossible sans tenir compte des variables du côté de la demande — aucune formule ne peut contourner cela.</p>
  <p class="pt">Eu o aposentaria como "ferramenta de previsão precisa de preços", mantendo-o como "visualização do impacto estrutural do halving sobre a oferta." Como abordado no <a href="/blog/bitcoin-halving-timing.html">guia do ciclo de halving</a>, o choque de oferta em si é real. O que o S2F realmente nos ensinou é que traduzir esse choque de oferta em "exatamente este preço" é simplesmente impossível sem levar em conta as variáveis do lado da demanda — nenhuma fórmula consegue contornar isso.</p>
  <p class="tr">Ben bunu "hassas fiyat tahmin aracı" olarak bir kenara bırakır, ancak "yarılanmanın yapısal arz etkisinin görselleştirilmesi" olarak kullanmaya devam ederdim. <a href="/blog/bitcoin-halving-timing.html">Yarılanma döngüsü rehberinde</a> ele alındığı gibi, arz şokunun kendisi gerçek. S2F'nin bize asıl öğrettiği şey şudur: bu arz şokunu talep tarafındaki değişkenleri hesaba katmadan "tam olarak şu fiyata" dönüştürmek kesinlikle imkansızdır — hiçbir formül bunun önüne geçemez.</p>
  <p class="vi">Tôi sẽ loại bỏ nó với vai trò "công cụ dự đoán giá chính xác" nhưng vẫn giữ lại như một "công cụ trực quan hóa tác động cấu trúc của halving lên nguồn cung." Như đã đề cập trong <a href="/blog/bitcoin-halving-timing.html">hướng dẫn về chu kỳ halving</a>, cú sốc nguồn cung tự nó là có thật. Điều mà S2F thực sự dạy cho chúng ta là việc chuyển cú sốc nguồn cung đó thành "chính xác mức giá này" là điều hoàn toàn bất khả thi nếu không tính đến các biến số phía cầu — không có công thức nào có thể vượt qua điều đó.</p>
