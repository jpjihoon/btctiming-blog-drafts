...
<p class="ko">2019년, 익명 트위터 계정 "PlanB"가 발표한 논문 하나가 비트코인 커뮤니티를 뒤집어놨어요. 채굴량이 줄어드는 반감기 구조만으로 미래 가격을 예측할 수 있다는 주장이었죠. 이게 <strong>Stock-to-Flow(S2F) 모델</strong>입니다. 한동안 무서울 정도로 잘 맞았고, 그다음엔 완전히 틀렸어요. 둘 다 사실이에요.</p>
  ...
  <h2 class="tr">Ardından, 2021'de tamamen raydan çıktı</h2>
  <h2 class="vi">Rồi đến năm 2021, mọi thứ hoàn toàn chệch hướng</h2>
  ...
  <p class="fr">À partir de fin 2021, le prix réel a continué à diverger de plus en plus en dessous de la ligne de prédiction S2F. Même pendant le marché haussier de 2024-2025, le prix réel est resté bien en dessous de la trajectoire projetée par le modèle. L'objectif de prix initial de PlanB pour 2021 (288 000 $) ne s'est jamais concrétisé.</p>
  <p class="pt">A partir do final de 2021, o preço real continuou divergindo cada vez mais abaixo da linha de previsão do S2F. Mesmo durante o mercado em alta de 2024-2025, o preço real permaneceu bem abaixo da trajetória projetada pelo modelo. A meta de preço original de PlanB para 2021 (US$ 288.000) nunca se concretizou.</p>
  <p class="tr">2021 sonlarından itibaren gerçek fiyat, S2F tahmin çizgisinin giderek daha altına sapmaya devam etti. 2024-2025 boğa piyasası boyunca bile gerçek fiyat, modelin öngördüğü yörüngenin oldukça altında kaldı. PlanB'nin 2021 için belirlediği orijinal fiyat hedefi (288.000 $) hiçbir zaman gerçekleşmedi.</p>
  ...
  <h2 class="fr">Pourquoi ça s'est effondré — la critique fondamentale</h2>
  <h2 class="pt">Por que falhou — a crítica central</h2>
  <h2 class="tr">Neden çöktü — temel eleştiri</h2>
  <h2 class="vi">Vì sao nó sụp đổ — lời chỉ trích cốt lõi</h2>
  ...
  <p class="fr">La réfutation la plus largement citée est le problème de la <strong>"régression fallacieuse"</strong>, soulevé par des critiques de type économétrique et divers analystes quantitatifs. Lorsque deux séries temporelles suivent simplement une tendance haussière au fil du temps, elles peuvent afficher une forte corrélation statistique même en l'absence de tout véritable lien de causalité. Le prix du Bitcoin est haussier ; le S2F augmente également à chaque halving — superposez les deux, et un coefficient de corrélation élevé est presque garanti, que l'un provoque réellement l'autre ou non.</p>
  <p class="pt">A refutação mais citada é o problema da <strong>"regressão espúria"</strong>, levantado por críticos de estilo econométrico e vários analistas quantitativos. Quando duas séries temporais simplesmente seguem uma tendência de alta ao longo do tempo, elas podem apresentar uma forte correlação estatística mesmo sem qualquer relação causal real. O preço do Bitcoin sobe; o S2F também sobe a cada halving — sobreponha os dois, e um coeficiente de correlação alto é quase garantido, independentemente de um realmente impulsionar o outro.</p>
  <p class="tr">En yaygın olarak dile getirilen itiraz, ekonometrist tarzı eleştirmenler ve çeşitli kantitatif analistler tarafından ortaya atılan <strong>"sahte regresyon"</strong> sorunudur. İki zaman serisi zamanla sadece yukarı yönlü bir eğilim gösterdiğinde, aralarında gerçek bir nedensellik ilişkisi olmasa bile güçlü bir istatistiksel korelasyon ortaya çıkabilir. Bitcoin fiyatı yukarı yönlü bir eğilim gösteriyor; S2F de her yarılanmada basamaklı şekilde yükseliyor — ikisini üst üste koyduğunuzda, biri gerçekten diğerini yönlendirsin ya da yönlendirmesin, yüksek bir korelasyon katsayısı neredeyse garantidir.</p>
  <p class="vi">Sự phản bác được trích dẫn rộng rãi nhất là vấn đề <strong>"hồi quy giả tạo" (spurious regression)</strong>, do các nhà phê bình theo trường phái kinh tế lượng và nhiều nhà phân tích định lượng khác nêu ra. Khi hai chuỗi dữ liệu theo thời gian đều đơn giản là có xu hướng tăng, chúng có thể cho thấy mối tương quan thống kê mạnh ngay cả khi không hề có quan hệ nhân quả thực sự nào. Giá Bitcoin có xu hướng tăng; S2F cũng tăng theo từng bậc sau mỗi lần halving — chồng hai đường này lên nhau, hệ số tương quan cao gần như chắc chắn xuất hiện, bất kể một yếu tố có thực sự chi phối yếu tố kia hay không.</p>
  ...
  <p class="fr">Autre critique : le modèle ne concerne que l'offre. Le S2F mesure uniquement "combien de nouvelle offre apparaît" — il ne dit rien sur "combien de demande existe pour l'acheter." Les conditions macroéconomiques, la réglementation, la participation institutionnelle influencent toutes le prix réel, et le modèle est structurellement aveugle à chacune d'entre elles.</p>
  <p class="pt">Outra crítica: é puramente do lado da oferta. O S2F mede apenas "quanta nova oferta surge" — não diz nada sobre "quanta demanda existe para comprá-la." Condições macroeconômicas, regulação e participação institucional movem o preço real, e o modelo é estruturalmente cego a todas elas.</p>
  <p class="tr">Bir başka eleştiri: model tamamen arz odaklıdır. S2F yalnızca "ne kadar yeni arz ortaya çıkıyor" ölçer — "bunu satın almak için ne kadar talep var" konusunda hiçbir şey söylemez. Makro koşullar, düzenlemeler, kurumsal katılım gerçek fiyatı hareket ettirir ve model bunların hepsine karşı yapısal olarak kördür.</p>
  <p class="vi">Một chỉ trích khác: mô hình này thuần túy chỉ nhìn từ phía cung. S2F chỉ đo lường "bao nhiêu nguồn cung mới xuất hiện" — nó không nói gì về "có bao nhiêu nhu cầu mua." Các điều kiện vĩ mô, quy định pháp lý, sự tham gia của các tổ chức đều tác động đến giá thực tế, và mô hình này về bản chất hoàn toàn mù mờ trước tất cả những yếu tố đó.</p>
  ...
  <h2 class="pt">Então, ele deve ser descartado por completo?</h2>
  <h2 class="tr">Peki tamamen bir kenara mı atılmalı?</h2>
  <h2 class="vi">Vậy có nên loại bỏ nó hoàn toàn không?</h2>
  ...
  <p class="fr">Je le mettrais à la retraite en tant qu'"outil de prédiction précise du prix", tout en le conservant comme "visualisation de l'impact structurel du halving sur l'offre." Comme évoqué dans le <a href="/blog/bitcoin-halving-timing.html">guide du cycle de halving</a>, le choc d'offre en lui-même est bien réel. Ce que le S2F nous a réellement enseigné, c'est qu'il est tout simplement impossible de traduire ce choc d'offre en "exactement ce prix" sans tenir compte des variables du côté de la demande — aucune formule n'échappe à cela.</p>
  <p class="pt">Eu o aposentaria como "ferramenta de previsão precisa de preço", mas o manteria como "visualização do impacto estrutural do halving na oferta." Como abordado no <a href="/blog/bitcoin-halving-timing.html">guia do ciclo de halving</a>, o choque de oferta em si é real. O que o S2F realmente nos ensinou é que traduzir esse choque de oferta em "exatamente este preço" é simplesmente impossível sem levar em conta as variáveis do lado da demanda — nenhuma fórmula escapa disso.</p>
  <p class="tr">Ben onu "kesin fiyat tahmin aracı" olarak emekliye ayırıp, "yarılanmanın yapısal arz etkisinin görselleştirilmesi" olarak kullanmaya devam ederdim. <a href="/blog/bitcoin-halving-timing.html">Yarılanma döngüsü rehberinde</a> ele alındığı gibi, arz şokunun kendisi gerçektir. S2F'nin bize asıl öğrettiği şey, bu arz şokunu talep tarafındaki değişkenleri hesaba katmadan "tam olarak şu fiyata" dönüştürmenin mümkün olmadığıdır — hiçbir formül bunun önüne geçemez.</p>
  <p class="vi">Tôi sẽ loại bỏ nó với vai trò "công cụ dự đoán giá chính xác", nhưng vẫn giữ lại như một "công cụ trực quan hóa tác động cấu trúc của halving lên nguồn cung." Như đã đề cập trong <a href="/blog/bitcoin-halving-timing.html">hướng dẫn về chu kỳ halving</a>, cú sốc nguồn cung tự nó là có thật. Điều mà S2F thực sự dạy cho chúng ta là việc chuyển cú sốc nguồn cung đó thành "chính xác mức giá này" là điều đơn giản là không thể nếu không tính đến các biến số phía cầu — không có công thức nào vượt qua được điều đó.</p>
