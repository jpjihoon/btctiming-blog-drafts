...
<p class="ko">2019년, 익명 트위터 계정 "PlanB"가 발표한 논문 하나가 비트코인 커뮤니티를 뒤집어놨어요. 채굴량이 줄어드는 반감기 구조만으로 미래 가격을 예측할 수 있다는 주장이었죠. 이게 <strong>Stock-to-Flow(S2F) 모델</strong>입니다. 한동안 무서울 정도로 잘 맞았고, 그다음엔 완전히 틀렸어요. 둘 다 사실이에요.</p>
  ...
  <p class="ko">저는 "정확한 가격 예측 도구"로는 폐기하되, "반감기가 공급에 미치는 구조적 영향을 시각화하는 도구"로는 여전히 쓸모 있다고 봐요. <a href="/blog/bitcoin-halving-timing">반감기 사이클 가이드</a>에서 다뤘듯, 공급 충격 자체는 실재하는 현상입니다. 다만 그 공급 충격이 "정확히 얼마의 가격"으로 이어지는지는 수요 측 변수 없이는 절대 알 수 없다는 게, S2F가 우리에게 남긴 진짜 교훈이에요.</p>
  <p class="en">I'd retire it as a "precise price prediction tool" while keeping it as a "visualization of the halving's structural supply impact." As covered in the <a href="/en/blog/bitcoin-halving-timing">halving cycle guide</a>, the supply shock itself is real. What S2F actually taught us is that translating that supply shock into "exactly this price" is simply impossible without accounting for demand-side variables — no formula gets around that.</p>
  <p class="ja">私は「正確な価格予測ツール」としては廃棄すべきだが、「半減期が供給に与える構造的影響を可視化するツール」としては依然として有用だと考えます。<a href="/ja/blog/bitcoin-halving-timing">半減期サイクルガイド</a>で扱った通り、供給ショック自体は実在する現象です。ただ、その供給ショックが「正確にいくらの価格」につながるかは需要側の変数なしには絶対に分からないというのが、S2Fが私たちに残した本当の教訓です。</p>
  <p class="es">Yo lo retiraría como "herramienta de predicción precisa de precios" mientras lo mantengo como "visualización del impacto estructural del halving en la oferta." Como se cubrió en la <a href="/es/blog/bitcoin-halving-timing">guía del ciclo de halving</a>, el shock de oferta en sí es real. Lo que S2F realmente nos enseñó es que traducir ese shock de oferta en "exactamente este precio" es simplemente imposible sin tener en cuenta las variables del lado de la demanda — ninguna fórmula puede evitarlo.</p>
  <p class="de">Ich würde es als "präzises Preisvorhersagewerkzeug" ausrangieren, aber als "Visualisierung der strukturellen Angebotsauswirkung des Halvings" beibehalten. Wie in der <a href="/de/blog/bitcoin-halving-timing">Halving-Zyklus-Anleitung</a> behandelt, ist der Angebotsschock selbst real. Was S2F uns tatsächlich lehrte, ist, dass die Übersetzung dieses Angebotsschocks in "genau diesen Preis" ohne Berücksichtigung der Nachfrageseite schlicht unmöglich ist — keine Formel kommt daran vorbei.</p>
  <p class="fr">Je le mettrais à la retraite en tant qu'"outil de prédiction précise du prix", tout en le conservant comme "visualisation de l'impact structurel du halving sur l'offre." Comme évoqué dans le <a href="/fr/blog/bitcoin-halving-timing">guide du cycle de halving</a>, le choc d'offre lui-même est bien réel. Ce que le S2F nous a réellement appris, c'est que traduire ce choc d'offre en "exactement ce prix" est tout simplement impossible sans tenir compte des variables du côté de la demande — aucune formule n'y échappe.</p>
  <p class="pt">Eu o aposentaria como "ferramenta de previsão precisa de preço", mantendo-o como "visualização do impacto estrutural do halving sobre a oferta." Como abordado no <a href="/pt/blog/bitcoin-halving-timing">guia do ciclo de halving</a>, o choque de oferta em si é real. O que o S2F realmente nos ensinou é que traduzir esse choque de oferta em "exatamente este preço" é simplesmente impossível sem levar em conta as variáveis do lado da demanda — nenhuma fórmula escapa disso.</p>
  <p class="tr">"Kesin fiyat tahmin aracı" olarak onu emekliye ayırır, ancak "yarılanmanın arz üzerindeki yapısal etkisini görselleştiren bir araç" olarak elde tutardım. <a href="/tr/blog/bitcoin-halving-timing">Yarılanma döngüsü rehberinde</a> ele alındığı gibi, arz şoku gerçek bir olgudur. S2F'nin bize asıl öğrettiği şey, bu arz şokunu "tam olarak şu fiyat"a dönüştürmenin, talep tarafındaki değişkenler hesaba katılmadan basitçe mümkün olmadığıdır — hiçbir formül bunun önüne geçemez.</p>
  <p class="vi">Tôi sẽ gác lại nó như một "công cụ dự đoán giá chính xác", nhưng vẫn giữ nó lại như một "công cụ trực quan hóa tác động cấu trúc của halving lên nguồn cung." Như đã đề cập trong <a href="/vi/blog/bitcoin-halving-timing">hướng dẫn về chu kỳ halving</a>, cú sốc nguồn cung tự nó là có thật. Điều mà S2F thực sự dạy chúng ta là việc chuyển cú sốc nguồn cung đó thành "chính xác mức giá này" đơn giản là bất khả thi nếu không tính đến các biến số phía cầu — không công thức nào có thể tránh được điều đó.</p>
