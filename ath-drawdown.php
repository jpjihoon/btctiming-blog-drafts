<?php $slug = 'ath-drawdown'; require __DIR__.'/_header.php'; ?>
  ...
  <p class="fr">Sans calcul on-chain complexe, une simple question permet de savoir à quel point le prix est proche d'une zone de creux historique : <strong>« De combien est-il tombé par rapport à son plus haut historique (ATH) ? »</strong> C'est exactement ce que mesure l'indicateur de <strong>Drawdown depuis l'ATH</strong>.</p>
  <p class="pt">Sem cálculos on-chain complexos, uma pergunta simples pode revelar o quão perto o preço está de uma zona de fundo histórica: <strong>"Quanto caiu em relação à sua máxima histórica (ATH)?"</strong> É exatamente isso que o indicador de <strong>Drawdown desde o ATH</strong> mede.</p>
  <p class="tr">Karmaşık zincir üstü (on-chain) hesaplamalara gerek kalmadan, tek bir basit soru fiyatın tarihsel bir dip bölgesine ne kadar yakın olduğunu gösterebilir: <strong>"Tüm zamanların en yüksek seviyesinden (ATH) ne kadar düştü?"</strong> <strong>ATH Drawdown</strong> göstergesinin ölçtüğü tam olarak budur.</p>
  <p class="vi">Không cần các phép tính on-chain phức tạp, chỉ một câu hỏi đơn giản cũng có thể cho biết giá hiện đang gần vùng đáy lịch sử đến mức nào: <strong>"Giá đã giảm bao nhiêu so với đỉnh cao nhất mọi thời đại (ATH)?"</strong> Đó chính xác là những gì chỉ báo <strong>ATH Drawdown</strong> đo lường.</p>
  ...
  <div class="box fr">💡 <strong>À retenir :</strong> Les 4 derniers creux de cycle majeurs de Bitcoin se sont tous formés entre -70% et -85% sous le plus haut historique. L'entrée dans cette zone mérite d'être recoupée avec d'autres indicateurs.</div>
  <div class="box pt">💡 <strong>Resumo essencial:</strong> Os últimos 4 fundos de ciclo principais do Bitcoin se formaram todos entre -70% e -85% abaixo da máxima histórica. Ao entrar nessa faixa, vale a pena cruzar com outros indicadores.</div>
  <div class="box tr">💡 <strong>Önemli çıkarım:</strong> Bitcoin'in son 4 büyük döngü dibi, tümü tüm zamanların en yüksek seviyesinin -70% ile -85% altında oluştu. Bu aralığa girildiğinde diğer göstergelerle çapraz kontrol yapmak değerlidir.</div>
  <div class="box vi">💡 <strong>Điểm chính:</strong> 4 đáy chu kỳ lớn gần nhất của Bitcoin đều hình thành trong khoảng -70% đến -85% dưới đỉnh cao nhất mọi thời đại. Khi giá bước vào vùng này, việc đối chiếu chéo với các chỉ báo khác là rất đáng làm.</div>
  ...
  <h2 class="fr">Le drawdown par cycle, visualisé</h2>
  <h2 class="pt">O drawdown por ciclo, visualizado</h2>
  <h2 class="tr">Döngüye göre düşüş (drawdown), görselleştirilmiş</h2>
  <h2 class="vi">Mức sụt giảm (drawdown) theo từng chu kỳ, minh họa trực quan</h2>
  ...
  <div class="fr">
  <svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    <text x="20" y="24" fill="#fafafa" font-size="12" font-weight="700" font-family="sans-serif">Baisse depuis l'ATH par cycle — Modération progressive</text>
    <line x1="60" y1="180" x2="660" y2="180" stroke="#3f3f46"/>
    <g font-family="sans-serif">
      <rect x="90" y="45" width="80" height="135" fill="#f87171" rx="4"/>
      <text x="130" y="37" fill="#f87171" font-size="13" font-weight="700" text-anchor="middle">-87%</text>
      ...
      <text x="540" y="120" fill="#4ade80" font-size="11" text-anchor="middle">Capitalisation en hausse →</text>
      <text x="540" y="140" fill="#4ade80" font-size="11" text-anchor="middle">baisses qui s'atténuent</text>
    </g>
  </svg>
  </div>
  <div class="pt">
  <svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    <text x="20" y="24" fill="#fafafa" font-size="12" font-weight="700" font-family="sans-serif">Drawdown desde o ATH por Ciclo — Moderação Gradual</text>
    <line x1="60" y1="180" x2="660" y2="180" stroke="#3f3f46"/>
    <g font-family="sans-serif">
      <rect x="90" y="45" width="80" height="135" fill="#f87171" rx="4"/>
      <text x="130" y="37" fill="#f87171" font-size="13" font-weight="700" text-anchor="middle">-87%</text>
      ...
      <text x="540" y="120" fill="#4ade80" font-size="11" text-anchor="middle">Capitalização de mercado cresce →</text>
      <text x="540" y="140" fill="#4ade80" font-size="11" text-anchor="middle">quedas se moderam</text>
    </g>
  </svg>
  </div>
  <div class="tr">
  <svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    <text x="20" y="24" fill="#fafafa" font-size="12" font-weight="700" font-family="sans-serif">Döngüye Göre ATH Düşüşü — Giderek Hafifliyor</text>
    <line x1="60" y1="180" x2="660" y2="180" stroke="#3f3f46"/>
    <g font-family="sans-serif">
      <rect x="90" y="45" width="80" height="135" fill="#f87171" rx="4"/>
      <text x="130" y="37" fill="#f87171" font-size="13" font-weight="700" text-anchor="middle">-87%</text>
      ...
      <text x="540" y="120" fill="#4ade80" font-size="11" text-anchor="middle">Piyasa değeri büyüyor →</text>
      <text x="540" y="140" fill="#4ade80" font-size="11" text-anchor="middle">düşüşler hafifliyor</text>
    </g>
  </svg>
  </div>
  <div class="vi">
  <svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto;background:#111113;border-radius:12px;border:1px solid rgba(255,255,255,.08);margin:20px 0">
    <text x="20" y="24" fill="#fafafa" font-size="12" font-weight="700" font-family="sans-serif">Mức Sụt Giảm Từ ATH Theo Chu Kỳ — Giảm Dần Theo Thời Gian</text>
    <line x1="60" y1="180" x2="660" y2="180" stroke="#3f3f46"/>
    <g font-family="sans-serif">
      <rect x="90" y="45" width="80" height="135" fill="#f87171" rx="4"/>
      <text x="130" y="37" fill="#f87171" font-size="13" font-weight="700" text-anchor="middle">-87%</text>
      ...
      <text x="540" y="120" fill="#4ade80" font-size="11" text-anchor="middle">Vốn hóa thị trường tăng →</text>
      <text x="540" y="140" fill="#4ade80" font-size="11" text-anchor="middle">mức sụt giảm giảm dần</text>
    </g>
  </svg>
  </div>
  ...
  <div class="rc">
    ...
    <div class="rt fr">A chuté de -87 % depuis le sommet de 2013 de $1,150 à $150.</div>
    <div class="rt pt">Caiu -87% desde o topo de 2013 de $1,150 até $150.</div>
    <div class="rt tr">2013 zirvesi olan $1,150'den -87% düşerek $150'ye geriledi.</div>
    <div class="rt vi">Giảm -87% từ đỉnh $1,150 năm 2013 xuống còn $150.</div>
    ...
    <div class="rr fr">→ A grimpé d'environ 130x jusqu'à $20,000 en 2017</div>
    <div class="rr pt">→ Subiu ~130x até $20,000 em 2017</div>
    <div class="rr tr">→ Ardından 2017'de $20,000'e kadar yaklaşık 130 kat yükseldi</div>
    <div class="rr vi">→ Sau đó tăng khoảng 130 lần lên $20,000 vào năm 2017</div>
  </div>
  <div class="rc">
    ...
    <div class="rt fr">A chuté de -84 % depuis le sommet de 2017 de $19,800 à $3,200.</div>
    <div class="rt pt">Caiu -84% desde o topo de 2017 de $19,800 até $3,200.</div>
    <div class="rt tr">2017 zirvesi olan $19,800'den -84% düşerek $3,200'e geriledi.</div>
    <div class="rt vi">Giảm -84% từ đỉnh $19,800 năm 2017 xuống còn $3,200.</div>
    ...
    <div class="rr fr">→ A grimpé d'environ 20x jusqu'à $69,000 en 2021</div>
    <div class="rr pt">→ Subiu ~20x até $69,000 em 2021</div>
    <div class="rr tr">→ Ardından 2021'de $69,000'e kadar yaklaşık 20 kat yükseldi</div>
    <div class="rr vi">→ Sau đó tăng khoảng 20 lần lên $69,000 vào năm 2021</div>
  </div>
  <div class="rc">
    ...
    <div class="rt fr">A chuté de -77 % depuis le sommet de 2021 de $69,000 à $15,500.</div>
    <div class="rt pt">Caiu -77% desde o topo de 2021 de $69,000 até $15,500.</div>
    <div class="rt tr">2021 zirvesi olan $69,000'den -77% düşerek $15,500'e geriledi.</div>
    <div class="rt vi">Giảm -77% từ đỉnh $69,000 năm 2021 xuống còn $15,500.</div>
    ...
    <div class="rr fr">→ A grimpé d'environ 8x jusqu'à $126,000 en 2025</div>
    <div class="rr pt">→ Subiu ~8x até $126,000 em 2025</div>
    <div class="rr tr">→ Ardından 2025'te $126,000'e kadar yaklaşık 8 kat yükseldi</div>
    <div class="rr vi">→ Sau đó tăng khoảng 8 lần lên $126,000 vào năm 2025</div>
  </div>
  ...
  <h2 class="fr">L'évolution à mesure que le marché mûrit</h2>
  <h2 class="pt">A mudança à medida que o mercado amadurece</h2>
  <h2 class="tr">Piyasa Olgunlaştıkça Ortaya Çıkan Değişim</h2>
  <h2 class="vi">Sự Thay Đổi Khi Thị Trường Trưởng Thành</h2>
  ...
  <p class="fr">Il est notable que l'ampleur du drawdown s'est progressivement réduite à mesure que la capitalisation de marché augmentait. De -87% en 2015 à -77% en 2022, le drawdown de chaque cycle s'est légèrement atténué — probablement le résultat d'une liquidité et d'une participation institutionnelle croissantes à mesure que le marché mûrit.</p>
  <p class="pt">É notável que a magnitude do drawdown tenha diminuído gradualmente à medida que a capitalização de mercado cresceu. De -87% em 2015 para -77% em 2022, o drawdown de cada ciclo se moderou ligeiramente — provavelmente resultado do aumento da liquidez e da participação institucional à medida que o mercado amadurece.</p>
  <p class="tr">Dikkat çekici olan, piyasa değeri büyüdükçe düşüş (drawdown) büyüklüğünün kademeli olarak küçülmesidir. 2015'teki -87%'den 2022'deki -77%'ye kadar, her döngüde düşüş biraz daha hafiflemiştir — bu durum, piyasa olgunlaştıkça artan likidite ve kurumsal katılımın bir sonucu olarak yorumlanabilir.</p>
  <p class="vi">Đáng chú ý là mức độ sụt giảm đã dần thu hẹp khi vốn hóa thị trường tăng lên. Từ -87% năm 2015 xuống -77% năm 2022, mức sụt giảm của mỗi chu kỳ đã giảm nhẹ — có thể là kết quả của thanh khoản và sự tham gia của các tổ chức ngày càng tăng khi thị trường trưởng thành.</p>
  ...
  <ul class="fr">
    <li><strong>Les drawdowns passés ne garantissent pas l'avenir.</strong> Rien ne garantit que le prochain cycle touchera son fond dans la fourchette de -70% à -85%.</li>
    <li><strong>Insuffisant à lui seul.</strong> « Il a beaucoup baissé » ne constitue pas à lui seul une thèse d'achat suffisante — il faut le combiner avec d'autres indicateurs on-chain et de sentiment.</li>
  </ul>
  <ul class="pt">
    <li><strong>Quedas passadas não garantem o futuro.</strong> Não há garantia de que o próximo ciclo forme fundo dentro da faixa de -70% a -85%.</li>
    <li><strong>Não é suficiente sozinho.</strong> "Caiu muito" não é, por si só, uma tese de compra suficiente — deve ser combinado com outros indicadores on-chain e de sentimento.</li>
  </ul>
  <ul class="tr">
    <li><strong>Geçmiş düşüşler geleceği garanti etmez.</strong> Bir sonraki döngünün -70% ile -85% aralığında dip yapacağının garantisi yoktur.</li>
    <li><strong>Tek başına yeterli değildir.</strong> "Çok düştü" demek tek başına yeterli bir alım tezi değildir — diğer on-chain ve duygu durumu göstergeleriyle birlikte değerlendirilmelidir.</li>
  </ul>
  <ul class="vi">
    <li><strong>Mức sụt giảm trong quá khứ không đảm bảo cho tương lai.</strong> Không có gì đảm bảo chu kỳ tiếp theo sẽ tạo đáy trong khoảng -70% đến -85%.</li>
    <li><strong>Không đủ nếu chỉ dùng riêng lẻ.</strong> "Đã giảm nhiều" không đủ để làm luận điểm mua một mình — cần kết hợp với các chỉ báo on-chain và tâm lý thị trường khác.</li>
  </ul>
